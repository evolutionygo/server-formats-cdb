...
function c38107923.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc38107923(c38107923,0))
	...
	e2:SetDescription(aux.Stringc38107923(c38107923,1))
	...
	e3:SetDescription(aux.Stringc38107923(c38107923,2))
...
function c38107923.tgop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e) then
		...
		c:RegisterFlagEffect(c38107923,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_STANDBY+RESET_SELF_TURN,0,1)
	end
end
function c38107923.spcon(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	return c:GetTurnID()~=Duel.GetTurnCount() and tp==Duel.GetTurnPlayer() and c:GetFlagEffect(c38107923)>0
end
function c38107923.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
	local c=e:GetHandler()
	Duel.SetOperationInfo(0,CATEGORY_SPECIAL_SUMMON,c,1,0,0)
	c:ResetFlagEffect(c38107923)
end
