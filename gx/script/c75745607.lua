...
function c75745607.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc75745607(c75745607,0))
	e2:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_F)
	e2:SetCode(EVENT_BATTLE_DAMAGE)
	e2:SetCondition(function(_,tp,_,ep) return ep==1-tp end)
	e2:SetOperation(c75745607.hdreg)
	c:RegisterEffect(e2)
end
function c75745607.hdreg(e,tp,eg,ep,ev,re,r,rp)
	...
	aux.RegisterClientHint(c,0,tp,0,1,aux.Stringc75745607(c75745607,1)):SetReset(RESET_PHASE+PHASE_DRAW)
end
