...
function c35975813.initial_effect(c)
	...
	c:RegisterEffect(e3)
	--Roll a six-sc35975813ed die when resolving an opponent's card effect that targets this card
...
c35975813.listed_series={SET_ARCHFIEND}
c35975813.roll_dice=true
...
function c35975813.disop(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.Hint(HINT_CARD,1-tp,c35975813)
