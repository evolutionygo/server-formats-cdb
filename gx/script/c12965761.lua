...
function c12965761.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc12965761(c12965761,2))
...
c12965761.listed_names={12965762,46571052}
...
function c12965761.tkop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.GetLocationCount(tp,LOCATION_MZONE)>0 
		and Duel.IsPlayerCanSpecialSummonMonster(tp,c12965761+1,0,TYPES_TOKEN,800,800,1,RACE_PLANT,ATTRIBUTE_EARTH) then
		local token=Duel.CreateToken(tp,c12965761+1)
