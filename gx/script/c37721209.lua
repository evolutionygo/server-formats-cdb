...
function c37721209.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc37721209(c37721209,0))
...
c37721209.listed_names={CARD_UMI}
function c37721209.cfilter(c,e,tp)
...
function c37721209.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c37721209.cfilter,tp,LOCATION_ONFIELD,0,1,nil,e,tp) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TOGRAVE)
	local g=Duel.SelectMatchingCard(tp,c37721209.cfilter,tp,LOCATION_ONFIELD,0,1,1,nil,e,tp)
