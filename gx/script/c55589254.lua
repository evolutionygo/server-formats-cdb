...
function c55589254.initial_effect(c)
	...
	e3:SetDescription(aux.Stringc55589254(c55589254,0))
...
function c55589254.sptg(e,tp,eg,ep,ev,re,r,rp,c)
	local rg=Duel.GetMatchingGroup(c55589254.spfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,nil,ATTRIBUTE_FIRE+ATTRIBUTE_WATER)
	local g=aux.SelectUnselectGroup(rg,e,tp,3,3,c55589254.rescon,1,tp,HINTMSG_REMOVE,nil,nil,true)
	if #g>0 then
		g:KeepAlive()
		e:SetLabelObject(g)
		return true
