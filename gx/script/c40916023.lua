...
function c40916023.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc40916023(c40916023,0))
...
function c40916023.spcon(e,c)
	...
	local rg=Duel.GetMatchingGroup(c40916023.spfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,nil,tp)
	local ft=Duel.GetLocationCount(tp,LOCATION_MZONE)
	return ft>-1 and #rg>0 and aux.SelectUnselectGroup(rg,e,tp,1,1,nil,0)
end
function c40916023.sptg(e,tp,eg,ep,ev,re,r,rp,c)
