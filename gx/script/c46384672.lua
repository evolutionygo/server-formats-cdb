...
function c46384672.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc46384672(c46384672,0))
	...
	e3:SetDescription(aux.Stringc46384672(c46384672,1))
...
c46384672.LVnum=5
c46384672.LVset=0x111
function c46384672.bdop(e,tp,eg,ep,ev,re,r,rp)
	e:GetHandler():RegisterFlagEffect(c46384672,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
end
...
function c46384672.spcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c46384672)>0
end
