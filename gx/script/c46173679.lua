...
function c46173679.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc46173679(c46173679,0))
...
c46173679.listed_names={46173680}
function c46173679.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	e1:SetDescription(aux.Stringc46173679(c46173679,1))
...
function c46173679.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return not Duel.IsPlayerAffectedByEffect(tp,CARD_BLUEEYES_SPIRIT)
		...
		and Duel.IsPlayerCanSpecialSummonMonster(tp,c46173679+1,0,TYPES_TOKEN,0,0,1,RACE_FIEND,ATTRIBUTE_DARK,POS_FACEUP_DEFENSE) end
...
function c46173679.activate(e,tp,eg,ep,ev,re,r,rp)
	if Duel.IsPlayerAffectedByEffect(tp,CARD_BLUEEYES_SPIRIT) or Duel.GetLocationCount(tp,LOCATION_MZONE)<2
		or not Duel.IsPlayerCanSpecialSummonMonster(tp,c46173679+1,0,TYPES_TOKEN,0,0,1,RACE_FIEND,ATTRIBUTE_DARK,POS_FACEUP_DEFENSE) then return end
	local c=e:GetHandler()
	for i=1,2 do
		local token=Duel.CreateToken(tp,c46173679+i)
