...
function c31829185.sptg(e,tp,eg,ep,ev,re,r,rp,c)
	local rg=Duel.GetMatchingGroup(c31829185.spfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,nil)
...
function c31829185.tgop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsPreviousControler(tp) and c:IsPreviousLocation(LOCATION_MZONE)
		...
		c:RegisterFlagEffect(c31829185,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
	end
end
function c31829185.eqcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c31829185)>0
end
