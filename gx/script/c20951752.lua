...
function c20951752.initial_effect(c)
	...
	e3:SetDescription(aux.Stringc20951752(c20951752,0))
	...
	e4:SetDescription(aux.Stringc20951752(c20951752,1))
...
function c20951752.sumcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if #(exg-g)>0 and Duel.SelectYesNo(tp,aux.Stringc20951752(59160188,2)) then
		g=g+(exg-g)
	end
