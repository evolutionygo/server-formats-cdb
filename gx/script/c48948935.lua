...
function c48948935.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc48948935(c48948935,0))
...
function c48948935.spfilter(c,tp)
...
function c48948935.spcon(e,c)
	...
	local rg2=Duel.GetMatchingGroup(c48948935.spfilter,tp,LOCATION_MZONE,0,nil,tp)
	return aux.SelectUnselectGroup(rg1,e,tp,2,2,aux.ChkfMMZ(1),0)
		and aux.SelectUnselectGroup(rg2,e,tp,1,1,aux.ChkfMMZ(1),0)
end
function c48948935.sptg(e,tp,eg,ep,ev,re,r,rp,c)
	local rg1=Duel.GetMatchingGroup(c48948935.spfilter,tp,LOCATION_MZONE,0,nil,tp)
...
function c48948935.filter(c)
	return c:IsCode(22610082) and not c:IsForbc48948935den()
end
