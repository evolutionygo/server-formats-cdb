...
function c65450690.initial_effect(c)
	...
	e1:SetCountLimit(1,c65450690,EFFECT_COUNT_CODE_OATH)
...
function c65450690.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc then
		...
		tc:RegisterFlagEffect(c65450690,RESET_EVENT+RESETS_STANDARD,0,1)
...
function c65450690.descon(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:GetFlagEffect(c65450690)~=0 then
		return true
	else
		e:Reset()
		return false
