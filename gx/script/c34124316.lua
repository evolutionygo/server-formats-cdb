...
function c34124316.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	local summonable1,nonsummonable1=Duel.GetDecktopGroup(p,5):Split(c34124316.spchk,nil,e,p)
	local summonable2,nonsummonable2=Duel.GetDecktopGroup(1-p,5):Split(c34124316.spchk,nil,e,1-p)
