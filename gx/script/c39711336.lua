...
function c39711336.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc39711336(c39711336,0))
	...
	e2:SetDescription(aux.Stringc39711336(c39711336,1))
	...
	c:RegisterEffect(e3)
	aux.DoubleSnareValc39711336ity(c,LOCATION_MZONE)
end
function c39711336.target(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	if chk==0 then return c:IsCanTurnSet() and c:GetFlagEffect(c39711336)==0 end
	c:RegisterFlagEffect(c39711336,RESET_EVENT+RESETS_STANDARD-RESET_TURN_SET+RESET_PHASE+PHASE_END,0,1)
