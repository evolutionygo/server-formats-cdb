...
function c13293158.initial_effect(c)
	c:EnableReviveLimit()
	--Fusion material
	aux.AddFusionProcCode2(c,true,true,21844576,86188410)
	--lizard check
	local e0=Effect.CreateEffect(c)
	e0:SetType(EFFECT_TYPE_SINGLE)
	e0:SetCode(CARD_CLOCK_LIZARD)
	e0:SetProperty(EFFECT_FLAG_CANNOT_DISABLE+EFFECT_FLAG_UNCOPYABLE)
	e0:SetCondition(c13293158.lizcon)
	e0:SetValue(1)
	c:RegisterEffect(e0)
	...
	e3:SetDescription(aux.Stringc13293158(c13293158,0))
...
c13293158.listed_names={CARD_DARK_FUSION,21844576,86188410}
function c13293158.lizcon(e,tp,eg,ep,ev,re,r,rp)
