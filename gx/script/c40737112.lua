...
function c40737112.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc40737112(c40737112,0))
	e1:SetCategory(CATEGORY_TOHAND)
	e1:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_O)
	e1:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e1:SetCode(EVENT_PHASE+PHASE_END)
	e1:SetRange(LOCATION_MZONE)
	e1:SetCountLimit(1,c40737112)
	...
	e2:SetDescription(aux.Stringc40737112(c40737112,1))
	...
	aux.GlobalCheck(s,function()
		...
		ge1:SetLabel(c40737112)
		ge1:SetProperty(EFFECT_FLAG_CANNOT_DISABLE)
		ge1:SetOperation(aux.sumreg)
		Duel.RegisterEffect(ge1,0)
		local ge2=ge1:Clone()
		ge2:SetCode(EVENT_SPSUMMON_SUCCESS)
		ge2:SetLabel(c40737112)
		Duel.RegisterEffect(ge2,0)
	end)
end
function c40737112.thcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():GetFlagEffect(c40737112)~=0 end
	e:GetHandler():ResetFlagEffect(c40737112)
end
