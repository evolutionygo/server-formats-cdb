...
function c31247589.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc31247589(c31247589,0))
...
c31247589.listed_series={0x19}
c31247589.listed_names={c31247589}
function c31247589.dacon(e)
	return e:GetHandler():GetFlagEffect(c31247589)>0
end
...
function c31247589.filter(c,e,tp)
	return not c:IsCode(c31247589) and c:IsSetCard(0x19) and c:IsCanBeSpecialSummoned(e,107,tp,false,false)
end
