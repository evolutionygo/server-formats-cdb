...
function c51192573.initial_effect(c)
	local e1=aux.AddNormalSummonProcedure(c,true,true,1,1,SUMMON_TYPE_TRIBUTE,aux.Stringc51192573(c51192573,0),c51192573.otfilter)
	--counter
	local e2=Effect.CreateEffect(c)
	e2:SetDescription(aux.Stringc51192573(c51192573,1))
...
c51192573.listed_series={0xc}
c51192573.counter_place_list={COUNTER_A}
