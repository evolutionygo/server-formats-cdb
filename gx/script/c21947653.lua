...
function c21947653.initial_effect(c)
	c:EnableReviveLimit()
	--Fusion material
	aux.AddFusionProcCode2(c,true,true,20721928,84327329)
	--lizard check
	local e0=Effect.CreateEffect(c)
	e0:SetType(EFFECT_TYPE_SINGLE)
	e0:SetCode(CARD_CLOCK_LIZARD)
	e0:SetProperty(EFFECT_FLAG_CANNOT_DISABLE+EFFECT_FLAG_UNCOPYABLE)
	e0:SetCondition(c21947653.lizcon)
	e0:SetValue(1)
	c:RegisterEffect(e0)
	...
	e2:SetDescription(aux.Stringc21947653(c21947653,0))
...
c21947653.listed_names={CARD_DARK_FUSION,20721928,84327329}
function c21947653.lizcon(e,tp,eg,ep,ev,re,r,rp)
