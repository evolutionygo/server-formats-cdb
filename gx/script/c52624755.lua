...
function c52624755.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc52624755(c52624755,0))
...
c52624755.listed_names={c52624755}
function c52624755.filter(c,e,sp)
	return c:IsCode(c52624755) and c:IsCanBeSpecialSummoned(e,0,sp,false,false)
end
