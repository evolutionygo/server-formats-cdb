...
function c40591390.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc40591390(c40591390,0))
...
c40591390.listed_series={0xc008}
c40591390.listed_names={75041269}
...
function c40591390.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if #g~=0 and Duel.SelectYesNo(tp,aux.Stringc40591390(c40591390,1)) then
		Duel.BreakEffect()
