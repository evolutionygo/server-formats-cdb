...
function c74841885.initial_effect(c)
	...
	c:RegisterEffect(e3)
	aux.DoubleSnareValc74841885ity(c,LOCATION_MZONE)
end
...
function c74841885.valcheck(e,c)
	...
	if lbl~=0 then
		...
		if lbl==TYPE_SPELL then
			e1:SetDescription(aux.Stringc74841885(c74841885,0))
		elseif lbl==TYPE_TRAP then
			e1:SetDescription(aux.Stringc74841885(c74841885,1))
		else
			e1:SetDescription(aux.Stringc74841885(c74841885,2))
		end
