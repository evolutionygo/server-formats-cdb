...
function c16762927.atcost(e,c,tp)
	local ct=#{Duel.GetPlayerEffect(tp,c16762927)}
	return Duel.IsPlayerCanDiscardDeckAsCost(tp,ct)
end
function c16762927.atop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.IsAttackCostPac16762927()~=2 and e:GetHandler():IsLocation(LOCATION_SZONE) then
		Duel.DiscardDeck(tp,1,REASON_COST)
		Duel.AttackCostPac16762927()
	end
end