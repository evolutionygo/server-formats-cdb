...
function c55948544.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	elseif op==2 and Duel.IsExistingMatchingCard(Card.IsCode,tp,LOCATION_GRAVE,0,1,nil,14731897)
		and not Duel.HasFlagEffect(tp,c55948544+1) then
		--If "Unity" is in your GY
		Duel.RegisterFlagEffect(tp,c55948544+1,RESET_PHASE|PHASE_END,0,1)
		--Your opponent cannot Set Spell/Trap Cards or activate Spell/Trap Cards or effects
		local e9=Effect.CreateEffect(c)
		e9:SetDescription(aux.Stringc55948544(c55948544,4))
