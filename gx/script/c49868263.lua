...
function c49868263.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCode2(c,false,false,75953262,67957315)
	--negate
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc49868263(c49868263,0))
	...
	c:RegisterEffect(e4)
	aux.DoubleSnareValc49868263ity(c,LOCATION_MZONE)
end
