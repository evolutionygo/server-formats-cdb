...
function c48453776.initial_effect(c)
	...
	e3:SetDescription(aux.Stringc48453776(c48453776,0))
...
function c48453776.sptg(e,tp,eg,ep,ev,re,r,rp,c)
	...
	local g=aux.SelectUnselectGroup(rg,e,tp,4,4,c48453776.rescon,1,tp,HINTMSG_REMOVE,nil,nil,true)
	if #g>0 then
		g:KeepAlive()
		e:SetLabelObject(g)
		return true
