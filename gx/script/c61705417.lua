...
function c61705417.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) then
		...
		tc:RegisterFlagEffect(c61705417,RESET_EVENT+0x5c0000+RESET_PHASE+PHASE_END,0,1)
...
function c61705417.tgcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return tc:GetControler()~=tc:GetOwner() and tc:GetFlagEffect(c61705417)~=0
end
...
function c61705417.actcon(e,tp,eg,ep,ev,re,r,rp)
	return rp==tp and re:GetHandler()==e:GetLabelObject() and re:GetHandler():GetFlagEffect(c61705417)~=0
end
function c61705417.actop(e,tp,eg,ep,ev,re,r,rp)
	re:GetHandler():RegisterFlagEffect(c61705417+1,RESET_CHAIN,0,1)
	e:Reset()
end
function c61705417.damcon(e,tp,eg,ep,ev,re,r,rp)
	return rp==tp and re:GetHandler()==e:GetLabelObject() and re:GetHandler():GetFlagEffect(c61705417+1)~=0
end
function c61705417.damop(e,tp,eg,ep,ev,re,r,rp)
	re:GetHandler():ResetFlagEffect(c61705417+1)
