...
function c57006589.operation(e,tp,eg,ep,ev,re,r,rp)
	local cc57006589=Duel.GetChainInfo(ev,CHAININFO_CHAIN_ID)
	local e1=Effect.CreateEffect(e:GetHandler())
	e1:SetType(EFFECT_TYPE_FIELD)
	e1:SetCode(EFFECT_REVERSE_DAMAGE)
	e1:SetProperty(EFFECT_FLAG_PLAYER_TARGET)
	e1:SetTargetRange(1,0)
	e1:SetLabel(cc57006589)
...
function c57006589.refcon(e,re,r,rp,rc)
	...
	local cc57006589=Duel.GetChainInfo(0,CHAININFO_CHAIN_ID)
	return cc57006589==e:GetLabel()
end