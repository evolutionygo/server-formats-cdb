...
function c83241722.coincon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetFlagEffect(tp,c83241722)==0
end
function c83241722.coinop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.GetFlagEffect(tp,c83241722)~=0 then return end
	if Duel.SelectYesNo(tp,aux.Stringc83241722(c83241722,0)) then
		Duel.Hint(HINT_CARD,0,c83241722)
		Duel.RegisterFlagEffect(tp,c83241722,RESET_PHASE+PHASE_END,0,1)
		local ct1=(ev&0xff)
		local ct2=(ev>>16)
