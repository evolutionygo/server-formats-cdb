...
function c89731911.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc89731911(c89731911,0))
...
function c89731911.operation(e,tp,eg,ep,ev,re,r,rp)
	if Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		...
		and Duel.SelectYesNo(tp,aux.Stringc89731911(c89731911,1)) then
	...
	if Duel.GetLocationCount(1-tp,LOCATION_MZONE)>0
		...
		and Duel.SelectYesNo(1-tp,aux.Stringc89731911(c89731911,1)) then
