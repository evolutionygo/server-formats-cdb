...
function c82003859.atcost(e,c,tp)
	local ct=#{Duel.GetPlayerEffect(tp,c82003859)}
	return Duel.CheckLPCost(tp,ct*500)
end
function c82003859.atop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.IsAttackCostPac82003859()~=2 and e:GetHandler():IsLocation(LOCATION_SZONE) then
		Duel.PayLPCost(tp,500)
		Duel.AttackCostPac82003859()
	end
end