...
function c42592719.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc42592719(c42592719,0))
...
c42592719.listed_series={0x19}
c42592719.listed_names={c42592719}
...
function c42592719.imcon(e)
	return e:GetHandler():GetFlagEffect(c42592719)>0
end
...
function c42592719.filter(c,e,tp)
	return not c:IsCode(c42592719) and c:IsSetCard(0x19) and c:IsCanBeSpecialSummoned(e,111,tp,false,false)
end
