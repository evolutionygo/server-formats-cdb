...
function c2851070.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc2851070(c2851070,0))
	...
	--destroy
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc2851070(c2851070,1))
...
function c2851070.damop(e,tp,eg,ep,ev,re,r,rp)
	...
	if lp2<lp1 then
		e:GetHandler():RegisterFlagEffect(c2851070,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_DAMAGE,0,1)
	end
end
function c2851070.destg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():GetFlagEffect(c2851070)~=0 end
