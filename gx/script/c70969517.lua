...
function c70969517.initial_effect(c)
	...
	local e1=aux.AddNormalSummonProcedure(c,true,true,1,1,SUMMON_TYPE_TRIBUTE,aux.Stringc70969517(c70969517,0),c70969517.otfilter)
	--damage1
	local e2=Effect.CreateEffect(c)
	e2:SetDescription(aux.Stringc70969517(c70969517,1))
	...
	--damage2
	local e2=Effect.CreateEffect(c)
	e2:SetDescription(aux.Stringc70969517(c70969517,2))
	e2:SetCategory(CATEGORY_DAMAGE)
	e2:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_F)
	e2:SetProperty(EFFECT_FLAG_PLAYER_TARGET)
