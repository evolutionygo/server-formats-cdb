...
function c9744376.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local ct=Duel.GetMatchingGroupCount(Card.IsCode,tp,LOCATION_GRAVE,0,nil,c9744376)
...
function c9744376.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local d=Duel.GetMatchingGroupCount(Card.IsCode,p,LOCATION_GRAVE,0,nil,c9744376)+1
