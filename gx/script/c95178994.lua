...
function c95178994.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc95178994(c95178994,0))
...
c95178994.listed_names={c95178994}
...
function c95178994.filter(c,e,tp)
	return c:IsCode(c95178994) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP_ATTACK)
end
function c95178994.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.Damage(1-tp,500,REASON_EFFECT)>0 then
		...
		if #g>0 and Duel.SelectYesNo(tp,aux.Stringc95178994(c95178994,1)) then
			Duel.BreakEffect()
