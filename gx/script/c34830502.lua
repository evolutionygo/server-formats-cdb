...
function c34830502.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc34830502(c34830502,0))
...
c34830502.listed_names={19877898,34088136}
c34830502.LVnum=5
c34830502.LVset=0x5d
function c34830502.con(e)
	return e:GetHandler():GetFlagEffect(c34830502)~=0
end
function c34830502.regop(e,tp,eg,ep,ev,re,r,rp)
	e:GetHandler():RegisterFlagEffect(c34830502+1,RESET_EVENT+0x1ec0000+RESET_PHASE+PHASE_END,0,1)
end
function c34830502.spcon(e,tp,eg,ep,ev,re,r,rp)
	return tp==Duel.GetTurnPlayer() and e:GetHandler():GetFlagEffect(c34830502+1)==0
end
