...
function c102380.initial_effect(c)
	...
	aux.AddLavaProcedure(c,2,POS_FACEUP,nil,0,aux.Stringc102380(c102380,0))
	--Take 1000 damage
	local e2=Effect.CreateEffect(c)
	e2:SetDescription(aux.Stringc102380(c102380,1))
	...
	e3:SetOperation(c102380.spcostop)
	c:RegisterEffect(e3)
end
...
function c102380.spcostop(e,tp,eg,ep,ev,re,r,rp)
	--Cannot Normal Summon/Set
	local e1=Effect.CreateEffect(e:GetHandler())
	e1:SetDescription(aux.Stringc102380(c102380,2))
