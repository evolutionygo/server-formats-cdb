...
function c58921041.aclimit(e,re,tp)
	...
	return not c:IsLocation(LOCATION_SZONE) or c:GetFlagEffect(c58921041)>0
end
function c58921041.aclimset(e,tp,eg,ep,ev,re,r,rp)
	local tc=eg:GetFirst()
	for tc in aux.Next(eg) do
		tc:RegisterFlagEffect(c58921041,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END+RESET_OPPO_TURN,0,1)
	end
end