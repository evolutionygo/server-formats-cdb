--王虎ワンフー
local s,c83986578 = GetID()
function c83986578.initial_effect(c)
	--destroy
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc83986578(c83986578,0))
...
function c83986578.condition(e,tp,eg,ep,ev,re,r,rp)
	return eg:IsExists(c83986578.filter,1,nil) and not eg:IsContains(e:GetHandler()) and not e:GetHandler():IsStatus(STATUS_BATTLE_DESTROYED)
end
function c83986578.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
	local g=eg:Filter(c83986578.filter,nil)
