...
function c19041767.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc19041767(c19041767,0))
...
function c19041767.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	local tc=Duel.SelectMatchingCard(tp,c19041767.filter,tp,LOCATION_HAND+LOCATION_MZONE,0,1,1,nil):GetFirst()
	if tc then
