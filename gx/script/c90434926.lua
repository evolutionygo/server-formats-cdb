...
function c90434926.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc90434926(c90434926,0))
...
function c90434926.drop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsLocation(LOCATION_GRAVE) and Duel.IsPlayerCanDraw(tp,1) and Duel.SelectYesNo(tp,aux.Stringc90434926(c90434926,1)) then
		Duel.BreakEffect()
