...
function c79580323.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc79580323(c79580323,0))
	...
	e2:SetDescription(aux.Stringc79580323(c79580323,1))
...
c79580323.listed_names={c79580323}
c79580323.listed_series={0x4d,0x19}
...
function c79580323.filter(c,e,tp)
	return not c:IsCode(c79580323) and c:IsSetCard(0x19) and c:IsCanBeSpecialSummoned(e,110,tp,false,false)
end
