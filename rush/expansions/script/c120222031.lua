...
function cm.spfilter(c,e,tp)
	return c:IsType(TYPE_NORMAL) and c:IsLevelBelow(6) and c:IsRace(RACE_BEASTWARRIOR)
...
function cm.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if RD.SendDeckTopToGraveAndExists(tp,2) and RD.IsSummonOrSpecialSummonMainPhase(c) then
