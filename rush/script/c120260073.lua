...
function cm.filter(c)
	return c:IsFaceup() and c:IsType(TYPE_EFFECT) and c:IsLevelAbove(3) and c:IsLevelBelow(8)
end
function cm.thfilter(c)
	return c:IsLevel(8) and c:IsAttack(2400) and RD.IsDefense(c,1000) and c:IsAbleToHand()
end
