...
function c511000480.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	elseif (dice==3 or dice==4) and Duel.IsExistingMatchingCard(c511000480.filter,tp,LOCATION_GRAVE,0,1,nil,e,tp) and Duel.GetLocationCount(tp,LOCATION_MZONE)>0 then
	...
	elseif dice==5 or dice==6 then
		...
		e1:SetTarget(aux.FieldSummonProcTg(c511000480.nttg))
