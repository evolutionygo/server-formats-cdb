...
function c3773196.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc3773196(c3773196,0))
...
function c3773196.rmop(e,tp,eg,ep,ev,re,r,rp)
	...
	e:GetHandler():RegisterFlagEffect(c3773196,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
end
function c3773196.condition(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c3773196)~=0
end
function c3773196.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():GetFlagEffect(c3773196+1)==0 end
	Duel.SetOperationInfo(0,CATEGORY_SPECIAL_SUMMON,e:GetHandler(),1,0,0)
	e:GetHandler():RegisterFlagEffect(c3773196+1,RESET_EVENT+0x4760000+RESET_PHASE+PHASE_END,0,1)
end
