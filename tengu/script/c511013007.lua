...
function c511013007.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsPlayerCanSpecialSummonMonster(tp,c511013007,0,0x1011,0,0,1,RACE_FIEND,ATTRIBUTE_FIRE) end
...
function c511013007.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.GetLocationCount(tp,LOCATION_MZONE)<=0
		or not Duel.IsPlayerCanSpecialSummonMonster(tp,c511013007,0,0x1011,0,0,1,RACE_FIEND,ATTRIBUTE_FIRE) then return end
