...
function c4694209.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc4694209(c4694209,0))
	...
	e4:SetDescription(aux.Stringc4694209(c4694209,1))
...
c4694209.counter_place_list={0x1021}
...
function c4694209.addct2(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	Duel.Hint(HINT_SELECTMSG,tp,aux.Stringc4694209(c4694209,1))
...
function c4694209.addc2(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsFaceup() and tc:IsRelateToEffect(e) then
		...
		if tc:GetFlagEffect(c4694209)~=0 then return end
		local e1=Effect.CreateEffect(c)
		...
		tc:RegisterFlagEffect(c4694209,RESET_EVENT+RESETS_STANDARD,0,0)
	end
end
