...
function c3146695.regop(e,tp,eg,ep,ev,re,r,rp)
	...
	for tc in aux.Next(g) do
		tc:RegisterFlagEffect(c3146695,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
	end
	g:KeepAlive()
	local e1=Effect.CreateEffect(e:GetHandler())
	e1:SetDescription(aux.Stringc3146695(c3146695,0))
...
function c3146695.filter(c,g)
	return c:GetFlagEffect(c3146695)>0 and g:IsContains(c)
end
