...
function c19605133.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc19605133(c19605133,0))
	...
	e2:SetDescription(aux.Stringc19605133(c19605133,1))
	e2:SetCategory(CATEGORY_ATKCHANGE)
	e2:SetType(EFFECT_TYPE_IGNITION)
	e2:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e2:SetRange(LOCATION_MZONE)
	e2:SetCost(aux.CostWithReplace(c19605133.atcost,CARD_NATURIA_CAMELLIA))
	e2:SetTarget(c19605133.attg)
	e2:SetOperation(c19605133.atop)
	c:RegisterEffect(e2)
end
c19605133.listed_series={0x2a}
