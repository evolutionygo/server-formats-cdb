...
function c64238008.initial_effect(c)
	...
	c:RegisterEffect(e1)
	Duel.AddCustomActivityCounter(c64238008,ACTIVITY_CHAIN,c64238008.chainfilter)
end
function c64238008.chainfilter(re,tp,cc64238008)
...
function c64238008.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	e:SetLabel(1)
	if chk==0 then return Duel.GetCustomActivityCount(c64238008,tp,ACTIVITY_CHAIN)==0 and Duel.CheckReleaseGroup(tp,nil,1,nil) end
