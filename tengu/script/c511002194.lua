...
function c511002194.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511002194(41442341,0))
...
function c511002194.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>2 
		and Duel.IsExistingMatchingCard(c511002194.filter,tp,LOCATION_GRAVE,0,3,nil,e,tp) end
...
function c511002194.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,c511002194.filter,tp,LOCATION_GRAVE,0,3,3,nil,e,tp)
