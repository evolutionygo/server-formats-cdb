...
function c29307554.checkop(e,tp,eg,ep,ev,re,r,rp)
	...
	if p1 then Duel.RegisterFlagEffect(0,c29307554,RESET_PHASE+PHASE_END,0,1) end
	if p2 then Duel.RegisterFlagEffect(1,c29307554,RESET_PHASE+PHASE_END,0,1) end
end
function c29307554.condition(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetFlagEffect(tp,c29307554)~=0 and Duel.GetTurnPlayer()==tp
