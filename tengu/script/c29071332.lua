...
function c29071332.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc29071332(c29071332,0))
...
function c29071332.eqtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return e:GetHandler():GetFlagEffect(c29071332)==0 and Duel.GetLocationCount(tp,LOCATION_SZONE)>0
	...
	e:GetHandler():RegisterFlagEffect(c29071332,RESET_EVENT+0x7e0000+RESET_PHASE+PHASE_END,0,1)
end
function c29071332.eqop(e,tp,eg,ep,ev,re,r,rp)
	...
	--unequip
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc29071332(c29071332,1))
	...
	e3:SetDescription(aux.Stringc29071332(c29071332,2))
...
function c29071332.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():GetFlagEffect(c29071332)==0 and Duel.GetLocationCount(tp,LOCATION_MZONE)>0
