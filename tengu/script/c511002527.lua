...
function c511002527.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	while tc do
		...
		tc:RegisterFlagEffect(c511002527,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
		tc=sg1:GetNext()
	end
...
function c511002527.desfilter(c,fc511002527)
	return c:GetFlagEffect(c511002527)>0
end
