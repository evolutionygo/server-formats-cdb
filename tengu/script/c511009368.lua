...
function c511009368.initial_effect(c)
	--fusion material
	aux.AddFusionProcCode2(c,true,true,c511009368.ffilter,aux.FilterBoolFunctionEx(Card.IsSetCard,0x9f))
	c:EnableReviveLimit()
	--damage
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc511009368(29343734,0))
	...
	e3:SetDescription(aux.Stringc511009368(66970002,0))
...
function c511009368.regop(e,tp,eg,ep,ev,re,r,rp)
	e:GetHandler():RegisterFlagEffect(c511009368,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
end
function c511009368.descon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c511009368)~=0
end
