...
function c511015129.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc511015129(698785,0))
...
function c511015129.target(e,tp,eg,ep,ev,re,r,rp,chk)
	local flag=e:GetHandler():GetFlagEffect(c511015129+1)
...
function c511015129.operation(e,tp,eg,ep,ev,re,r,rp)
	local g=Duel.GetMatchingGroup(c511015129.filter,tp,0,LOCATION_ONFIELD,nil,e:GetHandler():GetSequence(),e:GetHandler():GetFlagEffect(c511015129+1))
