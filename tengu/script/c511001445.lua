...
function c511001445.filter(c,tc511001445)
	return c:GetTurnID()==tc511001445 and c:IsReason(REASON_BATTLE)
end
...
function c511001445.target(e,tp,eg,ep,ev,re,r,rp,chk)
	local tc511001445=Duel.GetTurnCount()
	local mg=Duel.GetMatchingGroup(c511001445.filter,tp,LOCATION_GRAVE,0,nil,tc511001445)
