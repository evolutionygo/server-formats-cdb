...
function c65196094.initial_effect(c)
	...
	c:RegisterEffect(e1)
	Duel.AddCustomActivityCounter(c65196094,ACTIVITY_SPSUMMON,c65196094.counterfilter)
end
...
function c65196094.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	e:SetLabel(1)
	if chk==0 then return Duel.GetCustomActivityCount(c65196094,tp,ACTIVITY_SPSUMMON)==0 end
	...
	aux.RegisterClientHint(e:GetHandler(),nil,tp,1,0,aux.Stringc65196094(c65196094,1),nil)
end
