...
function c511001639.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511001639(c511001639,0))
...
function c511001639.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsFaceup() and c:IsRelateToEffect(e) then
		Duel.Hint(HINT_SELECTMSG,tp,aux.Stringc511001639(76922029,0))
		local op=Duel.SelectOption(tp,aux.Stringc511001639(82693917,0),aux.Stringc511001639(17643265,0))
		local e1=Effect.CreateEffect(c)
