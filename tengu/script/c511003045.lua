...
local s,c511003045,alias=GetID()
function c511003045.initial_effect(c)
	...
	e4:SetDescription(aux.Stringc511003045(alias,2))
...
function c511003045.indcon2(e,tp,eg,ep,ev,re,r,rp)
	...
	return ex and tg~=nil and tc+tg:FilterCount(c511003045.cfilter,nil,nil,tp)-#tg>0
end
...
function c511003045.scfilter1(c,tp,mc)
	return Duel.IsExistingMatchingCard(c511003045.scfilter2,tp,LOCATION_PZONE,0,1,nil,mc,c,tp)
end
function c511003045.scfilter2(c,mc,sc,tp)
...
function c511003045.sctg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return Duel.IsExistingMatchingCard(c511003045.scfilter1,tp,LOCATION_EXTRA,0,1,nil,tp,c) end
...
function c511003045.scop(e,tp,eg,ep,ev,re,r,rp)
	...
	if #g>0 then
		...
		Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_SMATERIAL)
		local mg=Duel.SelectMatchingCard(tp,c511003045.scfilter2,tp,LOCATION_PZONE,0,1,1,nil,c,sc,tp)
		mg:AddCard(c)
