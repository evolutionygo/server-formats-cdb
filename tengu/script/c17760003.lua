...
function c17760003.regop(e,tp,eg,ep,ev,re,r,rp)
	...
	if (att&ATTRIBUTE_WIND)~=0 then
		local e1=Effect.CreateEffect(c)
		e1:SetDescription(aux.Stringc17760003(c17760003,0))
		...
		c:RegisterEffect(e1)
		c:RegisterFlagEffect(0,RESET_EVENT+RESETS_STANDARD,EFFECT_FLAG_CLIENT_HINT,1,0,aux.Stringc17760003(c17760003,3))
	end
	if (att&ATTRIBUTE_WATER)~=0 then
		local e1=Effect.CreateEffect(c)
		e1:SetDescription(aux.Stringc17760003(c17760003,1))
		...
		e1:SetReset(RESET_EVENT+RESETS_STANDARD)
		c:RegisterEffect(e1)
		c:RegisterFlagEffect(0,RESET_EVENT+RESETS_STANDARD,EFFECT_FLAG_CLIENT_HINT,1,0,aux.Stringc17760003(c17760003,4))
	end
	if (att&ATTRIBUTE_DARK)~=0 then
		local e1=Effect.CreateEffect(c)
		e1:SetDescription(aux.Stringc17760003(c17760003,2))
		...
		e1:SetReset(RESET_EVENT+RESETS_STANDARD)
		c:RegisterEffect(e1)
		c:RegisterFlagEffect(0,RESET_EVENT+RESETS_STANDARD,EFFECT_FLAG_CLIENT_HINT,1,0,aux.Stringc17760003(c17760003,5))
	end
end
