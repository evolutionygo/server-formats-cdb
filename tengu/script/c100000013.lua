...
function c100000013.initial_effect(c)
	...
	e4:SetDescription(aux.Stringc100000013(13455953,0))
...
function c100000013.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingMatchingCard(c100000013.spfilter,tp,LOCATION_HAND,0,1,nil,e,tp) end
