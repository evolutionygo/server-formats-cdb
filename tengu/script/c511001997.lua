...
function c511001997.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc511001997(80764541,0))
	...
	e3:SetDescription(aux.Stringc511001997(93568288,0))
...
function c511001997.desop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.CheckLPCost(1-tp,500) and Duel.SelectYesNo(1-tp,aux.Stringc511001997(80764541,1)) then
