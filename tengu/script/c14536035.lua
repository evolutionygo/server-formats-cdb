...
function c14536035.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc14536035(c14536035,0))
	...
	e2:SetDescription(aux.Stringc14536035(c14536035,1))
...
function c14536035.spcon(e,c)
	...
	local rg=Duel.GetMatchingGroup(c14536035.spfilter,tp,LOCATION_HAND,0,nil)
	return aux.SelectUnselectGroup(rg,e,tp,1,1,aux.ChkfMMZ(1),0,c)
end
function c14536035.sptg(e,tp,eg,ep,ev,re,r,rp,c)
