...
function c511002871.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc511002871(c511002871,0))
	...
	e3:SetDescription(aux.Stringc511002871(c511002871,1))
	e3:SetCategory(CATEGORY_NEGATE+CATEGORY_HANDES)
	e3:SetProperty(EFFECT_FLAG_DAMAGE_STEP+EFFECT_FLAG_DAMAGE_CAL)
	e3:SetType(EFFECT_TYPE_QUICK_O)
	e3:SetRange(LOCATION_MZONE)
	e3:SetCode(EVENT_CHAINING)
	e3:SetCondition(c511002871.condition)
	e3:SetCost(aux.dxmcostgen(1,1,nil))
	e3:SetTarget(c511002871.target)
	e3:SetOperation(c511002871.operation)
...
c511002871.listed_series={SET_NUMBER}
c511002871.listed_names={2061963}
c511002871.aux.xyz_number=104
