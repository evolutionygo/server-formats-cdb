...
function c293542.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc293542(c293542,0))
...
c293542.listed_series={0x27}
c293542.listed_names={c293542}
...
function c293542.regop(e,tp,eg,ep,ev,re,r,rp)
	...
	if (c:GetPreviousLocation()&LOCATION_ONFIELD)~=0 and c:IsReason(REASON_DESTROY) then
		local e1=Effect.CreateEffect(c)
		e1:SetDescription(aux.Stringc293542(c293542,1))
...
function c293542.filter(c)
	return c:IsSetCard(0x27) and not c:IsCode(c293542) and c:IsMonster() and c:IsAbleToHand()
end
