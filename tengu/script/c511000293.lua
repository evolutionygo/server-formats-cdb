...
function c511000293.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc511000293(c511000293,0))
	...
	e3:SetDescription(aux.Stringc511000293(c511000293,1))
...
function c511000293.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then
		...
		return #pg<=1 and at and at:GetRank()>0 and Duel.IsExistingMatchingCard(c511000293.filter,tp,LOCATION_EXTRA,0,1,nil,e,tp,at:GetRank(),at,pg)
	end
