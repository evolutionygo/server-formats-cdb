...
function c511001952.initial_effect(c)
	c:AddSetcodesRule(c511001952,false,0x601)
	--level 0
	...
	e5:SetDescription(aux.Stringc511001952(29146185,1))
	e5:SetCategory(CATEGORY_DESTROY+CATEGORY_DAMAGE)
	e5:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_F)
	e5:SetCode(c511001952)
...
function c511001952.desreptg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	return Duel.SelectYesNo(tp,aux.Stringc511001952(c511001952,0))
end
function c511001952.desrepop(e,tp,eg,ep,ev,re,r,rp)
	Duel.RaiseSingleEvent(e:GetHandler(),c511001952,re,r,rp,0,0)
end
