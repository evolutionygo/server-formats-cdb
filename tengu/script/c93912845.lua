...
c93912845.listed_names={93912845}
...
function c93912845.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.GetLocationCount(1-tp,LOCATION_MZONE)>1 and Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		...
		and Duel.IsPlayerCanSpecialSummonMonster(tp,c93912845+1,0,TYPES_TOKEN,1500,1500,3,RACE_FIEND,ATTRIBUTE_DARK,POS_FACEUP,1-tp) end
...
function c93912845.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.GetLocationCount(1-tp,LOCATION_MZONE)>1 
		and Duel.IsPlayerCanSpecialSummonMonster(tp,c93912845+1,0,TYPES_TOKEN,1500,1500,3,RACE_FIEND,ATTRIBUTE_DARK,POS_FACEUP,1-tp) then
		for i=1,2 do
			local token=Duel.CreateToken(tp,c93912845+1)
