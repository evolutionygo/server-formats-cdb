...
function c5975022.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc5975022(c5975022,0))
	...
	e2:SetDescription(aux.Stringc5975022(c5975022,1))
...
function c5975022.filter(c,e,tp)
	return not c:IsCode(c5975022) and c:IsSetCard(0x19) and c:IsCanBeSpecialSummoned(e,105,tp,false,false)
end
