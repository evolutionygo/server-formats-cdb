...
function c60741115.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc60741115(c60741115,0))
...
function c60741115.operation(e,tp,eg,ep,ev,re,r,rp)
	local cc60741115=Duel.GetChainInfo(ev,CHAININFO_CHAIN_ID)
	--damage conversion
	...
	e1:SetLabel(cc60741115)
	Duel.RegisterEffect(e1,tp)
end
function c60741115.rev(e,re,r,rp,rc)
	local cc=Duel.GetCurrentChain()
	if cc==0 or (r&REASON_EFFECT)==0 then return false end
	local cc60741115=Duel.GetChainInfo(0,CHAININFO_CHAIN_ID)
	return cc60741115==e:GetLabel()
end