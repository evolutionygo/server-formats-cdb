...
function c511600091.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc511600091(62306203,0))
	e2:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e2:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_O)
	e2:SetProperty(EFFECT_FLAG_DELAY)
	e2:SetCode(EVENT_DESTROYED)
	e2:SetRange(LOCATION_GRAVE)
	e2:SetCountLimit(1,c511600091)
...
function c511600091.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		...
		and c:GetFlagEffect(c511600091)>0 end
...
function c511600091.regop(e,tp,eg,ep,ev,re,r,rp)
	e:GetHandler():RegisterFlagEffect(c511600091,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
end