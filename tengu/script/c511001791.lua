...
function c511001791.initial_effect(c)
	...
	e4:SetDescription(aux.Stringc511001791(c511001791,0))
	...
	e5:SetDescription(aux.Stringc511001791(35952884,1))
...
function c511001791.pcfilter(c)
	return c:IsType(TYPE_PENDULUM) and not c:IsForbc511001791den()
end
