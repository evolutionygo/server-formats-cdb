...
function c29587993.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc29587993(c29587993,0))
	...
	e1:SetTarget(c29587993.negtg)
	e1:SetOperation(c29587993.negop)
	c:RegisterEffect(e1)
end
c29587993.listed_series={SET_MIST_VALLEY}
function c29587993.tgfilter(c)
	return c:IsFaceup() and c:IsSetCard(SET_MIST_VALLEY) and c:IsAbleToHand()
end
function c29587993.negtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsOnField() and chkc:IsControler(tp) and c29587993.tgfilter(chkc) end
	if chk==0 then return Duel.IsExistingTarget(c29587993.tgfilter,tp,LOCATION_ONFIELD,0,1,nil) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_RTOHAND)
	local g=Duel.SelectTarget(tp,c29587993.tgfilter,tp,LOCATION_ONFIELD,0,1,1,nil)
...
function c29587993.negop(e,tp,eg,ep,ev,re,r,rp)
