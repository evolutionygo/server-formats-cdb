...
function c511002793.rmop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:GetFlagEffect(c511002793+1)>0 then
		Duel.Remove(c,POS_FACEUP,REASON_EFFECT)
		c:ResetFlagEffect(c511002793+1)
	end
end
...
function c511002793.regop(e,tp,eg,ep,ev,re,r,rp)
	e:GetHandler():RegisterFlagEffect(c511002793+1,RESET_EVENT+0x1fa0000,0,0)
end