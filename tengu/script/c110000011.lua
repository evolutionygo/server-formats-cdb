...
function c110000011.initial_effect(c)
	...
	e4:SetDescription(aux.Stringc110000011(c110000011,0))
	e4:SetCategory(CATEGORY_TOGRAVE)
	e4:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_F)
	e4:SetRange(LOCATION_MZONE)
	e4:SetCountLimit(1)
	e4:SetCode(EVENT_PHASE+PHASE_END)
	e4:SetCondition(c110000011.tgcon)
	e4:SetTarget(c110000011.tgtg)
	e4:SetOperation(c110000011.tgop)
	c:RegisterEffect(e4)
	--destroy
	local e5=Effect.CreateEffect(c)
	e5:SetDescription(aux.Stringc110000011(c110000011,1))
	e5:SetCategory(CATEGORY_DESTROY)
	e5:SetType(EFFECT_TYPE_IGNITION)
	e5:SetRange(LOCATION_MZONE)
	e5:SetCost(c110000011.descost)
	e5:SetTarget(c110000011.destg)
	e5:SetOperation(c110000011.desop)
	c:RegisterEffect(e5)
end
