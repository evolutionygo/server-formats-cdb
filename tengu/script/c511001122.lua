...
function c511001122.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511001122(c511001122,0))
	...
	e4:SetDescription(aux.Stringc511001122(c511001122,1))
	c:RegisterEffect(e4)
end
...
function c511001122.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local tc=Duel.SelectTarget(tp,c511001122.filter,tp,0,LOCATION_GRAVE,1,1,nil,e,tp,eg,ep,ev,re,r,rp,chain):GetFirst()
