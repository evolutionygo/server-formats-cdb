...
--updated by Larry126
local s,c511001949,alias=GetID()
function c511001949.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511001949(alias,0))
	...
	e3:SetDescription(aux.Stringc511001949(alias,1))
...
c511001949.synchro_tuner_required=1
