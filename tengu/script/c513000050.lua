...
function c513000050.initial_effect(c)
	...
	e3:SetCondition(c513000050.damcon)
	e3:SetOperation(c513000050.damop)
	c:RegisterEffect(e3)
	--disable summon
	...
	e4:SetTarget(c513000050.sumlimit)
	c:RegisterEffect(e4)
	local e5=e4:Clone()
	...
	e7:SetDescription(aux.Stringc513000050(c513000050,1))
	...
	e8:SetDescription(aux.Stringc513000050(c513000050,0))
	e8:SetCode(EVENT_BATTLED)
	e8:SetTarget(c513000050.tg)
	e8:SetOperation(c513000050.op)
	c:RegisterEffect(e8)
end
...
function c513000050.damop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.SelectYesNo(tp,aux.Stringc513000050(c513000050,2)) then
		Duel.Hint(HINT_CARD,1-tp,c513000050)
