...
function c511600383.initial_effect(c)
	--Activate
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc511600383(c511600383,0))
	e1:SetType(EFFECT_TYPE_ACTIVATE)
	e1:SetCode(EVENT_FREE_CHAIN)
	e1:SetHintTiming(TIMING_BATTLE_END)
	e1:SetCondition(c511600383.condition)
	e1:SetOperation(c511600383.activate)
	c:RegisterEffect(e1)
end
function c511600383.condition(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetCurrentChain(true)==0
end
function c511600383.activate(e,tp,eg,ep,ev,re,r,rp)
