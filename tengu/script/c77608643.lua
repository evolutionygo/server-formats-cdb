...
function c77608643.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc77608643(c77608643,0))
...
c77608643.listed_series={0xc008}
...
function c77608643.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:GetFlagEffect(c77608643)==0 then
		sg:Clear()
		c:RegisterFlagEffect(c77608643,RESET_EVENT+0x3fe0000+RESET_PHASE+PHASE_STANDBY+RESET_SELF_TURN,0,1)
	end
	sg:Merge(g)
end
function c77608643.spcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetTurnPlayer()==tp and e:GetHandler():GetFlagEffect(c77608643)~=0
end
