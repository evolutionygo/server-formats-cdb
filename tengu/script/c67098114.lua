...
function c67098114.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc67098114(c67098114,0))
	...
	e3:SetDescription(aux.Stringc67098114(c67098114,1))
	...
	e4:SetDescription(aux.Stringc67098114(c67098114,2))
	...
	c:RegisterEffect(e4)
	aux.DoubleSnareValc67098114ity(c,LOCATION_MZONE)
end
c67098114.listed_series={0xa042}
function c67098114.tfilter(c,scard,sumtype,tp)
...
function c67098114.regop(e,tp,eg,ep,ev,re,r,rp)
	...
	if rp~=tp and c:IsPreviousControler(tp) and c:IsReason(REASON_DESTROY)
		...
		c:RegisterFlagEffect(c67098114,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
	end
end
function c67098114.spcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c67098114)~=0
end
