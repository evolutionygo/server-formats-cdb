...
function c513000062.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc513000062(876330,0))
	...
	e2:SetDescription(aux.Stringc513000062(612115,0))
...
c513000062.listed_series={0x48}
c513000062.aux.xyz_number=80
...
function c513000062.rmop(e,tp,eg,ep,ev,re,r,rp)
	...
	local op=3
	Duel.Hint(HINT_SELECTMSG,tp,aux.Stringc513000062(53839837,5))
	if a and b and c then
		op=Duel.SelectOption(tp,aux.Stringc513000062(53839837,1),aux.Stringc513000062(53839837,2),aux.Stringc513000062(53839837,3))
	elseif a and b then
		op=Duel.SelectOption(tp,aux.Stringc513000062(53839837,1),aux.Stringc513000062(53839837,2))
	elseif b and c then
		op=Duel.SelectOption(tp,aux.Stringc513000062(53839837,2),aux.Stringc513000062(53839837,3))
		op=op+1
	elseif a and c then
		op=Duel.SelectOption(tp,aux.Stringc513000062(53839837,1),aux.Stringc513000062(53839837,3))
		if op==1 then op=op+1 end
	elseif a then
		Duel.SelectOption(tp,aux.Stringc513000062(53839837,1))
		op=0
	elseif b then
		Duel.SelectOption(tp,aux.Stringc513000062(53839837,2))
		op=1
	elseif c then
		Duel.SelectOption(tp,aux.Stringc513000062(53839837,3))
		op=2
	end
	local type=0
...
function c513000062.btcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc513000062(67441435,0))
...
function c513000062.op(e,tp,eg,ep,ev,re,r,rp)
	local cc513000062=Duel.GetChainInfo(ev,CHAININFO_CHAIN_ID)
	local e1=Effect.CreateEffect(e:GetHandler())
	e1:SetType(EFFECT_TYPE_FIELD)
	e1:SetCode(EFFECT_CHANGE_DAMAGE)
	e1:SetProperty(EFFECT_FLAG_PLAYER_TARGET)
	e1:SetTargetRange(1,0)
	e1:SetLabel(cc513000062)
...
function c513000062.refcon(e,re,val,r,rp,rc)
	...
	local cc513000062=Duel.GetChainInfo(0,CHAININFO_CHAIN_ID)
	return val/2
end
