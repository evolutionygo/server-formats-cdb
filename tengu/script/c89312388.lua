...
function c89312388.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc89312388(c89312388,0))
...
function c89312388.filter1(c,tp)
	return c.material and c:IsType(TYPE_FUSION) and Duel.IsExistingMatchingCard(c89312388.filter2,tp,LOCATION_DECK,0,1,nil,c)
end
