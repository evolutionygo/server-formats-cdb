...
function c100000014.initial_effect(c)
	...
	e4:SetDescription(aux.Stringc100000014(13455953,0))
...
c100000014.listed_series={0x4a}
c100000014.listed_names={36894320,8967776}
...
function c100000014.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0 
		and Duel.IsExistingMatchingCard(c100000014.spfilter,tp,LOCATION_HAND,0,1,nil,e,tp) end
end
