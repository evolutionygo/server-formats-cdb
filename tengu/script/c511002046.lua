...
function c511002046.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511002046(93830681,0))
...
function c511002046.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc and tc:IsRelateToEffect(e) and tc:IsFaceup() then
		...
		e1:SetDescription(aux.Stringc511002046(16691074,0))
		...
		e2:SetDescription(aux.Stringc511002046(29146185,1))
		e2:SetCategory(CATEGORY_DESTROY)
		e2:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
		e2:SetCode(c511002046)
...
function c511002046.atkop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsFaceup() and c:IsRelateToEffect(e) then
		Duel.RaiseSingleEvent(c,c511002046,e,r,rp,ep,0)
	end
end
