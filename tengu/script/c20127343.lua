...
function c20127343.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc20127343(c20127343,0))
	e1:SetType(EFFECT_TYPE_IGNITION)
	e1:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e1:SetRange(LOCATION_MZONE)
	e1:SetCountLimit(1)
	e1:SetTarget(c20127343.attrtg)
	e1:SetOperation(c20127343.attrop)
	c:RegisterEffect(e1)
end
function c20127343.attrtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c20127343.attrop(e,tp,eg,ep,ev,re,r,rp)
