...
function c513000159.filter(c,c513000159,e,tp)
	return c:IsReason(REASON_DESTROY) and c:IsReason(REASON_EFFECT) and c:GetTurnID()==c513000159 and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
