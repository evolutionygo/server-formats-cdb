...
function c81254059.initial_effect(c)
	...
	local e1=aux.AddNormalSummonProcedure(c,true,true,1,1,SUMMON_TYPE_TRIBUTE,aux.Stringc81254059(c81254059,0),c81254059.otfilter)
	--special summon
	local e2=Effect.CreateEffect(c)
	e2:SetDescription(aux.Stringc81254059(c81254059,1))
...
c81254059.listed_series={0x3e}
function c81254059.otfilter(c,tp)
