...
function c511002425.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCode2(c,true,true,511002422,511002423,511002424)
	Fusion.AddContactProc(c,c511002425.contactfilter,c511002425.contactop,c511002425.splimit)
	--sp summon
	local e3=Effect.CreateEffect(c)
	e3:SetDescription(aux.Stringc511002425(102380,0))
	...
	e4:SetDescription(aux.Stringc511002425(75347539,0))
