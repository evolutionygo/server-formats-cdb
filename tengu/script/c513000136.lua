...
function c513000136.initial_effect(c)
	...
	e4:SetCondition(function(e) return e:GetHandler():IsHasEffect(c513000136) end)
	...
	e6:SetDescription(aux.Stringc513000136(c513000136,0))
...
-------------------------------------------------------------------
function c513000136.atkfilter(c,p)
