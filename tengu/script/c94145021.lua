--ドロール＆ロックバード
--Droll & Lock Bird
local s, c94145021 = GetID()
function c94145021.initial_effect(c)
	--disable
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc94145021(c94145021,0))
	e1:SetCategory(CATEGORY_DISABLE)
	e1:SetProperty(EFFECT_FLAG_DELAY)
	e1:SetType(EFFECT_TYPE_QUICK_O)
	e1:SetCode(EVENT_CUSTOM+c94145021)
...
function c94145021.regop(e,tp,eg,ep,ev,re,r,rp)
	Duel.RaiseEvent(eg,EVENT_CUSTOM+c94145021,re,r,rp,ep,e:GetLabel())
end
...
function c94145021.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	e3:SetDescription(aux.Stringc94145021(c94145021,1))
