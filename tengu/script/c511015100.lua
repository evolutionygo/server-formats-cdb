...
function c511015100.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511015100(c511015100,0))
	...
	e2:SetDescription(aux.Stringc511015100(c511015100,1))
	...
	e5:SetDescription(aux.Stringc511015100(c511015100,2))
	...
	--half damage
	local e6=e5:Clone()
	e6:SetDescription(aux.Stringc511015100(c511015100,3))
...
function c511015100.dmcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return (a:IsControler(tp) or (d and d:IsControler(tp))) and Duel.GetFlagEffect(tp,c511015100)==0
end
...
function c511015100.dmcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.RegisterFlagEffect(tp,c511015100,RESET_PHASE+PHASE_DAMAGE_CAL,0,1)
end
...
function c511015100.dm2con(e,tp,eg,ep,ev,re,r,rp)
	...
	local d=Duel.GetAttackTarget()
	if a:IsControler(tp) then e:SetLabelObject(a) else e:SetLabelObject(d) end
	return (a:IsControler(tp) or (d and d:IsControler(tp))) and Duel.GetFlagEffect(tp,c511015100+1)==0
end
...
function c511015100.dm2cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.SendtoGrave(g,REASON_COST)
	Duel.RegisterFlagEffect(tp,c511015100+1,RESET_PHASE+PHASE_DAMAGE_CAL,0,1)
end
