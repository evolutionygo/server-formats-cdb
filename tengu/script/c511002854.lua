...
function c511002854.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511002854(40640057,0))
	...
	e3:SetDescription(aux.Stringc511002854(84565800,1))
	...
	e4:SetDescription(aux.Stringc511002854(20374351,1))
...
function c511002854.op2(e,tp,eg,ep,ev,re,r,rp,val,r,rc)
	local cc511002854=Duel.GetChainInfo(ev,CHAININFO_CHAIN_ID)
	local e1=Effect.CreateEffect(e:GetHandler())
	e1:SetType(EFFECT_TYPE_FIELD)
	e1:SetCode(EFFECT_CHANGE_DAMAGE)
	e1:SetProperty(EFFECT_FLAG_PLAYER_TARGET)
	e1:SetTargetRange(1,0)
	e1:SetLabel(cc511002854)
...
function c511002854.refcon(e,re,val,r,rp,rc)
	...
	local cc511002854=Duel.GetChainInfo(0,CHAININFO_CHAIN_ID)
	if cc511002854==e:GetLabel() then e:SetLabel(val) return 0
	else return val end
end
