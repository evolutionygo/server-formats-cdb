...
function c511600140.initial_effect(c)
	...
	e3:SetDescription(aux.Stringc511600140(79856792,0))
	...
	e4:SetDescription(aux.Stringc511600140(79856792,1))
...
c511600140.listed_series={0x1034}
...
function c511600140.spop(e,tp,eg,ep,ev,re,r,rp)
	e:GetHandler():RegisterFlagEffect(c511600140,RESET_EVENT+RESETS_STANDARD-(RESET_TOFIELD+RESET_TURN_SET)+RESET_PHASE+PHASE_END,0,1)
end
function c511600140.atcon(e,tp,eg,ep,ev,re,r,rp)
	if e:GetHandler():GetFlagEffect(c511600140)~=0 then return false end
...
function c511600140.tdcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c511600140)==0
end
