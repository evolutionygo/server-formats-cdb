...
function c511001040.cfilter(c)
	return c:GetFlagEffect(c511001040)>0
end
...
function c511001040.filter(c,e,tc511001040)
...
function c511001040.op(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:GetFlagEffect(c511001040)==0 then
		c:RegisterFlagEffect(c511001040,RESET_EVENT|RESETS_STANDARD_DISABLE,0,0)
	end
