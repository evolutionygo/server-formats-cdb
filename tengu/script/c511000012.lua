...
function c511000012.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc511000012(c511000012,0))
	e2:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_F)
	e2:SetCode(EVENT_PHASE+PHASE_STANDBY)
	e2:SetCountLimit(1)
	e2:SetRange(LOCATION_MZONE)
	e2:SetTarget(c511000012.bptg)
	e2:SetOperation(c511000012.bpop)
	c:RegisterEffect(e2)
	--selfdes
	...
	e3:SetCondition(c511000012.descon)
	c:RegisterEffect(e3)
	--damage
	...
	e5:SetCost(c511000012.spcost)
	e5:SetOperation(c511000012.spcop)
	c:RegisterEffect(e5)
end
c511000012.listed_series={SET_NORDIC,SET_AESIR}
...
function c511000012.spcop(e,tp,eg,ep,ev,re,r,rp)
	...
	aux.RegisterClientHint(c,EFFECT_FLAG_OATH,tp,1,0,aux.Stringc511000012(c511000012,1))
end