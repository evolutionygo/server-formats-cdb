...
function c511002834.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511002834(12958919,0))
	...
	e2:SetDescription(aux.Stringc511002834(12958919,1))
	...
	c:RegisterEffect(e2)
	Duel.AddCustomActivityCounter(c511002834,ACTIVITY_ATTACK,c511002834.counterfilter)
end
c511002834.listed_series={0x49}
...
function c511002834.damcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return Duel.GetCustomActivityCount(c511002834,tp,ACTIVITY_ATTACK)==0 
