...
function c511000770.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc511000770(c511000770,0))
...
function c511000770.acfilter(c,e,tp)
...
function c511000770.actg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsControler(1-tp) and chkc:IsLocation(LOCATION_GRAVE) and c511000770.acfilter(chkc,e,tp) end
	if chk==0 then return Duel.IsExistingTarget(c511000770.acfilter,tp,0,LOCATION_GRAVE,1,nil,e,tp) end
	Duel.Hint(HINT_SELECTMSG,tp,aux.Stringc511000770(c511000770,1))
	Duel.SelectTarget(tp,c511000770.acfilter,tp,0,LOCATION_GRAVE,1,1,nil,e,tp)
end
