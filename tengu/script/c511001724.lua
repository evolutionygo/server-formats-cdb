...
function c511001724.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511001724(c511001724,0))
...
c511001724.listed_series={SET_FLOWER_CARDIAN}
...
function c511001724.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
    if chk==0 then return Duel.CheckReleaseGroupCost(tp,c511001724.filter,1,false,aux.ReleaseCheckMMZ,nil) end
    Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_RELEASE)
    local g=Duel.SelectReleaseGroupCost(tp,c511001724.filter,1,1,false,aux.ReleaseCheckMMZ,nil)
