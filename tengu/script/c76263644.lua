...
function c76263644.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCode2(c,false,false,83965310,17132130)
	--destroy
	local e2=Effect.CreateEffect(c)
	e2:SetType(EFFECT_TYPE_IGNITION)
	e2:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e2:SetCategory(CATEGORY_DAMAGE+CATEGORY_DESTROY)
	e2:SetDescription(aux.Stringc76263644(c76263644,0))
	e2:SetCountLimit(1)
	...
	e3:SetDescription(aux.Stringc76263644(c76263644,1))
...
c76263644.listed_series={0xc008}
