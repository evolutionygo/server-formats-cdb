...
function c511013033.damop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e) and Duel.SendtoHand(c,nil,REASON_EFFECT)~=0 then
		local cc511013033=Duel.GetChainInfo(ev,CHAININFO_CHAIN_ID)
		local e1=Effect.CreateEffect(c)
		e1:SetType(EFFECT_TYPE_FIELD)
		e1:SetCode(EFFECT_CHANGE_DAMAGE)
		e1:SetProperty(EFFECT_FLAG_PLAYER_TARGET)
		e1:SetTargetRange(1,0)
		e1:SetLabel(cc511013033)
...
function c511013033.damval(e,re,val,r,rp,rc)
	...
	local cc511013033=Duel.GetChainInfo(0,CHAININFO_CHAIN_ID)
	if cc511013033~=e:GetLabel() then return val end
	return 0
end