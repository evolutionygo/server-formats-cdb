...
function c6150044.initial_effect(c)
	--Fusion Material
	c:EnableReviveLimit()
	aux.AddFusionProcCode2(c,false,false,25652259,90876561,64788463)
	--Negate
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc6150044(c6150044,0))
	...
	c:RegisterEffect(e1)
	aux.DoubleSnareValc6150044ity(c,LOCATION_MZONE)
end
