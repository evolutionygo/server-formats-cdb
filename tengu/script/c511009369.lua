...
function c511009369.initial_effect(c)
	...
	e1:SetCondition(c511009369.atkcon)
	e1:SetOperation(c511009369.atkop)
	c:RegisterEffect(e1)
	...
	e3:SetDescription(aux.Stringc511009369(c511009369,0))
	e3:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e3:SetProperty(EFFECT_FLAG_CARD_TARGET+EFFECT_FLAG_DELAY)
	e3:SetCode(511002005)
	e3:SetRange(LOCATION_PZONE)
	e3:SetTarget(c511009369.sctg)
	e3:SetOperation(c511009369.scop)
	c:RegisterEffect(e3)
	aux.GlobalCheck(s,function()
		local ge1=Effect.CreateEffect(c)
		ge1:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_CONTINUOUS)
		ge1:SetCode(EVENT_ADJUST)
		ge1:SetOperation(c511009369.checkop)
