...
function c511002763.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511002763(2191144,0))
...
function c511002763.atkcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():CheckRemoveOverlayCard(tp,1,REASON_COST) 
		and e:GetHandler():GetFlagEffect(c511002763)==0 end
	e:GetHandler():RemoveOverlayCard(tp,1,1,REASON_COST)
	e:GetHandler():RegisterFlagEffect(c511002763,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_DAMAGE,0,1)
end
