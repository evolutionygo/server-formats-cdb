...
function c511010053.initial_effect(c)
	...
	e3:SetDescription(aux.Stringc511010053(876330,0))
	...
	e7:SetDescription(aux.Stringc511010053(93730230,0))
	...
	e8:SetDescription(aux.Stringc511010053(64414267,0))
...
c511010053.aux.xyz_number=53
function c511010053.efilter(e,re)
	return e:GetHandlerPlayer()~=re:GetHandlerPlayer()
end
function c511010053.eqfilter(c)
	return c:IsMonster() and not c:IsForbc511010053den()
end
...
function c511010053.equipop(c,e,tp,tc,a)
	if not c:EquipByEffectAndLimitRegister(e,tp,tc,c511010053,true) or not a then return end
...
function c511010053.repfilter(c,ec)
	return c:GetEquipTarget()==ec and c:IsAbleToGrave() and c:GetFlagEffect(c511010053)>0
end
...
function c511010053.desrepop(e,tp,eg,ep,ev,re,r,rp)
	...
	local dif=atk1-atk2
	Duel.RaiseSingleEvent(e:GetHandler(),c511010053,e,r,rp,ep,dif)
end
...
function c511010053.damop(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.RaiseSingleEvent(e:GetHandler(),c511010053+1,e,r,rp,ep,d)
end
...
function c511010053.xyztg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chk==0 then
		...
		return #pg<=1 and Duel.IsExistingMatchingCard(c511010053.xyzfilter,tp,LOCATION_EXTRA,0,1,nil,e,tp,pg)
	end
