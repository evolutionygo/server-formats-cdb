...
function c511600039.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc511600039(34149830,0))
...
function c511600039.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return not c:IsStatus(STATUS_CHAINING)
		and c:GetFlagEffect(c511600039)<Duel.GetMatchingGroupCount(c511600039.filter,tp,LOCATION_PZONE,0,nil) end
	Duel.SetTargetCard(e:GetLabelObject())
end
function c511600039.operation(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	c:RegisterFlagEffect(c511600039,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
