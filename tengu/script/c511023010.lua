...
function c511023010.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCode2(c,true,true,CARD_NEOS,17955766)
	Fusion.AddContactProc(c,c511023010.contactfil,c511023010.contactop,c511023010.splimit)
	--return
	aux.EnableNeosReturn(c,nil,nil,nil)
	--destroy
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc511023010(c511023010,1))
	e1:SetCategory(CATEGORY_DESTROY)
	e1:SetType(EFFECT_TYPE_IGNITION)
	e1:SetRange(LOCATION_MZONE)
	e1:SetCountLimit(1)
	e1:SetCost(c511023010.descost)
	e1:SetTarget(c511023010.destg)
	e1:SetOperation(c511023010.desop)
	c:RegisterEffect(e1)
end
c511023010.listed_names={CARD_NEOS,17955766,CARD_POLYMERIZATION}
