...
function c513000066.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc513000066(c513000066,6))
	...
	e5:SetDescription(aux.Stringc513000066(c513000066,7))
	e5:SetType(EFFECT_TYPE_SINGLE)
	e5:SetProperty(EFFECT_FLAG_CANNOT_DISABLE+EFFECT_FLAG_UNCOPYABLE)
	e5:SetCode(EFFECT_QP_ACT_IN_SET_TURN)
	c:RegisterEffect(e5)
end
c513000066.listed_names={31829185}
...
function c513000066.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	c:RegisterFlagEffect(c513000066,RESET_EVENT|RESETS_STANDARD,EFFECT_FLAG_CLIENT_HINT,1,0,aux.Stringc513000066(c513000066,0))
end
...
function c513000066.letterop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	local ct=c:GetFlagEffectLabel(c513000066)+1
	c:ResetFlagEffect(c513000066)
	c:RegisterFlagEffect(c513000066,RESET_EVENT|RESETS_STANDARD,EFFECT_FLAG_CLIENT_HINT,1,ct,aux.Stringc513000066(c513000066,ct))
end
function c513000066.winop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	if c:GetFlagEffectLabel(c513000066)==5 then
		Duel.Win(tp,0x15)
	end
end