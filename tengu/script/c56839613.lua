...
function c56839613.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc56839613(c56839613,0))
	...
	e3:SetDescription(aux.Stringc56839613(c56839613,1))
...
c56839613.listed_series={0x28}
c56839613.listed_names={c56839613}
function c56839613.filter(c,e,tp)
	return not c:IsCode(c56839613) and c:IsSetCard(0x28) and c:IsLevelBelow(4) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function c56839613.flipop(e,tp,eg,ep,ev,re,r,rp)
	e:GetHandler():RegisterFlagEffect(c56839613,RESET_EVENT+RESETS_STANDARD_EXC_GRAVE,0,0)
end
function c56839613.drcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsLocation(LOCATION_GRAVE)
		and e:GetHandler():IsReason(REASON_BATTLE)
		and e:GetHandler():GetFlagEffect(c56839613)~=0
end
