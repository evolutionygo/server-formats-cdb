...
function c511009054.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc511009054(511000818,0))
	e2:SetCondition(c511009054.tdcon)
	e2:SetOperation(c511009054.tdop)
	c:RegisterEffect(e2)
	e1:SetLabelObject(e2)
end
c511009054.listed_series={0x10db}
...
function c511009054.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if sc then
		...
		if (tc:IsSetCard(0x10db) or tc:IsCode(16195942)) and Duel.SelectYesNo(tp,aux.Stringc511009054(95100814,0)) then
