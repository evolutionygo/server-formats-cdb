...
function c77642288.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc77642288(c77642288,0))
...
c77642288.listed_series={0x19}
c77642288.listed_names={c77642288}
...
function c77642288.filter(c,e,tp)
	return not c:IsCode(c77642288) and c:IsSetCard(0x19) and c:IsCanBeSpecialSummoned(e,106,tp,false,false)
end
