...
function c511000774.destg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then
		return Duel.GetFlagEffect(tp,c511000774)==0 and #g>0
	end
	e:SetLabel(#g)
...
function c511000774.desop(e,tp,eg,ep,ev,re,r,rp)
	Duel.RegisterFlagEffect(tp,c511000774,RESET_PHASE+PHASE_END,0,1)
	Duel.RaiseEvent(e:GetHandler(),c511000774,e,0,0,tp,0)
end
