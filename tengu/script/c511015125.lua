...
function c511015125.initial_effect(c)
	...
	Duel.ChangeAttackTarget=function(c)
		f(c)
		if c:GetFlagEffect(c511015125)==0 then
			Duel.RaiseEvent(c,c511015125,e1,REASON_EFFECT,c:GetControler(),c:GetControler(),0)
			c:RegisterFlagEffect(c511015125,RESET_CHAIN,0,0)
		end
	end
end
