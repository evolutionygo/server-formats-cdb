...
function c511002552.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511002552(c511002552,0))
...
function c511002552.poscheck(e,tp,eg,ep,ev,re,r,rp)
	if re==nil then
		Duel.RegisterFlagEffect(rp,c511002552,RESET_PHASE+PHASE_END,0,1)
	end
end
...
function c511002552.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetActivityCount(tp,ACTIVITY_SUMMON)==0
		...
		and Duel.GetFlagEffect(tp,c511002552)==0 end
	local c=e:GetHandler()
	--Cannot Summon monsters this turn
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc511002552(c511002552,1))
