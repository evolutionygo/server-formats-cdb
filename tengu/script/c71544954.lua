...
function c71544954.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc71544954(c71544954,0))
...
function c71544954.spfilter(c,tp)
...
function c71544954.spcon(e,c)
	...
	local rg=Duel.GetMatchingGroup(c71544954.spfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,nil,tp)
	local ft=Duel.GetLocationCount(tp,LOCATION_MZONE)
	return ft>-1 and #rg>0 and aux.SelectUnselectGroup(rg,e,tp,1,#rg,nil,0)
end
function c71544954.sptg(e,tp,eg,ep,ev,re,r,rp,c)
