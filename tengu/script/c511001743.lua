--ゴヨウ・ディフェンダー (Anime)
--Goyo Defender (Anime)
local s,c511001743,alias=GetID()
function c511001743.initial_effect(c)
	...
	e4:SetDescription(aux.Stringc511001743(c511001743,1))
...
function c511001743.atktg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c511001743.filter,tp,LOCATION_MZONE,LOCATION_MZONE,1,nil) 
		and e:GetHandler():GetFlagEffect(c511001743)==0 end
	e:GetHandler():RegisterFlagEffect(c511001743,RESET_PHASE+PHASE_DAMAGE_CAL,0,1)
end
