...
function c511806000.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511806000(c511806000,0))
	...
	e2:SetDescription(aux.Stringc511806000(c511806000,1))
...
c511806000.listed_series={SET_PHOTON}
...
function c511806000.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	e3:SetDescription(aux.Stringc511806000(c511806000,2))
