...
function c513000003.initial_effect(c)
	...
	e3:SetCondition(c513000003.damcon)
	e3:SetOperation(c513000003.damop)
	c:RegisterEffect(e3)
	--disable summon
	...
	e4:SetTarget(c513000003.sumlimit)
	c:RegisterEffect(e4)
	local e5=e4:Clone()
	...
	e7:SetDescription(aux.Stringc513000003(c513000003,2))
	...
	e8:SetDescription(aux.Stringc513000003(c513000003,0))
	e8:SetCategory(CATEGORY_TODECK)
	e8:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_F)
	e8:SetCode(EVENT_BATTLED)
	e8:SetTarget(c513000003.target)
	e8:SetOperation(c513000003.activate)
	c:RegisterEffect(e8)
	--draw
	local e9=Effect.CreateEffect(c)
	e9:SetDescription(aux.Stringc513000003(c513000003,1))
	e9:SetCategory(CATEGORY_DRAW)
	e9:SetProperty(EFFECT_FLAG_PLAYER_TARGET)
	e9:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_F)
	e9:SetCode(EVENT_TO_DECK)
	e9:SetCondition(c513000003.drcon)
	e9:SetTarget(c513000003.drtg)
	e9:SetOperation(c513000003.drop)
	c:RegisterEffect(e9)
	local e10=e9:Clone()
...
function c513000003.damop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.SelectYesNo(tp,aux.Stringc513000003(c513000003,3)) then
		Duel.Hint(HINT_CARD,1-tp,c513000003)
...
function c513000003.drcon(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
