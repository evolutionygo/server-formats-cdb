...
function c75081613.initial_effect(c)
	...
	e3:SetDescription(aux.Stringc75081613(c75081613,0))
...
function c75081613.spcon(e,c)
	...
	local rg=Duel.GetMatchingGroup(c75081613.spfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,nil,tp)
	local ft=Duel.GetLocationCount(tp,LOCATION_MZONE)
	return ft>-1 and #rg>0 and aux.SelectUnselectGroup(rg,e,tp,1,1,nil,0)
end
function c75081613.sptg(e,tp,eg,ep,ev,re,r,rp,c)
