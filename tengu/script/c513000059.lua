...
function c513000059.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc513000059(c513000059,0))
	...
	e3:SetDescription(aux.Stringc513000059(c513000059,1))
	e3:SetType(EFFECT_TYPE_IGNITION)
	e3:SetRange(LOCATION_MZONE)
	e3:SetCountLimit(1)
	e3:SetTarget(c513000059.target)
	e3:SetOperation(c513000059.operation)
	c:RegisterEffect(e3)
	--spsummon2
	local e4=Effect.CreateEffect(c)
	e4:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e4:SetDescription(aux.Stringc513000059(c513000059,2))
	e4:SetType(EFFECT_TYPE_IGNITION)
	e4:SetRange(LOCATION_MZONE)
	e4:SetLabelObject(e4)
	e4:SetCost(c513000059.spcost)
	e4:SetTarget(c513000059.sptg2)
	e4:SetOperation(c513000059.spop2)
...
c513000059.listed_series={SET_NUMBER}
c513000059.listed_names={48739166}
c513000059.aux.xyz_number=101
