...
function c511000760.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511000760(c511000760,0))
...
function c511000760.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsTrap() and tc:CheckActivateEffect(false,false,false)~=nil and not tc:IsHasEffect(EFFECT_CANNOT_TRIGGER)
		and Duel.GetLocationCount(tp,LOCATION_SZONE) and Duel.SelectYesNo(tp,aux.Stringc511000760(c511000760,1)) then
