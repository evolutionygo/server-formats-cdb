...
function c511001998.initial_effect(c)
	...
	e4:SetDescription(aux.Stringc511001998(c511001998,0))
	...
	e5:SetDescription(aux.Stringc511001998(c511001998,1))
...
function c511001998.ctop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc and tc:IsRelateToEffect(e) then
		if tc:IsDestructable() and Duel.SelectYesNo(1-tp,aux.Stringc511001998(80764541,1)) then
