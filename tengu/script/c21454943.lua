...
function c21454943.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc21454943(c21454943,0))
...
function c21454943.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return Duel.CheckLPCost(tp,100) and e:GetHandler():GetFlagEffect(c21454943)==0
	...
	Duel.Hint(HINT_SELECTMSG,tp,aux.Stringc21454943(c21454943,1))
	...
	e:SetLabel(-alp)
	e:GetHandler():RegisterFlagEffect(c21454943,RESET_PHASE+PHASE_DAMAGE,0,1)
end
