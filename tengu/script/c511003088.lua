...
function c511003088.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511003088(54912977,0))
...
function c511003088.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c511003088.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc and tc:IsRelateToEffect(e) and a and a:CanAttack() and not a:IsImmuneToEffect(e) then
		...
		if a:IsControler(1-tp) and a:IsType(TYPE_XYZ) then
			...
			if #og>0 and Duel.SelectYesNo(tp,aux.Stringc511003088(81330115,1)) then
