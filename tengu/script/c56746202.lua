...
function c56746202.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc56746202(c56746202,0))
...
c56746202.listed_series={SET_SCRAP}
function c56746202.spfilter(c,e,tp)
...
function c56746202.sumtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingTarget(c56746202.spfilter,tp,LOCATION_GRAVE,0,1,nil,e,tp) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_SPSUMMON)
	local g=Duel.SelectTarget(tp,c56746202.spfilter,tp,LOCATION_GRAVE,0,1,1,nil,e,tp)
