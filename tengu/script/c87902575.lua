...
function c87902575.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc87902575(c87902575,0))
	...
	e3:SetDescription(aux.Stringc87902575(c87902575,1))
...
function c87902575.retop(e,tp,eg,ep,ev,re,r,rp)
	...
	if #g>ft then
		local sg=g
		Duel.Hint(HINT_SELECTMSG,p,aux.Stringc87902575(c87902575,2))
