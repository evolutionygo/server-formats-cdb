...
function c511010139.initial_effect(c)
	...
	e0:SetDescription(aux.Stringc511010139(56840427,1))
	e0:SetCode(EFFECT_SPSUMMON_PROC)
	e0:SetProperty(EFFECT_FLAG_CANNOT_DISABLE+EFFECT_FLAG_UNCOPYABLE)
	e0:SetRange(LOCATION_EXTRA)
	e0:SetCondition(Xyz.Condition2(c511010139.ovfilter))
	e0:SetTarget(Xyz.Target2(c511010139.ovfilter))
	...
	e1:SetDescription(aux.Stringc511010139(c511010139,0))
...
c511010139.listed_names={84013237}
c511010139.aux.xyz_number=39
