...
--Cybernetic Hc511002826den Technology (Anime)
--fixed by Larry126
function c511002826.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc511002826(92773018,0))
	...
	e3:SetDescription(aux.Stringc511002826(21420702,0))
