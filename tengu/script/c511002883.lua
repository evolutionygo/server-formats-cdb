...
function c511002883.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511002883(80244114,0))
	...
	e2:SetDescription(aux.Stringc511002883(80244114,1))
...
c511002883.listed_names={CARD_STARDUST_DRAGON}
...
function c511002883.desreptg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if Duel.SelectYesNo(tp,aux.Stringc511002883(40945356,0)) then
		local e1=Effect.CreateEffect(c)
