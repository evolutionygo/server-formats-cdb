...
function c513000031.initial_effect(c)
	...
	e4:SetDescription(aux.Stringc513000031(c513000031,0))
	...
	e6:SetValue(c513000031.damval)
	c:RegisterEffect(e6)
	local e7=e6:Clone()
	e7:SetCode(EFFECT_NO_EFFECT_DAMAGE)
	c:RegisterEffect(e7)
end
c513000031.synchro_tuner_required=1
c513000031.synchro_nt_required=2
...
function c513000031.sumtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c513000031.filter,tp,LOCATION_EXTRA,0,1,nil,e,tp) end
