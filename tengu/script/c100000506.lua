...
function c100000506.initial_effect(c)
	...
	e1:SetTarget(c100000506.sptg)
	e1:SetOperation(c100000506.spop)
	c:RegisterEffect(e1)
	--send to grave
	local e2=Effect.CreateEffect(c)
	e2:SetDescription(aux.Stringc100000506(c100000506,0))
...
c100000506.listed_names={27780618}
...
function c100000506.spcon(e,c)
	...
	local rg=Duel.GetMatchingGroup(c100000506.spfilter,tp,LOCATION_HAND,0,nil)
	return Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and aux.SelectUnselectGroup(rg,e,tp,1,1,nil,0)
end
function c100000506.sptg(e,tp,eg,ep,ev,re,r,rp,c)
	local c=e:GetHandler()
	local rg=Duel.GetMatchingGroup(c100000506.spfilter,tp,LOCATION_HAND,0,c)
