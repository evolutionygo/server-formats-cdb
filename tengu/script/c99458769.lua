...
function c99458769.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc99458769(c99458769,0))
	...
	e2:SetDescription(aux.Stringc99458769(c99458769,1))
...
function c99458769.desop(e,tp,eg,ep,ev,re,r,rp)
	...
	if (b1 and b2) then
		op=Duel.SelectEffect(tp,
			{b1,aux.Stringc99458769(c99458769,2)},
			{b2,aux.Stringc99458769(c99458769,3)})
	else
		op=(b1 and 1 or 2)
	end
