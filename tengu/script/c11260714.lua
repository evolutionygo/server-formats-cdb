...
function c11260714.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc11260714(c11260714,0))
...
c11260714.listed_names={c11260714}
function c11260714.spcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsPreviousLocation(LOCATION_GRAVE)
end
function c11260714.filter(c,e,sp)
	return c:IsRace(RACE_FAIRY) and c:IsCanBeSpecialSummoned(e,0,sp,false,false) and not c:IsCode(c11260714)
end
