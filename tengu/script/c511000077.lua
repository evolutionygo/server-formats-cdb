...
function c511000077.initial_effect(c)
	...
	aux.AddSynchroProcedure(c,aux.FilterBoolFunctionEx(Card.IsSetCard,SET_TG),1,1,aux.NonTuner(nil),1,99)
	--Piercing damage
	...
	e3:SetDescription(aux.Stringc511000077(c511000077,0))
...
c511000077.listed_series={SET_TG}
