...
function c16509093.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc16509093(c16509093,0))
	...
	e2:SetDescription(aux.Stringc16509093(c16509093,1))
...
function c16509093.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return c:IsCanTurnSet() and c:GetFlagEffect(c16509093)==0 end
	c:RegisterFlagEffect(c16509093,RESET_EVENT+RESETS_STANDARD-RESET_TURN_SET+RESET_PHASE+PHASE_END,0,1)
