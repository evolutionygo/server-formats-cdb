...
function c98502113.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCode2(c,true,true,CARD_DARK_MAGICIAN,78193831)
	--negate
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc98502113(c98502113,0))
...
c98502113.listed_names={CARD_DARK_MAGICIAN,78193831}
