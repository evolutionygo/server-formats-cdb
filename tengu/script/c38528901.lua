...
function c38528901.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc38528901(c38528901,0))
...
c38528901.listed_series={SET_ICE_BARRIER}
function c38528901.thfilter(c)
...
function c38528901.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.IsExistingTarget(aux.FaceupFilter(Card.IsAttribute,ATTRIBUTE_WATER),tp,LOCATION_MZONE,LOCATION_MZONE,1,e:GetHandler())
		and Duel.IsExistingMatchingCard(c38528901.thfilter,tp,LOCATION_DECK,0,1,nil) end
...
function c38528901.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,c38528901.thfilter,tp,LOCATION_DECK,0,1,1,nil)
	if #g>0 then
