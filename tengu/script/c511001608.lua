...
local s,c511001608,alias=GetID()
function c511001608.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511001608(c511001608,0))
	...
	e7:SetDescription(aux.Stringc511001608(c511001608,1))
...
c511001608.listed_series={0x48}
c511001608.aux.xyz_number=93
...
function c511001608.filter(c,e,tp,ct)
...
function c511001608.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return aux.CheckSummonGate(tp,ct) and ct>0 and e:GetHandler():CheckRemoveOverlayCard(tp,1,REASON_EFFECT) 
		and Duel.IsExistingMatchingCard(c511001608.filter,tp,LOCATION_EXTRA,0,ct,nil,e,tp,ct) 
...
function c511001608.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.GetMatchingGroup(c511001608.filter,tp,LOCATION_EXTRA,0,nil,e,tp,ct)
