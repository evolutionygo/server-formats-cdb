...
function c100000282.initial_effect(c)
	...
	e1:SetTarget(c100000282.deckdestg)
	e1:SetOperation(c100000282.deckdesop)
	c:RegisterEffect(e1)
end
function c100000282.deckdestg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return ev>=400 and Duel.IsPlayerCanDiscardDeck(tp,1) end
	Duel.SetOperationInfo(0,CATEGORY_DECKDES,nil,0,tp,0)
end
function c100000282.deckdesop(e,tp,eg,ep,ev,re,r,rp)
