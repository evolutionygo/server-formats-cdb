...
function c67048711.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc67048711(c67048711,0))
	e2:SetCategory(CATEGORY_DRAW+CATEGORY_DESTROY)
	e2:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_F)
	e2:SetCode(EVENT_CUSTOM+c67048711)
	e2:SetTarget(c67048711.drtg)
	e2:SetOperation(c67048711.drop)
	c:RegisterEffect(e2)
	--recover
	local e3=Effect.CreateEffect(c)
	e3:SetDescription(aux.Stringc67048711(c67048711,1))
...
c67048711.listed_names={c67048711}
function c67048711.filter(c)
	return c:IsFaceup() and c:IsCode(c67048711)
end
function c67048711.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.GetMatchingGroupCount(c67048711.filter,tp,LOCATION_SZONE,0,nil)==3 then
		Duel.RaiseSingleEvent(e:GetHandler(),EVENT_CUSTOM+c67048711,e,0,0,0,0)
	end
end
