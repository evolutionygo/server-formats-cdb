...
function c86346643.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCode2(c,false,false,CARD_NEOS,aux.FilterBoolFunctionEx(Card.IsSetCard,0x2034))
	...
	e2:SetDescription(aux.Stringc86346643(c86346643,1))
	...
	e3:SetDescription(aux.Stringc86346643(c86346643,2))
	...
	e4:SetDescription(aux.Stringc86346643(c86346643,3))
...
c86346643.listed_series={0x2034}
c86346643.listed_names={CARD_NEOS}
