...
function c511010165.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc511010165(c511010165,0))
...
c511010165.listed_series={SET_NUMBER}
c511010165.listed_names={3790062}
c511010165.aux.xyz_number=65
...
function c511010165.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsFaceup() and tc:IsRelateToEffect(e) then
		local choice=Duel.SelectOption(tp,aux.Stringc511010165(c511010165,1),aux.Stringc511010165(c511010165,2))
