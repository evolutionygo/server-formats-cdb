...
function c984114.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc984114(c984114,0))
...
c984114.listed_series={0x16}
function c984114.filter(c)
	return c:IsSetCard(0x16) and c:GetCode()~=c984114 and c:IsMonster() and c:IsAbleToHand()
end
