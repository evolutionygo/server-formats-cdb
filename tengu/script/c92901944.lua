...
function c92901944.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc92901944(c92901944,0))
	...
	e2:SetDescription(aux.Stringc92901944(c92901944,1))
...
c92901944.listed_series={0x24}
function c92901944.cfilter(c,tp)
	return c:IsSetCard(0x24) and c:GetCode()~=c92901944 and c:IsReason(REASON_DESTROY) and c:IsPreviousControler(tp)
