...
function c511009441.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc511009441(c511009441,0))
	...
	e3:SetDescription(aux.Stringc511009441(c511009441,1))
	...
	e5:SetValue(c511009441.imfilter)
	c:RegisterEffect(e5)
	local e6=e3:Clone()
	...
	e8:SetDescription(aux.Stringc511009441(c511009441,2))
	...
	e9:SetDescription(aux.Stringc511009441(c511009441,3))
...
c511009441.listed_series={SET_SUPREME_KING,SET_SUPREME_KING_DRAGON}
...
function c511009441.leaveChk(c,category)
...
function c511009441.imfilter(e,te)
	...
	return (c:GetDestination()>0 and c:GetReasonEffect()==te)
		or (c511009441.leaveChk(c,CATEGORY_TOHAND) or c511009441.leaveChk(c,CATEGORY_DESTROY) or c511009441.leaveChk(c,CATEGORY_REMOVE)
		or c511009441.leaveChk(c,CATEGORY_TODECK) or c511009441.leaveChk(c,CATEGORY_RELEASE) or c511009441.leaveChk(c,CATEGORY_TOGRAVE))
end
...
function c511009441.spfilter(c,e,tp,rp)
...
function c511009441.sptg2(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		return loc~=0 and not Duel.IsPlayerAffectedByEffect(tp,CARD_BLUEEYES_SPIRIT) and Duel.IsExistingMatchingCard(c511009441.spfilter,tp,LOCATION_EXTRA,0,2,nil,e,tp,rp)
	end
	Duel.SetOperationInfo(0,CATEGORY_SPECIAL_SUMMON,nil,2,tp,LOCATION_EXTRA)
end
function c511009441.spop2(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_SPSUMMON)
	local g=Duel.SelectMatchingCard(tp,c511009441.spfilter,tp,LOCATION_EXTRA,0,2,2,nil,e,tp,rp)
	if #g>0 then
