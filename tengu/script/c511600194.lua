...
local s,c511600194,alias=GetID()
function c511600194.initial_effect(c)
	alias=c:GetOriginalCodeRule()
	--activate
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc511600194(alias,0))
	...
	e2:SetDescription(aux.Stringc511600194(alias,1))
...
function c511600194.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return c:GetFlagEffect(c511600194)==0 and Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and c:IsCanBeSpecialSummoned(e,0,tp,false,false) end
	c:RegisterFlagEffect(c511600194,RESET_CHAIN,0,1)
