...
function c511002895.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511002895(98263709,0))
	...
	e2:SetDescription(aux.Stringc511002895(76321376,0))
...
function c511002895.settg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return (c:IsMSetable(true,nil) or not Duel.IsPlayerAffectedByEffect(tp,EFFECT_CANNOT_MSET)) 
		and Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and c:GetFlagEffect(c511002895)==0 end
end
function c511002895.setop(e,tp,eg,ep,ev,re,r,rp)
	...
	c:RegisterFlagEffect(c511002895,RESET_EVENT+0x4760000,0,0)
	local e2=Effect.CreateEffect(c)
