...
function c511001973.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511001973(95100034,0))
	...
	e4:SetDescription(aux.Stringc511001973(c511001973,3))
	...
	e5:SetDescription(aux.Stringc511001973(95100034,4))
...
function c511001973.op(e,tp,eg,ep,ev,re,r,rp)
	...
	local op=2
	if a and b then
		op=Duel.SelectOption(tp,aux.Stringc511001973(2407147,0),aux.Stringc511001973(52823314,0))
	elseif a then
		Duel.SelectOption(tp,aux.Stringc511001973(2407147,0))
		op=0
	elseif b then
		Duel.SelectOption(tp,aux.Stringc511001973(52823314,0))
		op=1
	end
	...
	if sumable and sumtype==SUMMON_TYPE_SYNCHRO and #mg>0 and #mg<=ft and mg:FilterCount(aux.NecroValleyFilter(c511001973.mgfilter),nil,e,tp,tc)==#mg and Duel.SelectYesNo(tp,aux.Stringc511001973(c511001973,2)) then
		Duel.BreakEffect()
