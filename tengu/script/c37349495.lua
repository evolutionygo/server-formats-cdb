...
function c37349495.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc37349495(c37349495,0))
...
c37349495.listed_series={0x2a}
function c37349495.thcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsPreviousLocation(LOCATION_ONFIELD)
end
function c37349495.filter(c)
	return c:IsSetCard(0x2a) and c:IsMonster() and c:GetCode()~=c37349495 and c:IsAbleToHand()
end
