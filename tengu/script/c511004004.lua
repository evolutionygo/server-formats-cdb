...
function c511004004.rfilter(c,fc511004004)
	return c:IsReleasable() and c:GetFieldID()~=fc511004004
end
...
function c511004004.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if #sg>0 then
		if Duel.SpecialSummon(sg,0,tp,tp,false,false,POS_FACEUP)>0 then
			local fc511004004=e:GetHandler():GetFieldID()
			sg:KeepAlive()
			sg:GetFirst():RegisterFlagEffect(c511004004,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1,fc511004004)
...
function c511004004.rmfilter(c,fc511004004)
	return c:GetFlagEffectLabel(c511004004)==fc511004004
end
