...
function c513000134.initial_effect(c)
	...
	e5:SetValue(c513000134.valcheck)
	c:RegisterEffect(e5)
...
function c513000134.immortal(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local op=Duel.SelectEffect(tp,
		{c513000134.payatkcost(e,tp,eg,ep,ev,re,r,rp,0),aux.Stringc513000134(c513000134,0)},
		{true,aux.Stringc513000134(c513000134,1)},
		{true,aux.Stringc513000134(c513000134,2)})
	if op==1 then
...
function c513000134.payatkop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsFaceup() then
		...
		--Tribute for stats
		local e4=Effect.CreateEffect(c)
		e4:SetDescription(aux.Stringc513000134(c513000134,3))
		...
		e7:SetTarget(function(_e,_c) return _c:GetFlagEffect(c513000134+100)>0 end)
		...
		e8:SetCondition(c513000134.dfcon)
		...
		e10:SetCondition(c513000134.dfcon)
...
function c513000134.tatkop(e,tp,eg,ep,ev,re,r,rp)
	if not c513000134.dfcon(e) then return end
	local c=e:GetHandler()
	...
	e2:SetCode(EFFECT_UPDATE_DEFENSE)
	e2:SetCondition(c513000134.dfcon)
	e2:SetValue(def)
...
function c513000134.unop(e,tp,eg,ep,ev,re,r,rp)
	...
	if bc and bc:IsRelateToBattle() then
		bc:RegisterFlagEffect(c513000134+100,RESET_EVENT|RESETS_STANDARD|RESET_PHASE|PHASE_BATTLE,0,1)
	end
end
...
function c513000134.egpop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsFaceup() then
		...
		e2:SetValue(c513000134.imfilter)
		c:RegisterEffect(e2)
		local e3=e1:Clone()
		...
		--Send to Graveyard
		local e5=Effect.CreateEffect(c)
		e5:SetDescription(aux.Stringc513000134(c513000134,4))
		e5:SetCategory(CATEGORY_TOGRAVE)
		e5:SetType(EFFECT_TYPE_QUICK_O)
		e5:SetCode(EVENT_FREE_CHAIN)
		e5:SetProperty(EFFECT_FLAG_CARD_TARGET)
		e5:SetRange(LOCATION_MZONE)
		e5:SetCondition(c513000134.tgcon)
		e5:SetCost(c513000134.tgcost)
		e5:SetTarget(c513000134.tgtg)
		e5:SetOperation(c513000134.tgop)
		e5:SetReset(RESET_EVENT|RESETS_STANDARD|RESET_PHASE|PHASE_END)
		c:RegisterEffect(e5)
	end
end
function c513000134.leaveChk(c,category)
...
function c513000134.imfilter(e,te)
	...
	return (c:GetDestination()>0 and c:GetReasonEffect()==te)
		or (c513000134.leaveChk(c,CATEGORY_TOHAND) or c513000134.leaveChk(c,CATEGORY_DESTROY) or c513000134.leaveChk(c,CATEGORY_REMOVE)
		or c513000134.leaveChk(c,CATEGORY_TODECK) or c513000134.leaveChk(c,CATEGORY_RELEASE) or c513000134.leaveChk(c,CATEGORY_TOGRAVE))
end
function c513000134.tgcon(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
...
function c513000134.tgcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckLPCost(tp,1000) end
	Duel.PayLPCost(tp,1000)
end
function c513000134.tgtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c513000134.tgop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
