...
function c652362.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc652362(c652362,0))
...
function c652362.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) and Duel.SpecialSummon(tc,0,tp,tp,false,false,POS_FACEUP)~=0 then
		local fc652362=e:GetHandler():GetFieldID()
		tc:RegisterFlagEffect(c652362,RESET_EVENT+RESETS_STANDARD,0,1,fc652362)
		local e1=Effect.CreateEffect(e:GetHandler())
		e1:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_CONTINUOUS)
		e1:SetCode(EVENT_PHASE+PHASE_END)
		e1:SetCountLimit(1)
		e1:SetProperty(EFFECT_FLAG_IGNORE_IMMUNE)
		e1:SetLabel(fc652362)
...
function c652362.descon(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:GetFlagEffectLabel(c652362)~=e:GetLabel() then
		e:Reset()
		return false
