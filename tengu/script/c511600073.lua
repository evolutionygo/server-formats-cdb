...
function c511600073.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc511600073(63492244,0))
	...
	e3:SetDescription(aux.Stringc511600073(63492244,1))
	...
	e4:SetDescription(aux.Stringc511600073(47432275,0))
...
function c511600073.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	Duel.Hint(HINT_SELECTMSG,tp,aux.Stringc511600073(63492244,2))
...
function c511600073.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e) and tc:IsFacedown() and tc:IsRelateToEffect(e) then
		...
		local fc511600073=c:GetFieldID()
		c:RegisterFlagEffect(63492244,RESET_EVENT+RESETS_STANDARD,0,1,fc511600073)
		tc:RegisterFlagEffect(63492244,RESET_EVENT+RESETS_STANDARD,0,1,fc511600073)
		local e1=Effect.CreateEffect(c)
