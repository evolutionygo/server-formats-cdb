...
function c170000151.initial_effect(c)
	...
	e1:SetCondition(c170000151.condition)
...
function c170000151.condition(e,tp,eg,ep,ev,re,r,rp)
...
function c170000151.spfilter(c,e,tp)
	...
	return Duel.IsExistingMatchingCard(c170000151.tgfilter,tp,LOCATION_ONFIELD,0,1,nil,code,c,tp)
end
function c170000151.tgfilter(c,code,sc,tp)
...
function c170000151.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if sc then
		...
		local tg=Duel.SelectMatchingCard(tp,c170000151.tgfilter,tp,LOCATION_ONFIELD,0,1,1,nil,code,sc,tp)
