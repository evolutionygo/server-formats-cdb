...
function c511023015.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCode2(c,true,true,84327329,58932615)
	--lizard check
	local e0=Effect.CreateEffect(c)
	e0:SetType(EFFECT_TYPE_SINGLE)
	e0:SetCode(CARD_CLOCK_LIZARD)
	e0:SetProperty(EFFECT_FLAG_CANNOT_DISABLE+EFFECT_FLAG_UNCOPYABLE)
	e0:SetCondition(c511023015.lizcon)
	e0:SetValue(1)
	c:RegisterEffect(e0)
	...
	e2:SetDescription(aux.Stringc511023015(c511023015,0))
	...
	e4:SetDescription(aux.Stringc511023015(511000306,1))
...
c511023015.listed_names={CARD_DARK_FUSION,58932615,84327329}
function c511023015.lizcon(e,tp,eg,ep,ev,re,r,rp)
