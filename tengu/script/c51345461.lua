...
function c51345461.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc51345461(c51345461,0))
	...
	c:RegisterEffect(e1)
	aux.AddEREquipLimit(c,nil,aux.FilterBoolFunction(Card.IsMonster),c51345461.equipop,e1)
end
function c51345461.filter(c,rc,tc51345461)
	return c:IsReason(REASON_BATTLE) and c:GetReasonCard()==rc and c:GetTurnID()==tc51345461 and not c:IsForbc51345461den()
end
