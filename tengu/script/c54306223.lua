...
function c54306223.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc54306223(c54306223,0))
	...
	e4:SetDescription(aux.Stringc54306223(c54306223,1))
	e4:SetCategory(CATEGORY_DESTROY)
	e4:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_F)
	e4:SetCode(EVENT_CUSTOM+c54306223)
	e4:SetRange(LOCATION_FZONE)
	e4:SetTarget(c54306223.destg)
	e4:SetOperation(c54306223.desop)
	c:RegisterEffect(e4)
end
c54306223.listed_series={0x50}
c54306223.counter_place_list={0x1009}
...
function c54306223.acop(e,tp,eg,ep,ev,re,r,rp)
	...
	if #g>0 then
		Duel.RaiseEvent(g,EVENT_CUSTOM+c54306223,e,0,0,0,0)
	end
end
