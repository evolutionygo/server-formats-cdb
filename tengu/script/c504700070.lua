...
function c504700070.initial_effect(c)
	--Activate
	...
	e1:SetCondition(c504700070.condition)
	e1:SetCost(c504700070.cost)
	e1:SetTarget(c504700070.target)
	e1:SetOperation(c504700070.operation)
	c:RegisterEffect(e1)
end
function c504700070.condition(e,tp,eg,ep,ev,re,r,rp)
...
function c504700070.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	e:SetLabel(1)
	if chk==0 then return true end
end
function c504700070.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c504700070.operation(e,tp,eg,ep,ev,re,r,rp,chk)
