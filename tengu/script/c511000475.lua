...
function c511000475.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and e:IsHasType(EFFECT_TYPE_ACTIVATE) 
		and Duel.IsPlayerCanSpecialSummonMonster(tp,c511000475,0,0x21,2100,1000,4,RACE_INSECT,ATTRIBUTE_EARTH) end
...
function c511000475.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.GetLocationCount(tp,LOCATION_MZONE)<=0
		or not Duel.IsPlayerCanSpecialSummonMonster(tp,c511000475,0,0x21,2100,1000,5,RACE_INSECT,ATTRIBUTE_EARTH) then return end
