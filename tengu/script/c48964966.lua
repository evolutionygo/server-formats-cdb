...
function c48964966.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc48964966(c48964966,0))
	...
	e2:SetDescription(aux.Stringc48964966(c48964966,1))
	...
	e3:SetDescription(aux.Stringc48964966(c48964966,1))
	...
	e4:SetDescription(aux.Stringc48964966(c48964966,1))
...
function c48964966.filter1(c,ft)
	return c:IsFaceup() and c:IsRace(RACE_FAIRY) and c:GetCode()~=c48964966 and c:IsAbleToGraveAsCost()
...
function c48964966.filter2(c,e,sp)
	return c:IsRace(RACE_FAIRY) and c:GetCode()~=c48964966 and c:IsCanBeSpecialSummoned(e,0,sp,false,false)
end
