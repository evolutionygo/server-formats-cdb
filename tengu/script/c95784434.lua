...
function c95784434.initial_effect(c)
	...
	e4:SetDescription(aux.Stringc95784434(c95784434,0))
...
function c95784434.valcon(e,re,r,rp)
	if (r&REASON_BATTLE)~=0 then
		e:GetHandler():RegisterFlagEffect(c95784434,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_DAMAGE,0,1)
		return true
	else return false end
end
function c95784434.adcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c95784434)~=0
end
