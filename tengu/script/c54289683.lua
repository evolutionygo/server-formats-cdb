...
function c54289683.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.Hint(HINT_SELECTMSG,tp,aux.Stringc54289683(93130021,0))
	if t1 and t2 then
		op=Duel.SelectOption(tp,aux.Stringc54289683(93130021,1),aux.Stringc54289683(93130021,2),aux.Stringc54289683(93130021,3))
	elseif t1 then
		op=Duel.SelectOption(tp,aux.Stringc54289683(93130021,1),aux.Stringc54289683(93130021,2))
	elseif t2 then
		op=Duel.SelectOption(tp,aux.Stringc54289683(93130021,1),aux.Stringc54289683(93130021,3))
		if op==1 then op=2 end
	else op=Duel.SelectOption(tp,aux.Stringc54289683(93130021,1)) end
	if op==1 then
