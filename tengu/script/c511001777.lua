...
function c511001777.initial_effect(c)
	...
	e5:SetDescription(aux.Stringc511001777(c511001777,0))
	e5:SetCategory(CATEGORY_SPECIAL_SUMMON+CATEGORY_TOKEN)
	e5:SetType(EFFECT_TYPE_IGNITION)
	e5:SetRange(LOCATION_MZONE)
	e5:SetCountLimit(1)
	e5:SetCondition(c511001777.spcon)
	e5:SetCost(aux.dxmcostgen(1,1,nil))
	e5:SetTarget(c511001777.sptg)
	e5:SetOperation(c511001777.spop)
	--
...
c511001777.listed_series={SET_NUMBER}
c511001777.listed_names={56051086,32446631}
c511001777.aux.xyz_number=43
