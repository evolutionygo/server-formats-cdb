...
function c511015121.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsPlayerCanSpecialSummonMonster(tp,c511015121,0,0x21,0,2000,4,RACE_MACHINE,ATTRIBUTE_EARTH) end
...
function c511015121.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.GetLocationCount(tp,LOCATION_MZONE)<=0
		or not Duel.IsPlayerCanSpecialSummonMonster(tp,c511015121,0,0x21,0,2000,4,RACE_MACHINE,ATTRIBUTE_EARTH) then return end
...
function c511015121.operation(e,tp,eg,ep,ev,re,r,rp)
	local g=Duel.GetMatchingGroup(c511015121.codefilter,tp,LOCATION_SZONE,LOCATION_SZONE,nil,c511015121)
	local c=g:GetFirst()
	while c do
