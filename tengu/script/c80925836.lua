...
function c80925836.mtop(e,tp,eg,ep,ev,re,r,rp)
	...
	if #g1>0 and #g2>0 then
		select=Duel.SelectOption(tp,aux.Stringc80925836(c80925836,0),aux.Stringc80925836(c80925836,1),aux.Stringc80925836(c80925836,2))
	elseif #g1>0 then
		select=Duel.SelectOption(tp,aux.Stringc80925836(c80925836,0),aux.Stringc80925836(c80925836,2))
		if select==1 then select=2 end
	elseif #g2>0 then
		select=Duel.SelectOption(tp,aux.Stringc80925836(c80925836,1),aux.Stringc80925836(c80925836,2))+1
	else
		select=Duel.SelectOption(tp,aux.Stringc80925836(c80925836,2))
		select=2
	end
	if select==0 then
