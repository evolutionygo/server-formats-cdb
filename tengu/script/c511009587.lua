...
function c511009587.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCode2(c,true,true,16178681,41209827)
	--pendulum summon
	...
	e3:SetDescription(aux.Stringc511009587(900787,0))
	...
	e4:SetDescription(aux.Stringc511009587(10032958,0))
	...
	e5:SetDescription(aux.Stringc511009587(90036274,0))
...
function c511009587.op(e,tp,eg,ep,ev,re,r,rp)
	if ep==tp and e:GetHandler():GetFlagEffect(c511009587)==0 then
		e:GetHandler():RegisterFlagEffect(c511009587,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
...
function c511009587.regop(e,tp,eg,ep,ev,re,r,rp)
	e:GetHandler():RegisterFlagEffect(c511009587+1,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
end
function c511009587.atkcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c511009587+1)~=0
end
