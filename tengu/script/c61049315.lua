...
function c61049315.aclimit1(e,tp,eg,ep,ev,re,r,rp)
	...
	e:GetHandler():RegisterFlagEffect(c61049315,RESET_EVENT+RESETS_STANDARD_DISABLE+RESET_CONTROL+RESET_PHASE+PHASE_END,0,1)
end
function c61049315.aclimit2(e,tp,eg,ep,ev,re,r,rp)
	if ep==tp or not re:IsHasType(EFFECT_TYPE_ACTIVATE) then return end
	e:GetHandler():ResetFlagEffect(c61049315)
end
function c61049315.econ(e)
	return e:GetHandler():GetFlagEffect(c61049315)~=0
end
