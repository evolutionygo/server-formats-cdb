...
function c511002794.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511002794(18865703,0))
	...
	e2:SetDescription(aux.Stringc511002794(18865703,1))
...
function c511002794.negop2(e,tp,eg,ep,ev,re,r,rp,val,r,rc)
	...
	if #g>0 and Duel.SelectYesNo(tp,aux.Stringc511002794(28265983,0)) then
