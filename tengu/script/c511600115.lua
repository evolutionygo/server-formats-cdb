...
function c511600115.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511600115(70894,0))
	...
	e2:SetDescription(aux.Stringc511600115(1006081,0))
...
function c511600115.lvop(e,tp,eg,ep,ev,re,r,rp)
	...
	if #g>0 then
		...
		Duel.ShuffleHand(tp)
		if tc:IsLevelAbove(2) and Duel.SelectYesNo(tp,aux.Stringc511600115(1006081,2)) then
			local e1=Effect.CreateEffect(c)
