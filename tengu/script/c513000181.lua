...
function c513000181.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc513000181(c513000181,0))
	...
	e3:SetDescription(aux.Stringc513000181(c513000181,1))
	...
	e4:SetDescription(aux.Stringc513000181(c513000181,2))
...
c513000181.listed_series={SET_TG}
...
function c513000181.thfilter(c)
	return c:IsMonster() and c:IsSetCard(SET_TG) and c:IsAbleToHand()
end
function c513000181.stg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c513000181.thfilter,tp,LOCATION_DECK,0,1,nil) end
	Duel.SetOperationInfo(0,CATEGORY_TOHAND,nil,1,tp,LOCATION_DECK)
end
function c513000181.sop(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_ATOHAND)
	local g=Duel.SelectMatchingCard(tp,c513000181.thfilter,tp,LOCATION_DECK,0,1,1,nil)
	if #g>0 then
