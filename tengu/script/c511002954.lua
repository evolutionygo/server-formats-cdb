...
function c511002954.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCode2(c,true,true,14577226,aux.FilterBoolFunctionEx(Card.IsSetCard,0xf0))
	--copy
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc511002954(30312361,0))
	...
	e2:SetDescription(aux.Stringc511002954(81587028,0))
	...
	aux.GlobalCheck(s,function()
		...
		ge1:SetLabel(c511002954)
		ge1:SetProperty(EFFECT_FLAG_CANNOT_DISABLE)
		ge1:SetOperation(aux.sumreg)
		Duel.RegisterEffect(ge1,0)
		local ge2=ge1:Clone()
		ge2:SetCode(EVENT_SPSUMMON_SUCCESS)
		ge2:SetLabel(c511002954)
