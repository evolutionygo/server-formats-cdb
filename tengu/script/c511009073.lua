...
function c511009073.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511009073(54936498,0))
	...
	e2:SetDescription(aux.Stringc511009073(54936498,0))
...
function c511009073.efop(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_CARD,0,c511009073)
	local c=e:GetHandler()
	local rc=c:GetReasonCard()
	local e1=Effect.CreateEffect(rc)
	e1:SetDescription(aux.Stringc511009073(15981690,0))
