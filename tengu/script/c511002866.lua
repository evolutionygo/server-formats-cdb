...
function c511002866.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc511002866(c511002866,0))
	...
	e3:SetDescription(aux.Stringc511002866(c511002866,1))
	e3:SetCategory(CATEGORY_DESTROY)
	e3:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_O)
	e3:SetCode(EVENT_ATTACK_ANNOUNCE)
	e3:SetRange(LOCATION_MZONE)
	e3:SetCondition(c511002866.descon)
	e3:SetCost(aux.dxmcostgen(1,1,nil))
	e3:SetTarget(c511002866.destg)
	e3:SetOperation(c511002866.desop)
	--
...
c511002866.listed_series={SET_NUMBER}
c511002866.listed_names={2407234}
c511002866.aux.xyz_number=69
