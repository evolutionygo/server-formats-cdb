...
function c170000203.con(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(c170000203.filter1,tp,LOCATION_HAND+LOCATION_GRAVE,0,1,nil)
	and e:GetLabel()~=1 and e:GetHandler()==Duel.GetAttacker() and e:GetHandler():GetBattleTarget()~=nil
	or Duel.IsExistingMatchingCard(c170000203.filter1,tp,LOCATION_HAND+LOCATION_GRAVE,0,1,nil)
