...
function c511002419.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c511002419.filter,tp,LOCATION_DECK,0,1,nil) end
...
function c511002419.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,c511002419.filter,tp,LOCATION_DECK,0,1,2,nil)
	if #g>0 then
