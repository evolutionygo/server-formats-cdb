...
--updated by Larry126
local s,c511009022,alias=GetID()
function c511009022.initial_effect(c)
	...
	e4:SetDescription(aux.Stringc511009022(alias,0))
...
function c511009022.scfilter(c,tp,tc)
...
function c511009022.mfilter(c,e,tp)
	return c:GetLevel()==1 and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
		and Duel.IsExistingMatchingCard(c511009022.scfilter,tp,LOCATION_EXTRA,0,1,nil,tp,c)
end
...
function c511009022.scop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.GetMatchingGroup(c511009022.scfilter,tp,LOCATION_EXTRA,0,nil,tp,tc)
	if #g>0 then
