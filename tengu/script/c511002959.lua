...
function c511002959.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCode2(c,true,true,61538782,98049038,71218746,984114)
	--equip
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc511002959(3897065,0))
...
function c511002959.atcon(e)
	return e:GetHandler():IsHasEffect(c511002959)
end
function c511002959.atkop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	if c:IsHasEffect(c511002959) and c:GetAttackedCount()>0 then
		local e1=Effect.CreateEffect(c)
