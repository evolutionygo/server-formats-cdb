...
function c513000095.initial_effect(c)
	...
	e2:SetTarget(c513000095.sptg)
	e2:SetOperation(c513000095.spop)
	c:RegisterEffect(e2)
	--negate
	local e3=Effect.CreateEffect(c)
	e3:SetDescription(aux.Stringc513000095(88619463,0))
	...
	e4:SetDescription(aux.Stringc513000095(77058170,0))
...
function c513000095.rfilter(c,tp)
...
function c513000095.spcon(e,c)
	...
	return Duel.CheckReleaseGroup(tp,c513000095.rfilter,2,false,2,true,c,tp,nil,nil,nil,tp)
end
function c513000095.sptg(e,tp,eg,ep,ev,re,r,rp,c)
	local ft=Duel.GetLocationCount(tp,LOCATION_MZONE)
	local g=Duel.SelectReleaseGroup(tp,c513000095.rfilter,2,2,false,true,true,c,nil,nil,false,nil,tp)
	if g then
		g:KeepAlive()
		e:SetLabelObject(g)
	return true
...
function c513000095.atktg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return c:GetFlagEffect(c513000095)==0 and atk~=0
		and bc and bc:IsOnField() and bc:IsFaceup() and bc:IsCanBeEffectTarget(e) end
	c:RegisterFlagEffect(c513000095,RESET_CHAIN,0,1)
