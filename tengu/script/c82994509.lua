...
function c82994509.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc82994509(c82994509,0))
...
c82994509.listed_names={82994510}
...
function c82994509.operation(e,tp,eg,ep,ev,re,r,rp)
	if Duel.GetLocationCount(1-tp,LOCATION_MZONE)>0 
		and Duel.IsPlayerCanSpecialSummonMonster(tp,c82994509+1,0,TYPES_TOKEN,0,0,1,RACE_PLANT,ATTRIBUTE_WIND,POS_FACEUP_DEFENSE,1-tp) then
		local token=Duel.CreateToken(tp,c82994509+1)
