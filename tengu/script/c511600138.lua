...
function c511600138.initial_effect(c)
	c:AddSetcodesRule(c511600138,false,0x601)
	--dark synchro summon
	c:EnableReviveLimit()
	Synchro.AddDarkSynchroProcedure(c,aux.NonTuner(nil),nil,4)
	...
	e3:SetDescription(aux.Stringc511600138(31919988,0))
...
function c511600138.tgcon(e,tp,eg,ep,ev,re,r,rp)
