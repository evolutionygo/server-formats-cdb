...
function c511000264.initial_effect(c)
	...
	c:EnableReviveLimit()
	c:SetUniqueOnField(1,0,c511000264)
	--Influence of Rune
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc511000264(c511000264,0))
	...
	e3:SetDescription(aux.Stringc511000264(93483212,1))
	...
	e4:SetDescription(aux.Stringc511000264(93483212,2))
...
function c511000264.imcon(e,tp,eg,ep,ev,re,r,rp)
	...
	if ex and tg~=nil and tc+tg:FilterCount(c511000264.cfilter,nil)-#tg>0 then
		return true
	end
...
function c511000264.imop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.SelectYesNo(tp,aux.Stringc511000264(799183,0)) then
...
function c511000264.regop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsPreviousControler(tp) and c:IsReason(REASON_DESTROY)
		...
		c:RegisterFlagEffect(c511000264,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
	end
end
function c511000264.spcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c511000264)~=0
end
...
function c511000264.disop(e,tp,eg,ep,ev,re,r,rp,c,og)
	Duel.Hint(HINT_CARD,0,c511000264)
