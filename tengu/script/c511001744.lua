...
function c511001744.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511001744(3989465,0))
	...
	e2:SetDescription(aux.Stringc511001744(c511001744,0))
	...
	e3:SetDescription(aux.Stringc511001744(4941482,0))
...
function c511001744.atktg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c511001744.atkfilter,tp,LOCATION_MZONE,0,1,nil) 
		and e:GetHandler():GetFlagEffect(c511001744)==0 end
	e:GetHandler():RegisterFlagEffect(c511001744,RESET_PHASE+PHASE_DAMAGE_CAL,0,1)
end
