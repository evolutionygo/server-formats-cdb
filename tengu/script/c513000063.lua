...
function c513000063.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc513000063(c513000063,0))
	...
	e3:SetDescription(aux.Stringc513000063(c513000063,1))
	e3:SetType(EFFECT_TYPE_IGNITION)
	e3:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e3:SetCategory(CATEGORY_EQUIP)
	e3:SetRange(LOCATION_MZONE)
	e3:SetTarget(c513000063.eqtg)
	e3:SetOperation(c513000063.eqop)
	c:RegisterEffect(e3)
	...
	e4:SetCondition(c513000063.discon)
	e4:SetOperation(c513000063.disop)
	...
	e5:SetTarget(c513000063.reptg)
	e5:SetOperation(c513000063.repop)
	local e6=Effect.CreateEffect(c)
	e6:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_CONTINUOUS)
	e6:SetCode(EVENT_CHAIN_SOLVING)
	e6:SetRange(LOCATION_SZONE)
	e6:SetCondition(aux.damcon1)
	e6:SetOperation(c513000063.repop2)
...
c513000063.listed_series={SET_NUMBER}
c513000063.listed_names={93568288}
c513000063.aux.xyz_number=80
...
function c513000063.repop(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc513000063(c513000063,2))
...
function c513000063.repop2(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if not c:IsStatus(STATUS_DESTROY_CONFIRMED)
		...
		Duel.SendtoGrave(c,REASON_EFFECT+REASON_REPLACE)
		local cc513000063=Duel.GetChainInfo(ev,CHAININFO_CHAIN_ID)
		local e1=Effect.CreateEffect(c)
		e1:SetType(EFFECT_TYPE_FIELD)
		e1:SetCode(EFFECT_CHANGE_DAMAGE)
		e1:SetProperty(EFFECT_FLAG_PLAYER_TARGET)
		e1:SetTargetRange(1,0)
		e1:SetLabel(cc513000063)
		e1:SetValue(c513000063.refcon)
		e1:SetReset(RESET_CHAIN)
		Duel.RegisterEffect(e1,tp)
		local e2=Effect.CreateEffect(c)
		e2:SetDescription(aux.Stringc513000063(c513000063,2))
		e2:SetCategory(CATEGORY_SPECIAL_SUMMON)
		e2:SetType(EFFECT_TYPE_IGNITION)
		e2:SetRange(LOCATION_GRAVE)
		e2:SetCost(c513000063.spcost)
		e2:SetTarget(c513000063.sptg)
		e2:SetOperation(c513000063.spop)
		e2:SetReset(RESET_EVENT|RESETS_STANDARD)
		c:RegisterEffect(e2)
	end
end
function c513000063.refcon(e,re,val,r,rp,rc)
	...
	local cc513000063=Duel.GetChainInfo(0,CHAININFO_CHAIN_ID)
	if cc513000063==e:GetLabel() then e:SetLabel(val) return 0
	else return val end
end
