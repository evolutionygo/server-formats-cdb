...
function c513000091.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc513000091(c513000091,0))
...
function c513000091.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetDescription(aux.Stringc513000091(c513000091,1))
	...
	if Duel.Destroy(g,REASON_EFFECT)>0 then
		...
		local ct1=og:FilterCount(c513000091.filter,nil,tp)
		local ct2=og:FilterCount(c513000091.filter,nil,1-tp)
		Duel.BreakEffect()
