...
function c511002476.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.SendtoDeck(tc,nil,0,REASON_EFFECT)>0 and sumtype==SUMMON_TYPE_SYNCHRO and #mg>0 and #mg<=ft 
		and mg:FilterCount(aux.NecroValleyFilter(c511002476.mgfilter),nil,e,tp,tc)==#mg and Duel.SelectYesNo(tp,aux.Stringc511002476(32441317,0)) then
		Duel.BreakEffect()
