...
function c49597193.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCode2(c,false,false,54620698,aux.FilterBoolFunctionEx(Card.IsSetCard,0x1047))
	--spsummon condition
	...
	e3:SetDescription(aux.Stringc49597193(c49597193,0))
...
c49597193.listed_series={0x1047}
