...
function c511600092.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511600092(60953118,1))
	...
	e2:SetDescription(aux.Stringc511600092(40640057,0))
...
function c511600092.damop(e,tp,eg,ep,ev,re,r,rp)
	...
	c:RegisterFlagEffect(c511600092,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,0)
end
...
function c511600092.sumtg(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and c:GetFlagEffect(c511600092)>0
