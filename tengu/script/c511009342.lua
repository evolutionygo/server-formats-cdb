...
function c511009342.costfilter(c,tp)
...
function c511009342.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c511009342.costfilter,tp,LOCATION_HAND,0,1,nil,tp) end
	Duel.DiscardHand(tp,c511009342.costfilter,1,1,REASON_COST+REASON_DISCARD,nil,tp)
end
...
function c511009342.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if not c:IsRelateToEffect(e)
		or not Duel.IsPlayerCanSpecialSummonMonster(tp,c511009342,0x10db,0x21,1,0,0,RACE_WARRIOR,ATTRIBUTE_DARK)
	then return end
	Duel.BreakEffect()
	...
	--equip change
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc511009342(40884383,0))
	...
	e2:SetDescription(aux.Stringc511009342(76925842,0))
