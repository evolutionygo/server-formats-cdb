...
function c511004447.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc511004447(CARD_VIJAM,0))
	...
	e3:SetDescription(aux.Stringc511004447(CARD_VIJAM,1))
...
function c511004447.disop(e,tp,eg,ep,ev,re,r,rp)
	...
	c:RegisterEffect(e1)
	c:RegisterFlagEffect(c511004447,RESET_EVENT+RESETS_STANDARD-RESET_TURN_SET,0,1)
	local bc=c:GetBattleTarget()
...
function c511004447.spcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c511004447)~=0
end
