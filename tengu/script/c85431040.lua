...
function c85431040.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc85431040(c85431040,0))
...
function c85431040.filter(c,e,tp)
	return c:IsCode(c85431040) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
function c85431040.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.SelectYesNo(tp,aux.Stringc85431040(c85431040,1)) then
