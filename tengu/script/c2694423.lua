...
function c2694423.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc2694423(c2694423,0))
	...
	e2:SetDescription(aux.Stringc2694423(c2694423,1))
...
function c2694423.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return c:IsCanTurnSet() and c:GetFlagEffect(c2694423)==0 end
	c:RegisterFlagEffect(c2694423,RESET_EVENT+RESETS_STANDARD-RESET_TURN_SET+RESET_PHASE+PHASE_END,0,1)
