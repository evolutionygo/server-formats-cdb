...
c511004442.listed_names={CARD_VIJAM}
...
function c511004442.condition0(e,tp,eg,ev,ep,re,r,rp)
	return eg:IsExists(c511004442.filter3,1,nil,tp) and re:GetHandler():IsMonster() and re:GetHandler():IsSetCard(0xe3) and Duel.GetTurnPlayer()~=tp
end
