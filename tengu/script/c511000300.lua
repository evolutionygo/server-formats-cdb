...
function c511000300.initial_effect(c)
	...
	e3:SetDescription(aux.Stringc511000300(c511000300,0))
...
function c511000300.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	while tc do
		tc:RegisterFlagEffect(c511000300,RESET_EVENT+RESETS_STANDARD,0,0)
		tc=rg:GetNext()
	end
...
function c511000300.thfilter(c)
	return c:GetFlagEffect(c511000300)~=0 and c:IsAbleToHand()
end
...
function c511000300.dfilter(c)
	return c:GetFlagEffect(c511000300)~=0
end
