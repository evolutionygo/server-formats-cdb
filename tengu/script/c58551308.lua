...
function c58551308.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc58551308(c58551308,0))
...
function c58551308.flipop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsLocation(LOCATION_MZONE+LOCATION_GRAVE) then
		c:RegisterFlagEffect(c58551308,RESET_EVENT|(RESETS_STANDARD|RESET_OVERLAY)&~(RESET_LEAVE|RESET_TOGRAVE),0,1)
	end
end
...
function c58551308.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return e:GetHandler():GetFlagEffect(c58551308)~=0 end
