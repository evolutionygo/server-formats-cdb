...
function c511000657.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511000657(c511000657,0))
...
function c511000657.rescon(sg,e,tp,mg)
	return aux.ChkfMMZ(1)(sg,e,tp,mg) and Duel.IsExistingMatchingCard(c511000657.spfilter,tp,LOCATION_HAND,0,1,nil,e,tp,#sg)
end
function c511000657.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then
		...
		e:SetLabel(0)
		return aux.SelectUnselectGroup(cg,e,tp,nil,nil,c511000657.rescon,0)
	end
	local rg=aux.SelectUnselectGroup(cg,e,tp,nil,nil,c511000657.rescon,1,tp,HINTMSG_REMOVE,c511000657.rescon)
...
function c511000657.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local tc=Duel.SelectMatchingCard(tp,c511000657.spfilter,tp,LOCATION_HAND,0,1,1,nil,e,tp,lv):GetFirst()
