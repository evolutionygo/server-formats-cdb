...
function c74115234.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc74115234(c74115234,0))
	e1:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_F)
	e1:SetCategory(CATEGORY_RECOVER)
	e1:SetCode(EVENT_BATTLE_DESTROYING)
	e1:SetProperty(EFFECT_FLAG_PLAYER_TARGET)
	e1:SetRange(LOCATION_SZONE)
	e1:SetCondition(c74115234.recon)
	e1:SetTarget(c74115234.retg)
	e1:SetOperation(c74115234.reop)
	c:RegisterEffect(e1)
	--Return this card to the hand
	local e2=Effect.CreateEffect(c)
	e2:SetDescription(aux.Stringc74115234(c74115234,1))
	e2:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_F)
	e2:SetCategory(CATEGORY_TOHAND)
	e2:SetCode(EVENT_TO_GRAVE)
	e2:SetCondition(c74115234.retcon)
	e2:SetTarget(c74115234.rettg)
	e2:SetOperation(c74115234.retop)
	c:RegisterEffect(e2)
end
c74115234.listed_card_types={TYPE_SPIRIT}
