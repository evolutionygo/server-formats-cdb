...
c511002480.listed_series={0x104f}
...
function c511002480.filter1(c,e,tp,ft)
	return c:IsType(TYPE_SYNCHRO) and (ft>0 or (c:GetSequence()<5 and c:IsControler(tp))) 
		and Duel.IsExistingMatchingCard(c511002480.filter2,tp,LOCATION_DECK,0,1,nil,c:GetCode(),e,tp)
end
...
function c511002480.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local tc=Duel.SelectMatchingCard(tp,c511002480.filter2,tp,LOCATION_DECK,0,1,1,nil,code,e,tp):GetFirst()
...
function c511002480.efilter(e,re)
