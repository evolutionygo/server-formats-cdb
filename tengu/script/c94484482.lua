...
function c94484482.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc and Duel.SpecialSummon(g,0,tp,tp,false,false,POS_FACEUP_DEFENSE)~=0 then
		local fc94484482=e:GetHandler():GetFieldID()
		tc:RegisterFlagEffect(c94484482,RESET_EVENT+RESETS_STANDARD,0,1,fc94484482)
		local e1=Effect.CreateEffect(e:GetHandler())
		e1:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_CONTINUOUS)
		e1:SetCode(EVENT_PHASE+PHASE_END)
		e1:SetCountLimit(1)
		e1:SetProperty(EFFECT_FLAG_IGNORE_IMMUNE)
		e1:SetLabel(fc94484482)
...
function c94484482.retcon(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:GetFlagEffectLabel(c94484482)~=e:GetLabel() then
		e:Reset()
		return false
