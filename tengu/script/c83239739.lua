...
function c83239739.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc83239739(c83239739,0))
...
c83239739.listed_names={83239740}
...
function c83239739.operation(e,tp,eg,ep,ev,re,r,rp)
	if Duel.GetLocationCount(tp,LOCATION_MZONE)>0 
		and Duel.IsPlayerCanSpecialSummonMonster(tp,c83239739+1,0,TYPES_TOKEN,0,0,1,RACE_FISH,ATTRIBUTE_WATER) then
		local token=Duel.CreateToken(tp,c83239739+1)
