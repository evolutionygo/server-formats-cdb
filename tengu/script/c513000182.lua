...
function c513000182.initial_effect(c)
	...
	e3:SetDescription(aux.Stringc513000182(c513000182,1))
	...
	e4:SetDescription(aux.Stringc513000182(c513000182,1))
...
c513000182.listed_series={SET_TG}
...
function c513000182.thfilter(c)
	return c:IsMonster() and c:IsSetCard(SET_TG) and c:IsAbleToHand()
end
function c513000182.stg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c513000182.thfilter,tp,LOCATION_DECK,0,1,nil) end
	Duel.SetOperationInfo(0,CATEGORY_TOHAND,nil,1,tp,LOCATION_DECK)
end
function c513000182.sop(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_ATOHAND)
	local g=Duel.SelectMatchingCard(tp,c513000182.thfilter,tp,LOCATION_DECK,0,1,1,nil)
	if #g>0 then
