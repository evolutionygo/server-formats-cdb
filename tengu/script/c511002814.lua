...
function c511002814.ctop(e,tp,eg,ep,ev,re,r,rp)
	...
	local tc=g:GetFirst()
	while tc do
		tc:RegisterFlagEffect(c511002814,RESET_EVENT+RESETS_STANDARD,0,1)
		tc=g:GetNext()
	end
end
...
function c511002814.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local ct=c:GetFlagEffect(c511002814)
