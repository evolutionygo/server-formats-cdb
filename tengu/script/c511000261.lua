...
function c511000261.initial_effect(c)
	c:EnableReviveLimit()
	c:SetUniqueOnField(1,1,c511000261)
	...
	e2:SetTarget(c511000261.sptg)
	e2:SetOperation(c511000261.spop)
	c:RegisterEffect(e2)
	--Create Token
	local e3=Effect.CreateEffect(c)
	e3:SetDescription(aux.Stringc511000261(c511000261,0))
	...
	e6:SetDescription(aux.Stringc511000261(c511000261,1))
...
function c511000261.sptg(e,tp,eg,ep,ev,re,r,rp,c)
