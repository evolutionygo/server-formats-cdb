...
function c22587018.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc22587018(c22587018,0))
...
c22587018.listed_names={c22587018}
function c22587018.filter(c,e,tp)
	return c:IsCode(c22587018) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
