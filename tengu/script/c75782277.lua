...
function c75782277.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc75782277(c75782277,0))
	e2:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_F)
	e2:SetRange(LOCATION_FZONE)
	e2:SetProperty(EFFECT_FLAG_CARD_TARGET+EFFECT_FLAG_EVENT_PLAYER)
	e2:SetCode(EVENT_CUSTOM+c75782277)
	e2:SetTarget(c75782277.target)
	e2:SetOperation(c75782277.operation)
	c:RegisterEffect(e2)
	--atk/def
...
function c75782277.check(e,tp,eg,ep,ev,re,r,rp)
	...
	if #g1>0 then Duel.RaiseEvent(g1,EVENT_CUSTOM+c75782277,re,r,rp,0,0) end
	if #g2>0 then Duel.RaiseEvent(g2,EVENT_CUSTOM+c75782277,re,r,rp,1,0) end
end
