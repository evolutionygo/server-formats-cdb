...
--updated by Larry126
local s,c100000505,alias=GetID()
function c100000505.initial_effect(c)
	alias=c:GetOriginalCodeRule()
	--Place in the Spell/Trap Zone
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc100000505(alias,0))
	...
	e2:SetDescription(aux.Stringc100000505(alias,1))
	e2:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e2:SetType(EFFECT_TYPE_QUICK_O)
	e2:SetCode(EVENT_FREE_CHAIN)
	e2:SetRange(LOCATION_SZONE)
	e2:SetHintTiming(0,TIMING_MAIN_END)
	e2:SetCondition(c100000505.spcon)
	...
	e3:SetDescription(aux.Stringc100000505(alias,2))
...
c100000505.listed_series={0x5008}
...
function c100000505.spcon(e,tp,eg,ep,ev,re,r,rp)
