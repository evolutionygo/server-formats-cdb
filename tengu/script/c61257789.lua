...
function c61257789.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc61257789(c61257789,0))
	...
	e3:SetDescription(aux.Stringc61257789(c61257789,1))
	...
	e4:SetDescription(aux.Stringc61257789(c61257789,2))
...
c61257789.listed_names={CARD_ASSAULT_MODE,CARD_STARDUST_DRAGON}
c61257789.assault_mode=CARD_STARDUST_DRAGON
...
function c61257789.negop(e,tp,eg,ep,ev,re,r,rp)
	...
	e:GetHandler():RegisterFlagEffect(c61257789,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,0)
end
function c61257789.sumtg(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and c:GetFlagEffect(c61257789)>0
