...
function c511002293.initial_effect(c)
	...
	local e1=aux.AddNormalSummonProcedure(c,true,true,3,3,SUMMON_TYPE_TRIBUTE+1,aux.Stringc511002293(c511002293,0))
	--equip
	local e2=Effect.CreateEffect(c)
	e2:SetDescription(aux.Stringc511002293(95100269,0))
