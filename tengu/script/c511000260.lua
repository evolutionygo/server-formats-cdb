...
function c511000260.initial_effect(c)
	...
	c:EnableReviveLimit()
	c:SetUniqueOnField(1,0,c511000260)
	--Negate Spell/Trap
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc511000260(c511000260,0))
	...
	e3:SetDescription(aux.Stringc511000260(67098114,1))
	...
	e4:SetDescription(aux.Stringc511000260(67098114,2))
...
function c511000260.regop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsPreviousControler(tp) and c:IsReason(REASON_DESTROY)
		...
		c:RegisterFlagEffect(c511000260,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
	end
end
function c511000260.spcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c511000260)~=0
end
