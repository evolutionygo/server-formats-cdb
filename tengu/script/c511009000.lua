...
function c511009000.rmop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.Remove(g,0,REASON_EFFECT+REASON_TEMPORARY)~=0 then
		local fc511009000=c:GetFieldID()
		local og=Duel.GetOperatedGroup()
		for oc in aux.Next(og) do
			oc:RegisterFlagEffect(c511009000,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1,fc511009000)
		end
		og:KeepAlive()
		local e1=Effect.CreateEffect(c)
...
function c511009000.retfilter(c,fc511009000)
	return c:GetFlagEffectLabel(c511009000)==fc511009000
end
