...
function c513000165.initial_effect(c)
	...
	e4:SetCondition(c513000165.rdcon1)
	e4:SetOperation(c513000165.rdop1)
	c:RegisterEffect(e4)
	...
	e5:SetCondition(c513000165.rdcon2)
	e5:SetOperation(c513000165.rdop2)
	c:RegisterEffect(e5)
end
c513000165.listed_names={CARD_CLEAR_WORLD}
function c513000165.rdcon1(e,tp,eg,ep,ev,re,r,rp)
...
function c513000165.rdop1(e,tp,eg,ep,ev,re,r,rp)
	Duel.ChangeBattleDamage(tp,0)
end
function c513000165.rdcon2(e,tp,eg,ep,ev,re,r,rp)
	local ac=Duel.GetAttacker()
	local at=Duel.GetAttackTarget()
	return Duel.GetBattleDamage(tp)>1000
		and ((ac:IsControler(tp) and ac:IsFaceup() and ac:IsClear())
...
function c513000165.rdop2(e,tp,eg,ep,ev,re,r,rp)
	if Duel.SelectYesNo(tp,aux.Stringc513000165(23857661,0)) then 
		Duel.ChangeBattleDamage(tp,0) 
