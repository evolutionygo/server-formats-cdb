...
function c23846921.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc23846921(c23846921,0))
...
function c23846921.coinop(e,tp,eg,ep,ev,re,r,rp)
	...
	c23846921.arcanareg(c,Arcana.TossCoin(c,tp))
end
function c23846921.arcanareg(c,coin)
	--coin effect
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc23846921(c23846921,1))
	...
	e2:SetDescription(aux.Stringc23846921(c23846921,2))
