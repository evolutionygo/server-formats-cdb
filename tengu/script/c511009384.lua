--ＳＲ５６プレーン
--Speedroc511009384 Rubberband Plane (Anime)
function c511009384.initial_effect(c)
	--atk up
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc511009384(c511009384,0))
	...
	e2:SetDescription(aux.Stringc511009384(c511009384,1))
	e2:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e2:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_O)
	e2:SetProperty(EFFECT_FLAG_DELAY)
	e2:SetCode(EVENT_SPSUMMON_SUCCESS)
	e2:SetRange(LOCATION_HAND)
	e2:SetCondition(c511009384.spcon)
	e2:SetTarget(c511009384.sptg)
	e2:SetOperation(c511009384.spop)
	c:RegisterEffect(e2)
end
