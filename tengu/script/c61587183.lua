...
function c61587183.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc61587183(c61587183,0))
	e1:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e1:SetCode(EVENT_BATTLE_DAMAGE)
	e1:SetCondition(function(e,tp,eg,ep,ev,re,r,rp) return ep==1-tp end)
	e1:SetTarget(c61587183.efftg)
	e1:SetOperation(c61587183.effop)
	c:RegisterEffect(e1)
end
function c61587183.efftg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local op=Duel.SelectEffect(tp,
		{b1,aux.Stringc61587183(c61587183,1)},
		{b2,aux.Stringc61587183(c61587183,2)})
	e:SetLabel(op)
	if op==1 then
...
function c61587183.effop(e,tp,eg,ep,ev,re,r,rp)
	if e:GetLabel()==1 then
		...
		if #g>0 then
			...
			local ac=Duel.SelectOption(tp,aux.Stringc61587183(c61587183,3),aux.Stringc61587183(c61587183,4))
