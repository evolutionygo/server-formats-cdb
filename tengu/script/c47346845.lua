...
function c47346845.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc47346845(c47346845,0))
...
c47346845.listed_names={c47346845}
function c47346845.filter(c,e,tp)
	return c:IsCode(c47346845) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
