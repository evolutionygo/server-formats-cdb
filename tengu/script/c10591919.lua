...
function c10591919.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc10591919(c10591919,0))
...
function c10591919.opa(e,tp,eg,ep,ev,re,r,rp)
	...
	local fc10591919=e:GetHandler():GetFieldID()
	tc:RegisterFlagEffect(c10591919,RESET_EVENT+RESETS_STANDARD,0,1,fc10591919)
	local e1=Effect.CreateEffect(e:GetHandler())
	e1:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_CONTINUOUS)
	e1:SetCode(EVENT_PHASE+PHASE_END)
	e1:SetCountLimit(1)
	e1:SetProperty(EFFECT_FLAG_IGNORE_IMMUNE)
	e1:SetLabel(fc10591919)
...
function c10591919.descon(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:GetFlagEffectLabel(c10591919)~=e:GetLabel() then
		e:Reset()
		return false
