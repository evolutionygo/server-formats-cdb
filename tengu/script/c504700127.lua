--援護射撃
--Covering Fire (Goat)
function c504700127.initial_effect(c)
	--Activate
	...
	e1:SetCondition(c504700127.condition)
	e1:SetTarget(c504700127.target)
	e1:SetOperation(c504700127.activate)
	c:RegisterEffect(e1)
end
function c504700127.condition(e,tp,eg,ep,ev,re,r,rp)
...
function c504700127.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c504700127.activate(e,tp,eg,ep,ev,re,r,rp)
