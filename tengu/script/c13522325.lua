...
function c13522325.spfilter(c,tp)
...
function c13522325.spcon(e,c)
	...
	local rg=Duel.GetMatchingGroup(c13522325.spfilter,tp,LOCATION_GRAVE,0,nil,ATTRIBUTE_WIND)
	return aux.SelectUnselectGroup(rg,e,tp,1,1,aux.ChkfMMZ(1),0)
end
function c13522325.sptg(e,tp,eg,ep,ev,re,r,rp,c)
	local rg=Duel.GetMatchingGroup(c13522325.spfilter,tp,LOCATION_GRAVE,0,nil,ATTRIBUTE_WIND)
