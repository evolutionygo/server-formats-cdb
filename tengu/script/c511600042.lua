...
function c511600042.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511600042(76232522,0))
...
function c511600042.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) and Duel.SpecialSummonStep(tc,0,tp,tp,false,false,POS_FACEUP) then
		...
		tc:RegisterFlagEffect(c511600042,RESET_EVENT+RESETS_STANDARD,0,1)
		Duel.SpecialSummonComplete()
	end
end
function c511600042.descon(e,tp,eg,ep,ev,re,r,rp)
	local tc=e:GetLabelObject()
	if tc:GetFlagEffect(c511600042)==0 then
		e:Reset()
		return false
	end
	return true
