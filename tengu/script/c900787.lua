...
function c900787.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc900787(c900787,0))
...
function c900787.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():GetFlagEffect(c900787)==0
	...
	e:GetHandler():RegisterFlagEffect(c900787,RESET_PHASE+PHASE_DAMAGE,0,1)
end
