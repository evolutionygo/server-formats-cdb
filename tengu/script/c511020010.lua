...
function c511020010.initial_effect(c)
	...
	e1:SetCondition(c511020010.eqcon)
	e1:SetTarget(c511020010.eqtg)
	e1:SetOperation(c511020010.eqop)
	c:RegisterEffect(e1)
...
function c511020010.eqcon(e,tp,eg,ep,ev,re,r,rp)
	local at=Duel.GetAttacker()
	return at:GetControler()~=tp and at:IsType(TYPE_XYZ)
end
function c511020010.eqtg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c511020010.eqop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
