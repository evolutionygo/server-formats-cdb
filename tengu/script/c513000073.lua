...
function c513000073.initial_effect(c)
	...
	e3:SetDescription(aux.Stringc513000073(c513000073,0))
	...
	e4:SetDescription(aux.Stringc513000073(c513000073,1))
...
c513000073.listed_series={0x23}
c513000073.listed_names={79856792,27564031}
...
function c513000073.spcon(e,c)
	...
	local rg=Duel.GetMatchingGroup(c513000073.spfilter,tp,LOCATION_DECK,0,nil)
	return aux.SelectUnselectGroup(rg,e,tp,1,1,aux.ChkfMMZ(1),0)
end
function c513000073.sptg(e,tp,eg,ep,ev,re,r,rp,c)
	local rg=Duel.GetMatchingGroup(c513000073.spfilter,tp,LOCATION_DECK,0,nil)
