...
function c511002018.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCode2(c,true,true,30068120,3841833)
	--equip
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc511002018(c511002018,0))
	...
	c:RegisterEffect(e1)
	aux.AddEREquipLimit(c,nil,aux.FilterBoolFunction(Card.IsMonster),c511002018.equipop,e1)
end
