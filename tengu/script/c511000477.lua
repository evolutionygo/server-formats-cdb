...
function c511000477.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCode2(c,true,true,67284908,30778711)
	--move
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc511000477(c511000477,0))
	...
	e2:SetDescription(aux.Stringc511000477(c511000477,0))
	...
	e5:SetDescription(aux.Stringc511000477(c511000477,0))
