...
function c513000012.initial_effect(c)
	--synchro summon
	aux.AddSynchroProcedure(c,aux.FilterBoolFunctionEx(Card.IsType,TYPE_SYNCHRO),1,1,aux.FilterBoolFunction(Card.IsCode,CARD_STARDUST_DRAGON),1,1)
	c:EnableReviveLimit()
	--Synchto Summon this card on your opponent's turn
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc513000012(575512,0))
	...
	e2:SetDescription(aux.Stringc513000012(24696097,0))
	...
	e3:SetDescription(aux.Stringc513000012(24696097,1))
	...
	e4:SetDescription(aux.Stringc513000012(24696097,2))
	...
	e5:SetDescription(aux.Stringc513000012(24696097,3))
...
c513000012.material={CARD_STARDUST_DRAGON}
c513000012.listed_names={CARD_STARDUST_DRAGON}
c513000012.synchro_tuner_required=1
c513000012.synchro_nt_required=1
...
function c513000012.banop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	c:RegisterFlagEffect(c513000012,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
...
function c513000012.rettg(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and c:GetFlagEffect(c513000012)>0 end
end
