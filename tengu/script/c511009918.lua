...
function c511009918.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511009918(168917,0))
...
c511009918.listed_series={0x119}
...
function c511009918.spcost2(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c511009918.spcfilter,tp,LOCATION_HAND,0,1,e:GetHandler()) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TOGRAVE)
	local g=Duel.SelectMatchingCard(tp,c511009918.spcfilter,tp,LOCATION_HAND,0,1,1,e:GetHandler())
