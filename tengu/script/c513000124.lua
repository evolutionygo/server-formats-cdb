...
function c513000124.initial_effect(c)
	...
	e2:SetCode(EVENT_CUSTOM+c513000124)
	e2:SetRange(LOCATION_HAND)
	e2:SetCondition(c513000124.spcon)
	e2:SetCost(c513000124.spcost)
	e2:SetTarget(c513000124.sptg)
	e2:SetOperation(c513000124.spop)
	c:RegisterEffect(e2)
	--Condition
	...
	e3:SetCode(c513000124)
	e3:SetLabel(0)
	e3:SetLabelObject(e2)
	e3:SetCondition(c513000124.econ)
	Duel.RegisterEffect(e3,0)
	local e4=e3:Clone()
	e4:SetLabel(1)
	Duel.RegisterEffect(e4,1)
	--Indec513000124. Battle
	...
	e6:SetCondition(c513000124.ctcon)
	e6:SetOperation(c513000124.ctop)
	c:RegisterEffect(e6)
	--Self-Destruction
	...
	e7:SetCondition(c513000124.descon)
	c:RegisterEffect(e7)
	...
	aux.GlobalCheck(s,function()
		...
		ge1:SetOperation(c513000124.zeroop)
		Duel.RegisterEffect(ge1,0)
	end)
end
function c513000124.econ(e,tp)
	return e:GetLabelObject() and e:GetLabelObject():IsActivatable(e:GetLabel())
end
function c513000124.spcon(e,tp)
	return Duel.GetLP(tp)<=0
end
function c513000124.zeroop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	if Duel.GetLP(0)<=0 and not Duel.IsPlayerAffectedByEffect(0,EFFECT_CANNOT_LOSE_LP)
		and Duel.GetFlagEffect(0,c513000124+1)==0 and Duel.IsPlayerAffectedByEffect(0,c513000124)
		...
		iz2:SetLabel(0)
		iz2:SetOperation(c513000124.zeroresetop)
		Duel.RegisterEffect(iz2,0)
		Duel.RaiseEvent(Duel.GetMatchingGroup(aux.TRUE,0,0xff,0,nil),EVENT_CUSTOM+c513000124,nil,0,0,0,0)
		Duel.RegisterFlagEffect(0,c513000124+1,0,0,1)
	end
	if Duel.GetLP(1)<=0 and not Duel.IsPlayerAffectedByEffect(1,EFFECT_CANNOT_LOSE_LP)
		and Duel.GetFlagEffect(1,c513000124+1)==0 and Duel.IsPlayerAffectedByEffect(1,c513000124)
		...
		Duel.RaiseEvent(Duel.GetMatchingGroup(aux.TRUE,0,0xff,0,nil),EVENT_CUSTOM+c513000124,nil,0,0,1,0)
		Duel.RegisterFlagEffect(1,c513000124+1,0,0,1)
	end
end
function c513000124.zeroresetop(e,tp,eg,ep,ev,re,r,rp)
	...
	if (e:GetLabel()==2 and Duel.GetCurrentPhase()&PHASE_DAMAGE==0) or e:GetLabel()==3 then
		...
		e:Reset()
		Duel.ResetFlagEffect(tp,c513000124+1)
	end
end
