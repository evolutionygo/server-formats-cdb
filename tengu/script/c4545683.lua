...
function c4545683.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc4545683(c4545683,0))
	...
	e5:SetDescription(aux.Stringc4545683(c4545683,1))
	...
	e6:SetDescription(aux.Stringc4545683(c4545683,2))
...
function c4545683.equipop(c,e,tp,tc)
	...
	if not c:EquipByEffectAndLimitRegister(e,tp,tc,c4545683) then return end
	if atk>0 then
		local e2=Effect.CreateEffect(c)
...
function c4545683.spfilter(c,e,tp,ec)
	return c:GetFlagEffect(c4545683)~=0 and c:GetEquipTarget()==ec and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP_DEFENSE)
end
