...
function c100000301.initial_effect(c)
	...
	e1:SetTarget(c100000301.sptg)
	e1:SetOperation(c100000301.spop)
	c:RegisterEffect(e1)
	--Inflict 500 damage
	local e2=Effect.CreateEffect(c)
	e2:SetDescription(aux.Stringc100000301(c100000301,0))
...
function c100000301.spfilter(c)
...
function c100000301.spcon(e,c)
	...
	local rg=Duel.GetMatchingGroup(c100000301.spfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,e:GetHandler())
	return aux.SelectUnselectGroup(rg,e,tp,3,3,aux.ChkfMMZ(1),0)
end
function c100000301.sptg(e,tp,eg,ep,ev,re,r,rp,c)
	local rg=Duel.GetMatchingGroup(c100000301.spfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,e:GetHandler())
