...
function c55690251.initial_effect(c)
	...
	local e2=aux.AddNormalSummonProcedure(c,true,true,1,1,SUMMON_TYPE_TRIBUTE,aux.Stringc55690251(c55690251,0),c55690251.otfilter)
	local e3=aux.AddNormalSetProcedure(c,true,true,1,1,SUMMON_TYPE_TRIBUTE,aux.Stringc55690251(c55690251,0),c55690251.otfilter)
	--send to grave
	local e4=Effect.CreateEffect(c)
	e4:SetDescription(aux.Stringc55690251(c55690251,1))
