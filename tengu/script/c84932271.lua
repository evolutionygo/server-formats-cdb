...
function c84932271.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc84932271(c84932271,0))
...
function c84932271.flipop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsLocation(LOCATION_MZONE+LOCATION_GRAVE) then
		c:RegisterFlagEffect(c84932271,RESET_EVENT+RESETS_STANDARD_EXC_GRAVE+RESET_PHASE+PHASE_END,0,1)
	end
end
...
function c84932271.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():GetFlagEffect(c84932271)~=0 end
