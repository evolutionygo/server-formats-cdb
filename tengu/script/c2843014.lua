...
function c2843014.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc2843014(c2843014,0))
...
c2843014.listed_names={c2843014}
...
function c2843014.filter2(c,e,tp)
	return c:IsCode(c2843014) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
function c2843014.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.SendtoGrave(g,REASON_EFFECT)~=0 then
		...
		if tc and Duel.SelectYesNo(tp,aux.Stringc2843014(c2843014,1)) then
			Duel.BreakEffect()
