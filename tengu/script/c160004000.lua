--人造人間－サイコ・ショッカー
--Jinzo (Rush)
function c160004000.initial_effect(c)
	--cannot trigger
	...
	e2:SetCondition(c160004000.cond)
	c:RegisterEffect(e2)
	--cannot activate
	...
	e3:SetValue(c160004000.aclimit)
	e3:SetReset(RESET_PHASE+PHASE_END)
	c:RegisterEffect(e3)
	local e4=e3:Clone()
	e4:SetTargetRange(1,0)
	e4:SetCondition(c160004000.cond)
	c:RegisterEffect(e4)
	--disable
	...
	e6:SetCondition(c160004000.cond)
	c:RegisterEffect(e6)
	--disable effect
	...
	e7:SetOperation(c160004000.disop)
	c:RegisterEffect(e7)
	...
	e9:SetCondition(c160004000.cond)
	c:RegisterEffect(e9)
	aux.DoubleSnareValc160004000ity(c,LOCATION_MZONE)
end
function c160004000.cond(e)
	local c=e:GetHandler()
	return c:GetEffectCount(303660)==0
end
function c160004000.disop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
...
function c160004000.aclimit(e,re,tp)
