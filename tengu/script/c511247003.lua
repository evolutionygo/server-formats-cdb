...
function c511247003.initial_effect(c)
	...
	e3:SetDescription(aux.Stringc511247003(c511247003,0))
	...
	e4:SetDescription(aux.Stringc511247003(c511247003,1))
...
c511247003.listed_series={SET_FORTUNE_LADY}
...
function c511247003.drtg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.SetOperationInfo(0,CATEGORY_DRAW,nil,0,tp,Duel.GetMatchingGroupCount(c511247003.filter,tp,LOCATION_MZONE,0,nil))
end
