...
function c170000167.initial_effect(c)
	...
	e1:SetValue(c170000167.splimit)
	c:RegisterEffect(e1)
	...
	e6:SetDescription(aux.Stringc170000167(62892347,0))
...
function c170000167.splimit(e,se,sp,st)
...
function c170000167.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>1 and not Duel.IsPlayerAffectedByEffect(tp,CARD_BLUEEYES_SPIRIT)
		and Duel.IsExistingMatchingCard(c170000167.spfilter,tp,LOCATION_DECK+LOCATION_HAND,0,1,nil,e,tp,c170000167+1)
...
function c170000167.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g1=Duel.GetMatchingGroup(c170000167.spfilter,tp,LOCATION_HAND+LOCATION_DECK,0,nil,e,tp,c170000167+1)
