--Gouki The Solc511009018 Ogre
--fixed by MLD
function c511009018.initial_effect(c)
	--link summon
	Link.AddProcedure(c,c511009018.matfilter,2)
	c:EnableReviveLimit()
	--indes
	...
	e3:SetDescription(aux.Stringc511009018(92204263,0))
...
c511009018.listed_series={0xfc}
function c511009018.matfilter(c,scard,sumtype,tp)
...
function c511009018.seqtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	Duel.Hint(HINT_SELECTMSG,tp,aux.Stringc511009018(92204263,1))
