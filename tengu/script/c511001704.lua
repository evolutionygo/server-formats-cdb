...
function c511001704.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc511001704(c511001704,1))
...
function c511001704.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():GetFlagEffect(c511001704)==0
		and Duel.IsExistingMatchingCard(Card.IsAbleToHand,tp,0,LOCATION_MZONE,1,nil) end
	e:GetHandler():RegisterFlagEffect(c511001704,RESET_CHAIN,0,1)
