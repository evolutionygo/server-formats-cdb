...
function c12800777.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc12800777(c12800777,0))
...
function c12800777.spcon(e,c)
	...
	local rg=Duel.GetMatchingGroup(c12800777.spfilter,tp,LOCATION_GRAVE,0,nil,ATTRIBUTE_WIND)
	return aux.SelectUnselectGroup(rg,e,tp,1,1,aux.ChkfMMZ(1),0)
end
function c12800777.sptg(e,tp,eg,ep,ev,re,r,rp,c)
	local rg=Duel.GetMatchingGroup(c12800777.spfilter,tp,LOCATION_GRAVE,0,nil,ATTRIBUTE_WIND)
