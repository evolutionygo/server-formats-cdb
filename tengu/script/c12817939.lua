...
function c12817939.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc12817939(c12817939,0))
...
c12817939.listed_names={58206034,85313220}
c12817939.LVnum=6
c12817939.LVset=0x4f
function c12817939.disop(e,tp,eg,ep,ev,re,r,rp)
	...
	if d and d:IsStatus(STATUS_BATTLE_DESTROYED) and d:IsType(TYPE_EFFECT)
		...
		d:RegisterEffect(e1)
		c:RegisterFlagEffect(c12817939,RESET_EVENT|RESETS_STANDARD+RESET_PHASE+PHASE_END+RESET_SELF_TURN,0,2)
	end
end
function c12817939.spcon(e,tp,eg,ep,ev,re,r,rp)
	return tp==Duel.GetTurnPlayer() and e:GetHandler():GetFlagEffect(c12817939)~=0
end
...
function c12817939.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc and Duel.SpecialSummon(tc,0,tp,tp,true,true,POS_FACEUP)>0 then
		tc:RegisterFlagEffect(c12817939,RESET_EVENT|RESETS_STANDARD&~(RESET_LEAVE|RESET_TEMP_REMOVE),0,0)
