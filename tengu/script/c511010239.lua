...
function c511010239.initial_effect(c)
	...
	e2:SetValue(c511010239.aclimit)
	e2:SetCondition(c511010239.actcon)
	--negate
	local e3=Effect.CreateEffect(c)
	e3:SetDescription(aux.Stringc511010239(c511010239,0))
	...
	e3:SetCondition(c511010239.atkcon)
	e3:SetCost(aux.dxmcostgen(1,1,nil))
	e3:SetTarget(c511010239.atktg)
	e3:SetOperation(c511010239.atkop)
	--
...
c511010239.listed_series={SET_NUMBER}
c511010239.listed_names={84013237}
c511010239.aux.xyz_number=39
