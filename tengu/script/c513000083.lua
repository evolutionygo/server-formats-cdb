...
function c513000083.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc513000083(6330307,0))
	...
	e4:SetDescription(aux.Stringc513000083(60645181,0))
...
c513000083.listed_series={0x107f,0x1048}
function c513000083.filter(c)
	local class=c:GetMetatable(true)
	if class==nil then return false end
	local no=clasc513000083.aux.xyz_number
