...
function c44689688.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc44689688(c44689688,0))
...
c44689688.listed_names={44689689}
...
function c44689688.spop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.GetLocationCount(1-tp,LOCATION_MZONE,tp)>0 
		and Duel.IsPlayerCanSpecialSummonMonster(tp,c44689688+1,0,TYPES_TOKEN,300,0,1,RACE_DINOSAUR,ATTRIBUTE_FIRE,POS_FACEUP_ATTACK,1-tp) then
		local token=Duel.CreateToken(tp,c44689688+1)
