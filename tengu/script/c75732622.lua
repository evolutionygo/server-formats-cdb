...
c75732622.listed_names={75732623}
function c75732622.spcon(e,c)
	...
	return Duel.GetLocationCount(tp,LOCATION_MZONE)>=2 and Duel.GetLocationCount(1-tp,LOCATION_MZONE)>0
		...
		and Duel.IsPlayerCanSpecialSummonMonster(tp,c75732622+1,0,TYPES_TOKEN,0,0,1,RACE_FIEND,ATTRIBUTE_DARK)
end
function c75732622.spop(e,tp,eg,ep,ev,re,r,rp,c)
	for i=1,2 do
		local token=Duel.CreateToken(tp,c75732622+1)
