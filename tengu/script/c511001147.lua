...
function c511001147.regop(e,tp,eg,ep,ev,re,r,rp)
	Duel.RaiseEvent(Group.CreateGroup(),c511001147,e,REASON_EFFECT,Duel.GetTurnPlayer(),Duel.GetTurnPlayer(),0)
end
...
function c511001147.op(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.Hint(HINT_CARD,0,c511001147)
