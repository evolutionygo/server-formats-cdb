...
function c25682811.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc25682811(c25682811,0))
	...
	c:RegisterEffect(e1)
	aux.AddEREquipLimit(c,nil,c25682811.eqval,Card.EquipByEffectAndLimitRegister,e1)
	--increase ATK
...
function c25682811.filter(c)
	return c:IsSetCard(0x29) and c:IsRace(RACE_DRAGON) and not c:IsForbc25682811den()
end
