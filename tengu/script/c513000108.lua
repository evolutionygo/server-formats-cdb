...
function c513000108.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc513000108(c513000108,0))
	e1:SetProperty(CATEGORY_DAMAGE)
	e1:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_QUICK_O)
	e1:SetCode(EVENT_CHAINING)
	e1:SetRange(LOCATION_GRAVE)
	e1:SetCondition(c513000108.condition)
	e1:SetCost(aux.bfgcost)
	e1:SetOperation(c513000108.operation)
	c:RegisterEffect(e1)
...
function c513000108.condition(e,tp,eg,ep,ev,re,r,rp)
...
function c513000108.operation(e,tp,eg,ep,ev,re,r,rp)
...
function c513000108.refcon(e,re,val,r,rp,rc)
	...
	local cc513000108=Duel.GetChainInfo(0,CHAININFO_CHAIN_ID)
	if cc513000108==e:GetLabel() then return 0
	else return val end
end
