...
function c513000078.initial_effect(c)
	--synchro summon
	c:EnableReviveLimit()
	Synchro.AddMajesticProcedure(c,aux.FilterBoolFunction(Card.IsCode,21159309),true,aux.FilterBoolFunction(Card.IsCode,70902743),true,aux.NonTuner(nil),false)
	--destroy
	local e2=Effect.CreateEffect(c)
	e2:SetDescription(aux.Stringc513000078(67030233,0))
	...
	e3:SetDescription(aux.Stringc513000078(67030233,1))
	...
	e4:SetDescription(aux.Stringc513000078(67030233,2))
	...
	e5:SetDescription(aux.Stringc513000078(12298909,0))
...
c513000078.material={70902743,21159309}
c513000078.listed_names={70902743,21159309}
c513000078.synchro_nt_required=1
