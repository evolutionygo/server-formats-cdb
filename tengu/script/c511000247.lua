...
function c511000247.initial_effect(c)
	...
	c:EnableReviveLimit()
	c:SetUniqueOnField(1,0,c511000247)
	--Effect Absorber
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc511000247(c511000247,0))
	...
	e3:SetDescription(aux.Stringc511000247(30604579,1))
	...
	e4:SetDescription(aux.Stringc511000247(30604579,2))
...
function c511000247.effop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc and c:IsRelateToEffect(e) and tc:IsFaceup() and tc:IsRelateToEffect(e) then
		...
		if Duel.SelectYesNo(tp,aux.Stringc511000247(10032958,0)) then
...
function c511000247.regop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsReason(REASON_DESTROY)
		...
		c:RegisterFlagEffect(c511000247,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
	end
end
function c511000247.spcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c511000247)~=0
end
