...
function c511002064.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511002064(c511002064,0))
...
function c511002064.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	while tc do
		...
		e1:SetDescription(aux.Stringc511002064(95100126,1))
...
function c511002064.checkop(e,tp,eg,ep,ev,re,r,rp)
	if eg:IsExists(Card.IsCode,1,nil,c511002064+1) then
		s[0]=true
	end
end
Duel.LoadCardScript("c51735257.lua")
