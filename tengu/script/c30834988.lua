...
function c30834988.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc30834988(c30834988,0))
...
function c30834988.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.GetFlagEffect(tp,c30834988)==0 then
		Duel.RegisterFlagEffect(tp,c30834988,RESET_PHASE+PHASE_END,0,1)
		e:SetLabel(0)
	else
