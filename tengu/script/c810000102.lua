...
function c810000102.filter(c,e,tp,c810000102)
	return (c:IsRace(RACE_MACHINE) or c:IsRace(RACE_ROCK)) and c:GetTurnID()==c810000102 and not c:IsReason(REASON_RETURN) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
