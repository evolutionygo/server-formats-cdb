...
function c83446909.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc83446909(c83446909,0))
...
c83446909.listed_series={0x28}
function c83446909.spfilter(c,e,tp)
	return c:GetCode()~=c83446909 and c:IsSetCard(0x28) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
