...
function c511001982.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511001982(3429238,0))
	...
	e2:SetDescription(aux.Stringc511001982(95100043,1))
	...
	e3:SetDescription(aux.Stringc511001982(95100043,2))
...
c511001982.material={56286179}
c511001982.listed_names={56286179}
c511001982.material_setcode=0x1017
function c511001982.tfilter(c,lc,stype,tp)
...
function c511001982.rmop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e) and Duel.Remove(e:GetHandler(),POS_FACEUP,REASON_EFFECT)~=0 then
		e:GetHandler():RegisterFlagEffect(c511001982,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_STANDBY+RESET_SELF_TURN,0,1)
	end
end
...
function c511001982.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():GetFlagEffect(c511001982)~=0 end
	e:GetHandler():ResetFlagEffect(c511001982)
