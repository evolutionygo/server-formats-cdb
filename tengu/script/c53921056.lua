...
function c53921056.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc53921056(c53921056,0))
...
c53921056.listed_series={0x2f}
function c53921056.filter(c,e,tp)
	return c:IsSetCard(0x2f) and c:GetCode()~=c53921056 and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
