...
function c11662742.initial_effect(c)
	...
	e4:SetDescription(aux.Stringc11662742(c11662742,0))
	...
	e5:SetDescription(aux.Stringc11662742(c11662742,0))
	...
	e6:SetDescription(aux.Stringc11662742(c11662742,0))
...
function c11662742.dmop(e,tp,eg,ep,ev,re,r,rp)
	...
	if (r&REASON_BATTLE)~=0 then
		c:RegisterFlagEffect(c11662742,RESET_PHASE+PHASE_DAMAGE,0,1)
	elseif Duel.GetCurrentPhase()==PHASE_DAMAGE and not Duel.IsDamageCalculated() then
		c:RegisterFlagEffect(c11662742+1,RESET_PHASE+PHASE_DAMAGE,0,1)
	end
end
function c11662742.descon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c11662742)>0
end
function c11662742.descon2(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c11662742+1)>0
end
