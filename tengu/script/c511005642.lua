...
function c511005642.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511005642(c511005642,0))
...
function c511005642.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc then
		...
		if fc and fc:IsFaceup() and Duel.IsPlayerCanDraw(1-tp,1) and Duel.SelectYesNo(1-tp,aux.Stringc511005642(c511005642,1)) then
