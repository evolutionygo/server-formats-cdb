...
c511310014.listed_series={0x9f,0xc6}
...
function c511310014.negop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:GetFlagEffect(c511310014)==0 and Duel.SelectEffectYesNo(tp,c) then
		Duel.Hint(HINT_CARD,0,c:GetOriginalCode())
		Duel.Hint(HINT_CARD,0,c511310014)
		Duel.NegateAttack()
		c:RegisterFlagEffect(c511310014,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,0)
	end
end