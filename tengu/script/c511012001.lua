...
function c511012001.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc511012001(16178681,0))
...
function c511012001.rdcon(e,tp,eg,ep,ev,re,r,rp)
	if e:GetHandler():GetFlagEffect(c511012001)>0 then return false end
...
function c511012001.rdop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:GetFlagEffect(c511012001)==0 and Duel.SelectEffectYesNo(tp,c) then
		Duel.Hint(HINT_CARD,0,c511012001)
		c:RegisterFlagEffect(c511012001,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
