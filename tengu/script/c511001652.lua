...
function c511001652.initial_effect(c)
	...
	Fusion.AddContactProc(c,c511001652.contactfilter,c511001652.contactop,c511001652.splimit)
	--return
	...
	e1:SetOperation(c511001652.sprop)
	c:RegisterEffect(e1)
end
c511001652.listed_names={CARD_NEOS,43237273,17732278,CARD_POLYMERIZATION}
