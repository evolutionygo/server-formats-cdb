...
function c511009522.initial_effect(c)
	...
	e5:SetDescription(aux.Stringc511009522(c511009522,1))
	...
	e6:SetDescription(aux.Stringc511009522(c511009522,2))
...
c511009522.listed_series={SET_SUPREME_KING_DRAGON}
...
function c511009522.spcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return eg:IsExists(c511009522.spfilter,1,nil,tp)
...
function c511009522.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.CheckReleaseGroup(tp,c511009522.costfilter,1,nil,tp,sg,c)
		and e:GetHandler():IsCanBeSpecialSummoned(e,0,tp,false,false)
		and Duel.SelectEffectYesNo(tp,c,aux.Stringc511009522(c511009522,0)) then
		while #sg<2 do
...
function c511009522.spfilter2(c,e,tp,ec)
...
function c511009522.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return c:IsAbleToDeckOrExtraAsCost()
		and Duel.IsExistingMatchingCard(c511009522.spfilter2,tp,LOCATION_EXTRA,0,2,c,e,tp,c) end
	Duel.SendtoExtraP(c,nil,REASON_COST)
end
function c511009522.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return not Duel.IsPlayerAffectedByEffect(tp,CARD_BLUEEYES_SPIRIT)
		and aux.CheckSummonGate(tp,2) and e:GetHandler():GetFlagEffect(c511009522)==0 end
	e:GetHandler():RegisterFlagEffect(c511009522,RESET_CHAIN,0,0)
...
function c511009522.spop2(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.GetMatchingGroup(c511009522.spfilter2,tp,LOCATION_EXTRA,0,e:GetHandler(),e,tp,e:GetHandler())
	if #g>=2 then
