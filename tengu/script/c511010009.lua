...
function c511010009.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511010009(c511010009,0))
	...
	e2:SetDescription(aux.Stringc511010009(c511010009,1))
	...
	e3:SetDescription(aux.Stringc511010009(c511010009,0))
...
c511010009.aux.xyz_number=9
c511010009.listed_series={SET_NUMBER}
...
function c511010009.atkcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():GetFlagEffect(c511010009)==0 end
	e:GetHandler():RegisterFlagEffect(c511010009,RESET_EVENT|RESETS_STANDARD|RESET_PHASE|PHASE_DAMAGE,0,1)
end
