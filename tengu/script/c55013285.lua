...
function c55013285.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc55013285(c55013285,0))
...
c55013285.listed_names={c55013285}
function c55013285.condition(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsLocation(LOCATION_GRAVE) and e:GetHandler():IsReason(REASON_BATTLE)
end
function c55013285.filter(c,e,tp)
	return c:IsCode(c55013285) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
