...
function c28183605.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc28183605(c28183605,0))
	...
	c:RegisterEffect(e2)
	aux.AddEREquipLimit(c,nil,c28183605.eqval,Card.EquipByEffectAndLimitRegister,e2)
end
c28183605.listed_series={0x29}
...
function c28183605.filter(c)
	return c:IsLevelBelow(3) and c:IsSetCard(0x29) and c:IsRace(RACE_DRAGON) and not c:IsForbc28183605den()
end
