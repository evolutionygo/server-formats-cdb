...
function c511000076.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511000076(c511000076,0))
	...
	e2:SetDescription(aux.Stringc511000076(c511000076,1))
	...
	e3:SetDescription(aux.Stringc511000076(c511000076,2))
	...
	e4:SetDescription(aux.Stringc511000076(c511000076,3))
...
c511000076.synchro_tuner_required=1
c511000076.synchro_nt_required=1
c511000076.listed_series={SET_TG}
...
function c511000076.rmop(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if Duel.Remove(c,POS_FACEUP,REASON_EFFECT)~=0 then
		c:RegisterFlagEffect(c511000076,RESET_EVENT|RESETS_STANDARD|RESET_PHASE|PHASE_END,0,1)
	end
end
function c511000076.spcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c511000076)~=0
end
