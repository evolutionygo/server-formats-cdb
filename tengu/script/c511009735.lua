...
function c511009735.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511009735(c511009735,0))
	...
	e2:SetDescription(aux.Stringc511009735(c511009735,1))
...
function c511009735.cfilter(c,ec)
...
function c511009735.descon(e,tp,eg,ep,ev,re,r,rp)
	...
	for tc in aux.Next(Duel.GetMatchingGroup(Card.IsType,tp,LOCATION_MZONE,LOCATION_MZONE,nil,TYPE_LINK)) do
		if eg:IsExists(c511009735.cfilter,1,nil,tc) then return true end
	end
	return false
end
