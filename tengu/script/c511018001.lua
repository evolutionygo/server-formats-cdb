...
function c511018001.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511018001(46613515,0))
	...
	e2:SetDescription(aux.Stringc511018001(46613515,1))
...
function c511018001.drop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc and tc:IsMonster() and Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and tc:IsCanBeSpecialSummoned(e,0,tp,false,false) 
		and Duel.SelectYesNo(tp,aux.Stringc511018001(46613515,2)) and Duel.SpecialSummon(tc,0,tp,tp,false,false,POS_FACEUP)~=0 
