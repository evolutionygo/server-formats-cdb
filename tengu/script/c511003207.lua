...
function c511003207.initial_effect(c)
    --Summon with 1 tribute
    local e0=aux.AddNormalSummonProcedure(c,true,true,1,1,SUMMON_TYPE_TRIBUTE,aux.Stringc511003207(c511003207,0),c511003207.otfilter)
    ...
    e1:SetOperation(c511003207.desop)
    c:RegisterEffect(e1)
end
function c511003207.otfilter(c,tp)
    return c:IsAttribute(ATTRIBUTE_WATER) and (c:IsControler(tp) or c:IsFaceup())
end
function c511003207.desop(e,tp,eg,ep,ev,re,r,rp)
