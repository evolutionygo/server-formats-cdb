...
function c511000670.initial_effect(c)
	...
	e4:SetDescription(aux.Stringc511000670(c511000670,0))
	...
	e5:SetDescription(aux.Stringc511000670(c511000670,1))
...
c511000670.listed_names={96561011,511000669}
...
function c511000670.hspfilter(c,tp)
	return c:IsCode(96561011) and c:GetEquipGroup():IsExists(Card.IsCode,1,nil,511000669) 
end
function c511000670.spcon(e,c)
	if c==nil then return true end
	return Duel.CheckReleaseGroup(c:GetControler(),c511000670.hspfilter,1,false,1,true,c,c:GetControler(),nil,false,nil)
end
function c511000670.sptg(e,tp,eg,ep,ev,re,r,rp,c)
	local g=Duel.SelectReleaseGroup(tp,c511000670.hspfilter,1,1,false,true,true,c,nil,nil,false,nil)
	if g then
		g:KeepAlive()
		e:SetLabelObject(g)
	return true
