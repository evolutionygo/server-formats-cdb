...
function c511000995.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc511000995(c511000995,0))
	...
	e3:SetDescription(aux.Stringc511000995(c511000995,1))
	...
	c:RegisterEffect(e3)
	aux.DoubleSnareValc511000995ity(c,LOCATION_MZONE)
end
