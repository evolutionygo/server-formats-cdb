...
function c513000139.initial_effect(c)
	...
	e5:SetDescription(aux.Stringc513000139(c513000139,0))
	...
	e6:SetOperation(c513000139.divevo)
	c:RegisterEffect(e6)
end
...
function c513000139.erasop(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_CARD,tp,c513000139)
	Duel.Hint(HINT_CARD,1-tp,c513000139)
...
function c513000139.divevo(e,tp,eg,ev,ep,re,r,rp)
