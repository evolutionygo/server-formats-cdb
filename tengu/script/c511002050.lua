...
function c511002050.checkop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.GetFlagEffect(0,c511002050)==0 and re:IsActiveType(TYPE_SPELL) and re:IsHasType(EFFECT_TYPE_ACTIVATE) then
		s[0]=s[0]+1
		Duel.RegisterFlagEffect(0,c511002050,RESET_CHAIN,0,1)
	end
end
