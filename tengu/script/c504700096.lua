...
--Reasoning (GOAT)
--Doesn't check deck
function c504700096.initial_effect(c)
	local e1=Effect.CreateEffect(c)
	e1:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e1:SetType(EFFECT_TYPE_ACTIVATE)
	e1:SetCode(EVENT_FREE_CHAIN)
	e1:SetTarget(c504700096.target)
	e1:SetOperation(c504700096.operation)
	c:RegisterEffect(e1)
end
function c504700096.target(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c504700096.operation(e,tp,eg,ep,ev,re,r,rp)
