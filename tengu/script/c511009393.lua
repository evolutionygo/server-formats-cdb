...
--fixed by MLD
local s,c511009393,alias=GetID()
function c511009393.initial_effect(c)
	...
	e1:SetCountLimit(1)
	e1:SetDescription(aux.Stringc511009393(alias,1))
	...
	e3:SetDescription(aux.Stringc511009393(alias,0))
	...
	e5:SetDescription(aux.Stringc511009393(alias,3))
