...
function c511008508.initial_effect(c)
	...
	e1:SetValue(c511008508.efilter)
	c:RegisterEffect(e1)
	local e2=e1:Clone()
	...
	e4:SetDescription(aux.Stringc511008508(c511008508,0))
	e4:SetCategory(CATEGORY_DAMAGE)
	e4:SetProperty(EFFECT_FLAG_PLAYER_TARGET)
	e4:SetType(EFFECT_TYPE_IGNITION)
	e4:SetRange(LOCATION_MZONE)
	e4:SetCountLimit(1)
	e4:SetCost(c511008508.cost)
	e4:SetTarget(c511008508.target)
	e4:SetOperation(c511008508.operation)
	c:RegisterEffect(e4)
end
function c511008508.efilter(e,te)
