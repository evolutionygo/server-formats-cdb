...
function c511000164.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511000164(c511000164,0))
...
function c511000164.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	tc:RegisterFlagEffect(c511000164,RESET_EVENT+RESETS_STANDARD,0,0)
	local descnum=tp==c:GetOwner() and 0 or 1
	local e3=Effect.CreateEffect(c)
	e3:SetType(EFFECT_TYPE_SINGLE)
	e3:SetDescription(aux.Stringc511000164(4931121,descnum))
...
function c511000164.desop(e,tp,eg,ep,ev,re,r,rp)
	...
	if ct==3 then
		...
		c:ResetFlagEffect(c511000164)
		Duel.Destroy(c,REASON_EFFECT)
		if re then re:Reset() end
	end
end
function c511000164.efilter(c)
	return c:IsFaceup() and c:GetFlagEffect(c511000164)>0
end
