...
function c28677304.initial_effect(c)
	--Fusion Material
	c:EnableReviveLimit()
	aux.AddFusionProcCode2(c,true,true,CARD_NEOS,43237273)
	Fusion.AddContactProc(c,c28677304.contactfil,c28677304.contactop,c28677304.splimit)
	aux.EnableNeosReturn(c)
	--Negate the effects of 1 face-up monster
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc28677304(c28677304,1))
	e1:SetCategory(CATEGORY_DISABLE)
	e1:SetType(EFFECT_TYPE_IGNITION)
	e1:SetRange(LOCATION_MZONE)
	e1:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e1:SetCondition(c28677304.discon)
	e1:SetTarget(c28677304.distg)
	e1:SetOperation(c28677304.disop)
	c:RegisterEffect(e1)
end
