...
function c513000115.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc513000115(511000011,1))
...
function c513000115.op(e,tp,eg,ep,ev,re,r,rp)
	if e:GetHandler():IsDiscardable() and ep==tp and Duel.GetAttackTarget()==nil and Duel.SelectYesNo(tp,aux.Stringc513000115(81275309,0)) 
...
function c513000115.cost2(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetFlagEffect(tp,c513000115)==0 end
	Duel.RegisterFlagEffect(tp,c513000115,0,0,0)
end
