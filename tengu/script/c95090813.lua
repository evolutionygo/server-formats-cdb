...
function c95090813.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc95090813(c95090813,3))
...
function c95090813.mtop(e,tp,eg,ep,ev,re,r,rp)
	...
	if #g1>0 and #g2>0 then
		select=Duel.SelectOption(tp,aux.Stringc95090813(c95090813,0),aux.Stringc95090813(c95090813,1),aux.Stringc95090813(c95090813,2))
	elseif #g1>0 then
		select=Duel.SelectOption(tp,aux.Stringc95090813(c95090813,0),aux.Stringc95090813(c95090813,2))
		if select==1 then select=2 end
	elseif #g2>0 then
		select=Duel.SelectOption(tp,aux.Stringc95090813(c95090813,1),aux.Stringc95090813(c95090813,2))+1
	else
		select=Duel.SelectOption(tp,aux.Stringc95090813(c95090813,2))
		select=2
	end
	if select==0 then
...
function c95090813.filter(c)
	return c:IsLevelBelow(3) and c:IsRace(RACE_WARRIOR) and not c:IsForbc95090813den()
end
