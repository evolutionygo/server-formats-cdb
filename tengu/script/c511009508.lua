...
function c511009508.initial_effect(c)
	...
	e3:SetDescription(aux.Stringc511009508(c511009508,1))
	...
	e4:SetDescription(aux.Stringc511009508(c511009508,2))
...
c511009508.listed_series={SET_SUPREME_KING_DRAGON}
...
function c511009508.spcon(e,tp,eg,ep,ev,re,r,rp)
	return eg:IsExists(c511009508.spfilter,1,nil,tp) and e:GetHandler():IsXyzSummonable()
...
function c511009508.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsXyzSummonable() and Duel.SelectEffectYesNo(tp,c,aux.Stringc511009508(c511009508,0)) then
...
function c511009508.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return not Duel.IsPlayerAffectedByEffect(tp,CARD_BLUEEYES_SPIRIT)
		and ft>=2 and e:GetHandler():GetFlagEffect(c511009508)==0
		and Duel.IsExistingMatchingCard(c511009508.spfilter2,tp,LOCATION_GRAVE,0,2,nil,e,tp) end
	e:GetHandler():RegisterFlagEffect(c511009508,RESET_CHAIN,0,0)
