...
function c69529567.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc69529567(c69529567,0))
	...
	e2:SetDescription(aux.Stringc69529567(c69529567,1))
...
function c69529567.desop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e) and Duel.Destroy(e:GetHandler(),REASON_EFFECT)~=0 then
		e:GetHandler():RegisterFlagEffect(c69529567,RESET_EVENT+RESETS_STANDARD,0,1)
	end
end
...
function c69529567.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():GetFlagEffect(c69529567)~=0 end
