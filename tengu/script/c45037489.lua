...
function c45037489.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc45037489(c45037489,0))
	...
	c:RegisterEffect(e1)
	aux.DoubleSnareValc45037489ity(c,LOCATION_MZONE)
end
c45037489.material={19642774}
c45037489.listed_names={19642774}
c45037489.material_setcode=0x1017
function c45037489.tfilter(c,scard,sumtype,tp)
