...
function c700000011.initial_effect(c)
	...
	aux.GlobalCheck(s,function()
		...
		ge1:SetLabel(c700000011)
		ge1:SetOperation(aux.sumreg)
		Duel.RegisterEffect(ge1,0)
		local ge2=ge1:Clone()
		ge2:SetCode(EVENT_SPSUMMON_SUCCESS)
		ge2:SetLabel(c700000011)
		Duel.RegisterEffect(ge2,0)
	end)
end
function c700000011.condition(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c700000011)>0
end
function c700000011.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local ac=Duel.AnnounceCard(tp,table.unpack(c700000011.announce_filter))
