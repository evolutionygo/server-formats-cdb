...
function c511009593.initial_effect(c)
	--Fusion summon
	aux.AddFusionProcCode2(c,true,true,aux.FilterBoolFunctionEx(Card.IsSetCard,0x10af),aux.FilterBoolFunctionEx(Card.IsSetCard,0xaf))
	c:EnableReviveLimit()
	--pendulum summon
	...
	e5:SetDescription(aux.Stringc511009593(66970002,0))
	...
	e6:SetDescription(aux.Stringc511009593(7845138,0))
...
c511009593.listed_series={0x10af,0xaf}
