...
function c511002989.regop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsReason(REASON_LOST_TARGET) and ec:IsLocation(LOCATION_GRAVE+LOCATION_REMOVED+LOCATION_EXTRA)
		...
		local e1=Effect.CreateEffect(c)
		e1:SetDescription(aux.Stringc511002989(37534148,0))
		e1:SetCategory(CATEGORY_SPECIAL_SUMMON)
		...
		c:RegisterEffect(e1)
		ec:RegisterFlagEffect(c511002989,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
	end
end
function c511002989.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	local ec=e:GetHandler():GetPreviousEquipTarget()
	if chk==0 then return ec and ec:GetFlagEffect(c511002989)~=0 end
