...
function c511016002.initial_effect(c)
	...
	e3:SetDescription(aux.Stringc511016002(62892347,0))
	...
	Duel.TossCoin=function(tp,ct)
		if Duel.IsPlayerAffectedByEffect(tp,c511016002) and Duel.SelectYesNo(tp,1623) then
			local tct=ct
			local t={}
			for i=1,ct do
...
function c511016002.coinop(e,tp,eg,ep,ev,re,r,rp)
	...
	c511016002.arcanareg(c,Arcana.TossCoin(c,tp))
end
