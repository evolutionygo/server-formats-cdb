...
function c15341821.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc15341821(c15341821,0))
...
c15341821.listed_names={15341822}
...
function c15341821.operation(e,tp,eg,ep,ev,re,r,rp)
	if Duel.IsPlayerAffectedByEffect(tp,CARD_BLUEEYES_SPIRIT) or Duel.GetLocationCount(tp,LOCATION_MZONE)<2 
		or not Duel.IsPlayerCanSpecialSummonMonster(tp,c15341821+1,0,TYPES_TOKEN,0,0,1,RACE_PLANT,ATTRIBUTE_WIND) then return end
	for i=1,2 do
		local token=Duel.CreateToken(tp,c15341821+i)
