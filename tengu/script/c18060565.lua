...
function c18060565.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc18060565(c18060565,0))
...
function c18060565.eqfilter(c)
	return c:IsSetCard(0x29) and c:IsRace(RACE_DRAGON) and c:IsLevelBelow(3) and not c:IsForbc18060565den()
end
