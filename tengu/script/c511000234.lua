...
function c511000234.initial_effect(c)
	c:EnableReviveLimit()
	c:SetUniqueOnField(1,1,c511000234)
	...
	e5:SetDescription(aux.Stringc511000234(c511000234,0))
...
function c511000234.spr(e,tp,eg,ep,ev,re,r,rp)
	...
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc511000234(c511000234,1))
