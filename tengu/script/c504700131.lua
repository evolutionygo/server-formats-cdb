...
function c504700131.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc504700131(c504700131,0))
	e2:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_F)
	e2:SetCode(EVENT_BATTLE_DAMAGE)
	e2:SetCondition(function(_,tp,_,ep) return ep==1-tp end)
	e2:SetOperation(c504700131.hdreg)
	c:RegisterEffect(e2)
end
function c504700131.hdreg(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetOperation(c504700131.hdop)
	...
	local hinteff=aux.RegisterClientHint(c,0,tp,0,1,aux.Stringc504700131(c504700131,1))
...
function c504700131.hdop(e,tp,eg,ep,ev,re,r,rp)
