...
function c27383110.initial_effect(c)
	local e1=Ritual.AddProcEqual(c,c27383110.ritualfil,6,nil,nil,nil,nil,c27383110.stage2)
	--salvage
	local e2=Effect.CreateEffect(c)
	e2:SetCategory(CATEGORY_TOHAND)
	e2:SetDescription(aux.Stringc27383110(c27383110,0))
	e2:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e2:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_O)
	e2:SetCode(EVENT_CUSTOM+c27383110)
...
function c27383110.evop(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.RaiseEvent(tc,EVENT_CUSTOM+c27383110,e,0,tp,tp,0)
