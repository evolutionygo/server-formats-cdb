...
function c511009545.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511009545(88412339,0))
	...
	e2:SetDescription(aux.Stringc511009545(511010173,0))
...
function c511009545.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():GetFlagEffect(c511009545)==0 end
	e:GetHandler():RegisterFlagEffect(c511009545,RESET_CHAIN,0,1)
end
