...
function c511001376.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc511001376(55888045,0))
	...
	e3:SetDescription(aux.Stringc511001376(15939229,0))
...
function c511001376.destg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c511001376.desfilter,tp,LOCATION_ONFIELD,LOCATION_ONFIELD,1,nil,TYPE_SPELL+TYPE_TRAP) end
