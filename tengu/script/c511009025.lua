...
function c511009025.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc511009025(900787,0))
	...
	e3:SetDescription(aux.Stringc511009025(10032958,0))
	...
	e4:SetDescription(aux.Stringc511009025(7338,2))
...
function c511009025.regop(e,tp,eg,ep,ev,re,r,rp)
	e:GetHandler():RegisterFlagEffect(c511009025,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
end
function c511009025.atkcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c511009025)~=0
end
