...
function c511002054.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511002054(10389142,0))
...
function c511002054.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	local fc511002054=e:GetHandler():GetFieldID()
	...
	for i=1,ft do
		...
		token:RegisterFlagEffect(10389142,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1,fc511002054)
		g:AddCard(token)
	end
	...
	e1:SetCountLimit(1)
	e1:SetLabel(fc511002054)
	e1:SetLabelObject(g)
	e1:SetCondition(c511002054.descon)
	e1:SetOperation(c511002054.desop)
	Duel.RegisterEffect(e1,tp)
end
function c511002054.desfilter(c,fc511002054)
	return c:GetFlagEffectLabel(10389142)==fc511002054
end
