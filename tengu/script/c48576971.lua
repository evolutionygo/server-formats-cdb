...
function c48576971.initial_effect(c)
	...
	e3:SetDescription(aux.Stringc48576971(c48576971,0))
...
function c48576971.efftg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if b1 and b2 then
		opt=Duel.SelectOption(tp,aux.Stringc48576971(c48576971,1),aux.Stringc48576971(c48576971,2))
	elseif b1 then
		opt=Duel.SelectOption(tp,aux.Stringc48576971(c48576971,1))
	elseif b2 then
		opt=Duel.SelectOption(tp,aux.Stringc48576971(c48576971,2))+1
	else opt=2 end
	e:SetLabel(opt)
	if opt==0 then
