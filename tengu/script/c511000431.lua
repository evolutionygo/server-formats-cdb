...
function c511000431.initial_effect(c)
	...
	e4:SetDescription(aux.Stringc511000431(c511000431,0))
...
function c511000431.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if #g>0 and Duel.SpecialSummon(g,0,tp,tp,false,false,POS_FACEUP)>0 then
		...
		if #ag>0 and Duel.GetLocationCount(tp,LOCATION_SZONE)>0 and Duel.SelectYesNo(tp,aux.Stringc511000431(48680970,0)) then
