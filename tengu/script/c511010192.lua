...
function c511010192.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc511010192(c511010192,0))
	...
	e2:SetCountLimit(1)
	e2:SetCondition(c511010192.reccon)
	e2:SetTarget(c511010192.rectg)
	e2:SetOperation(c511010192.recop)
	c:RegisterEffect(e2)
	--negate
	local e3=Effect.CreateEffect(c)
	e3:SetDescription(aux.Stringc511010192(c511010192,1))
	e3:SetCategory(CATEGORY_DISABLE)
	e3:SetType(EFFECT_TYPE_IGNITION)
	e3:SetRange(LOCATION_MZONE)
	e3:SetCountLimit(1)
	e3:SetCost(aux.dxmcostgen(1,1,nil))
	e3:SetTarget(c511010192.distg)
	e3:SetOperation(c511010192.disop)
	local e4=Effect.CreateEffect(c)
	e4:SetType(EFFECT_TYPE_SINGLE)
	e4:SetCode(EFFECT_RANKUP_EFFECT)
	e4:SetLabelObject(e3)
	c:RegisterEffect(e4,false,REGISTER_FLAG_DETACH_XMAT)
	aux.DoubleSnareValc511010192ity(c,LOCATION_MZONE)
	aux.GlobalCheck(s,function()
		...
		ge1:SetOperation(c511010192.checkop)
		Duel.RegisterEffect(ge1,0)
		local ge2=Effect.CreateEffect(c)
		ge2:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_CONTINUOUS)
		ge2:SetCode(EVENT_ADJUST)
		ge2:SetCountLimit(1)
		ge2:SetOperation(c511010192.clear)
		Duel.RegisterEffect(ge2,0)
	end)
end
c511010192.listed_series={SET_NUMBER}
c511010192.listed_names={97403510}
c511010192.aux.xyz_number=92
