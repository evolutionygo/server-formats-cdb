...
function c76614340.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCode2(c,false,false,91731841,aux.FilterBoolFunctionEx(Card.IsSetCard,0x1047))
	--spsummon condition
	...
	e3:SetDescription(aux.Stringc76614340(c76614340,0))
...
c76614340.listed_series={0x47,0x1047}
