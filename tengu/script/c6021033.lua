...
function c6021033.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc6021033(c6021033,0))
...
c6021033.material={33420078}
c6021033.listed_names={33420078}
...
function c6021033.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) and tc:IsRace(RACE_ZOMBIE)
		...
		c:SetCardTarget(tc)
		e:SetLabelObject(tc)
		tc:RegisterFlagEffect(c6021033,RESET_EVENT+RESETS_STANDARD,0,0)
		c:RegisterFlagEffect(c6021033,RESET_EVENT+0x1020000,0,0)
	end
end
function c6021033.desop(e,tp,eg,ep,ev,re,r,rp)
	local tc=e:GetLabelObject():GetLabelObject()
	if tc and tc:GetFlagEffect(c6021033)~=0 and e:GetHandler():GetFlagEffect(c6021033)~=0 then
