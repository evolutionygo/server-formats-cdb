--Last Machine Acc513000178 Virus (Anime)
...
function c513000178.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckReleaseGroupCost(tp,c513000178.costfilter,1,false,nil,nil) end
	local g=Duel.SelectReleaseGroupCost(tp,c513000178.costfilter,1,1,false,nil,nil)
