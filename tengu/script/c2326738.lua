...
function c2326738.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc2326738(c2326738,0))
	...
	e2:SetDescription(aux.Stringc2326738(c2326738,1))
...
function c2326738.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return c:IsCanTurnSet() and c:GetFlagEffect(c2326738)==0 end
	c:RegisterFlagEffect(c2326738,RESET_EVENT+RESETS_STANDARD-RESET_TURN_SET+RESET_PHASE+PHASE_END,0,1)
