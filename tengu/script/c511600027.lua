...
function c511600027.initial_effect(c)
	...
	e4:SetDescription(aux.Stringc511600027(168917,0))
	e4:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e4:SetType(EFFECT_TYPE_IGNITION)
	e4:SetRange(LOCATION_FZONE)
	e4:SetCountLimit(1,c511600027)
	e4:SetTarget(c511600027.sptg)
	e4:SetOperation(c511600027.spop)
	c:RegisterEffect(e4)
	--evacuate
	local e5=Effect.CreateEffect(c)
	e5:SetDescription(aux.Stringc511600027(10753491,0))
	e5:SetCategory(CATEGORY_TOGRAVE)
	e5:SetType(EFFECT_TYPE_IGNITION)
	e5:SetRange(LOCATION_FZONE)
	e5:SetCountLimit(1,c511600027)
	e5:SetTarget(c511600027.mttg)
	e5:SetOperation(c511600027.mtop)
	c:RegisterEffect(e5)
end
c511600027.listed_series={SET_ROKKET}
