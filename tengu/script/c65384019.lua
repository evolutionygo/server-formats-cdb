...
function c65384019.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	for tc in aux.Next(g) do
		if not tc:IsImmuneToEffect(e) then
			...
			tc:RegisterFlagEffect(c65384019,RESET_EVENT+RESETS_STANDARD_EXC_GRAVE+RESET_PHASE+PHASE_END,0,1,fc65384019)
		end
	end
	local e2=Effect.CreateEffect(c)
	e2:SetDescription(aux.Stringc65384019(c65384019,0))
	...
	e2:SetLabel(fc65384019)
	Duel.RegisterEffect(e2,tp)
end
function c65384019.drfilter(c,fc65384019)
	return c:GetFlagEffectLabel(c65384019)==fc65384019
end
