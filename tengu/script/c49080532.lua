...
function c49080532.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc49080532(c49080532,0))
...
c49080532.listed_names={c49080532}
...
function c49080532.filter(c,e,tp)
	return c:IsCode(c49080532) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
