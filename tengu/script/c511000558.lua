...
function c511000558.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511000558(c511000558,0))
	...
	e3:SetDescription(aux.Stringc511000558(c511000558,3))
...
c511000558.material={2403771}
c511000558.listed_names={2403771}
c511000558.synchro_nt_required=1
...
function c511000558.lpop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.GetLP(tp)<2000 and Duel.SelectYesNo(tp,aux.Stringc511000558(c511000558,1)) then
		Duel.BreakEffect()
		Duel.SetLP(tp,2000)
	end
	if Duel.GetLP(1-tp)<2000 and Duel.SelectYesNo(tp,aux.Stringc511000558(c511000558,2)) then
		Duel.BreakEffect()
