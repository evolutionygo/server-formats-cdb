--ＳＲアクマグネ (Anime)
--Speedroc511009380 Maliciousmagnet (Anime)
function c511009380.initial_effect(c)
	--synchro
	local e2=Effect.CreateEffect(c)
	e2:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e2:SetDescription(aux.Stringc511009380(83236601,0))
	...
	aux.GlobalCheck(s,function()
		...
		ge1:SetLabel(c511009380)
		ge1:SetProperty(EFFECT_FLAG_CANNOT_DISABLE)
		ge1:SetOperation(aux.sumreg)
		Duel.RegisterEffect(ge1,0)
		local ge2=ge1:Clone()
		ge2:SetCode(EVENT_SPSUMMON_SUCCESS)
		ge2:SetLabel(c511009380)
...
function c511009380.spcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c511009380)>0
end
