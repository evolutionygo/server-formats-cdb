...
function c511002001.initial_effect(c)
	--xyz summon
	aux.AddXyzProcedure(c,nil,4,3,c511002001.ovfilter,aux.Stringc511002001(86532744,1))
	c:EnableReviveLimit()
	--Banish
	local e1=Effect.CreateEffect(c)
	e1:SetCategory(CATEGORY_REMOVE+CATEGORY_DAMAGE)
	e1:SetDescription(aux.Stringc511002001(95100063,0))
...
c511002001.aux.xyz_number=39
function c511002001.ovfilter(c,tp,lc)
