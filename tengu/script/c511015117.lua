--Armoroc511015117 (Manga)
function c511015117.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCode2N(c,true,true,aux.FilterBoolFunctionEx(Card.IsSetCard,0x16),3)
	Fusion.AddContactProc(c,c511015117.contactfilter,c511015117.contactop,true)
	--damage
