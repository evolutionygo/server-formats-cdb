...
function c511009194.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCode2(c,true,true,48608796,aux.FilterBoolFunctionEx(Card.IsSetCard,0xf7))
	--level
	...
	e4:SetDescription(aux.Stringc511009194(17415895,0))
...
c511009194.listed_names={48608796}
