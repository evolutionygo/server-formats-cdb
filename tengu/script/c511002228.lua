...
function c511002228.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCode2Rep(c,true,true,c511002228.mfilter2,1,99,c511002228.mfilter1)
	--spsummon
...
function c511002228.mfilter1(c,fc,sumtype,tp)
	return c:IsSetCard(0xad,fc,sumtype,tp) and c:IsLevelAbove(6)
end
function c511002228.mfilter2(c,fc,sumtype,tp)
