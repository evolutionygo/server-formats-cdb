...
function c511009544.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511009544(95453143,0))
	...
	e2:SetDescription(aux.Stringc511009544(93368494,0))
	...
	--gain atk
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc511009544(511001290,0))
...
c511009544.listed_series={0x2b}
function c511009544.target(e,tp,eg,ep,ev,re,r,rp,chk)
	local seq=e:GetHandler():GetSequence()
	local tc=Duel.GetFieldCard(tp,LOCATION_SZONE,13-seq)
	if chk==0 then return tc and e:GetHandler():GetFlagEffect(c511009544)==0 end
...
function c511009544.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e) and c:IsFaceup() and tc:IsRelateToEffect(e) and tc:IsFaceup() then
		...
		local cc511009544=c:ReplaceEffect(code,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END)
		local e2=Effect.CreateEffect(c)
		e2:SetDescription(aux.Stringc511009544(95453143,2))
		...
		e2:SetLabel(cc511009544)
		e2:SetOperation(c511009544.rstop)
		c:RegisterEffect(e2)
		c:RegisterFlagEffect(c511009544,RESET_EVENT+RESETS_STANDARD,0,0)
	end
end
function c511009544.rstop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	local cc511009544=e:GetLabel()
	c:ResetEffect(cc511009544,RESET_COPY)
