...
function c14677495.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc14677495(c14677495,0))
	...
	e2:SetDescription(aux.Stringc14677495(c14677495,1))
...
c14677495.listed_series={0x6042}
...
function c14677495.filter(c,e,tp)
	return c:IsSetCard(0x6042) and c:GetCode()~=c14677495 and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP_DEFENSE)
end
