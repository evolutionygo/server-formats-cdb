...
function c97836203.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc97836203(c97836203,0))
	...
	c:RegisterEffect(e2)
	local e3=e2:Clone()
	e3:SetDescription(aux.Stringc97836203(c97836203,1))
	e3:SetCode(EVENT_FLIP_SUMMON)
	c:RegisterEffect(e3)
	local e4=e2:Clone()
	e4:SetDescription(aux.Stringc97836203(c97836203,2))
	e4:SetCode(EVENT_SPSUMMON)
	c:RegisterEffect(e4)
	--Special Summon
	local e5=Effect.CreateEffect(c)
	e5:SetDescription(aux.Stringc97836203(c97836203,3))
...
c97836203.listed_series={0x27}
c97836203.synchro_tuner_required=1
c97836203.synchro_nt_required=2
