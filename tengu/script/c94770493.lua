...
function c94770493.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsFaceup() and tc:IsRelateToEffect(e) and tc:GetFlagEffect(c94770493)==0 then
		tc:RegisterFlagEffect(c94770493,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
