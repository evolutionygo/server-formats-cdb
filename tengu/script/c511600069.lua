...
function c511600069.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511600069(40240595,0))
	...
	e7:SetCountLimit(1)
	e7:SetCondition(c511600069.descon)
	e7:SetOperation(c511600069.desop)
	c:RegisterEffect(e7)
	--spsummon
	local e8=Effect.CreateEffect(c)
	e8:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_CONTINUOUS)
	e8:SetCode(EVENT_TO_GRAVE)
	e8:SetCondition(c511600069.spcon)
	e8:SetOperation(c511600069.spop)
	c:RegisterEffect(e8)
	--name change
	local e9=e4:Clone()
...
c511600069.listed_names={87756343,40240595}
...
function c511600069.spcon(e,tp,eg,ev,ep,re,r,rp)
