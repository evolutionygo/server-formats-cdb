...
function c511002906.initial_effect(c)
	--You can Special Summon this card (from your hand) by removing 3 Gearspring Counters from your sc511002906e of the field
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc511002906(c511002906,0))
	...
	e2:SetDescription(aux.Stringc511002906(c511002906,1))
	...
	e2:SetOperation(c511002906.atkop)
	c:RegisterEffect(e2)
end
c511002906.counter_list={COUNTER_GEARSPRING}
...
function c511002906.atkop(e,tp,eg,ep,ev,re,r,rp)
