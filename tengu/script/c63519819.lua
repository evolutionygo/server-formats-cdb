...
function c63519819.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc63519819(c63519819,0))
...
function c63519819.eqfilter(c)
	return c:GetFlagEffect(c63519819)~=0
end
...
function c63519819.equipop(c,e,tp,tc)
	if not c:EquipByEffectAndLimitRegister(e,tp,tc,c63519819) then return end
	--substitute
	local e2=Effect.CreateEffect(c)
...
function c63519819.eqop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc and tc:IsRelateToEffect(e) and tc:IsMonster() and tc:IsControler(1-tp)  and c63519819.eqcon(e,tp,eg,ep,ev,re,r,rp) then
