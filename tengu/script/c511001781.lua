...
function c511001781.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511001781(c511001781,0))
	...
	aux.AddEREquipLimit(c,nil,aux.FilterBoolFunction(Card.IsSetCard,SET_NUMBER),c511001781.equipop,e1,nil)
	--equip 2
	local e2=Effect.CreateEffect(c)
	e2:SetDescription(aux.Stringc511001781(c511001781,1))
	e2:SetCategory(CATEGORY_EQUIP)
	e2:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e2:SetCode(EVENT_BATTLED)
	e2:SetTarget(c511001781.eqtg2)
	e2:SetOperation(c511001781.eqop)
	aux.AddEREquipLimit(c,nil,aux.NOT(aux.FilterBoolFunction(Card.IsType,TYPE_TOKEN)),c511001781.equipop,e2,nil)
	--atkup
	...
	e4:SetDescription(aux.Stringc511001781(c511001781,2))
	...
	e5:SetDescription(aux.Stringc511001781(c511001781,3))
	...
	e6:SetDescription(aux.Stringc511001781(c511001781,4))
	...
	aux.DoubleSnareValc511001781ity(c,LOCATION_MZONE)
end
c511001781.listed_series={SET_NUMBER}
c511001781.listed_names={9161357}
c511001781.aux.xyz_number=6
...
function c511001781.eqtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_SZONE)>0
		and Duel.IsExistingTarget(c511001781.eqfilter,tp,LOCATION_MZONE,LOCATION_MZONE,1,e:GetHandler(),tp) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_EQUIP)
	local g=Duel.SelectTarget(tp,c511001781.eqfilter,tp,LOCATION_MZONE,LOCATION_MZONE,1,1,e:GetHandler(),tp)
	Duel.SetOperationInfo(0,CATEGORY_EQUIP,g,1,tp,0)
end
function c511001781.equipop(c,e,tp,tc)
	c:EquipByEffectAndLimitRegister(e,tp,tc,c511001781)
end
...
function c511001781.eqtc(c)
	return c:GetFlagEffect(c511001781)>0
end
