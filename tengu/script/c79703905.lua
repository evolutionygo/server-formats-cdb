...
function c79703905.initial_effect(c)
	...
	e3:SetDescription(aux.Stringc79703905(c79703905,0))
	...
	e4:SetDescription(aux.Stringc79703905(c79703905,1))
...
c79703905.listed_series={0x18}
c79703905.counter_place_list={0x1019}
