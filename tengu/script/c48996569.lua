...
function c48996569.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCode2(c,true,true,CARD_NEOS,80344569)
	Fusion.AddContactProc(c,c48996569.contactfil,c48996569.contactop,c48996569.splimit)
	aux.EnableNeosReturn(c)
	--tohand
	local e5=Effect.CreateEffect(c)
	e5:SetDescription(aux.Stringc48996569(c48996569,1))
