...
function c8581705.initial_effect(c)
	...
	c:RegisterEffect(e1)
	--Roll a six-sc8581705ed die when resolving an opponent's card effect that targets this card
	...
	e3:SetDescription(aux.Stringc8581705(c8581705,0))
...
c8581705.listed_series={SET_ARCHFIEND}
c8581705.roll_dice=true
...
function c8581705.disop(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.Hint(HINT_CARD,1-tp,c8581705)
...
function c8581705.atktg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local g=Duel.SelectTarget(tp,c8581705.filter,tp,LOCATION_MZONE,0,1,1,nil)
