...
function c511310013.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc511310013(71863024,0))
...
function c511310013.atkop(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.Hint(HINT_SELECTMSG,tp,aux.Stringc511310013(30494314,0))
...
function c511310013.atktg2(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	tc:RegisterFlagEffect(c511310013,RESET_CHAIN,0,0)
...
function c511310013.atkop2(e,tp,eg,ep,ev,re,r,rp)
	...
	local tc2=g:GetNext()
	if tc1:GetFlagEffect(c511310013)==0 then tc2,tc1=tc1,tc2 end
	if not tc1 or tc1:GetFlagEffect(c511310013)==0 then return end
