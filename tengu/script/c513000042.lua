...
function c513000042.initial_effect(c)
	...
	e3:SetCondition(c513000042.damcon)
	e3:SetOperation(c513000042.damop)
	c:RegisterEffect(e3)
	--disable summon
	...
	e4:SetTarget(c513000042.sumlimit)
	c:RegisterEffect(e4)
	local e5=e4:Clone()
	...
	e7:SetDescription(aux.Stringc513000042(c513000042,1))
	...
	e8:SetDescription(aux.Stringc513000042(c513000042,0))
	e8:SetCode(EVENT_BATTLED)
	e8:SetCondition(c513000042.con)
	e8:SetTarget(c513000042.tg)
	e8:SetOperation(c513000042.op)
	c:RegisterEffect(e8)
end
...
function c513000042.damop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.SelectYesNo(tp,aux.Stringc513000042(c513000042,2)) then
		Duel.Hint(HINT_CARD,1-tp,c513000042)
