--Number 37: Hope Woven Dragon Spc511001273er Shark
...
function c511001273.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511001273(c511001273,0))
	...
	e3:SetDescription(aux.Stringc511001273(c511001273,2))
	...
	e4:SetDescription(aux.Stringc511001273(c511001273,3))
...
function c511001273.regop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:GetPreviousLocation()&LOCATION_MZONE~=0 and c:IsReason(REASON_DESTROY) then
		local e1=Effect.CreateEffect(c)
		e1:SetDescription(aux.Stringc511001273(c511001273,1))
...
function c511001273.spfilter(c,e,tp,tc511001273)
	return c:IsReason(REASON_DESTROY) and c:GetTurnID()==tc511001273 and c:IsCanBeSpecialSummoned(e,0,tp,false,false) and c:GetCode()~=37279508
end
