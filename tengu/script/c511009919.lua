...
local s,c511009919,alias=GetID()
function c511009919.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc511009919(alias,0))
	...
	e4:SetDescription(aux.Stringc511009919(alias,1))
...
c511009919.listed_series={0x119}
...
function c511009919.linkop(e,tp,eg,ep,ev,re,r,rp,c)
