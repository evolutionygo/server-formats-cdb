...
function c511002373.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCode2N(c,true,true,97165977,1,aux.FilterBoolFunction(Card.IsSetCard,0xdf),2)
	--immune
...
function c511002373.desop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.GetAttacker()==c and c:GetFlagEffect(c511002373)==0 then
		local sg=Duel.GetMatchingGroup(Card.IsDestructable,tp,0,LOCATION_MZONE,nil)
		Duel.Destroy(sg,REASON_EFFECT)
		c:RegisterFlagEffect(c511002373,RESET_PHASE+PHASE_END,0,1)
	end
end