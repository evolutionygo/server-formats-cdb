--地底のアラクネー (Anime)
--Underground Arachnc511600137 (Anime)
--scripted by Larry126
function c511600137.initial_effect(c)
	c:AddSetcodesRule(c511600137,false,0x601)
	--dark synchro summon
	c:EnableReviveLimit()
	...
	e2:SetDescription(aux.Stringc511600137(63465535,0))
...
function c511600137.eqfilter(c)
	return c:GetFlagEffect(c511600137)~=0 
end
...
function c511600137.equipop(c,e,tp,tc)
	c:EquipByEffectAndLimitRegister(e,tp,tc,c511600137)
end
