...
function c511009635.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511009635(53027855,0))
	e1:SetCategory(CATEGORY_DESTROY)
	e1:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_F)
	e1:SetCode(EVENT_SPSUMMON_SUCCESS)
	e1:SetTarget(c511009635.destg)
	e1:SetOperation(c511009635.desop)
	c:RegisterEffect(e1)
	--pierce
	...
	e3:SetDescription(aux.Stringc511009635(35638627,0))
	...
	e4:SetDescription(aux.Stringc511009635(8062132,0))
	e4:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e4:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e4:SetCode(EVENT_TO_GRAVE)
	e4:SetCondition(c511009635.condition)
	e4:SetCost(c511009635.cost)
	e4:SetTarget(c511009635.target)
	e4:SetOperation(c511009635.operation)
	c:RegisterEffect(e4)
end
