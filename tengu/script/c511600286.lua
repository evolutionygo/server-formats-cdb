...
function c511600286.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	...
	e2:SetTarget(c511600286.desreptg)
	c:RegisterEffect(e2)
end
c511600286.material_setcode={0x8,0x3008}
function c511600286.desreptg(e,tp,eg,ep,ev,re,r,rp,chk)
