...
function c58054262.initial_effect(c)
	...
	e3:SetDescription(aux.Stringc58054262(c58054262,0))
...
c58054262.listed_names={22666164,60999392,23782705,96384007}
function c58054262.atcost(e,c,tp)
	return Duel.CheckLPCost(tp,1000)
end
function c58054262.atop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.IsAttackCostPac58054262()~=2 and e:GetHandler():IsLocation(LOCATION_MZONE) then
		Duel.PayLPCost(tp,1000)
		Duel.AttackCostPac58054262()
	end
end
