...
function c41201555.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc41201555(c41201555,3))
...
function c41201555.mtop(e,tp,eg,ep,ev,re,r,rp)
	...
	if #g1>0 and #g2>0 then
		select=Duel.SelectOption(tp,aux.Stringc41201555(c41201555,0),aux.Stringc41201555(c41201555,1),aux.Stringc41201555(c41201555,2))
	elseif #g1>0 then
		select=Duel.SelectOption(tp,aux.Stringc41201555(c41201555,0),aux.Stringc41201555(c41201555,2))
		if select==1 then select=2 end
	elseif #g2>0 then
		select=Duel.SelectOption(tp,aux.Stringc41201555(c41201555,1),aux.Stringc41201555(c41201555,2))+1
	else
		select=Duel.SelectOption(tp,aux.Stringc41201555(c41201555,2))
		select=2
	end
	if select==0 then
