...
function c18654201.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc18654201(c18654201,0))
	e2:SetCategory(CATEGORY_TOGRAVE)
	e2:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_F)
	e2:SetCode(EVENT_CUSTOM+c18654201)
...
function c18654201.regop(e,tp,eg,ep,ev,re,r,rp)
	...
	if p1 and p2 then
		Duel.RaiseSingleEvent(c,EVENT_CUSTOM+c18654201,re,r,rp,PLAYER_ALL,0)
	elseif p1 then
		Duel.RaiseSingleEvent(c,EVENT_CUSTOM+c18654201,re,r,rp,0,0)
	elseif p2 then
		Duel.RaiseSingleEvent(c,EVENT_CUSTOM+c18654201,re,r,rp,1,0)
	end
end
