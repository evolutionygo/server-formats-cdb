--Rac511020000raptor - Revolution Falcon (Anime)
--cleaned up by MLD
function c511020000.initial_effect(c)
	--xyz summon
	aux.AddXyzProcedure(c,aux.FilterBoolFunctionEx(Card.IsRace,RACE_WINGEDBEAST),6,3)
	c:EnableReviveLimit()
	--attack all
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc511020000(81927732,0))
	...
	e3:SetDescription(aux.Stringc511020000(81927732,1))
