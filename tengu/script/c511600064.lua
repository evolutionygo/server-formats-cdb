...
function c511600064.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc511600064(c511600064,0))
	...
	e3:SetDescription(aux.Stringc511600064(c511600064,1))
...
c511600064.listed_series={SET_FRIGHTFUR,SET_FLUFFAL,SET_EDGE_IMP}
...
function c511600064.atkcon(e)
	return Duel.IsExistingMatchingCard(c511600064.filter,e:GetHandlerPlayer(),LOCATION_MZONE,LOCATION_MZONE,1,e:GetHandler())
end
