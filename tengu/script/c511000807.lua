...
function c511000807.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc511000807(c511000807,0))
	...
	e3:SetDescription(aux.Stringc511000807(c511000807,1))
	...
	e4:SetDescription(aux.Stringc511000807(c511000807,1))
...
function c511000807.regop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.GetTurnPlayer()==tp and Duel.GetActivityCount(tp,ACTIVITY_SUMMON)==0
		...
		Duel.RaiseEvent(e:GetHandler(),c511000807,e,0,0,tp,0)
	end
end
