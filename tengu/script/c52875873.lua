...
c52875873.listed_names={CARD_CYBER_DRAGON}
function c52875873.checkop(e,tp,eg,ep,ev,re,r,rp)
	local tc=eg:GetFirst()
	if tc:IsCode(CARD_CYBER_DRAGON) then
		Duel.RegisterFlagEffect(tc:GetControler(),c52875873,RESET_PHASE+PHASE_END,0,1)
	end
end
...
function c52875873.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetFlagEffect(tp,c52875873)==0 end
