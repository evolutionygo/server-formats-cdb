...
function c22751868.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc22751868(c22751868,0))
	...
	e3:SetDescription(aux.Stringc22751868(c22751868,1))
...
function c22751868.spfilter(c,e,tp)
...
function c22751868.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsLocation(LOCATION_GRAVE) and chkc:IsControler(tp) and c22751868.spfilter(chkc,e,tp) end
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingTarget(c22751868.spfilter,tp,LOCATION_GRAVE,0,1,nil,e,tp) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_SPSUMMON)
	local g=Duel.SelectTarget(tp,c22751868.spfilter,tp,LOCATION_GRAVE,0,1,1,nil,e,tp)
