...
function c74576482.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc74576482(c74576482,3))
...
function c74576482.mtop(e,tp,eg,ep,ev,re,r,rp)
	...
	if #g1>0 and #g2>0 then
		select=Duel.SelectOption(tp,aux.Stringc74576482(c74576482,0),aux.Stringc74576482(c74576482,1),aux.Stringc74576482(c74576482,2))
	elseif #g1>0 then
		select=Duel.SelectOption(tp,aux.Stringc74576482(c74576482,0),aux.Stringc74576482(c74576482,2))
		if select==1 then select=2 end
	elseif #g2>0 then
		select=Duel.SelectOption(tp,aux.Stringc74576482(c74576482,1),aux.Stringc74576482(c74576482,2))+1
	else
		select=Duel.SelectOption(tp,aux.Stringc74576482(c74576482,2))
		select=2
	end
	if select==0 then
