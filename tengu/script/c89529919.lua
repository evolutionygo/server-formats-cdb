...
function c89529919.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc89529919(c89529919,0))
...
function c89529919.filter(c)
	return c:IsLevelBelow(4) and c:IsRace(RACE_WARRIOR) and c:GetCode()~=c89529919
end
function c89529919.operation(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_SELECTMSG,tp,aux.Stringc89529919(c89529919,1))
