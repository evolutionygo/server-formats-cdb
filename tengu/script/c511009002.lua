...
function c511009002.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511009002(alias,0))
	...
	e2:SetDescription(aux.Stringc511009002(alias,1))
...
function c511009002.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:HasNonZeroAttack() and tc:IsRelateToEffect(e) then
		...
		local fc511009002=c:GetFieldID()
		tc:RegisterFlagEffect(alias,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1,fc511009002)
		local e1=Effect.CreateEffect(c)
		e1:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_CONTINUOUS)
		e1:SetCode(EVENT_PHASE+PHASE_END)
		e1:SetCountLimit(1)
		e1:SetLabel(fc511009002)
...
function c511009002.bttg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():GetFlagEffect(c511009002)==0 end
	e:GetHandler():RegisterFlagEffect(c511009002,RESET_CHAIN,0,1)
end
