...
function c511002517.initial_effect(c)
	...
	e3:SetDescription(aux.Stringc511002517(c511002517,0))
	...
	e4:SetDescription(aux.Stringc511002517(c511002517,1))
	...
	e5:SetDescription(aux.Stringc511002517(c511002517,2))
...
c511002517.listed_series={0x557,0x507,0x525,0x50d}
...
function c511002517.equipop(c,e,tp,tc)
	...
	if not c:EquipByEffectAndLimitRegister(e,tp,tc,c511002517) then return end
	local e2=Effect.CreateEffect(c)
...
function c511002517.dcfilter(c)
	return c:GetFlagEffect(c511002517)~=0 and c:IsAbleToGraveAsCost()
end
