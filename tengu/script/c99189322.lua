...
function c99189322.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc99189322(c99189322,0))
...
c99189322.listed_series={SET_ARCANA_FORCE}
...
function c99189322.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc and tc:IsRelateToEffect(e) and tc:IsFaceup() and c99189322.filter(tc) and regc:IsRelateToEffect(e) then
		...
		regfun(tc,val)
		tc:RegisterFlagEffect(c99189322,RESET_EVENT|RESETS_STANDARD_DISABLE|RESET_PHASE|PHASE_END,0,1)
...
function c99189322.rec_effect(e,tp,eg,ep,ev,re,r,rp)
	...
	if not tc or tc:GetFlagEffect(c99189322)==0 or tc:GetFlagEffect(CARD_REVERSAL_OF_FATE)==0 then return end
