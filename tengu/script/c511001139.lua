...
function c511001139.initial_effect(c)
	...
	e4:SetDescription(aux.Stringc511001139(c511001139,0))
	...
	e5:SetDescription(aux.Stringc511001139(c511001139,1))
	...
	aux.GlobalCheck(s,function()
		...
		ge1:SetLabel(c511001139)
		ge1:SetProperty(EFFECT_FLAG_CANNOT_DISABLE)
		ge1:SetOperation(aux.sumreg)
		Duel.RegisterEffect(ge1,0)
		local ge2=ge1:Clone()
		ge2:SetCode(EVENT_SPSUMMON_SUCCESS)
		ge2:SetLabel(c511001139)
		Duel.RegisterEffect(ge2,0)
	end)
end
c511001139.listed_series={SET_ADVANCED_CRYSTAL_BEAST,SET_CRYSTAL_BEAST}
...
function c511001139.overdrivecon(e,tp,eg,ep,ev,re,r,rp)
	if e:GetHandler():GetFlagEffect(c511001139)~=0 then return false end
...
function c511001139.protectioncon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c511001139)==0
end
...
function c511001139.protectiontg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	return Duel.SelectYesNo(tp,aux.Stringc511001139(c511001139,1))
end
