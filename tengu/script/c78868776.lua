...
function c78868776.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc78868776(c78868776,0))
...
c78868776.listed_series={0x19}
c78868776.listed_names={c78868776}
function c78868776.atkcon(e)
	return e:GetHandler():GetFlagEffect(c78868776)>0
end
...
function c78868776.filter(c,e,tp)
	return not c:IsCode(c78868776) and c:IsSetCard(0x19) and c:IsCanBeSpecialSummoned(e,100,tp,false,false)
end
