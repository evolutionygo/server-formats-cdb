...
function c82012319.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc82012319(c82012319,0))
...
c82012319.listed_series={SET_SCRAP}
function c82012319.spfilter(c,e,tp)
...
function c82012319.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return (Duel.GetLocationCount(tp,LOCATION_MZONE)>0 or Duel.GetLocationCount(1-tp,LOCATION_MZONE)>0)
		and Duel.IsExistingTarget(c82012319.spfilter,tp,LOCATION_GRAVE,0,1,nil,e,tp) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_SPSUMMON)
	local g=Duel.SelectTarget(tp,c82012319.spfilter,tp,LOCATION_GRAVE,0,1,1,nil,e,tp)
...
function c82012319.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if b1 and b2 then
		op=Duel.SelectOption(tp,aux.Stringc82012319(c82012319,1),aux.Stringc82012319(c82012319,2))
	elseif b1 then
		op=Duel.SelectOption(tp,aux.Stringc82012319(c82012319,1))
	elseif b2 then
		op=Duel.SelectOption(tp,aux.Stringc82012319(c82012319,2))+1
	else return end
	if op==0 then
