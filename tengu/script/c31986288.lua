...
function c31986288.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc31986288(c31986288,0))
...
c31986288.listed_names={31986289}
...
function c31986288.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return not Duel.IsPlayerAffectedByEffect(tp,CARD_BLUEEYES_SPIRIT)
		...
		and Duel.IsPlayerCanSpecialSummonMonster(tp,c31986288+1,0x123,TYPES_TOKEN,1200,1200,3,RACE_PLANT,ATTRIBUTE_DARK) end
...
function c31986288.operation(e,tp,eg,ep,ev,re,r,rp)
	if Duel.IsPlayerAffectedByEffect(tp,CARD_BLUEEYES_SPIRIT) or Duel.GetLocationCount(tp,LOCATION_MZONE)<2 
		or not Duel.IsPlayerCanSpecialSummonMonster(tp,c31986288+1,0x123,TYPES_TOKEN,1200,1200,3,RACE_PLANT,ATTRIBUTE_DARK) then return end
	for i=1,2 do
		local token=Duel.CreateToken(tp,c31986288+1)
