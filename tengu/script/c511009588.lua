...
function c511009588.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511009588(c511009588,0))
	...
	e2:SetDescription(aux.Stringc511009588(c511009588,1))
	...
	e3:SetDescription(aux.Stringc511009588(c511009588,2))
...
c511009588.listed_series={SET_ODD_EYES}
c511009588.listed_names={82044279}
...
function c511009588.reptg(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	if chk==0 then return c:IsType(TYPE_PENDULUM) and Duel.CheckPendulumZones(tp) and eg:IsExists(c511009588.repfilter,1,nil,tp) end
