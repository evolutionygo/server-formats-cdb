...
function c511002110.initial_effect(c)
	...
	e3:SetDescription(aux.Stringc511002110(8062132,0))
	...
	e6:SetDescription(aux.Stringc511002110(8062132,1))
...
function c511002110.ctop(e,tp,eg,ep,ev,re,r,rp)
	...
	e3:SetDescription(aux.Stringc511002110(4931121,descnum))
