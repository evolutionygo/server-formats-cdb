...
function c511003004.tgfilter(c,e,tp,tc)
	return c:IsSetCard(0xad) and c:GetLevel()==tc:GetLevel() and c:IsAbleToGrave() and Duel.IsExistingMatchingCard(c511003004.spfilter,tp,LOCATION_EXTRA,0,1,c,e,tp,tc)
end
