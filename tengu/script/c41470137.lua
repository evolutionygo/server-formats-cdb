...
function c41470137.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc41470137(c41470137,0))
	...
	e2:SetDescription(aux.Stringc41470137(c41470137,1))
...
c41470137.listed_series={0x19}
c41470137.listed_names={c41470137}
...
function c41470137.filter(c,e,tp)
	return not c:IsCode(c41470137) and c:IsSetCard(0x19) and c:IsCanBeSpecialSummoned(e,102,tp,false,false)
end
