...
function c50282757.initial_effect(c)
	...
	e0:SetCondition(c50282757.lizcon)
	e0:SetValue(1)
	c:RegisterEffect(e0)
	...
	e2:SetDescription(aux.Stringc50282757(c50282757,0))
...
c50282757.listed_names={CARD_DARK_FUSION,58932615,84327329}
function c50282757.lizcon(e,tp,eg,ep,ev,re,r,rp)
