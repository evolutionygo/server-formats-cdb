...
function c511600022.initial_effect(c)
	...
	e6:SetDescription(aux.Stringc511600022(35952884,0))
...
function c511600022.lvop(e,tp,eg,ep,ev,re,r,rp)
	...
	if #g<=0 and e:GetHandler():GetFlagEffect(c511600022)==0 then
		Duel.RaiseEvent(g,c511600022,e,0,0,tp,0)
		e:GetHandler():RegisterFlagEffect(c511600022,RESET_EVENT+RESETS_STANDARD,0,1)
	end
end
