...
function c511002444.initial_effect(c)
	...
	e5:SetDescription(aux.Stringc511002444(48009503,0))
...
function c511002444.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if res and c511002444.damcon(e,tp,teg,tep,tev,tre,tr,trp) and c511002444.damtg(e,tp,teg,tep,tev,tre,tr,trp,0) then
		e:SetOperation(c511002444.damop)
		c511002444.damtg(e,tp,teg,tep,tev,tre,tr,trp,1)
