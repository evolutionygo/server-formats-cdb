...
function c511015116.initial_effect(c)
	c:EnableReviveLimit()
	aux.AddFusionProcCode2Rep(c,true,true,aux.FilterBoolFunctionEx(Card.IsSetCard,0x36),2,99)
...
function c511015116.atop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.IsAttackCostPac511015116()~=2 and e:GetHandler():IsLocation(LOCATION_MZONE) then
		Duel.PayLPCost(tp,1000)
		Duel.AttackCostPac511015116()
	end
end