...
function c511001776.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511001776(56051086,0))
	...
	c:RegisterEffect(e1)
	aux.AddEREquipLimit(c,c511001776.eqcon,c511001776.eqval,Card.EquipByEffectAndLimitRegister,e1)
	--
	...
	e4:SetDescription(aux.Stringc511001776(56051086,1))
	...
	e5:SetDescription(aux.Stringc511001776(c511001776,0))
	e5:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_F)
	e5:SetCategory(CATEGORY_DAMAGE)
	e5:SetProperty(EFFECT_FLAG_PLAYER_TARGET)
	e5:SetCode(c511001776)
	e5:SetTarget(c511001776.damtg)
	e5:SetOperation(c511001776.damop)
	c:RegisterEffect(e5)
	--negate
	local e6=Effect.CreateEffect(c)
	e6:SetDescription(aux.Stringc511001776(11819616,0))
...
function c511001776.atkop(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.RaiseSingleEvent(e:GetHandler(),c511001776,e,r,rp,ep,ev)
end
