...
function c3429238.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc3429238(c3429238,0))
	...
	e2:SetDescription(aux.Stringc3429238(c3429238,1))
	...
	e3:SetDescription(aux.Stringc3429238(c3429238,2))
...
c3429238.material={56286179}
c3429238.listed_names={56286179}
c3429238.material_setcode=0x1017
function c3429238.tfilter(c,scard,sumtype,tp)
...
function c3429238.rmop(e,tp,eg,ep,ev,re,r,rp)
	...
	if #g>0 then
		...
		if c:IsRelateToEffect(e) and Duel.Remove(e:GetHandler(),POS_FACEUP,REASON_EFFECT)~=0 then
			e:GetHandler():RegisterFlagEffect(c3429238,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_STANDBY+RESET_SELF_TURN,0,1)
		end
	end
end
...
function c3429238.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():GetFlagEffect(c3429238)~=0 end
	e:GetHandler():ResetFlagEffect(c3429238)
