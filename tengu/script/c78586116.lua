...
function c78586116.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc78586116(c78586116,0))
	e2:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_F)
	e2:SetCode(EVENT_CUSTOM+c78586116)
	e2:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e2:SetTarget(c78586116.attg)
	e2:SetOperation(c78586116.atop)
	c:RegisterEffect(e2)
end
c78586116.listed_series={0x26}
...
function c78586116.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc and tc:IsRelateToEffect(e) and tc:IsFaceup() then
		...
		c:RegisterEffect(e2)
		Duel.RaiseSingleEvent(c,EVENT_CUSTOM+c78586116,e,0,0,0,0,0)
	else
