--封魔の伝承者
--Disciple of the Forbc15595052den Spell
function c15595052.initial_effect(c)
	--to defense
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc15595052(c15595052,0))
...
function c15595052.ancop(e,tp,eg,ep,ev,re,r,rp)
	...
	local ct=Duel.GetMatchingGroupCount(Card.IsCode,tp,LOCATION_GRAVE,0,nil,c15595052)
	if ct>0 and c:IsFaceup() and c:IsRelateToEffect(e) then
		...
		--destroy
		local e1=Effect.CreateEffect(c)
		e1:SetDescription(aux.Stringc15595052(c15595052,1))
