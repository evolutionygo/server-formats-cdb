...
function c511009013.initial_effect(c)
	...
	e3:SetCondition(c511009013.ctcon)
	e3:SetOperation(c511009013.ctop)
	c:RegisterEffect(e3)
end
function c511009013.ctcon(e,tp,eg,ep,ev,re,r,rp)
...
function c511009013.ctop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	local bc=c:GetBattleTarget()
	local ct=bc:GetCounter(0x1109)
	local count=0
	...
	if count>0 then
		Duel.Hint(HINT_CARD,0,c511009013)
