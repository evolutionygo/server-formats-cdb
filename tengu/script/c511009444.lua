...
function c511009444.initial_effect(c)
	...
	c:RegisterEffect(e1)
	--Gain LP if the effect of "Supreme King Gate Zero" is used to avoc511009444 damage
	local e2=Effect.CreateEffect(c)
	e2:SetDescription(aux.Stringc511009444(c511009444,0))
	e2:SetProperty(EFFECT_FLAG_PLAYER_TARGET+EFFECT_FLAG_DAMAGE_STEP)
	e2:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_O)
	e2:SetCategory(CATEGORY_RECOVER)
	e2:SetCode(96227613)
	e2:SetRange(LOCATION_PZONE)
	e2:SetCondition(c511009444.reccon)
	e2:SetTarget(c511009444.rectg)
	e2:SetOperation(c511009444.recop)
	c:RegisterEffect(e2)
	--Search 1 "Supreme King Gate Zero"
	local e3=Effect.CreateEffect(c)
	e3:SetDescription(aux.Stringc511009444(c511009444,1))
...
c511009444.listed_names={96227613} --Supreme King Gate Zero
