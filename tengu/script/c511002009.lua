...
function c511002009.initial_effect(c)
	c:EnableReviveLimit()
	--Fustion Materials
	aux.AddFusionProcCode2(c,true,true,51777272,aux.FilterBoolFunction(Card.IsSetCard,SET_LUNALIGHT))
	...
	e3:SetTarget(c511002009.indtg)
	e3:SetValue(c511002009.indct)
	c:RegisterEffect(e3)
	...
	e4:SetCondition(c511002009.atkcon)
	e4:SetOperation(c511002009.atkop)
	c:RegisterEffect(e4)
end
c511002009.listed_names={51777272}
c511002009.listed_series={SET_LUNALIGHT}
c511002009.material_setcode=SET_LUNALIGHT
function c511002009.indtg(e,c)
	local hc=e:GetHandler()
	return c:GetReasonCard()==hc and Duel.GetAttacker()==hc
end
function c511002009.indct(e,re,r,rp,c)
