...
function c56387350.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc56387350(c56387350,0))
...
function c56387350.regop(e,tp,eg,ep,ev,re,r,rp)
	e:GetHandler():RegisterFlagEffect(c56387350,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_BATTLE,0,1)
end
function c56387350.spcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c56387350)~=0
end
function c56387350.filter(c,e,tp,rc,tc56387350)
	return c:IsReason(REASON_BATTLE) and c:GetReasonCard()==rc and c:GetTurnID()==tc56387350
