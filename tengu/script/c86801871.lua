...
function c86801871.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc86801871(c86801871,0))
...
c86801871.listed_names={86801872}
...
function c86801871.spop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.GetLocationCount(tp,LOCATION_MZONE)>0 
		and Duel.IsPlayerCanSpecialSummonMonster(tp,c86801871+1,0,TYPES_TOKEN,1200,1200,3,RACE_REPTILE,ATTRIBUTE_EARTH) then
		local token=Duel.CreateToken(tp,c86801871+1)
