...
function c511010534.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511010534(44035031,0))
	...
	e4:SetDescription(aux.Stringc511010534(44035031,1))
	...
	e5:SetDescription(aux.Stringc511010534(47754278,0))
...
function c511010534.attg(e,tp,eg,ev,ep,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.IsExistingTarget(c511010534.filter,tp,0,LOCATION_MZONE,1,nil) and e:GetHandler():GetFlagEffect(c511010534)==0 end
	Duel.SelectTarget(tp,c511010534.filter,tp,0,LOCATION_MZONE,1,1,nil,0)
	e:GetHandler():RegisterFlagEffect(c511010534,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
end
...
function c511010534.descon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c511010534)~=0
end
