...
function c91345518.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc91345518(c91345518,0))
...
function c91345518.damcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	e2:SetDescription(aux.Stringc91345518(c91345518,1))
...
function c91345518.damtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLP(tp)>Duel.GetLP(1-tp)
		and (Duel.IsExistingMatchingCard(c91345518.envfilter,tp,LOCATION_ONFIELD,0,1,nil) or Duel.IsEnvironment(CARD_SANCTUARY_SKY,tp)) end
...
function c91345518.damop(e,tp,eg,ep,ev,re,r,rp)
	if not (Duel.IsExistingMatchingCard(c91345518.envfilter,tp,LOCATION_ONFIELD,0,1,nil) or Duel.IsEnvironment(CARD_SANCTUARY_SKY,tp)) then return end
