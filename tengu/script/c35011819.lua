...
function c35011819.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc35011819(c35011819,0))
...
function c35011819.target1(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if te:GetCode()==EVENT_SUMMON_SUCCESS and te:IsMonsterEffect() and Duel.IsChainNegatable(ct-1)
		and Duel.IsPlayerCanDraw(tc:GetControler(),1) and Duel.SelectYesNo(tp,aux.Stringc35011819(c35011819,1)) then
		e:SetLabel(1)
		...
		e:GetHandler():RegisterFlagEffect(0,RESET_CHAIN,EFFECT_FLAG_CLIENT_HINT,1,0,aux.Stringc35011819(c35011819,2))
	end
end
