--断層地帯 (Action Field)
--Canyon (Action Field)
function c151000007.initial_effect(c)
	--activate
	...
	e2:SetCondition(c151000007.dcon1)
	e2:SetValue(DOUBLE_DAMAGE)
	c:RegisterEffect(e2)
	local e3=e2:Clone()
	e3:SetTargetRange(0,1)
	e3:SetCondition(c151000007.dcon2)
	c:RegisterEffect(e3)
end
c151000007.af="a"
function c151000007.dcon1(e)
