...
--scripted by pyrQ
function c511030004.initial_effect(c)
	--atk change
	...
	e1:SetCondition(c511030004.condition)
	e1:SetCost(c511030004.cost)
	e1:SetOperation(c511030004.operation)
	c:RegisterEffect(e1)
end
c511030004.listed_series={0x11a}
function c511030004.condition(e,tp,eg,ep,ev,re,r,rp)
...
function c511030004.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():IsAbleToGraveAsCost() end
	Duel.SendtoGrave(e:GetHandler(),REASON_COST)
end
function c511030004.operation(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if a:IsRelateToBattle() and not a:IsImmuneToEffect(e) then
		...
		if b:IsRelateToBattle() and not b:IsImmuneToEffect(e) then
			...
			e2:SetOperation(c511030004.atkop)
			e2:SetReset(RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_DAMAGE)
			b:RegisterEffect(e2)
		end
	end
end
function c511030004.atkop(e,tp,eg,ep,ev,re,r,rp)
