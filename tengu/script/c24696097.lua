...
function c24696097.initial_effect(c)
	...
	aux.AddSynchroProcedure(c,aux.FilterBoolFunctionEx(Card.IsType,TYPE_SYNCHRO),1,1,aux.FilterSummonCode(CARD_STARDUST_DRAGON),1,1)
	--Excavate the top 5 cards of your deck and gain extra attack per Tuner monster excavated
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc24696097(c24696097,0))
	...
	e2:SetDescription(aux.Stringc24696097(c24696097,1))
	...
	e3:SetDescription(aux.Stringc24696097(c24696097,2))
	...
	e4:SetDescription(aux.Stringc24696097(c24696097,3))
...
c24696097.material={CARD_STARDUST_DRAGON}
c24696097.listed_names={CARD_STARDUST_DRAGON}
c24696097.synchro_tuner_required=1
c24696097.synchro_nt_required=1
...
function c24696097.daop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e) and Duel.Remove(c,POS_FACEUP,REASON_EFFECT)~=0 then
		Duel.NegateAttack()
		c:RegisterFlagEffect(c24696097,RESETS_STANDARD_PHASE_END,0,0)
	end
end
function c24696097.sumtg(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and c:HasFlagEffect(c24696097)
