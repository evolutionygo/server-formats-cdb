...
function c511001785.refcon(e,re,val,r,rp,rc)
	...
	local cc511001785=Duel.GetChainInfo(0,CHAININFO_CHAIN_ID)
	return cc511001785==e:GetLabel()
end
function c511001785.condition(e,tp,eg,ep,ev,re,r,rp)
