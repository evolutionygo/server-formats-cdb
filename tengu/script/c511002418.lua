...
function c511002418.initial_effect(c)
	...
	e4:SetDescription(aux.Stringc511002418(53347303,0))
	...
	e5:SetDescription(aux.Stringc511002418(74131780,0))
...
function c511002418.sptg(e,tp,eg,ep,ev,re,r,rp,c)
