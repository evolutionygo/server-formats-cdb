...
function c511001275.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511001275(c511001275,0))
	...
	e2:SetDescription(aux.Stringc511001275(c511001275,1))
	...
	e3:SetDescription(aux.Stringc511001275(c511001275,2))
	...
	e4:SetDescription(aux.Stringc511001275(c511001275,3))
	...
	e5:SetDescription(aux.Stringc511001275(c511001275,4))
...
function c511001275.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if re:GetHandler():IsRelateToEffect(re) and e:GetHandler():IsRelateToEffect(e) then
		...
		eg:GetFirst():RegisterFlagEffect(c511001275,RESET_EVENT+RESETS_STANDARD,0,1)
		e:GetHandler():RegisterFlagEffect(c511001275,RESET_EVENT+0x0fe0000,0,1)
...
function c511001275.atcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return c:GetPreviousLocation()==LOCATION_REMOVED and c:GetFlagEffect(c511001275)>0 and tc and tc:GetFlagEffect(c511001275)>0
end
