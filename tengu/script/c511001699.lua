...
function c511001699.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511001699(c511001699,0))
...
c511001699.listed_series={SET_FLOWER_CARDIAN}
...
function c511001699.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
    if chk==0 then return Duel.CheckReleaseGroupCost(tp,c511001699.filter,1,false,aux.ReleaseCheckMMZ,nil) end
    Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_RELEASE)
    local g=Duel.SelectReleaseGroupCost(tp,c511001699.filter,1,1,false,aux.ReleaseCheckMMZ,nil)
