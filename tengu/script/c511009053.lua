...
function c511009053.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCode2N(c,true,true,aux.FilterBoolFunctionEx(Card.IsSetCard,SET_DESTINY_HERO),2)
	--spsummon
	local e1=Effect.CreateEffect(c)
	e1:SetCategory(CATEGORY_DAMAGE)
	e1:SetDescription(aux.Stringc511009053(c511009053,0))
	...
	e2:SetDescription(aux.Stringc511009053(c511009053,1))
	...
	c:RegisterEffect(e2)
	local e3=e2:Clone()
	e3:SetCode(c511009053)
	e3:SetCondition(c511009053.descon2)
	c:RegisterEffect(e3)
end
c511009053.material_setcode={SET_HERO,SET_DESTINY_HERO}
