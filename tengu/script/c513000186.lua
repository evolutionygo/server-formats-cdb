...
function c513000186.initial_effect(c)
	c:AddSetcodesRule(c513000186,false,0x601)
	--dark synchro summon
	c:EnableReviveLimit()
	Synchro.AddDarkSynchroProcedure(c,aux.NonTuner(nil),nil,6)
	--special summon
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc513000186(100000153,0))
	...
	e2:SetDescription(aux.Stringc513000186(100000153,1))
	...
	e3:SetDescription(aux.Stringc513000186(100000153,0))
...
c513000186.listed_names={39823987}
