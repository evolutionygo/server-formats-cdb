...
function c511002830.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511002830(75433814,0))
	...
	e2:SetDescription(aux.Stringc511002830(75433814,1))
...
function c511002830.ctop(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.RegisterFlagEffect(tp,c511002830,RESET_PHASE+PHASE_END,0,2)
end
function c511002830.descon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetFlagEffect(tp,c511002830)~=0 and Duel.GetTurnPlayer()~=tp
end
