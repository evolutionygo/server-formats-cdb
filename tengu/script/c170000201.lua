...
function c170000201.initial_effect(c)
	...
	e1:SetCondition(c170000201.condition)
	e1:SetCost(c170000201.cost)
	e1:SetTarget(c170000201.target)
	e1:SetOperation(c170000201.operation)
	c:RegisterEffect(e1)
end
c170000201.listed_names={1784686,46232525,11082056,80019195,85800949,84565800,48179391,110000100,110000101}
function c170000201.condition(e,tp,eg,ep,ev,re,r,rp)
