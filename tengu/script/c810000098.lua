...
c810000098.listed_series={0x46,0xad}
c810000098.listed_names={CARD_POLYMERIZATION}
function c810000098.cfilter(c)
	return (c:IsCode(CARD_POLYMERIZATION) or c:IsSetCard(0x46)) and c:IsAbleToRemoveAsCost()
end
function c810000098.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
