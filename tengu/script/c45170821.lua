...
function c45170821.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCode2N(c,true,true,aux.FilterBoolFunctionEx(Card.IsSetCard,0x8),2)
	--summon success
	local e2=Effect.CreateEffect(c)
	e2:SetDescription(aux.Stringc45170821(c45170821,0))
