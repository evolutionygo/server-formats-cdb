...
function c80244114.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc80244114(c80244114,0))
	...
	e2:SetDescription(aux.Stringc80244114(c80244114,1))
...
c80244114.listed_names={CARD_STARDUST_DRAGON}
...
function c80244114.valcon(e,re,r,rp)
	if (r&REASON_BATTLE)~=0 then
		e:GetHandler():RegisterFlagEffect(c80244114,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_DAMAGE,0,1)
		return true
	else return false end
end
function c80244114.addown(e,tp,eg,ep,ev,re,r,rp)
	if e:GetHandler():GetFlagEffect(c80244114)==0 then return end
