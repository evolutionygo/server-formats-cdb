...
function c513000049.initial_effect(c)
	...
	e3:SetCondition(c513000049.damcon)
	e3:SetOperation(c513000049.damop)
	c:RegisterEffect(e3)
	--disable summon
	...
	e4:SetTarget(c513000049.sumlimit)
	c:RegisterEffect(e4)
	local e5=e4:Clone()
	...
	e7:SetDescription(aux.Stringc513000049(c513000049,1))
	...
	e8:SetDescription(aux.Stringc513000049(c513000049,0))
	e8:SetCode(EVENT_BATTLED)
	e8:SetTarget(c513000049.tg)
	e8:SetOperation(c513000049.op)
	c:RegisterEffect(e8)
end
...
function c513000049.damop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.SelectYesNo(tp,aux.Stringc513000049(c513000049,2)) then
		Duel.Hint(HINT_CARD,1-tp,c513000049)
