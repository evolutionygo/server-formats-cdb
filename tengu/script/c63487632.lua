...
function c63487632.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc63487632(c63487632,0))
	...
	c:RegisterEffect(e2)
	aux.AddEREquipLimit(c,nil,c63487632.eqval,Card.EquipByEffectAndLimitRegister,e2)
	local e3=e2:Clone()
	e3:SetCode(EVENT_SPSUMMON_SUCCESS)
	c:RegisterEffect(e3)
	aux.AddEREquipLimit(c,nil,c63487632.eqval,Card.EquipByEffectAndLimitRegister,e3)
	--special summon
	...
	e5:SetDescription(aux.Stringc63487632(c63487632,1))
...
c63487632.listed_series={0x29}
c63487632.listed_names={c63487632}
function c63487632.eqval(ec,c,tp)
	return ec:IsControler(tp) and not ec:IsCode(c63487632) and ec:IsRace(RACE_DRAGON)
end
...
function c63487632.spcon(e,c)
	...
	local rg=Duel.GetMatchingGroup(c63487632.spfilter,tp,LOCATION_MZONE,0,nil,tp)
	local ft=Duel.GetLocationCount(tp,LOCATION_MZONE)
	return ft>-1 and #rg>0 and aux.SelectUnselectGroup(rg,e,tp,1,1,nil,0)
end
function c63487632.sptg(e,tp,eg,ep,ev,re,r,rp,c)
...
function c63487632.filter(c)
	return c:GetCode()~=c63487632 and c:IsRace(RACE_DRAGON) and not c:IsForbc63487632den()
end
