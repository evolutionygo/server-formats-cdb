...
function c511002520.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc511002520(c511002520,0))
...
c511002520.listed_names={CARD_STARDUST_DRAGON}
...
function c511002520.condition(e,tp,eg,ep,ev,re,r,rp)
	...
	return ex and tg~=nil and tc+tg:FilterCount(c511002520.cfilter,nil,tp)-#tg>1
end
...
function c511002520.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		...
		return #pg<=0 and Duel.IsExistingMatchingCard(c511002520.filter,tp,LOCATION_EXTRA,0,1,nil,e,tp)
	end
