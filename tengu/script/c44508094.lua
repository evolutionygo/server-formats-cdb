...
function c44508094.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc44508094(c44508094,0))
	...
	e2:SetDescription(aux.Stringc44508094(c44508094,1))
...
function c44508094.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	e:GetHandler():RegisterFlagEffect(c44508094,RESETS_STANDARD_PHASE_END,0,0)
end
function c44508094.sumtg(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and c:HasFlagEffect(c44508094)
