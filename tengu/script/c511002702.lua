...
function c511002702.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc511002702(c511002702,0))
	...
	e3:SetDescription(aux.Stringc511002702(c511002702,1))
...
c511002702.listed_series={0x99}
function c511002702.regcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetSummonType()==SUMMON_TYPE_PENDULUM
end
function c511002702.regop(e,tp,eg,ep,ev,re,r,rp)
	e:GetHandler():RegisterFlagEffect(c511002702,RESET_EVENT|RESETS_STANDARD&~(RESET_TEMP_REMOVE|RESET_TURN_SET)|RESET_PHASE+PHASE_END,0,1)
end
function c511002702.damcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c511002702)>0 and ep~=tp
end
...
function c511002702.atkop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.SelectYesNo(tp,aux.Stringc511002702(c511002702,0)) then
		Duel.Hint(HINT_CARD,0,c511002702)
