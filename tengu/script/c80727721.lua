...
function c80727721.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc80727721(c80727721,0))
...
c80727721.listed_series={0x22}
function c80727721.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():IsReleasable() end
	Duel.Release(e:GetHandler(),REASON_COST)
end
function c80727721.filter(c,e,tp)
	return c:IsLevelBelow(4) and c:IsSetCard(0x22) and c:GetCode()~=c80727721 and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
