...
function c78156759.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc78156759(c78156759,1))
...
function c78156759.reptg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if Duel.SelectEffectYesNo(tp,c,96) then
		...
		c:RegisterFlagEffect(c78156759,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
		return true
	else return false end
end
function c78156759.descon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c78156759)~=0
end
