...
function c33970665.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	Duel.Hint(HINT_SELECTMSG,tp,aux.Stringc33970665(c33970665,2))
...
function c33970665.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if s1 and s2 then op=Duel.SelectOption(tp,aux.Stringc33970665(c33970665,0),aux.Stringc33970665(c33970665,1))
	elseif s1 then op=Duel.SelectOption(tp,aux.Stringc33970665(c33970665,0))
	elseif s2 then op=Duel.SelectOption(tp,aux.Stringc33970665(c33970665,1))+1
	else op=2 end
