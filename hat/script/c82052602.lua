...
function c82052602.filter(c,c82052602,e,tp)
	return c:IsReason(REASON_BATTLE) and c:GetTurnID()==c82052602 and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP_DEFENSE)
end
function c82052602.condition(e,tp,eg,ep,ev,re,r,rp)
	return s[tp] and Duel.GetFlagEffect(tp,c82052602)==0
end
function c82052602.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.RegisterFlagEffect(tp,c82052602,RESET_PHASE+PHASE_END,0,1)
end
