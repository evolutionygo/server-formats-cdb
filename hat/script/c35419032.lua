...
function c35419032.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc35419032(c35419032,0))
...
function c35419032.target1(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if Duel.IsExistingMatchingCard(c35419032.cfilter,tp,LOCATION_HAND+LOCATION_MZONE,0,1,nil)
		...
		and Duel.SelectYesNo(tp,aux.Stringc35419032(c35419032,1)) then
		...
		e:GetHandler():RegisterFlagEffect(c35419032,RESET_PHASE+PHASE_END,0,1)
	else
		e:SetCategory(0)
		e:SetLabel(0)
	end
...
function c35419032.target2(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():GetFlagEffect(c35419032)==0
