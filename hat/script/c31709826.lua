...
function c31709826.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc31709826(c31709826,0))
...
function c31709826.spop(e,tp,eg,ep,ev,re,r,rp)
	e:GetHandler():RegisterFlagEffect(c31709826,RESET_EVENT+RESETS_STANDARD,0,0)
end
function c31709826.spcon2(e,tp,eg,ep,ev,re,r,rp)
	return tp==Duel.GetTurnPlayer() and e:GetHandler():GetFlagEffect(c31709826)>0
end
function c31709826.spop2(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	c:ResetFlagEffect(c31709826)
