...
function c39987164.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc39987164(c39987164,0))
	...
	e2:SetDescription(aux.Stringc39987164(c39987164,1))
...
function c39987164.equipop(c,e,tp,tc)
	c:EquipByEffectAndLimitRegister(e,tp,tc,c39987164)
end
...
function c39987164.desfilter(c,att)
	return c:GetFlagEffect(c39987164)>0 and c:IsAttribute(att)
end
...
function c39987164.desop(e,tp,eg,ep,ev,re,r,rp)
	...
	if #eqg==0 or not eqg:IsExists(c39987164.desfilter,1,nil,dt:GetAttribute()) then return end
