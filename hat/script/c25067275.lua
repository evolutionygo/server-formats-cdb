...
function c25067275.initial_effect(c)
	...
	e1:SetCountLimit(1,c25067275,EFFECT_COUNT_CODE_OATH)
...
function c25067275.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	aux.RegisterClientHint(e:GetHandler(),nil,tp,1,0,aux.Stringc25067275(c25067275,2),nil)
end
...
function c25067275.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	Duel.Hint(HINT_SELECTMSG,tp,aux.Stringc25067275(c25067275,0))
	local g=Duel.SelectTarget(tp,c25067275.ecfilter,tp,LOCATION_GRAVE,0,1,1,nil)
	local ec=g:GetFirst()
	e:SetLabelObject(ec)
	Duel.Hint(HINT_SELECTMSG,tp,aux.Stringc25067275(c25067275,1))
