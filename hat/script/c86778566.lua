...
function c86778566.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if Duel.IsExistingTarget(nil,tp,LOCATION_MZONE,LOCATION_MZONE,1,nil) then
		opt=Duel.SelectOption(tp,aux.Stringc86778566(c86778566,0),aux.Stringc86778566(c86778566,1))
	else opt=Duel.SelectOption(tp,aux.Stringc86778566(c86778566,1))+1 end
	e:SetLabel(opt)
	if opt==0 then
