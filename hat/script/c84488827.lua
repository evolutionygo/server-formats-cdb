...
function c84488827.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc84488827(c84488827,0))
...
c84488827.listed_series={0x100a}
c84488827.listed_names={62729173}
...
function c84488827.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.Hint(HINT_SELECTMSG,tp,aux.Stringc84488827(c84488827,0))
	if #g1>0 and #g2>0 then
		op=Duel.SelectOption(tp,aux.Stringc84488827(c84488827,1),aux.Stringc84488827(c84488827,2))+1
	elseif #g1>0 then
		op=Duel.SelectOption(tp,aux.Stringc84488827(c84488827,1))+1
	elseif #g2>0 then
		op=Duel.SelectOption(tp,aux.Stringc84488827(c84488827,2))+2
	end
	if op==1 then
