...
function c26885836.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc26885836(c26885836,0))
...
function c26885836.eqfilter(c)
	return c:GetFlagEffect(c26885836)~=0 
end
function c26885836.eqcon(e,tp,eg,ep,ev,re,r,rp)
	local tc=e:GetHandler():GetBattleTarget()
	return aux.bdogcon(e,tp,eg,ep,ev,re,r,rp) and not tc:IsForbc26885836den() 
...
function c26885836.equipop(c,e,tp,tc)
	...
	if not c:EquipByEffectAndLimitRegister(e,tp,tc,c26885836) then return end
	if atk>0 then
