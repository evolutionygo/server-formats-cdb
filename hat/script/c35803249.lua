...
function c35803249.initial_effect(c)
	...
	e7:SetDescription(aux.Stringc35803249(c35803249,0))
	...
	c:RegisterEffect(e7)
	aux.DoubleSnareValc35803249ity(c,LOCATION_MZONE)
end
...
function c35803249.spcon(e,c)
	...
	local rg=Duel.GetMatchingGroup(c35803249.spfilter,tp,LOCATION_MZONE,0,nil)
	return #rg>0 and aux.SelectUnselectGroup(rg,e,tp,1,1,aux.ChkfMMZ(1),0)
end
function c35803249.sptg(e,tp,eg,ep,ev,re,r,rp,c)
