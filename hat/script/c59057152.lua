...
function c59057152.initial_effect(c)
	...
	e5:SetDescription(aux.Stringc59057152(c59057152,0))
...
c59057152.listed_series={0x107a,0x207a}
...
function c59057152.spfilter(c,e,tp)
	return c:IsSetCard(0x107a) and c:GetCode()~=c59057152 and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP_DEFENSE)
end
