...
function c58165765.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc58165765(c58165765,0))
	e1:SetCategory(CATEGORY_TODECK)
	e1:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e1:SetProperty(EFFECT_FLAG_CARD_TARGET+EFFECT_FLAG_DAMAGE_STEP)
	e1:SetCode(EVENT_SUMMON_SUCCESS)
	e1:SetCountLimit(1,c58165765)
...
c58165765.listed_series={0x2b,0x61}
...
function c58165765.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc and tc:IsRelateToEffect(e) and tc:IsFacedown() then
		...
		if tc:IsAbleToDeck() then
			local opt=Duel.SelectOption(tp,aux.Stringc58165765(c58165765,1),aux.Stringc58165765(c58165765,2))
			if opt==0 then
