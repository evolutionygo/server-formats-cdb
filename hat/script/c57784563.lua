...
function c57784563.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc57784563(c57784563,0))
...
function c57784563.eqcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return ec==nil or ec:GetFlagEffect(c57784563)==0
end
...
function c57784563.eqop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc and tc:IsFaceup() and tc:IsRelateToEffect(e) and tc:IsMonster() then
		...
		--Add Equip limit
		tc:RegisterFlagEffect(c57784563,RESET_EVENT+RESETS_STANDARD,0,0)
		e:SetLabelObject(tc)
		local e1=Effect.CreateEffect(c)
