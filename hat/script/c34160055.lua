...
function c34160055.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc34160055(c34160055,0))
...
c34160055.listed_names={c34160055}
function c34160055.target(e,tp,eg,ep,ev,re,r,rp,chk)
	local tc=eg:GetFirst()
	if chk==0 then return tc:IsControler(tp) and not tc:IsCode(c34160055) end
