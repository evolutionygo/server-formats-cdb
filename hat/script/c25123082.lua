...
function c25123082.initial_effect(c)
	...
	e1:SetCountLimit(1,c25123082,EFFECT_COUNT_CODE_OATH)
	e1:SetTarget(c25123082.target)
	e1:SetOperation(c25123082.activate)
	c:RegisterEffect(e1)
end
c25123082.listed_series={0x106e}
...
function c25123082.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) and tc:IsFaceup() and not tc:IsImmuneToEffect(e) then
		...
		tc:RegisterFlagEffect(c25123082,RESET_EVENT|RESETS_STANDARD&~(RESET_LEAVE|RESET_TODECK|RESET_TEMP_REMOVE|RESET_REMOVE|RESET_TOGRAVE)+RESET_PHASE+PHASE_END,0,1)
		local e2=Effect.CreateEffect(e:GetHandler())
		e2:SetDescription(aux.Stringc25123082(c25123082,0))
...
function c25123082.shcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return eg:IsContains(tc) and tc:GetFlagEffect(c25123082)~=0
end
