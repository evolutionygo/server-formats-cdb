...
function c97997309.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc97997309(c97997309,0))
	e1:SetCategory(CATEGORY_TOHAND)
	e1:SetType(EFFECT_TYPE_ACTIVATE)
	e1:SetCode(EVENT_FREE_CHAIN)
	e1:SetHintTiming(0,TIMING_END_PHASE)
	e1:SetCountLimit(1,c97997309,EFFECT_COUNT_CODE_OATH)
	...
	e2:SetDescription(aux.Stringc97997309(c97997309,1))
	e2:SetCategory(CATEGORY_POSITION)
	e2:SetType(EFFECT_TYPE_ACTIVATE)
	e2:SetCode(EVENT_FREE_CHAIN)
	e2:SetHintTiming(0,TIMINGS_CHECK_MONSTER+TIMING_BATTLE_PHASE)
	e2:SetCountLimit(1,c97997309,EFFECT_COUNT_CODE_OATH)
	...
	e3:SetDescription(aux.Stringc97997309(c97997309,2))
	e3:SetCategory(CATEGORY_REMOVE)
	e3:SetType(EFFECT_TYPE_ACTIVATE)
	e3:SetCode(EVENT_FREE_CHAIN)
	e3:SetHintTiming(0,TIMINGS_CHECK_MONSTER_E)
	e3:SetCountLimit(1,c97997309,EFFECT_COUNT_CODE_OATH)
...
c97997309.listed_series={0x106e}
