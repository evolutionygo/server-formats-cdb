...
function c90957527.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCode2(c,true,true,79580323,aux.FilterBoolFunctionEx(Card.IsSetCard,0x19))
	Fusion.AddContactProc(c,c90957527.contactfil,c90957527.contactop,c90957527.splimit)
	--damage
	local e3=Effect.CreateEffect(c)
	e3:SetDescription(aux.Stringc90957527(c90957527,0))
	...
	e4:SetDescription(aux.Stringc90957527(c90957527,1))
