...
function c41753322.initial_effect(c)
	...
	e4:SetDescription(aux.Stringc41753322(c41753322,1))
...
function c41753322.ottg(e,tp,eg,ep,ev,re,r,rp,c)
...
function c41753322.postg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return c:IsCanTurnSet() and c:GetFlagEffect(c41753322)==0 end
	c:RegisterFlagEffect(c41753322,RESET_EVENT+RESETS_STANDARD-RESET_TURN_SET+RESET_PHASE+PHASE_END,0,1)
