...
function c15941690.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc15941690(c15941690,0))
...
c15941690.listed_series={0x70}
c15941690.listed_names={c15941690}
...
function c15941690.filter(c,e,tp)
	return c:IsSetCard(0x70) and not c:IsCode(c15941690) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
