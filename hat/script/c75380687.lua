...
function c75380687.initial_effect(c)
	--Fusion Procedure
	c:EnableReviveLimit()
	aux.AddFusionProcCode2(c,false,false,CARD_DARK_MAGICIAN,aux.FilterBoolFunctionEx(Card.IsRace,RACE_DRAGON))
	...
	e2:SetDescription(aux.Stringc75380687(c75380687,0))
	...
	e3:SetDescription(aux.Stringc75380687(c75380687,1))
...
c75380687.listed_names={CARD_DARK_MAGICIAN,1784686}
