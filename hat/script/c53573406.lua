...
function c53573406.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc53573406(c53573406,0))
	...
	c:RegisterEffect(e2)
	Duel.AddCustomActivityCounter(c53573406,ACTIVITY_SPSUMMON,c53573406.counterfilter)
end
...
function c53573406.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetCustomActivityCount(c53573406,tp,ACTIVITY_SPSUMMON)==0 end
	local fc53573406=e:GetHandler():GetFieldID()
	e:SetLabel(fc53573406)
	...
	e1:SetLabel(fc53573406)
	e1:SetTarget(c53573406.sumlimit)
	Duel.RegisterEffect(e1,tp)
	aux.RegisterClientHint(e:GetHandler(),nil,tp,1,0,aux.Stringc53573406(c53573406,1),nil)
	--lizard check
