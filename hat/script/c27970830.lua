...
function c27970830.initial_effect(c)
	...
	e4:SetDescription(aux.Stringc27970830(c27970830,0))
	...
	e5:SetDescription(aux.Stringc27970830(c27970830,1))
	...
	e6:SetDescription(aux.Stringc27970830(c27970830,2))
...
c27970830.listed_series={0x3d,0x20}
c27970830.counter_place_list={0x3}
