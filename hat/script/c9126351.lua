...
function c9126351.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc9126351(c9126351,1))
	...
	e5:SetDescription(aux.Stringc9126351(c9126351,1))
...
function c9126351.spcon(e,c)
	...
	local g=Duel.GetMatchingGroup(c9126351.spfilter,tp,LOCATION_HAND,0,e:GetHandler())
...
function c9126351.excost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetFlagEffect(tp,c9126351)==0 and Duel.IsExistingMatchingCard(Card.IsAbleToHandAsCost,tp,LOCATION_MZONE,0,1,nil) end
...
function c9126351.exop(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetType(EFFECT_TYPE_FIELD)
	e1:SetDescription(aux.Stringc9126351(c9126351,2))
	e1:SetTargetRange(LOCATION_HAND+LOCATION_MZONE,0)
	e1:SetCode(EFFECT_EXTRA_SUMMON_COUNT)
	e1:SetTarget(c9126351.estg)
	e1:SetReset(RESET_PHASE+PHASE_END)
	Duel.RegisterEffect(e1,tp)
	Duel.RegisterFlagEffect(tp,c9126351,RESET_PHASE+PHASE_END,0,1)
end
function c9126351.estg(e,c)
	return c:IsSetCard(0x12) and c:GetCode()~=c9126351
end