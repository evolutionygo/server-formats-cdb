...
function c78933589.initial_effect(c)
	c:SetUniqueOnField(1,0,c78933589)
	--activate
	...
	e1:SetDescription(aux.Stringc78933589(c78933589,0))
...
c78933589.listed_series={0x604e}
...
function c78933589.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,c78933589.filter,tp,LOCATION_HAND,0,1,2,nil)
	if #g>0 then
