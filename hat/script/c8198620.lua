...
local TOKEN_DARK_SOUL=c8198620+1
function c8198620.initial_effect(c)
	c:EnableReviveLimit()
	--Fusion Materials: 2 Zombie monsters
	aux.AddFusionProcCode2N(c,true,true,aux.FilterBoolFunctionEx(Card.IsRace,RACE_ZOMBIE),2)
	c:AddMustFirstBeFusionSummoned()
	--You can only control 1 "Dragonecro Nethersoul Dragon"
	c:SetUniqueOnField(1,0,c8198620)
	...
	e2:SetDescription(aux.Stringc8198620(c8198620,0))
	e2:SetCategory(CATEGORY_ATKCHANGE+CATEGORY_SPECIAL_SUMMON+CATEGORY_TOKEN)
	e2:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_F)
	e2:SetCode(EVENT_DAMAGE_STEP_END)
	e2:SetTarget(c8198620.atktg)
	e2:SetOperation(c8198620.atkop)
	c:RegisterEffect(e2)
end
c8198620.listed_names={c8198620,TOKEN_DARK_SOUL}
function c8198620.atktg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c8198620.atkop(e,tp,eg,ep,ev,re,r,rp)
