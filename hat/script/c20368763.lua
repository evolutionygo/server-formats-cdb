...
function c20368763.initial_effect(c)
	...
	e4:SetDescription(aux.Stringc20368763(c20368763,0))
	...
	e5:SetDescription(aux.Stringc20368763(c20368763,1))
...
c20368763.listed_series={SET_MECHA_PHANTOM_BEAST}
c20368763.listed_names={TOKEN_MECHA_PHANTOM_BEAST}
...
function c20368763.tknfilter(c)
	return c:IsType(TYPE_TOKEN) or c:IsOriginalType(TYPE_TOKEN)
end
function c20368763.indcon(e)
	return Duel.IsExistingMatchingCard(c20368763.tknfilter,e:GetHandlerPlayer(),LOCATION_ONFIELD,0,1,nil)
end
...
function c20368763.spcon(e,tp,eg,ep,ev,re,r,rp)
	return re and re:GetHandler()~=e:GetHandler() and re:IsActivated() and eg:IsExists(c20368763.cfilter,1,nil,tp)
end
...
function c20368763.spcost2(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckReleaseGroupCost(tp,c20368763.spcfilter,1,false,nil,nil,tp) end
	local g=Duel.SelectReleaseGroupCost(tp,c20368763.spcfilter,1,1,false,nil,nil,tp)
