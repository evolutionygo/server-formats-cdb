...
function c60992364.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc60992364(c60992364,0))
	...
	e3:SetDescription(aux.Stringc60992364(c60992364,1))
	...
	c:RegisterEffect(e3)
	aux.AddZWEquipLimit(c,nil,function(tc,c,tp) return c60992364.filter(tc) and tc:IsControler(tp) end,c60992364.equipop,e3)
	--Send this equip card to GY, the monster it was equipped to can make a second attack on monsters
	local e4=Effect.CreateEffect(c)
	e4:SetDescription(aux.Stringc60992364(c60992364,2))
...
c60992364.listed_series={0x107e,0x107f}
...
function c60992364.eqop(e,tp,eg,ep,ev,re,r,rp)
	...
	c60992364.equipop(c,e,tp,tc)
end
function c60992364.equipop(c,e,tp,tc)
