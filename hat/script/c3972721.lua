...
function c3972721.checkop(e,tp,eg,ep,ev,re,r,rp)
	...
	if p1 then Duel.RegisterFlagEffect(0,c3972721,RESET_PHASE+PHASE_END,0,1) end
	if p2 then Duel.RegisterFlagEffect(1,c3972721,RESET_PHASE+PHASE_END,0,1) end
end
function c3972721.condition(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetFlagEffect(tp,c3972721)~=0
end
