...
function c67922702.initial_effect(c)
	...
	e4:SetDescription(aux.Stringc67922702(c67922702,0))
	...
	e5:SetDescription(aux.Stringc67922702(c67922702,1))
...
c67922702.listed_names={TOKEN_MECHA_PHANTOM_BEAST}
...
function c67922702.tknfilter(c)
	return c:IsType(TYPE_TOKEN) or c:IsOriginalType(TYPE_TOKEN)
end
function c67922702.indcon(e)
	return Duel.IsExistingMatchingCard(c67922702.tknfilter,e:GetHandlerPlayer(),LOCATION_ONFIELD,0,1,nil)
end
...
function c67922702.atkcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return not e:GetHandler():HasFlagEffect(c67922702)
	...
	e:GetHandler():RegisterFlagEffect(c67922702,RESET_PHASE|PHASE_DAMAGE_CAL,0,1)
end
