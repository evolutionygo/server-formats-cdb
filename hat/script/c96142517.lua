...
c96142517.listed_series={0x1048,0x1073}
function c96142517.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	e2:SetDescription(aux.Stringc96142517(c96142517,2))
...
function c96142517.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	g:Sub(g1)
	if #g>0 and Duel.SelectYesNo(tp,aux.Stringc96142517(c96142517,1)) then
		Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TARGET)
