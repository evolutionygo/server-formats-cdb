...
function c75347539.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc75347539(c75347539,0))
...
c75347539.listed_names={99785935,39256679,11549357}
...
function c75347539.sptg(e,tp,eg,ep,ev,re,r,rp,c)
	local rg=Duel.GetReleaseGroup(tp,true):Filter(Card.IsCode,nil,99785935,39256679,11549357)
	local g=aux.SelectUnselectGroup(rg,e,tp,3,3,c75347539.rescon,1,tp,HINTMSG_RELEASE,nil,nil,true)
	if #g>0 then
		g:KeepAlive()
		e:SetLabelObject(g)
		return true
