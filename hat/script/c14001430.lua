...
function c14001430.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc14001430(c14001430,0))
	...
	e4:SetDescription(aux.Stringc14001430(c14001430,0))
...
function c14001430.reptg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if Duel.SelectYesNo(tp,aux.Stringc14001430(c14001430,0)) then
		...
		for tc in g:Iter() do
			...
			tc:RegisterFlagEffect(c14001430,RESET_EVENT|RESETS_STANDARD&~RESET_TOHAND+RESET_PHASE+PHASE_END,0,1)
		end
		local e1=Effect.CreateEffect(c)
...
function c14001430.thfilter(c)
	return c:GetFlagEffect(c14001430)~=0
end
