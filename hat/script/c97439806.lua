...
function c97439806.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc97439806(c97439806,0))
...
c97439806.listed_series={0x35}
function c97439806.costfilter(c)
	return c:IsSetCard(0x35) and c:IsMonster() and c:GetCode()~=c97439806 and c:IsDiscardable()
end
