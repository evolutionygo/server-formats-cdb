...
function c76080032.initial_effect(c)
	c:SetUniqueOnField(1,0,c76080032)
	--equip
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc76080032(c76080032,0))
	...
	c:RegisterEffect(e1)
	aux.AddZWEquipLimit(c,c76080032.eqcon,function(tc,c,tp) return c76080032.filter(tc) and tc:IsControler(tp) end,c76080032.equipop,e1)
	--disable
...
function c76080032.eqop(e,tp,eg,ep,ev,re,r,rp)
	...
	c76080032.equipop(c,e,tp,tc)
end
function c76080032.equipop(c,e,tp,tc)
