...
function c1372887.initial_effect(c)
	...
	e1:SetCountLimit(1,c1372887,EFFECT_COUNT_CODE_OATH)
...
function c1372887.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	aux.RegisterClientHint(e:GetHandler(),nil,tp,1,0,aux.Stringc1372887(c1372887,1),nil)
end
...
function c1372887.drop1(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_CARD,0,c1372887)
	Duel.Draw(tp,1,REASON_EFFECT)
end
function c1372887.regcon(e,tp,eg,ep,ev,re,r,rp)
	return eg:IsExists(c1372887.cfilter,1,nil,tp) and Duel.GetFlagEffect(tp,c1372887)==0 
		and re:IsHasType(EFFECT_TYPE_ACTIONS) and not re:IsHasType(EFFECT_TYPE_CONTINUOUS)
end
function c1372887.regop(e,tp,eg,ep,ev,re,r,rp)
	Duel.RegisterFlagEffect(tp,c1372887,RESET_CHAIN,0,1)
end
function c1372887.drcon2(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetFlagEffect(tp,c1372887)>0
end
function c1372887.drop2(e,tp,eg,ep,ev,re,r,rp)
	Duel.ResetFlagEffect(tp,c1372887)
	Duel.Hint(HINT_CARD,0,c1372887)
	Duel.Draw(tp,1,REASON_EFFECT)
end