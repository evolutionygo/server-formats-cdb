...
function c78266168.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc78266168(c78266168,0))
	...
	e2:SetDescription(aux.Stringc78266168(c78266168,1))
...
function c78266168.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return c:IsCanTurnSet() and c:GetFlagEffect(c78266168)==0 end
	c:RegisterFlagEffect(c78266168,RESET_EVENT+RESETS_STANDARD-RESET_TURN_SET+RESET_PHASE+PHASE_END,0,1)
