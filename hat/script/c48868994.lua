...
function c48868994.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc48868994(c48868994,0))
	...
	e2:SetDescription(aux.Stringc48868994(c48868994,1))
...
function c48868994.cond(e,tp,eg,ep,ev,re,r,rp)
	return not e:GetHandler():IsDisabled() and e:GetHandler():IsDefensePos()
		and not e:GetHandler():IsHasEffect(c48868994)
end
