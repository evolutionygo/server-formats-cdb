...
function c88686573.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc88686573(c88686573,0))
...
c88686573.listed_series={0x78}
function c88686573.condition(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsPreviousLocation(LOCATION_HAND+LOCATION_DECK)
end
function c88686573.filter(c,e,tp)
	return c:IsSetCard(0x78) and c:GetCode()~=c88686573 and c:IsLevelBelow(3) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
