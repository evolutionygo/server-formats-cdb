...
function c4423206.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc4423206(c4423206,0))
...
function c4423206.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc and Duel.SpecialSummon(tc,0,tp,tp,false,false,POS_FACEUP_DEFENSE)~=0 then
		local fc4423206=e:GetHandler():GetFieldID()
		tc:RegisterFlagEffect(c4423206,RESET_EVENT+RESETS_STANDARD,0,1,fc4423206)
		local e1=Effect.CreateEffect(e:GetHandler())
		e1:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_CONTINUOUS)
		e1:SetCode(EVENT_PHASE+PHASE_END)
		e1:SetCountLimit(1)
		e1:SetProperty(EFFECT_FLAG_IGNORE_IMMUNE)
		e1:SetLabel(fc4423206)
...
function c4423206.descon(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:GetFlagEffectLabel(c4423206)~=e:GetLabel() then
		e:Reset()
		return false
