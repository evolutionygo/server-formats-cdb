...
c96287685.listed_names={83968380}
function c96287685.regop(e,tp,eg,ep,ev,re,r,rp)
	if re:GetHandler():IsCode(83968380) then
		e:GetHandler():RegisterFlagEffect(c96287685,RESET_EVENT+RESETS_STANDARD+RESET_CHAIN,0,1)
	end
end
function c96287685.drawop(e,tp,eg,ep,ev,re,r,rp)
	if e:GetHandler():GetFlagEffect(c96287685)~=0 and re:GetHandler():IsCode(83968380) then
