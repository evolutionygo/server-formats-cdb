...
function c27762803.con(e)
	return e:GetHandler():GetFlagEffect(c27762803)~=0
end
function c27762803.adop(e,tp,eg,ep,ev,re,r,rp)
	if re:IsHasType(EFFECT_TYPE_ACTIVATE) and re:IsActiveType(TYPE_SPELL) then
		if e:GetHandler():GetFlagEffect(c27762803)==0 then
			e:GetHandler():RegisterFlagEffect(c27762803,RESET_EVENT+RESETS_STANDARD_DISABLE,0,0)
		else
			e:GetHandler():ResetFlagEffect(c27762803)
		end
	end
end