...
function c33972299.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc33972299(c33972299,0))
...
c33972299.material={68505803}
c33972299.listed_names={68505803}
c33972299.listed_series={0x2}
function c33972299.valcon(e)
	return e:GetHandler():GetFlagEffect(c33972299)~=0
...
function c33972299.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsFaceup() and c:IsRelateToEffect(e) then
		c:RegisterFlagEffect(c33972299,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
	end
end