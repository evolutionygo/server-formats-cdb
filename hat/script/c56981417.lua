...
function c56981417.initial_effect(c)
	...
	e1:SetCountLimit(1,c56981417,EFFECT_COUNT_CODE_OATH)
...
c56981417.listed_names={c56981417}
c56981417.listed_series={0x106e}
...
function c56981417.filter(c)
	return c:IsSetCard(0x106e) and not c:IsCode(c56981417) and c:GetType()==TYPE_SPELL and c:CheckActivateEffect(true,true,false)~=nil
end
