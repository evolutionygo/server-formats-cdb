...
function c25484449.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc25484449(c25484449,0))
	...
	e3:SetDescription(aux.Stringc25484449(c25484449,1))
...
function c25484449.lvtg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local op=Duel.SelectOption(tp,aux.Stringc25484449(c25484449,2),aux.Stringc25484449(c25484449,3))
	e:SetLabel(op)
end
