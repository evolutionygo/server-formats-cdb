...
function c26211048.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc26211048(c26211048,0))
...
function c26211048.eqfilter(c)
	return c:IsLocation(LOCATION_MZONE) or c:IsMonster() and not c:IsForbc26211048den()
end
...
function c26211048.eqop(e,tp,eg,ep,ev,re,r,rp)
	...
	if not c26211048.equipop(c,e,tp,tc) then return end
end