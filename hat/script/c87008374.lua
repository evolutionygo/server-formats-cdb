...
function c87008374.initial_effect(c)
	c:SetUniqueOnField(1,0,c87008374)
	--equip
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc87008374(c87008374,0))
	...
	c:RegisterEffect(e1)
	aux.AddZWEquipLimit(c,c87008374.eqcon,function(tc,c,tp) return c87008374.filter(tc) and tc:IsControler(tp) end,c87008374.equipop,e1)
	--damage
	local e3=Effect.CreateEffect(c)
	e3:SetDescription(aux.Stringc87008374(c87008374,1))
...
function c87008374.eqop(e,tp,eg,ep,ev,re,r,rp)
	...
	c87008374.equipop(c,e,tp,tc)
end
function c87008374.equipop(c,e,tp,tc)
