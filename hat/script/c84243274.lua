...
function c84243274.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCode2(c,true,true,58859575,91998119)
	Fusion.AddContactProc(c,c84243274.contactfil,c84243274.contactop,c84243274.splimit)
	--remove
	local e3=Effect.CreateEffect(c)
	e3:SetDescription(aux.Stringc84243274(c84243274,0))
	...
	e4:SetDescription(aux.Stringc84243274(c84243274,1))
