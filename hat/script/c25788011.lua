...
function c25788011.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc25788011(c25788011,0))
...
function c25788011.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsFaceup() and tc:IsRelateToEffect(e) then
		local lv=Duel.SelectOption(tp,aux.Stringc25788011(c25788011,1),aux.Stringc25788011(c25788011,2),aux.Stringc25788011(c25788011,3))
		local e1=Effect.CreateEffect(c)
