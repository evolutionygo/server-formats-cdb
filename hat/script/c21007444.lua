...
function c21007444.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if #sg>0 then
		...
		local fc21007444=e:GetHandler():GetFieldID()
		for tc in aux.Next(sg) do
			if Duel.SpecialSummonStep(tc,0,tp,tp,false,false,POS_FACEUP_ATTACK) then
				tc:RegisterFlagEffect(c21007444,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1,fc21007444)
			end
		end
		...
		e1:SetLabel(fc21007444)
		e1:SetLabelObject(sg)
		Duel.RegisterEffect(e1,tp)
	end
end
function c21007444.desfilter(c,fc21007444)
	return c:GetFlagEffectLabel(c21007444)==fc21007444
end
