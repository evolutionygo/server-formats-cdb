...
function c77565204.tgtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
...
function c77565204.tgop(e,tp,eg,ep,ev,re,r,rp)
	...
	if #sg>0 then
		...
		for mc in aux.Next(mat) do
			mc:RegisterFlagEffect(c77565204,RESET_EVENT+RESETS_STANDARD,0,1)
		end
		e:SetLabel(code)
...
function c77565204.procop(e,tp,eg,ep,ev,re,r,rp)
	...
	for mc in aux.Next(mat) do
		if mc:GetFlagEffect(c77565204)>0 then
