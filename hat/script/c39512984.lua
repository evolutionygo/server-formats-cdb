...
function c39512984.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCode2N(c,true,true,aux.FilterBoolFunctionEx(Card.IsSetCard,0x1047),3)
	--spsummon condition
	...
	e3:SetDescription(aux.Stringc39512984(c39512984,0))
...
c39512984.listed_series={0x47,0x1047}
