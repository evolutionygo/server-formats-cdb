...
function c63227401.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc63227401(c63227401,0))
...
function c63227401.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) then
		tc:RegisterFlagEffect(c63227401,RESET_EVENT+RESETS_STANDARD-RESET_TURN_SET+RESET_PHASE+PHASE_END,0,1)
		tc:RegisterFlagEffect(0,RESET_EVENT+RESETS_STANDARD-RESET_TURN_SET+RESET_PHASE+PHASE_END,EFFECT_FLAG_CLIENT_HINT,1,0,aux.Stringc63227401(c63227401,1))
		local e1=Effect.CreateEffect(c)
...
function c63227401.discon(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:GetFlagEffect(c63227401)==0 or not re:IsHasProperty(EFFECT_FLAG_CARD_TARGET) then return false end
