...
function c95291684.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc95291684(c95291684,0))
	...
	e3:SetOperation(c95291684.spcostop)
	c:RegisterEffect(e3)
end
...
function c95291684.spcostop(e,tp,eg,ep,ev,re,r,rp)
	--Cannot Normal Summon/Set
	local e1=Effect.CreateEffect(e:GetHandler())
	e1:SetDescription(aux.Stringc95291684(c95291684,1))
	e1:SetType(EFFECT_TYPE_FIELD)
