...
function c33981008.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc33981008(c33981008,0))
	...
	e3:SetDescription(aux.Stringc33981008(c33981008,1))
...
c33981008.listed_series={0x106e}
...
function c33981008.filter(c)
	return c:IsSetCard(0x106e) and c:GetCode()~=c33981008 and c:IsSpell() and c:IsAbleToDeck()
end
