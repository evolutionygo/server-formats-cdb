...
function c34086406.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc34086406(c34086406,0))
	e1:SetType(EFFECT_TYPE_IGNITION)
	e1:SetRange(LOCATION_MZONE)
	e1:SetCountLimit(1)
	e1:SetCost(aux.dxmcostgen(1,1,nil))
	e1:SetTarget(c34086406.efftg)
	e1:SetOperation(c34086406.effop)
	c:RegisterEffect(e1,false,REGISTER_FLAG_DETACH_XMAT)
end
function c34086406.efftg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local op=Duel.SelectEffect(tp,
		{b1,aux.Stringc34086406(c34086406,1)},
		{b2,aux.Stringc34086406(c34086406,2)})
	e:SetLabel(op)
	if op==1 then
...
function c34086406.effop(e,tp,eg,ep,ev,re,r,rp)
	local op=e:GetLabel()
	if op==1 then
	...
	elseif op==2 then
		...
		Duel.Hint(HINT_SELECTMSG,tp,aux.Stringc34086406(c34086406,3))
