...
function c59019082.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc59019082(c59019082,0))
...
c59019082.listed_series={0x38}
c59019082.listed_names={c59019082}
...
function c59019082.condtion(e,tp,eg,ep,ev,re,r,rp)
	...
	return rp==tp and (r&REASON_EFFECT)~=0 and not rc:IsCode(c59019082) and rc:IsSetCard(0x38) and rc:IsMonster()
