...
function c45869829.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc45869829(c45869829,0))
...
function c45869829.filter(c)
	return c:IsType(TYPE_QUICKPLAY) and c:GetCode()~=c45869829 and c:IsAbleToDeck()
end
...
function c45869829.thfilter(c)
	return c:IsType(TYPE_QUICKPLAY) and c:GetCode()~=c45869829 and c:IsAbleToHand()
end
