...
function c77799846.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc77799846(c77799846,0))
	...
	e2:SetDescription(aux.Stringc77799846(c77799846,1))
...
function c77799846.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c77799846.rfilter,tp,LOCATION_GRAVE+LOCATION_MZONE,0,1,nil,tp) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_REMOVE)
	local g=Duel.SelectMatchingCard(tp,c77799846.rfilter,tp,LOCATION_GRAVE+LOCATION_MZONE,0,1,1,nil,tp)
...
function c77799846.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e) and Duel.SpecialSummon(c,0,tp,tp,false,false,POS_FACEUP)>0 then
		...
		if #g>0 and Duel.SelectYesNo(tp,aux.Stringc77799846(c77799846,2)) then
			Duel.BreakEffect()
