...
function c10613952.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc10613952(c10613952,0))
	...
	e2:SetDescription(aux.Stringc10613952(c10613952,1))
	...
	e3:SetDescription(aux.Stringc10613952(c10613952,2))
...
c10613952.listed_series={0x207a,0x107a}
...
function c10613952.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local g=Duel.GetMatchingGroup(c10613952.filter,tp,LOCATION_GRAVE,0,nil,e,tp,c)
	if chkc then return chkc:IsControler(tp) and chkc:IsLocation(LOCATION_GRAVE) and c10613952.filter(chkc,e,tp,c) end
