...
function c98780137.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc98780137(c98780137,0))
...
c98780137.listed_series={0x8b}
function c98780137.filter(c,e,tp)
	return c:GetCode()~=c98780137 and c:IsSetCard(0x8b) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
