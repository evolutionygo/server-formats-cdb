...
function c46925518.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc46925518(c46925518,0))
	...
	e3:SetOperation(c46925518.fdtg)
	e3:SetOperation(c46925518.fdop)
	c:RegisterEffect(e3)
end
c46925518.listed_series={0x8d}
...
function c46925518.postg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return c:IsCanTurnSet() and c:GetFlagEffect(c46925518)==0 end
	c:RegisterFlagEffect(c46925518,RESET_EVENT+RESETS_STANDARD-RESET_TURN_SET+RESET_PHASE+PHASE_END,0,1)
...
function c46925518.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if #sg>0 and Duel.SelectYesNo(tp,aux.Stringc46925518(c46925518,1)) then
		Duel.BreakEffect()
