...
function c81330115.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc81330115(c81330115,0))
...
function c81330115.rmop(e,tp,eg,ep,ev,re,r,rp)
	if e:GetHandler():CheckRemoveOverlayCard(tp,1,REASON_EFFECT) and Duel.SelectYesNo(tp,aux.Stringc81330115(c81330115,1)) then
