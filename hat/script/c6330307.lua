...
function c6330307.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc6330307(c6330307,0))
	...
	c:RegisterEffect(e1)
	aux.AddZWEquipLimit(c,nil,function(tc,c,tp) return c6330307.filter(tc) and tc:IsControler(tp) end,aux.EquipAndLimitRegister,e1)
	--destroy sub
	...
	e3:SetDescription(aux.Stringc6330307(c6330307,1))
