...
function c93717133.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc93717133(c93717133,0))
...
function c93717133.sptg(e,tp,eg,ep,ev,re,r,rp,c)
...
function c93717133.rmop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.Remove(g,0,REASON_EFFECT+REASON_TEMPORARY)~=0 then
		...
		for oc in aux.Next(og) do
			oc:RegisterFlagEffect(c93717133,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
		end
		og:KeepAlive()
		local e1=Effect.CreateEffect(c)
...
function c93717133.retfilter(c)
	return c:GetFlagEffect(c93717133)~=0
end
