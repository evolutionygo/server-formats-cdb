...
function c13492423.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc13492423(c13492423,0))
...
c13492423.listed_names={c13492423}
function c13492423.filter(c,e,tp)
	return c:IsCode(c13492423) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
