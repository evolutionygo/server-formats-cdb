...
function c57836546.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local fc57836546=e:GetHandler():GetFieldID()
	local tc=g:GetFirst()
	for tc in aux.Next(g) do
		if Duel.SpecialSummonStep(tc,0,tp,tp,false,false,POS_FACEUP) then
			tc:RegisterFlagEffect(c57836546,RESET_EVENT+RESETS_STANDARD,0,1,fc57836546)
		end
	end
	...
	e1:SetLabel(fc57836546)
	e1:SetLabelObject(g)
	Duel.RegisterEffect(e1,tp)
end
function c57836546.desfilter(c,fc57836546)
	return c:GetFlagEffectLabel(c57836546)==fc57836546
end
