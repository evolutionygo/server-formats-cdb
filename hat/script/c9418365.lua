...
function c9418365.initial_effect(c)
	c:SetUniqueOnField(1,0,c9418365)
	c:EnableReviveLimit()
	--special summon
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc9418365(c9418365,0))
	...
	e2:SetDescription(aux.Stringc9418365(c9418365,1))
...
function c9418365.spfilter(c,tp)
	return c:IsSetCard(0x88) and c:IsMonster() and not c:IsCode(c9418365) and c:IsAbleToRemoveAsCost() and aux.SpElimFilter(c,true) 
		and (Duel.GetLocationCount(tp,LOCATION_MZONE)>0 or (c:IsLocation(LOCATION_MZONE) and c:GetSequence()<5))
end
function c9418365.spcon(e,c)
	if c==nil then return true end
	local tp=c:GetControler()
	local g=Duel.GetMatchingGroup(c9418365.spfilter,tp,LOCATION_GRAVE+LOCATION_MZONE,0,nil,tp)
