...
function c32679370.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc32679370(c32679370,0))
...
c32679370.listed_names={c32679370}
function c32679370.filter(c,e,tp)
	return c:IsCode(c32679370) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
