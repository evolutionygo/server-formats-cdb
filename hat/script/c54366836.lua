...
function c54366836.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc54366836(c54366836,0))
	...
	e3:SetDescription(aux.Stringc54366836(c54366836,1))
...
function c54366836.damcost2(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	if chk==0 then return c:GetFlagEffect(c54366836)==0 and c:CheckRemoveOverlayCard(tp,1,REASON_COST) end
	c:RemoveOverlayCard(tp,1,1,REASON_COST)
	c:RegisterFlagEffect(c54366836,RESET_CHAIN,0,1)
end
