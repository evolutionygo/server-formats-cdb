...
function c6387204.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc6387204(c6387204,0))
	...
	e2:SetDescription(aux.Stringc6387204(c6387204,1))
...
c6387204.listed_series={0x48}
c6387204.aux.xyz_number=6
...
function c6387204.equipop(c,e,tp,tc)
	if not c:EquipByEffectAndLimitRegister(e,tp,tc,c6387204) then return end
	local e2=Effect.CreateEffect(c)
...
function c6387204.filter(c)
	return c:GetFlagEffect(c6387204)~=0 and c:IsSetCard(0x48) and c:IsFaceup() and c:IsAbleToGraveAsCost()
end
