...
function c43332022.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc43332022(c43332022,0))
...
function c43332022.desop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.IsExistingMatchingCard(Card.IsDiscardable,1-tp,LOCATION_HAND,0,1,nil) and Duel.SelectYesNo(1-tp,aux.Stringc43332022(c43332022,1)) then
