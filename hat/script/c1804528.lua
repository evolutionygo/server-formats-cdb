...
function c1804528.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc1804528(c1804528,0))
...
function c1804528.desop(e,tp,eg,ep,ev,re,r,rp)
	...
	if #g1>0 and #g2>0 then
		opt=Duel.SelectOption(1-tp,aux.Stringc1804528(c1804528,1),aux.Stringc1804528(c1804528,2))
	elseif #g1>0 then
		opt=Duel.SelectOption(1-tp,aux.Stringc1804528(c1804528,1))
	elseif #g2>0 then
		opt=Duel.SelectOption(1-tp,aux.Stringc1804528(c1804528,2))+1
	else return end
	if opt==0 then
