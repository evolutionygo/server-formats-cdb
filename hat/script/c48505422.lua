...
function c48505422.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc48505422(c48505422,0))
...
function c48505422.filter(c)
	return c:IsSetCard(0x3d) and c:GetCode()~=c48505422 and c:IsMonster() and c:IsAbleToHand()
end
