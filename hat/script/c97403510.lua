...
function c97403510.initial_effect(c)
	...
	e3:SetDescription(aux.Stringc97403510(c97403510,0))
	...
	e4:SetDescription(aux.Stringc97403510(c97403510,1))
	...
	e5:SetDescription(aux.Stringc97403510(c97403510,2))
...
c97403510.aux.xyz_number=92
function c97403510.checkop(e,tp,eg,ep,ev,re,r,rp)
	local tc=eg:GetFirst()
	for tc in aux.Next(eg) do
		tc:RegisterFlagEffect(c97403510,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
	end
end
...
function c97403510.filter(c,turn)
	return (c:IsLocation(LOCATION_MZONE) or c:GetFlagEffect(c97403510)~=0) and c:GetTurnID()==turn and c:IsAbleToRemove()
end
