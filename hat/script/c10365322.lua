...
function c10365322.initial_effect(c)
	--Fusion Material
	c:EnableReviveLimit()
	aux.AddFusionProcCode2(c,true,true,aux.FilterBoolFunctionEx(Card.IsRace,RACE_MACHINE),aux.FilterBoolFunctionEx(Card.IsRace,RACE_PYRO))
	--Destroy
	local e2=Effect.CreateEffect(c)
	e2:SetDescription(aux.Stringc10365322(c10365322,0))
