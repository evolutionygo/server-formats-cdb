...
function c57690191.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc57690191(c57690191,0))
	...
	e3:SetDescription(aux.Stringc57690191(c57690191,1))
...
c57690191.listed_series={0x107a,0x207a}
function c57690191.atcon(e)
	local g=Duel.GetFieldGroup(e:GetHandlerPlayer(),LOCATION_MZONE,0)
	return #g~=3 or g:IsExists(c57690191.atkfilter,1,nil)
end
...
function c57690191.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	aux.RegisterClientHint(e:GetHandler(),nil,tp,1,0,aux.Stringc57690191(c57690191,2),nil)
end
