...
function c89405199.initial_effect(c)
	...
	e3:SetDescription(aux.Stringc89405199(c89405199,0))
...
function c89405199.drop(e,tp,eg,ep,ev,re,r,rp)
	...
	local flag=(ep==0 and c89405199 or c89405199+1)
...
function c89405199.damcon(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	return c:GetFlagEffect(c89405199)>0 or c:GetFlagEffect(c89405199+1)>0
end
function c89405199.damtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
	local c=e:GetHandler()
	local ct1=c:GetFlagEffectLabel(c89405199)
	local ct2=c:GetFlagEffectLabel(c89405199+1)
	if ct1 and ct2 then
...
function c89405199.damop(e,tp,eg,ep,ev,re,r,rp)
	...
	local ct1=c:GetFlagEffectLabel(c89405199+tp)
	local ct2=c:GetFlagEffectLabel(c89405199+1-tp)
