...
function c73136204.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc73136204(c73136204,0))
	...
	e2:SetDescription(aux.Stringc73136204(c73136204,2))
...
c73136204.listed_series={SET_SYLVAN}
c73136204.listed_names={c73136204}
...
function c73136204.filter(c)
	return c:IsSetCard(SET_SYLVAN) and not c:IsCode(c73136204) and c:IsAbleToDeck()
end
