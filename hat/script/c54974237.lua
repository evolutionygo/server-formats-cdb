...
function c54974237.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.Hint(HINT_SELECTMSG,tp,aux.Stringc54974237(c54974237,2))
	local ac=Duel.SelectOption(tp,aux.Stringc54974237(c54974237,0),aux.Stringc54974237(c54974237,1))
	local ty=TYPE_SPELL
...
function c54974237.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	e3:SetDescription(aux.Stringc54974237(c54974237,descnum))
	...
	e4:SetDescription(aux.Stringc54974237(c54974237,3))
