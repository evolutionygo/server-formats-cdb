...
function c63465535.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc63465535(c63465535,0))
...
function c63465535.eqfilter(c)
	return c:GetFlagEffect(c63465535)~=0 
end
...
function c63465535.equipop(c,e,tp,tc)
	c:EquipByEffectAndLimitRegister(e,tp,tc,c63465535)
end
