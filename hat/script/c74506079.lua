...
function c74506079.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCode2Rep(c,true,true,c74506079.ffilter,2,99)
	--summon success
...
function c74506079.matcheck(e,c)
	...
	if ct>=2 then
		...
		e1:SetDescription(aux.Stringc74506079(c74506079,0))
	...
	if ct>=4 then
		local e1=Effect.CreateEffect(c)
		e1:SetDescription(aux.Stringc74506079(c74506079,1))
	...
	if ct>=6 then
		local e1=Effect.CreateEffect(c)
		e1:SetDescription(aux.Stringc74506079(c74506079,2))
