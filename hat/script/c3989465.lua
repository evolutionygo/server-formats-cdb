...
function c3989465.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc3989465(c3989465,0))
...
function c3989465.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():GetFlagEffect(c3989465)==0 and e:GetHandler():CheckRemoveOverlayCard(tp,1,REASON_COST) end
	e:GetHandler():RemoveOverlayCard(tp,1,1,REASON_COST)
	e:GetHandler():RegisterFlagEffect(c3989465,RESET_PHASE+PHASE_DAMAGE,0,1)
end
