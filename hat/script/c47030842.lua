...
function c47030842.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc47030842(c47030842,0))
...
function c47030842.filter(c)
	return c:IsSetCard(0x72) and c:GetCode()~=c47030842 and c:IsMonster() and c:IsAbleToHand()
end
