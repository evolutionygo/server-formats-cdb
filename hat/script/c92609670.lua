...
function c92609670.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc92609670(c92609670,0))
	e1:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e1:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_O)
	e1:SetCode(EVENT_PHASE+PHASE_STANDBY)
	e1:SetRange(LOCATION_MZONE)
	e1:SetCountLimit(1,c92609670)
	...
	e2:SetDescription(aux.Stringc92609670(c92609670,1))
	e2:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e2:SetCode(EVENT_CUSTOM+c92609670)
	e2:SetCost(c92609670.lvcost)
	e2:SetTarget(c92609670.lvtg)
	e2:SetOperation(c92609670.lvop)
	c:RegisterEffect(e2)
end
c92609670.listed_series={0x106f}
c92609670.listed_names={c92609670}
...
function c92609670.filter(c,e,tp)
	return not c:IsCode(c92609670) and c:IsSetCard(0x106f) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function c92609670.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if #g>0 then
		...
		Duel.RaiseSingleEvent(e:GetHandler(),EVENT_CUSTOM+c92609670,e,0,tp,tp,0)
	end
end
