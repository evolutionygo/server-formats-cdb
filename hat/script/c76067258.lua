...
function c76067258.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc76067258(c76067258,0))
...
function c76067258.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsFaceup() and c:IsRelateToEffect(e) and tc:IsRelateToEffect(e) then
		c:SetCardTarget(tc)
		tc:RegisterFlagEffect(c76067258,RESET_EVENT+RESETS_STANDARD,0,0)
		--indes
...
function c76067258.repfilter(c,tp)
	return c:IsControler(tp) and c:GetFlagEffect(c76067258)~=0
end
