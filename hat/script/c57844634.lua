...
function c57844634.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc57844634(c57844634,0))
...
c57844634.listed_names={c57844634}
...
function c57844634.filter(c,e,tp)
	return c:IsCode(c57844634) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP_ATTACK,1-tp)
end
function c57844634.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if #g>0 and Duel.SelectYesNo(tp,aux.Stringc57844634(c57844634,1)) then
		Duel.BreakEffect()
		Duel.SpecialSummonStep(g:GetFirst(),0,tp,1-tp,false,false,POS_FACEUP_ATTACK)
		if ft>1 and #g>1 and Duel.SelectYesNo(tp,aux.Stringc57844634(c57844634,1)) then
