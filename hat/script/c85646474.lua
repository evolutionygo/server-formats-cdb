...
function c85646474.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc85646474(c85646474,0))
...
c85646474.listed_series={0x2e}
c85646474.listed_names={c85646474}
...
function c85646474.filter(c,e,tp)
	return c:IsSetCard(0x2e) and not c:IsCode(c85646474) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEDOWN_DEFENSE)
end
