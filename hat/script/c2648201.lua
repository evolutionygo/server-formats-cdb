...
function c2648201.initial_effect(c)
	c:SetUniqueOnField(1,0,c2648201)
	--Equip
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc2648201(c2648201,0))
	...
	c:RegisterEffect(e1)
	aux.AddZWEquipLimit(c,c2648201.eqcon,function(tc,c,tp) return c2648201.filter(tc) and tc:IsControler(tp) end,c2648201.equipop,e1)
	--Special summon
	local e2=Effect.CreateEffect(c)
	e2:SetDescription(aux.Stringc2648201(c2648201,1))
...
c2648201.listed_series={0x107f}
function c2648201.eqcon(e)
...
function c2648201.eqop(e,tp,eg,ep,ev,re,r,rp)
	...
	c2648201.equipop(c,e,tp,tc)
end
function c2648201.equipop(c,e,tp,tc)
