...
function c63485233.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local tc=g:GetFirst()
	local op=0
	if tc:GetLevel()==1 then op=Duel.SelectOption(tp,aux.Stringc63485233(c63485233,0))
	else op=Duel.SelectOption(tp,aux.Stringc63485233(c63485233,0),aux.Stringc63485233(c63485233,1)) end
	e:SetLabel(op)
end
