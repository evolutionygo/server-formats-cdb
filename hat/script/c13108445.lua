...
function c13108445.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCode2(c,false,false,27126980,aux.FilterBoolFunctionEx(Card.IsSetCard,0x1047))
	--spsummon condition
	...
	e3:SetDescription(aux.Stringc13108445(c13108445,0))
...
c13108445.listed_series={0x1047}
