...
function c131182.initial_effect(c)
	...
	e6:SetDescription(aux.Stringc131182(c131182,0))
	...
	e7:SetDescription(aux.Stringc131182(c131182,1))
...
function c131182.excon(e)
	...
	return Duel.IsExistingMatchingCard(aux.FaceupFilter(Card.IsCode,c131182),c:GetControler(),LOCATION_ONFIELD,0,1,nil)
end
function c131182.splimit(e,se,sp,st,spos,tgp)
	return not Duel.IsExistingMatchingCard(aux.FaceupFilter(Card.IsCode,c131182),tgp,LOCATION_ONFIELD,0,1,nil)
end
function c131182.atlimit(e,c)
	return c:IsFaceup() and c~=e:GetHandler()
end
function c131182.battleop(e,tp,eg,ep,ev,re,r,rp)
	e:GetHandler():RegisterFlagEffect(c131182,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_BATTLE,0,1)
end
function c131182.spcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c131182)~=0
end
