...
function c70908596.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc70908596(c70908596,0))
...
function c70908596.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local tc=g:GetFirst()
	local op=0
	if tc:GetLevel()==1 then op=Duel.SelectOption(tp,aux.Stringc70908596(c70908596,1))
	else op=Duel.SelectOption(tp,aux.Stringc70908596(c70908596,1),aux.Stringc70908596(c70908596,2)) end
	e:SetLabel(op)
end
