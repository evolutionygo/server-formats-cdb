...
function c35952884.initial_effect(c)
	...
	--negate
	local e3=Effect.CreateEffect(c)
	e3:SetDescription(aux.Stringc35952884(c35952884,0))
	...
	e4:SetDescription(aux.Stringc35952884(c35952884,1))
...
c35952884.synchro_tuner_required=1
c35952884.synchro_nt_required=2
