...
function c45653036.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsFaceup() and tc:IsRelateToEffect(e) then
		...
		if b1 and b2 then opt=Duel.SelectOption(tp,aux.Stringc45653036(c45653036,0),aux.Stringc45653036(c45653036,1))
		elseif b1 then opt=Duel.SelectOption(tp,aux.Stringc45653036(c45653036,0))
		elseif b2 then opt=Duel.SelectOption(tp,aux.Stringc45653036(c45653036,1))+1
		else opt=2 end
		if opt==0 then
