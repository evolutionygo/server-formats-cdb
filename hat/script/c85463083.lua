...
function c85463083.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc85463083(c85463083,0))
	...
	e3:SetDescription(aux.Stringc85463083(c85463083,1))
...
function c85463083.postg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return c:IsCanTurnSet() and c:GetFlagEffect(c85463083)==0 end
	c:RegisterFlagEffect(c85463083,RESET_EVENT+RESETS_STANDARD-RESET_TURN_SET+RESET_PHASE+PHASE_END,0,1)
