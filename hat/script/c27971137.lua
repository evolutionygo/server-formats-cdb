...
function c27971137.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc27971137(c27971137,1))
...
function c27971137.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc then
		...
		tc:RegisterFlagEffect(c27971137,RESET_EVENT+RESETS_STANDARD,0,1)
...
function c27971137.descon(e,tp,eg,ep,ev,re,r,rp)
	...
	return Duel.GetTurnPlayer()==tp and Duel.GetTurnCount()~=e:GetLabel() and tc:GetFlagEffect(c27971137)~=0
end
