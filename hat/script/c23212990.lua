...
function c23212990.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc23212990(c23212990,0))
...
c23212990.counter_list={COUNTER_BUSHIDO}
...
function c23212990.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local op=Duel.SelectEffect(tp,
		{b1,aux.Stringc23212990(c23212990,1)},
		{b2,aux.Stringc23212990(c23212990,2)})
	e:SetLabel(op)
	if op==1 then
