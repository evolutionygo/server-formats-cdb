...
function c1992816.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc1992816(c1992816,0))
	...
	e2:SetDescription(aux.Stringc1992816(c1992816,1))
	...
	e3:SetDescription(aux.Stringc1992816(c1992816,2))
...
function c1992816.atkcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():GetFlagEffect(c1992816)==0 end
	e:GetHandler():RegisterFlagEffect(c1992816,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_DAMAGE,0,1)
end
