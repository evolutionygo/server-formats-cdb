...
function c92394653.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc92394653(c92394653,0))
...
c92394653.listed_card_types={TYPE_SPIRIT}
...
function c92394653.mtop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.CheckLPCost(tp,500) and Duel.SelectYesNo(tp,aux.Stringc92394653(c92394653,1)) then
