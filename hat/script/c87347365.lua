...
function c87347365.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc87347365(c87347365,0))
	e1:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_F)
	e1:SetCode(EVENT_TO_GRAVE)
	e1:SetCountLimit(1,c87347365)
...
function c87347365.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if b1 and b2 then
		opt=Duel.SelectOption(tp,aux.Stringc87347365(c87347365,1),aux.Stringc87347365(c87347365,2))+1
	elseif b1 then
		opt=Duel.SelectOption(tp,aux.Stringc87347365(c87347365,1))+1
	elseif b2 then
		opt=Duel.SelectOption(tp,aux.Stringc87347365(c87347365,2))+2
	end
	e:SetLabel(opt)
	if opt==1 then
