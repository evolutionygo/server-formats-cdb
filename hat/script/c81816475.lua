...
function c81816475.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc81816475(c81816475,0))
...
function c81816475.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.Hint(HINT_SELECTMSG,tp,aux.Stringc81816475(c81816475,2))
	local mg=g1:Select(tp,1,1,nil)
	Duel.Hint(HINT_SELECTMSG,tp,aux.Stringc81816475(c81816475,1))
