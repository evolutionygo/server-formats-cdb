...
function c37511832.initial_effect(c)
	...
	e2:SetCode(c37511832)
	e2:SetRange(LOCATION_GRAVE)
	e2:SetTargetRange(1,0)
	c:RegisterEffect(e2)
	--search
	local e3=Effect.CreateEffect(c)
	e3:SetDescription(aux.Stringc37511832(c37511832,0))
...
function c37511832.operation(e,tp,eg,ep,ev,re,r,rp)
	local cc37511832=Duel.GetChainInfo(ev,CHAININFO_CHAIN_ID)
	local e1=Effect.CreateEffect(e:GetHandler())
	e1:SetType(EFFECT_TYPE_FIELD)
	e1:SetCode(EFFECT_CHANGE_DAMAGE)
	e1:SetProperty(EFFECT_FLAG_PLAYER_TARGET)
	e1:SetTargetRange(1,0)
	e1:SetLabel(cc37511832)
...
function c37511832.damcon(e,re,val,r,rp,rc)
	...
	local cc37511832=Duel.GetChainInfo(0,CHAININFO_CHAIN_ID)
	if cc37511832==e:GetLabel() then return 0 else return val end
end
