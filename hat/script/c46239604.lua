...
function c46239604.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc46239604(c46239604,0))
...
c46239604.listed_series={0x12}
c46239604.listed_names={c46239604}
...
function c46239604.filter(c)
	return c:IsSetCard(0x12) and not c:IsCode(c46239604) and c:IsAbleToHand()
end
