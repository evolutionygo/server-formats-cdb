...
function c706925.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc706925(c706925,0))
	...
	e2:SetDescription(aux.Stringc706925(c706925,1))
...
c706925.listed_series={0x77}
c706925.listed_names={c706925}
function c706925.spcon(e,tp,eg,ep,ev,re,r,rp)
	return ep==1-tp
end
function c706925.spfilter(c,e,tp)
	return not c:IsCode(c706925) and c:IsLevelBelow(4) and c:IsSetCard(0x77) and c:IsRace(RACE_SEASERPENT)
