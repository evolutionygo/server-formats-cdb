...
function c52971944.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc52971944(c52971944,1))
...
function c52971944.rmtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return  Duel.IsExistingTarget(c52971944.rmfilter,tp,0,LOCATION_MZONE+LOCATION_GRAVE,1,nil) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_REMOVE)
