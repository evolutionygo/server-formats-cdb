...
function c50903514.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc50903514(c50903514,0))
	...
	e1:SetTarget(c50903514.atktg)
	e1:SetOperation(c50903514.atkop)
	c:RegisterEffect(e1)
	--Special Summon 1 FIRE Warrior monster from your GY
	local e2=Effect.CreateEffect(c)
	e2:SetDescription(aux.Stringc50903514(c50903514,1))
...
function c50903514.atktg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c50903514.atkop(e,tp,eg,ep,ev,re,r,rp)
