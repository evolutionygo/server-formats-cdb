...
function c13455953.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc13455953(c13455953,0))
...
c13455953.listed_series={0x5042,0x42}
function c13455953.sumop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.GetFlagEffect(tp,c13455953)~=0 then return end
	local e1=Effect.CreateEffect(e:GetHandler())
	e1:SetDescription(aux.Stringc13455953(c13455953,1))
	...
	Duel.RegisterFlagEffect(tp,c13455953,RESET_PHASE+PHASE_END,0,1)
end
