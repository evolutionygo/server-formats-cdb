...
function c95027497.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc95027497(c95027497,0))
	...
	e2:SetDescription(aux.Stringc95027497(c95027497,0))
...
c95027497.listed_series={0x61,0x2b}
function c95027497.filter1(c)
	return c:IsSetCard(0x61) and c:IsAbleToHand()
end
function c95027497.filter2(c)
	return c:IsSetCard(0x2b) and c:GetCode()~=c95027497 and c:IsMonster() and c:IsAbleToHand()
end
