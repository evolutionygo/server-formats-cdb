...
function c34838437.initial_effect(c)
	...
	e1:SetCountLimit(1,c34838437,EFFECT_COUNT_CODE_OATH)
...
c34838437.listed_series={0x55,0x7b}
...
function c34838437.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	aux.RegisterClientHint(e:GetHandler(),nil,tp,1,0,aux.Stringc34838437(c34838437,1),nil)
end
