...
function c68597372.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc68597372(c68597372,0))
...
function c68597372.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsFaceup() and tc:IsRelateToEffect(e) and tc:IsFaceup() then
		...
		tc:RegisterFlagEffect(c68597372,RESET_EVENT+RESETS_STANDARD-RESET_TURN_SET+RESET_PHASE+PHASE_END,0,1)
...
function c68597372.flipcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return tc:IsFacedown() and tc:GetFlagEffect(c68597372)~=0
end
