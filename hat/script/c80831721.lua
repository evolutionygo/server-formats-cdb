...
function c80831721.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc80831721(c80831721,0))
	...
	e2:SetDescription(aux.Stringc80831721(c80831721,1))
...
c80831721.listed_series={0x46,0x10a4}
c80831721.listed_names={c80831721}
...
function c80831721.rfilter(c)
	return c:IsCode(c80831721) and c:IsAbleToRemoveAsCost()
end
