...
function c70222318.initial_effect(c)
	...
	e3:SetDescription(aux.Stringc70222318(c70222318,3))
...
c70222318.listed_series={SET_SYLVAN}
...
function c70222318.operation(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_SELECTMSG,tp,aux.Stringc70222318(c70222318,0))
...
function c70222318.tgop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRace(RACE_PLANT) then
		...
		local opt=Duel.SelectOption(tp,aux.Stringc70222318(c70222318,1),aux.Stringc70222318(c70222318,2))
		if opt==1 then
