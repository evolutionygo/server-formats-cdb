...
function c10406322.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc10406322(c10406322,0))
	...
	e2:SetDescription(aux.Stringc10406322(c10406322,1))
	e2:SetCategory(CATEGORY_TODECK)
	e2:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_O)
	e2:SetProperty(EFFECT_FLAG_CARD_TARGET+EFFECT_FLAG_DELAY)
	e2:SetCode(EVENT_TO_GRAVE)
	e2:SetRange(LOCATION_MZONE)
	e2:SetCountLimit(1,c10406322)
...
function c10406322.tdop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsType(TYPE_FUSION|TYPE_SYNCHRO|TYPE_XYZ)
		or Duel.SelectOption(tp,aux.Stringc10406322(c10406322,2),aux.Stringc10406322(c10406322,3))==0 then
