...
function c3027001.condition(e,tp,eg,ep,ev,re,r,rp)
	...
	return ex and tg~=nil and #tg==tc and tg:IsExists(c3027001.cfilter,1,e:GetHandler(),tp)
end
...
function c3027001.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	for tc in aux.Next(reg) do
		tc:RegisterFlagEffect(c3027001,RESET_EVENT+RESETS_STANDARD+RESET_CHAIN,0,1)
	end
end
...
function c3027001.repfilter(c)
	return c:GetFlagEffect(c3027001)~=0
end
