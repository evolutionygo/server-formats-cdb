...
function c70355994.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc70355994(c70355994,0))
	...
	e2:SetDescription(aux.Stringc70355994(c70355994,1))
...
function c70355994.descost(e,tp,eg,ep,ev,re,r,rp,chk)
	local nc=Duel.IsExistingMatchingCard(c70355994.filter1,tp,LOCATION_ONFIELD,0,1,nil)
	if chk==0 then return nc or Duel.IsPlayerAffectedByEffect(tp,CARD_FIRE_FIST_EAGLE) end
	if nc and not (Duel.IsPlayerAffectedByEffect(tp,CARD_FIRE_FIST_EAGLE) and Duel.SelectYesNo(tp,aux.Stringc70355994(CARD_FIRE_FIST_EAGLE,0))) then
