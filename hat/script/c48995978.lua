...
function c48995978.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc48995978(c48995978,0))
	e1:SetCategory(CATEGORY_COUNTER)
	e1:SetType(EFFECT_TYPE_IGNITION)
	e1:SetRange(LOCATION_MZONE)
	e1:SetCountLimit(1)
	e1:SetCondition(function(e,tp) return Duel.GetFieldGroupCount(tp,LOCATION_STZONE,0)==0 end)
	e1:SetCost(c48995978.ctcost)
	e1:SetTarget(c48995978.cttg)
	e1:SetOperation(c48995978.ctop)
	c:RegisterEffect(e1)
...
c48995978.counter_place_list={0x2b} --Destiny Counter
c48995978.aux.xyz_number=88
function c48995978.ctcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsPhase(PHASE_MAIN1) end
	--Cannot conduct your Battle Phase this turn
	local e1=Effect.CreateEffect(e:GetHandler())
	e1:SetDescription(aux.Stringc48995978(c48995978,1))
...
function c48995978.cttg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c48995978.ctop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
