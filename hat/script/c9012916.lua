...
function c9012916.initial_effect(c)
	...
	e4:SetDescription(aux.Stringc9012916(c9012916,0))
	e4:SetCategory(CATEGORY_ATKCHANGE+CATEGORY_DAMAGE)
	e4:SetType(EFFECT_TYPE_IGNITION)
	e4:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e4:SetRange(LOCATION_MZONE)
	e4:SetCountLimit(1)
	e4:SetCost(c9012916.cost)
	e4:SetTarget(c9012916.target)
	e4:SetOperation(c9012916.operation)
	c:RegisterEffect(e4)
end
c9012916.counter_list={COUNTER_FEATHER}
