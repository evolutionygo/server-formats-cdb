...
function c72913666.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc72913666(c72913666,0))
	...
	e3:SetDescription(aux.Stringc72913666(c72913666,1))
	e3:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_F)
	e3:SetCategory(CATEGORY_DAMAGE)
	e3:SetCode(EVENT_FLIP)
	e3:SetCountLimit(1,c72913666)
	e3:SetTarget(c72913666.damtg)
	e3:SetOperation(c72913666.damop)
	c:RegisterEffect(e3)
end
c72913666.listed_series={0x8d}
...
function c72913666.postg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return c:IsCanTurnSet() and c:GetFlagEffect(c72913666)==0 end
	c:RegisterFlagEffect(c72913666,RESET_EVENT+RESETS_STANDARD-RESET_TURN_SET+RESET_PHASE+PHASE_END,0,1)
