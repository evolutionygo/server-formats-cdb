...
function c23116808.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc23116808(c23116808,0))
	e1:SetType(EFFECT_TYPE_FIELD)
	e1:SetProperty(EFFECT_FLAG_UNCOPYABLE)
	e1:SetCode(EFFECT_SPSUMMON_PROC)
	e1:SetRange(LOCATION_HAND)
	e1:SetCondition(c23116808.selfspcon)
	e1:SetValue(1)
	c:RegisterEffect(e1)
	--Destroy 1 FIRE monster you control
	local e2=Effect.CreateEffect(c)
	e2:SetDescription(aux.Stringc23116808(c23116808,1))
	...
	e3:SetDescription(aux.Stringc23116808(c23116808,2))
	...
	e4:SetDescription(aux.Stringc23116808(c23116808,3))
...
c23116808.listed_names={TOKEN_FIREBALL}
function c23116808.selfspcon(e,c)
