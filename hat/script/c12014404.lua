...
function c12014404.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc12014404(c12014404,0))
...
function c12014404.atkop(e,tp,eg,ep,ev,re,r,rp)
	...
	if not bc or c:GetFlagEffect(c12014404)~=0 then return end
	--Gain 1000 ATK
	local e1=Effect.CreateEffect(c)
	...
	c:RegisterFlagEffect(c12014404,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_DAMAGE,0,1)
end