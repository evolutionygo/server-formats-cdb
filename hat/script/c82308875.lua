...
function c82308875.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc82308875(c82308875,0))
...
c82308875.roll_dice=true
c82308875.aux.xyz_number=7
...
function c82308875.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	local b2=Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and Duel.IsExistingMatchingCard(aux.NecroValleyFilter(c82308875.spfilter),tp,LOCATION_HAND|LOCATION_GRAVE,LOCATION_GRAVE,1,nil,e,tp)
	local b3=Duel.IsPlayerCanDraw(tp,3)
	if not (b1 or b2 or b3) then return end
	local op=Duel.SelectEffect(tp,
		{b1,aux.Stringc82308875(c82308875,1)},
		{b2,aux.Stringc82308875(c82308875,2)},
		{b3,aux.Stringc82308875(c82308875,3)})
	if op==1 then
	...
	elseif op==2 then
		...
		local sg=Duel.SelectMatchingCard(tp,aux.NecroValleyFilter(c82308875.spfilter),tp,LOCATION_HAND|LOCATION_GRAVE,LOCATION_GRAVE,1,1,nil,e,tp)
