...
function c56570271.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc56570271(c56570271,0))
	e1:SetCategory(CATEGORY_DRAW)
	e1:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e1:SetProperty(EFFECT_FLAG_PLAYER_TARGET+EFFECT_FLAG_DELAY)
	e1:SetCode(EVENT_SPSUMMON_SUCCESS)
	e1:SetCountLimit(1,c56570271,EFFECT_COUNT_CODE_DUEL)
...
function c56570271.tgop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.GetFlagEffect(tp,c56570271)~=0 then return end
	--cannot special summon
	local e1=Effect.CreateEffect(c)
	...
	c:RegisterEffect(e1)
	Duel.RegisterFlagEffect(tp,c56570271,RESET_PHASE+PHASE_END,0,1)
end