...
function c56240989.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc56240989(c56240989,0))
...
function c56240989.regop(e,tp,eg,ep,ev,re,r,rp)
	e:GetHandler():RegisterFlagEffect(c56240989,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
end
function c56240989.spcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c56240989)~=0
end
...
function c56240989.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then
		...
		return ft>1 and not Duel.IsPlayerAffectedByEffect(tp,CARD_BLUEEYES_SPIRIT) and g:IsExists(c56240989.filter2,1,nil,g)
	end
...
function c56240989.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if #dg>=1 then
		...
		tc1:RegisterFlagEffect(c56240989,RESET_EVENT+RESETS_STANDARD,0,1,fc56240989)
		tc2:RegisterFlagEffect(c56240989,RESET_EVENT+RESETS_STANDARD,0,1,fc56240989)
		local e1=Effect.CreateEffect(c)
...
function c56240989.rmfilter(c,fc56240989)
	return c:GetFlagEffectLabel(c56240989)==fc56240989
end
