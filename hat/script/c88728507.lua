...
function c88728507.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc88728507(c88728507,0))
	...
	e2:SetDescription(aux.Stringc88728507(c88728507,1))
...
function c88728507.sumop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.GetFlagEffect(tp,c88728507)==0 then
		local e1=Effect.CreateEffect(e:GetHandler())
		e1:SetDescription(aux.Stringc88728507(c88728507,2))
		e1:SetType(EFFECT_TYPE_FIELD)
		e1:SetTargetRange(LOCATION_HAND,0)
		e1:SetCode(EFFECT_SUMMON_PROC)
		e1:SetCountLimit(1)
		e1:SetCondition(c88728507.ntcon)
		e1:SetTarget(aux.FieldSummonProcTg(c88728507.nttg))
		e1:SetReset(RESET_PHASE+PHASE_END)
		Duel.RegisterEffect(e1,tp)
		Duel.RegisterFlagEffect(tp,c88728507,RESET_PHASE+PHASE_END,0,1)
	end
end
