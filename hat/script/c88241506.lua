--青き眼の乙女
--Mac88241506en with Eyes of Blue
...
function c88241506.naop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.NegateAttack() and c:IsRelateToEffect(e) then
		...
		if #g>0 and Duel.SelectYesNo(tp,aux.Stringc88241506(c88241506,2)) then
			Duel.BreakEffect()
