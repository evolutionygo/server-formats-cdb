...
function c27491571.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc27491571(c27491571,0))
	...
	e3:SetDescription(aux.Stringc27491571(c27491571,1))
...
function c27491571.postg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return c:IsCanTurnSet() and c:GetFlagEffect(c27491571)==0 end
	c:RegisterFlagEffect(c27491571,RESET_EVENT+RESETS_STANDARD-RESET_TURN_SET+RESET_PHASE+PHASE_END,0,1)
