...
function c18482591.aclimit(e,re,tp)
	...
	return not c:IsLocation(LOCATION_SZONE) or c:GetFlagEffect(c18482591)>0
end
function c18482591.aclimset(e,tp,eg,ep,ev,re,r,rp)
	local tc=eg:GetFirst()
	for tc in aux.Next(eg) do
		tc:RegisterFlagEffect(c18482591,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END+RESET_OPPO_TURN,0,1)
	end
end