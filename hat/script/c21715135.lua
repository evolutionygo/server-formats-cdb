...
function c21715135.initial_effect(c)
	...
	e1:SetCountLimit(1,c21715135,EFFECT_COUNT_CODE_OATH)
	...
	c:RegisterEffect(e1)
	Duel.AddCustomActivityCounter(c21715135,ACTIVITY_SPSUMMON,c21715135.counterfilter)
end
c21715135.listed_series={0x54}
...
function c21715135.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetCustomActivityCount(c21715135,tp,ACTIVITY_SPSUMMON)==0 end
	...
	aux.RegisterClientHint(e:GetHandler(),nil,tp,1,0,aux.Stringc21715135(c21715135,1),nil)
end
