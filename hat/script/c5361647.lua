...
function c5361647.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc5361647(c5361647,0))
	...
	e2:SetDescription(aux.Stringc5361647(c5361647,1))
...
function c5361647.filter(c)
	return c:IsSetCard(0x84) and c:GetCode()~=c5361647 and c:IsMonster() and c:IsAbleToHand()
end
