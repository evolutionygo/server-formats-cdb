...
function c64038662.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc64038662(c64038662,0))
...
function c64038662.select(e,tp,b1,b2)
	local op=0
	if b1 and b2 then
		op=Duel.SelectOption(tp,aux.Stringc64038662(c64038662,2),aux.Stringc64038662(c64038662,3))+1
	elseif b1 then
		op=Duel.SelectOption(tp,aux.Stringc64038662(c64038662,2))+1
	else op=Duel.SelectOption(tp,aux.Stringc64038662(c64038662,3))+2 end
	e:SetLabel(op)
	if op==1 then
		e:SetCategory(CATEGORY_EQUIP)
		Duel.Hint(HINT_SELECTMSG,tp,aux.Stringc64038662(c64038662,4))
