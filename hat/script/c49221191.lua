...
function c49221191.initial_effect(c)
	--xyz summon
	c:EnableReviveLimit()
	aux.AddXyzProcedure(c,aux.FilterBoolFunctionEx(Card.IsAttribute,ATTRIBUTE_WATER),4,4,c49221191.ovfilter,aux.Stringc49221191(c49221191,0))
	--atk/def
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc49221191(c49221191,1))
...
c49221191.aux.xyz_number=32
c49221191.listed_names={65676461}
function c49221191.ovfilter(c,tp,lc)
