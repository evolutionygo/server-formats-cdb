...
function c79798060.initial_effect(c)
	...
	e1:SetCondition(c79798060.sdcon)
	c:RegisterEffect(e1)
	...
	e4:SetDescription(aux.Stringc79798060(c79798060,0))
	e4:SetCategory(CATEGORY_DESTROY)
	e4:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_F)
	e4:SetCode(EVENT_DESTROYED)
	e4:SetCondition(c79798060.descon)
	e4:SetTarget(c79798060.destg)
	e4:SetOperation(c79798060.desop)
	c:RegisterEffect(e4)
end
c79798060.listed_series={SET_EARTHBOUND_IMMORTAL}
