...
function c66762372.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc66762372(c66762372,0))
	...
	e2:SetDescription(aux.Stringc66762372(c66762372,1))
...
c66762372.listed_series={0x79,0x7c}
function c66762372.spcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsLocation(LOCATION_GRAVE) and e:GetHandler():IsReason(REASON_BATTLE)
end
function c66762372.spfilter(c,e,tp)
	return c:IsSetCard(0x79) and c:GetLevel()==4 and c:GetCode()~=c66762372 and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
