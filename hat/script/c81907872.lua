...
function c81907872.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc81907872(c81907872,0))
	...
	e3:SetDescription(aux.Stringc81907872(c81907872,1))
...
function c81907872.postg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return c:IsCanTurnSet() and c:GetFlagEffect(c81907872)==0 end
	c:RegisterFlagEffect(c81907872,RESET_EVENT+RESETS_STANDARD-RESET_TURN_SET+RESET_PHASE+PHASE_END,0,1)
