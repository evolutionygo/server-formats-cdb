...
function c15394083.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc15394083(c15394083,0))
...
c15394083.listed_names={15394084}
...
function c15394083.operation(e,tp,eg,ep,ev,re,r,rp)
	if Duel.IsPlayerAffectedByEffect(tp,CARD_BLUEEYES_SPIRIT) or Duel.GetLocationCount(tp,LOCATION_MZONE)<2 
		or not Duel.IsPlayerCanSpecialSummonMonster(tp,c15394083+1,0x6042,TYPES_TOKEN,0,0,3,RACE_BEAST,ATTRIBUTE_EARTH) then return end
	for i=1,2 do
		local token=Duel.CreateToken(tp,c15394083+1)
