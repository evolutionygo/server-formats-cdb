...
function c43892408.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCode2(c,false,false,CARD_DARK_MAGICIAN_GIRL,aux.FilterBoolFunctionEx(Card.IsRace,RACE_DRAGON))
	--spsummon condition
	...
	e2:SetDescription(aux.Stringc43892408(c43892408,0))
