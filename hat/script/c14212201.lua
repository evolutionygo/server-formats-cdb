...
function c14212201.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc14212201(c14212201,0))
...
c14212201.listed_series={0x8e}
function c14212201.filter(c,e,tp)
	return c:GetCode()~=c14212201 and c:IsSetCard(0x8e) and c:IsAttribute(ATTRIBUTE_DARK) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function c14212201.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc and Duel.SpecialSummon(tc,0,tp,tp,false,false,POS_FACEUP)>0 then
		...
		aux.RegisterClientHint(e:GetHandler(),nil,tp,1,0,aux.Stringc14212201(c14212201,1),nil)
	end
end
