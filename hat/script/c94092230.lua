...
function c94092230.initial_effect(c)
	...
	local e3=aux.AddNormalSummonProcedure(c,true,false,3,3,SUMMON_TYPE_TRIBUTE,aux.Stringc94092230(c94092230,0))
	local e4=aux.AddNormalSetProcedure(c)
	--destroy
	local e5=Effect.CreateEffect(c)
	e5:SetDescription(aux.Stringc94092230(c94092230,1))
...
c94092230.listed_series={0x100a}
