...
function c73652465.initial_effect(c)
	...
	e1:SetCountLimit(1,c73652465,EFFECT_COUNT_CODE_OATH)
	e1:SetCondition(c73652465.spcon)
	c:RegisterEffect(e1)
	--position
	local e2=Effect.CreateEffect(c)
	e2:SetDescription(aux.Stringc73652465(c73652465,0))
...
c73652465.listed_series={0x33}
function c73652465.filter(c)
	return c:IsFaceup() and c:IsSetCard(0x33) and c:GetCode()~=c73652465
end
