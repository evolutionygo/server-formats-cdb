...
function c88190790.initial_effect(c)
	--Equip
	aux.AddEquipProcedure(c,0,c88190790.eqfilter,c88190790.eqlimit)
	--Atk up
	...
	e2:SetDescription(aux.Stringc88190790(c88190790,0))
	e2:SetType(EFFECT_TYPE_IGNITION)
	e2:SetRange(LOCATION_SZONE)
	e2:SetCondition(c88190790.macon)
	e2:SetCost(c88190790.macost)
	e2:SetOperation(c88190790.maop)
	c:RegisterEffect(e2)
end
...
function c88190790.eqfilter(c,e,tp)
