...
function c46961802.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	tc1:RegisterFlagEffect(c46961802,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
	tc2:RegisterFlagEffect(c46961802,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
...
function c46961802.atop(e,tp,eg,ep,ev,re,r,rp)
	...
	if oc:GetFlagEffect(c46961802)~=0 then
