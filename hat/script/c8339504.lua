...
function c8339504.initial_effect(c)
	...
	e1:SetCountLimit(1,c8339504,EFFECT_COUNT_CODE_OATH)
	e1:SetLabel(0)
...
function c8339504.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if sc and Duel.SpecialSummon(sc,0,tp,tp,false,false,POS_FACEUP)~=0 then
		...
		local fc8339504=c:GetFieldID()
		sc:RegisterFlagEffect(c8339504,RESET_EVENT+RESETS_STANDARD,0,1,fc8339504)
		local e1=Effect.CreateEffect(c)
		e1:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_CONTINUOUS)
		e1:SetCode(EVENT_PHASE+PHASE_END)
		e1:SetCountLimit(1)
		e1:SetProperty(EFFECT_FLAG_IGNORE_IMMUNE)
		e1:SetLabel(fc8339504)
...
function c8339504.tgcon(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:GetFlagEffectLabel(c8339504)~=e:GetLabel() then
		e:Reset()
		return false
