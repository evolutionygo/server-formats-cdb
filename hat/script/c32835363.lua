...
function c32835363.initial_effect(c)
	...
	e3:SetDescription(aux.Stringc32835363(c32835363,0))
	e3:SetCategory(CATEGORY_DAMAGE)
	e3:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_F)
	e3:SetCode(EVENT_CUSTOM+c32835363)
...
function c32835363.regop(e,tp,eg,ep,ev,re,r,rp)
	Duel.RaiseSingleEvent(e:GetHandler(),EVENT_CUSTOM+c32835363,e,0,tp,e:GetLabel(),0)
end
