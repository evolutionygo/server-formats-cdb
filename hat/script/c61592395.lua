...
function c61592395.initial_effect(c)
	...
	e1:SetCountLimit(1,c61592395,EFFECT_COUNT_CODE_OATH)
	e1:SetTarget(c61592395.target)
	e1:SetOperation(c61592395.activate)
	c:RegisterEffect(e1)
end
c61592395.listed_series={0x106e}
function c61592395.filter(c)
	return c:IsFaceup() and c:IsSetCard(0x106e) and c:IsSpell() and c:GetCode()~=c61592395 and c:IsAbleToHand()
end
