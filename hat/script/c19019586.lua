...
function c19019586.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc19019586(c19019586,0))
	...
	e2:SetDescription(aux.Stringc19019586(c19019586,1))
...
function c19019586.defcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():GetFlagEffect(c19019586)==0
	...
	e:GetHandler():RegisterFlagEffect(c19019586,RESET_PHASE+PHASE_DAMAGE_CAL,0,1)
end
