...
function c48179391.initial_effect(c)
	...
	e1:SetCountLimit(1,c48179391,EFFECT_COUNT_CODE_OATH+EFFECT_COUNT_CODE_DUEL)
...
function c48179391.negdcon(e,tp,eg,ep,ev,re,r,rp)
	return re==e:GetLabelObject() and re:IsHasType(EFFECT_TYPE_ACTIVATE)
end
function c48179391.negdop(e)
	Duel.ResetFlagEffect(e:GetHandlerPlayer(),c48179391)
end
