...
function c63175639.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc63175639(c63175639,0))
	...
	e2:SetDescription(aux.Stringc63175639(c63175639,1))
...
c63175639.listed_series={0x106e}
...
function c63175639.sgtg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	e:GetHandler():RegisterFlagEffect(c63175639,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
end
...
function c63175639.spcon(e,tp,eg,ep,ev,re,r,rp)
	if e:GetHandler():GetFlagEffect(c63175639)==0 then return false end
