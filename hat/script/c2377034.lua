...
function c2377034.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc2377034(c2377034,0))
	...
	e2:SetDescription(aux.Stringc2377034(c2377034,1))
...
function c2377034.filter(c)
	...
	return def>=0 and def<=200 and c:IsAttribute(ATTRIBUTE_FIRE) and c:GetCode()~=c2377034 and c:IsAbleToHand()
end
