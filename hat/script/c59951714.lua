...
function c59951714.initial_effect(c)
	...
	e3:SetDescription(aux.Stringc59951714(c59951714,0))
	...
	c:RegisterEffect(e3)
	Duel.AddCustomActivityCounter(c59951714,ACTIVITY_SPSUMMON,c59951714.counterfilter)
end
...
function c59951714.spr(e,tp,eg,ep,ev,re,r,rp)
	...
	if r==REASON_SUMMON then
		c:RegisterFlagEffect(c59951714,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_STANDBY+RESET_SELF_TURN,0,1)
	end
end
function c59951714.spcon(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	return c:GetTurnID()~=Duel.GetTurnCount() and tp==Duel.GetTurnPlayer() and c:GetFlagEffect(c59951714)>0
end
function c59951714.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetCustomActivityCount(c59951714,tp,ACTIVITY_SPSUMMON)==0 end
	...
	aux.RegisterClientHint(e:GetHandler(),nil,tp,1,0,aux.Stringc59951714(c59951714,1),nil)
	--lizard check
...
function c59951714.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	e:GetHandler():ResetFlagEffect(c59951714)
end
