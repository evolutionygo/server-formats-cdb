...
function c88989706.initial_effect(c)
	...
	e3:SetDescription(aux.Stringc88989706(c88989706,0))
	...
	c:RegisterEffect(e3)
	aux.DoubleSnareValc88989706ity(c,LOCATION_MZONE)
end
c88989706.listed_names={39711336}
function c88989706.effcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c88989706+1)>0
end
function c88989706.regop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	if c:IsRelateToBattle() then
		c:RegisterFlagEffect(c88989706+1,RESET_EVENT+RESETS_STANDARD,0,0)
	end
end
function c88989706.discon(e,tp,eg,ep,ev,re,r,rp)
	if e:GetHandler():GetFlagEffect(c88989706+1)==0 or not re:IsHasProperty(EFFECT_FLAG_CARD_TARGET) then return false end
...
function c88989706.spcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c88989706+1)>=2
end
