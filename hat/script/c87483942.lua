...
function c87483942.initial_effect(c)
	c:SetUniqueOnField(1,1,c87483942)
	--spsummon
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc87483942(c87483942,0))
...
c87483942.listed_series={0x2b}
c87483942.listed_names={c87483942}
function c87483942.filter(c,e,tp)
	return c:IsSetCard(0x2b) and not c:IsCode(c87483942) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEDOWN_DEFENSE)
end
