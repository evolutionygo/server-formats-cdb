...
function c6353603.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc6353603(c6353603,0))
	...
	e2:SetDescription(aux.Stringc6353603(c6353603,1))
...
function c6353603.destg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local nc=Duel.IsExistingMatchingCard(c6353603.filter1,tp,LOCATION_ONFIELD,0,1,nil)
	if chk==0 then 
	...
	if nc and not (Duel.IsPlayerAffectedByEffect(tp,CARD_FIRE_FIST_EAGLE) and Duel.SelectYesNo(tp,aux.Stringc6353603(CARD_FIRE_FIST_EAGLE,0))) then
