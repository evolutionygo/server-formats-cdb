...
function c6625096.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc6625096(c6625096,0))
	e1:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e1:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e1:SetProperty(EFFECT_FLAG_DAMAGE_STEP)
	e1:SetCode(EVENT_SUMMON_SUCCESS)
	e1:SetCountLimit(1,c6625096)
...
function c6625096.filter(c,e,tp)
	return c:IsLevelBelow(4) and c:IsRace(RACE_FISH) and not c:IsCode(c6625096) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
