...
function c23434538.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc23434538(c23434538,0))
	e1:SetCategory(CATEGORY_DRAW)
	e1:SetType(EFFECT_TYPE_QUICK_O)
	e1:SetCode(EVENT_FREE_CHAIN)
	e1:SetHintTiming(0,TIMINGS_CHECK_MONSTER)
	e1:SetRange(LOCATION_HAND)
	e1:SetCountLimit(1,c23434538)
...
function c23434538.regop(e,tp,eg,ep,ev,re,r,rp)
	Duel.RegisterFlagEffect(tp,c23434538,RESET_CHAIN,0,1)
end
function c23434538.drcon2(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetFlagEffect(tp,c23434538)>0
end
function c23434538.drop2(e,tp,eg,ep,ev,re,r,rp)
	local n=Duel.GetFlagEffect(tp,c23434538)
	Duel.ResetFlagEffect(tp,c23434538)
