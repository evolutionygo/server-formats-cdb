...
function c76442347.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc76442347(c76442347,0))
...
c76442347.listed_series={0x5a}
function c76442347.flipop(e,tp,eg,ep,ev,re,r,rp)
	e:GetHandler():RegisterFlagEffect(c76442347,RESET_EVENT|(RESETS_STANDARD|RESET_OVERLAY)&~(RESET_LEAVE|RESET_TOGRAVE),0,0)
end
function c76442347.spcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c76442347)~=0
end
function c76442347.filter(c,e,tp)
	return c:IsSetCard(0x5a) and c:GetCode()~=c76442347
