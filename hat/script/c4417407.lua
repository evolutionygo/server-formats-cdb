...
function c4417407.initial_effect(c)
	...
	e4:SetDescription(aux.Stringc4417407(c4417407,0))
	...
	e5:SetDescription(aux.Stringc4417407(c4417407,1))
...
c4417407.listed_names={TOKEN_MECHA_PHANTOM_BEAST}
...
function c4417407.tknfilter(c)
	return c:IsType(TYPE_TOKEN) or c:IsOriginalType(TYPE_TOKEN)
end
function c4417407.indcon(e)
	return Duel.IsExistingMatchingCard(c4417407.tknfilter,e:GetHandlerPlayer(),LOCATION_ONFIELD,0,1,nil)
end
