...
function c67489919.initial_effect(c)
	...
	e3:SetDescription(aux.Stringc67489919(c67489919,0))
	...
	e6:SetLabel(c67489919)
	e6:SetValue(c67489919.synval)
	c:RegisterEffect(e6)
end
c67489919.listed_series={SET_MECHA_PHANTOM_BEAST}
c67489919.listed_names={TOKEN_MECHA_PHANTOM_BEAST}
...
function c67489919.chk2(c)
	...
	for i=1,#te do
		local e=te[i]
		if e:GetLabel()==c67489919 then return true end
	end
	return false
end
...
function c67489919.tknfilter(c)
	return c:IsType(TYPE_TOKEN) or c:IsOriginalType(TYPE_TOKEN)
end
function c67489919.indcon(e)
	return Duel.IsExistingMatchingCard(c67489919.tknfilter,e:GetHandlerPlayer(),LOCATION_ONFIELD,0,1,nil)
end
