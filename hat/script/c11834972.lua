...
function c11834972.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc11834972(c11834972,0))
...
c11834972.listed_series={0x39}
function c11834972.cfilter(c)
	return c:IsSetCard(0x39) and c:GetCode()~=c11834972
end
...
function c11834972.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if #ct==1 then 
		...
		Duel.Hint(HINT_SELECTMSG,tp,aux.Stringc11834972(c11834972,1))
