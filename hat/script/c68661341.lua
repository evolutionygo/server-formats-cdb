...
function c68661341.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return #g>=3 and not g:IsExists(c68661341.cfilter,1,nil) end
...
function c68661341.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if #g>0 then
		...
		aux.RegisterClientHint(e:GetHandler(),nil,tp,1,0,aux.Stringc68661341(c68661341,1),nil)
	end
end
