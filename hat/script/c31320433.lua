...
function c31320433.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc31320433(c31320433,0))
	...
	e2:SetDescription(aux.Stringc31320433(c31320433,1))
...
function c31320433.daop(e,tp,eg,ep,ev,re,r,rp)
	...
	e2:SetTarget(c31320433.ftarget)
