...
function c24040093.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc24040093(c24040093,0))
...
function c24040093.filter(c)
	return c:IsSetCard(0x35) and c:IsMonster() and c:GetCode()~=c24040093 and c:IsAbleToHand()
end
