...
function c68226653.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc68226653(c68226653,0))
	...
	e2:SetDescription(aux.Stringc68226653(c68226653,1))
...
c68226653.listed_names={c68226653}
...
function c68226653.filter(c)
	return c:IsCode(c68226653) and c:IsAbleToHand()
end
