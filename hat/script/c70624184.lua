...
function c70624184.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc70624184(c70624184,0))
...
c70624184.listed_series={0x53}
c70624184.listed_names={c70624184}
function c70624184.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():IsReleasable() end
	Duel.Release(e:GetHandler(),REASON_COST)
end
function c70624184.filter(c,e,tp)
	return c:IsSetCard(0x53) and not c:IsCode(c70624184) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP_DEFENSE)
end
