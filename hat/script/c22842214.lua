...
function c22842214.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc22842214(c22842214,0))
...
function c22842214.filter(c)
	return c:IsFaceup() and c:IsRace(RACE_FISH+RACE_AQUA+RACE_SEASERPENT) and not c:IsForbc22842214den()
end
...
function c22842214.equipop(c,e,tp,tc,chk)
	...
	tc:RegisterFlagEffect(c22842214,RESET_EVENT+RESETS_STANDARD,0,0)
	local e1=Effect.CreateEffect(c)
...
function c22842214.eqfilter(c,ec)
	return c:GetFlagEffect(c22842214)~=0 and c:IsHasCardTarget(ec)
end
