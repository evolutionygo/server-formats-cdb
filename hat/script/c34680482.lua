...
function c34680482.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc34680482(c34680482,0))
	...
	e2:SetDescription(aux.Stringc34680482(c34680482,1))
	e2:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e2:SetType(EFFECT_TYPE_IGNITION)
	e2:SetRange(LOCATION_MZONE)
	e2:SetCountLimit(1,c34680482)
	e2:SetCost(c34680482.spcost)
	e2:SetTarget(c34680482.sptg)
	e2:SetOperation(c34680482.spop)
	c:RegisterEffect(e2)
end
c34680482.listed_series={0x71}
...
function c34680482.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc and Duel.SpecialSummon(tc,0,tp,tp,false,false,POS_FACEUP)>0 then
		tc:RegisterFlagEffect(c34680482,RESET_EVENT+RESETS_STANDARD,0,1,Duel.GetTurnCount())
...
function c34680482.tdcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return Duel.GetTurnCount()~=e:GetLabel() and Duel.GetTurnPlayer()==tp and tc:GetFlagEffectLabel(c34680482)==e:GetLabel()
end
function c34680482.tdop(e,tp,eg,ep,ev,re,r,rp)
	local tc=e:GetLabelObject()
	Duel.Hint(HINT_CARD,0,c34680482)
