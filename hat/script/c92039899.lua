...
function c92039899.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc92039899(c92039899,0))
...
function c92039899.spfilter(c,e,tp)
	return c:IsSetCard(0x45) and c:GetCode()~=c92039899 and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
