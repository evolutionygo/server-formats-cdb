...
function c66094973.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc66094973(c66094973,0))
	...
	e3:SetDescription(aux.Stringc66094973(c66094973,1))
...
function c66094973.eqfilter(c)
	return c:GetFlagEffect(c66094973)~=0 
end
...
function c66094973.equipop(c,e,tp,tc)
	...
	if not c:EquipByEffectAndLimitRegister(e,tp,tc,c66094973) then return end
	if atk>0 then
		local e2=Effect.CreateEffect(c)
