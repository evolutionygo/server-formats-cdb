...
function c96864105.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc96864105(c96864105,0))
...
function c96864105.atkcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return c:CheckRemoveOverlayCard(tp,1,REASON_COST) and c:GetFlagEffect(c96864105)==0 end
	c:RemoveOverlayCard(tp,1,1,REASON_COST)
	c:RegisterFlagEffect(c96864105,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_DAMAGE_CAL,0,1)
end
