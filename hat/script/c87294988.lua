...
function c87294988.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc87294988(c87294988,0))
...
function c87294988.filter(c,e,tp)
	return c:IsRace(RACE_PLANT) and not c:IsCode(c87294988) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
