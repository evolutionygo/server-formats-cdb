...
function c15475415.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc15475415(c15475415,0))
	...
	e2:SetDescription(aux.Stringc15475415(c15475415,1))
...
c15475415.listed_series={0xc}
c15475415.counter_place_list={COUNTER_A}
