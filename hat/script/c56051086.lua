...
function c56051086.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc56051086(c56051086,0))
	...
	aux.AddEREquipLimit(c,nil,c56051086.eqval,Card.EquipByEffectAndLimitRegister,e1)
	--indest
	...
	e4:SetDescription(aux.Stringc56051086(c56051086,1))
...
c56051086.listed_series={0x48}
c56051086.aux.xyz_number=43
...
function c56051086.filter(c)
	return c:IsSetCard(0x48) and c:IsMonster() and not c:IsForbc56051086den()
end
