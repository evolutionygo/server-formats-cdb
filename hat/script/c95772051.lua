...
function c95772051.initial_effect(c)
	c:SetUniqueOnField(1,0,c95772051)
	--special summon
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc95772051(c95772051,0))
	...
	e2:SetDescription(aux.Stringc95772051(c95772051,1))
	e2:SetCategory(CATEGORY_TOHAND+CATEGORY_SEARCH)
	e2:SetType(EFFECT_TYPE_IGNITION)
	e2:SetRange(LOCATION_MZONE)
	e2:SetCountLimit(1,c95772051)
	e2:SetCost(c95772051.thcost)
	e2:SetTarget(c95772051.thtg)
	e2:SetOperation(c95772051.thop)
	c:RegisterEffect(e2)
end
c95772051.listed_series={0x207a}
