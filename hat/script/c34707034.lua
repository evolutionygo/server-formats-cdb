...
function c34707034.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	for tc in aux.Next(g) do
		...
		tc:RegisterFlagEffect(c34707034,RESET_EVENT+RESETS_STANDARD,0,1,fc34707034)
	end
	...
	e1:SetCountLimit(1)
	e1:SetLabel(fc34707034)
	e1:SetLabelObject(g)
	e1:SetCondition(c34707034.descon)
	e1:SetOperation(c34707034.desop)
	Duel.RegisterEffect(e1,tp)
end
function c34707034.desfilter(c,fc34707034)
	return c:GetFlagEffectLabel(c34707034)==fc34707034
end
