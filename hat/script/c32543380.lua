...
function c32543380.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc32543380(c32543380,0))
	...
	e4:SetDescription(aux.Stringc32543380(c32543380,1))
...
function c32543380.cfilter(c)
	return c:IsFaceup() and c:IsCode(21420702) and c:IsAbleToGraveAsCost()
end
function c32543380.spcon(e,c)
	if c==nil then return true end
	local tp=c:GetControler()
	local g=Duel.GetMatchingGroup(c32543380.cfilter,tp,LOCATION_ONFIELD,0,nil,ft)
	return #g>0 and Duel.GetMZoneCount(tp,g)>0
end
function c32543380.sptg(e,tp,eg,ep,ev,re,r,rp,c)
	local g=Duel.GetMatchingGroup(c32543380.cfilter,tp,LOCATION_ONFIELD,0,nil)
