...
function c14261867.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc14261867(c14261867,0))
	...
	e2:SetDescription(aux.Stringc14261867(c14261867,1))
...
function c14261867.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return c:IsCanTurnSet() and c:GetFlagEffect(c14261867)==0 end
	c:RegisterFlagEffect(c14261867,RESET_EVENT+RESETS_STANDARD-RESET_TURN_SET+RESET_PHASE+PHASE_END,0,1)
