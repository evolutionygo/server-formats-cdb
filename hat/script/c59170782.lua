...
function c59170782.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc59170782(c59170782,0))
	...
	e2:SetDescription(aux.Stringc59170782(c59170782,0))
	...
	e3:SetDescription(aux.Stringc59170782(c59170782,1))
...
function c59170782.spfilter(c,e,tp)
	return c:IsSetCard(0x74) and c:GetCode()~=c59170782 and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
