...
function c35950025.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc35950025(c35950025,0))
	...
	e2:SetDescription(aux.Stringc35950025(c35950025,1))
...
c35950025.listed_series={0x55,0x7b}
c35950025.listed_names={CARD_GALAXYEYES_P_DRAGON}
