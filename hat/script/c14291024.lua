...
function c14291024.tgop(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.Hint(HINT_SELECTMSG,tp,aux.Stringc14291024(c14291024,0))
	...
	c:RegisterFlagEffect(c14291024,RESET_EVENT+RESETS_STANDARD_DISABLE,0,1)
end
...
function c14291024.sdcon(e)
	return e:GetHandler():GetFirstCardTarget()==nil and e:GetHandler():GetFlagEffect(c14291024)~=0
end