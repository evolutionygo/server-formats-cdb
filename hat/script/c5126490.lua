...
function c5126490.initial_effect(c)
	...
	e3:SetDescription(aux.Stringc5126490(c5126490,0))
...
c5126490.listed_names={CARD_NEOS,78371393}
...
function c5126490.sptg(e,tp,eg,ep,ev,re,r,rp,c)
	local sg=Duel.GetMatchingGroup(c5126490.spfilter,tp,LOCATION_MZONE,0,nil,CARD_NEOS,78371393)
	local g=aux.SelectUnselectGroup(sg,e,tp,2,2,c5126490.rescon,1,tp,HINTMSG_TOGRAVE,nil,nil,true)
	if #g>0 then
		g:KeepAlive()
		e:SetLabelObject(g)
	return true
