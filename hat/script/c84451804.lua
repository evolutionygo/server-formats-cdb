...
function c84451804.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc84451804(c84451804,0))
...
c84451804.listed_names={10456559}
function c84451804.condition(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsSummonType(SUMMON_TYPE_TRIBUTE)
end
function c84451804.filter(c,e,tp)
	return c:IsCode(c84451804) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
