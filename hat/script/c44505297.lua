...
function c44505297.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc44505297(c44505297,0))
	...
	c:RegisterEffect(e1)
	aux.AddEREquipLimit(c,nil,aux.FilterBoolFunction(Card.IsMonster),c44505297.equipop,e1)
	--tograve
	local e2=Effect.CreateEffect(c)
	e2:SetDescription(aux.Stringc44505297(c44505297,1))
...
function c44505297.eqfilter(c)
	return c:IsMonster() and not c:IsForbc44505297den()
end
