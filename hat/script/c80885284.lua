...
function c80885284.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc80885284(c80885284,0))
	...
	e3:SetDescription(aux.Stringc80885284(c80885284,1))
	e3:SetCategory(CATEGORY_TOHAND+CATEGORY_SEARCH)
	e3:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e3:SetProperty(EFFECT_FLAG_DAMAGE_STEP)
	e3:SetCode(EVENT_FLIP)
	e3:SetCountLimit(1,c80885284)
	e3:SetTarget(c80885284.thtg)
	e3:SetOperation(c80885284.thop)
	c:RegisterEffect(e3)
end
c80885284.listed_series={0x8d}
...
function c80885284.postg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return c:IsCanTurnSet() and c:GetFlagEffect(c80885284)==0 end
	c:RegisterFlagEffect(c80885284,RESET_EVENT+RESETS_STANDARD-RESET_TURN_SET+RESET_PHASE+PHASE_END,0,1)
