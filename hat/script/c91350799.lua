...
function c91350799.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc91350799(c91350799,0))
	...
	e2:SetDescription(aux.Stringc91350799(c91350799,1))
	e2:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e2:SetType(EFFECT_TYPE_IGNITION)
	e2:SetRange(LOCATION_MZONE)
	e2:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e2:SetCountLimit(1,c91350799)
	e2:SetTarget(c91350799.sptg)
	e2:SetOperation(c91350799.spop)
	c:RegisterEffect(e2)
end
c91350799.listed_series={0x71}
...
function c91350799.filter(c,e,tp)
	return c:IsSetCard(0x71) and c:GetCode()~=c91350799 and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
