...
function c20349913.initial_effect(c)
	...
	e1:SetCountLimit(1,c20349913,EFFECT_COUNT_CODE_OATH)
...
function c20349913.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if e:IsHasType(EFFECT_TYPE_ACTIVATE) then
		...
		e1:SetDescription(aux.Stringc20349913(c20349913,1))
...
function c20349913.val(e,re,val,r,rp,rc)
