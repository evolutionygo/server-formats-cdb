...
function c7617062.regop(e,tp,eg,ep,ev,re,r,rp)
	...
	c:RegisterFlagEffect(c7617062,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_DAMAGE,0,1)
	eg:GetFirst():RegisterFlagEffect(c7617062+1,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_DAMAGE,0,1)
end
function c7617062.poscon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c7617062)>0
end
function c7617062.filter(c)
	return c:GetFlagEffect(c7617062+1)>0
end
