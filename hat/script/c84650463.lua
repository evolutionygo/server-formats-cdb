...
function c84650463.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc84650463(c84650463,0))
	...
	e2:SetDescription(aux.Stringc84650463(c84650463,1))
	e2:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e2:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e2:SetType(EFFECT_TYPE_IGNITION)
	e2:SetRange(LOCATION_GRAVE)
	e2:SetCountLimit(1,c84650463)
...
function c84650463.tgfilter(c)
	return c:IsCode(c84650463) and c:IsAbleToGrave()
end
...
function c84650463.cfilter(c)
	return c:IsCode(c84650463) and c:IsFaceup()
end
