...
function c71628381.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCode2(c,true,true,25247218,58843503)
	--Return itself to the Extra Deck and special summon materials
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc71628381(c71628381,0))
...
function c71628381.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if sumable and Duel.SelectYesNo(tp,aux.Stringc71628381(c71628381,1)) then
		Duel.BreakEffect()
