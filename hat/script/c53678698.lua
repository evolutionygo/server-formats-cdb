...
function c53678698.initial_effect(c)
	c:SetUniqueOnField(1,0,c53678698)
	--spsummon
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc53678698(c53678698,0))
	...
	e2:SetDescription(aux.Stringc53678698(c53678698,1))
...
function c53678698.thcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c53678698)>0
end
...
function c53678698.regop(e,tp,eg,ep,ev,re,r,rp)
	e:GetHandler():RegisterFlagEffect(c53678698,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
end