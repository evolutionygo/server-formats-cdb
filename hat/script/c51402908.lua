...
function c51402908.initial_effect(c)
	...
	e3:SetDescription(aux.Stringc51402908(c51402908,0))
...
function c51402908.spr(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsReason(REASON_DESTROY) and c:IsPreviousLocation(LOCATION_ONFIELD)
		...
		c:RegisterFlagEffect(c51402908,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,2)
	end
end
function c51402908.spcon(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	return c:GetTurnID()~=Duel.GetTurnCount() and c:GetFlagEffect(c51402908)>0
end
...
function c51402908.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	e:GetHandler():ResetFlagEffect(c51402908)
end
