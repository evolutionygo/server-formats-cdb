...
function c32999573.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc32999573(c32999573,0))
...
function c32999573.rcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c32999573+ep)==0
...
function c32999573.rop(e,tp,eg,ep,ev,re,r,rp)
	...
	e:GetHandler():RegisterFlagEffect(c32999573+ep,RESET_PHASE+PHASE_END,0,1)
