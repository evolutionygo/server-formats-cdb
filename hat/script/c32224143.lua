...
function c32224143.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc32224143(c32224143,0))
...
function c32224143.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) and tc:IsFaceup() and Duel.Destroy(tc,REASON_EFFECT)~=0 then
		...
		for tc in aux.Next(g) do
			tc:RegisterFlagEffect(c32224143,RESET_EVENT|RESETS_STANDARD|RESET_OVERLAY,0,1)
		end
...
function c32224143.cfilter2(c)
	return c32224143.cfilter(c) and c:GetFlagEffect(c32224143)~=0
end
