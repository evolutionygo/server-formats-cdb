...
function c32559361.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc32559361(c32559361,0))
	...
	e2:SetDescription(aux.Stringc32559361(c32559361,1))
	...
	e3:SetDescription(aux.Stringc32559361(c32559361,2))
	...
	e3:SetCost(aux.dxmcostgen(1,c32559361.mxmc,c32559361.slwc))
	e3:SetTarget(c32559361.damtg2)
	e3:SetOperation(c32559361.damop2)
	c:RegisterEffect(e3,false,REGISTER_FLAG_DETACH_XMAT)
end
c32559361.aux.xyz_number=9
...
function c32559361.mxmc(e,tp)
	return e:GetHandler():GetOverlayCount()
end
function c32559361.slwc(e,og)
	e:SetLabel(#og)
end
