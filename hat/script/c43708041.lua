...
function c43708041.initial_effect(c)
	...
	e3:SetDescription(aux.Stringc43708041(c43708041,0))
...
c43708041.listed_series={0x7d,0x107d}
...
function c43708041.filter(c)
	return c:IsSetCard(0x7d) and c:GetCode()~=c43708041 and c:IsAbleToHand()
end
