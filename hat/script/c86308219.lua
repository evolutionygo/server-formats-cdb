...
function c86308219.initial_effect(c)
	...
	c:RegisterEffect(e1)
	Duel.AddCustomActivityCounter(c86308219,ACTIVITY_SPSUMMON,c86308219.counterfilter)
end
...
function c86308219.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetCustomActivityCount(c86308219,tp,ACTIVITY_SPSUMMON)==0
	...
	e3:SetDescription(aux.Stringc86308219(c86308219,1))
