...
function c7573135.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc7573135(c7573135,0))
	...
	e2:SetDescription(aux.Stringc7573135(c7573135,1))
...
function c7573135.hspop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc then
		...
		local fc7573135=e:GetHandler():GetFieldID()
		tc:RegisterFlagEffect(c7573135,RESET_EVENT+RESETS_STANDARD,0,1,fc7573135)
...
function c7573135.retcon(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:GetFlagEffectLabel(c7573135)~=e:GetLabel() then
		e:Reset()
		return false
...
function c7573135.filter(c,e,tp)
	return c:IsSetCard(0x19) and not c:IsCode(c7573135) and c:IsCanBeSpecialSummoned(e,113,tp,false,false)
end
