--コドモドラゴン
--Kc35629124modo Dragon
function c35629124.initial_effect(c)
	--spsummon
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc35629124(c35629124,0))
	e1:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e1:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e1:SetProperty(EFFECT_FLAG_DAMAGE_STEP+EFFECT_FLAG_DELAY)
	e1:SetCode(EVENT_TO_GRAVE)
	e1:SetCountLimit(1,c35629124)
	e1:SetCost(c35629124.spcost)
	e1:SetTarget(c35629124.sptg)
	e1:SetOperation(c35629124.spop)
	c:RegisterEffect(e1)
	Duel.AddCustomActivityCounter(c35629124,ACTIVITY_SPSUMMON,c35629124.counterfilter)
end
...
function c35629124.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetActivityCount(tp,ACTIVITY_BATTLE_PHASE)==0
		and Duel.GetCustomActivityCount(c35629124,tp,ACTIVITY_SPSUMMON)==0 end
	...
	aux.RegisterClientHint(e:GetHandler(),nil,tp,1,0,aux.Stringc35629124(c35629124,1),nil)
end
