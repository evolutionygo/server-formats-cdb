...
function c8522996.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc8522996(c8522996,1))
...
function c8522996.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsPlayerCanSpecialSummonMonster(tp,c8522996,0,0x21,1000,2400,6,RACE_FIEND,ATTRIBUTE_DARK) end
...
function c8522996.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.GetLocationCount(tp,LOCATION_MZONE)<=0
		or not Duel.IsPlayerCanSpecialSummonMonster(tp,c8522996,0,0x21,1000,2400,6,RACE_FIEND,ATTRIBUTE_DARK) then return end
