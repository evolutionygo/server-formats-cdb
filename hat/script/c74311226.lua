...
function c74311226.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc74311226(c74311226,0))
...
c74311226.listed_names={c74311226}
...
function c74311226.thfilter(c)
	return not c:IsCode(c74311226) and c:IsRace(RACE_SEASERPENT) and c:IsAbleToHand()
end
