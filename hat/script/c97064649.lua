--暗躍のドルイド・ウィド
--Secret Sect Druc97064649 Wc97064649
function c97064649.initial_effect(c)
	--set
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc97064649(c97064649,0))
	e1:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e1:SetProperty(EFFECT_FLAG_DELAY+EFFECT_FLAG_DAMAGE_STEP+EFFECT_FLAG_CARD_TARGET)
	e1:SetCode(EVENT_TO_GRAVE)
	e1:SetCountLimit(1,c97064649)
...
function c97064649.settg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local tc=Duel.SelectTarget(tp,c97064649.filter,tp,LOCATION_GRAVE,0,1,1,nil)
