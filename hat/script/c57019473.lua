...
function c57019473.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc57019473(c57019473,0))
...
c57019473.listed_names={c57019473}
function c57019473.filter(c)
	return c:IsRace(RACE_THUNDER) and c:IsAttribute(ATTRIBUTE_LIGHT) and c:GetLevel()==4
		and not c:IsCode(c57019473) and c:IsAttackBelow(1600) and c:IsAbleToRemove() and aux.SpElimFilter(c,true)
end
