...
function c50789693.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc50789693(c50789693,0))
	...
	e2:SetDescription(aux.Stringc50789693(c50789693,1))
	e2:SetType(EFFECT_TYPE_QUICK_O)
	e2:SetCountLimit(1,c50789693,EFFECT_COUNT_CODE_DUEL)
...
function c50789693.adop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e) and c:IsFaceup() then
		local opt=Duel.SelectOption(tp,aux.Stringc50789693(c50789693,2),aux.Stringc50789693(c50789693,3))
		local e1=Effect.CreateEffect(c)
