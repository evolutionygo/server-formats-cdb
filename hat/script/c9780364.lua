...
function c9780364.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if #cg==0 then
		sel=Duel.SelectOption(tp,aux.Stringc9780364(c9780364,0))
	else sel=Duel.SelectOption(tp,aux.Stringc9780364(c9780364,0),aux.Stringc9780364(c9780364,1)) end
	if sel==0 then
