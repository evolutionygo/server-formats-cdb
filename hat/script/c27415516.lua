...
function c27415516.initial_effect(c)
	--Special summon 1 "Tc27415516al, Dragon Ruler of Waterfalls" from deck
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc27415516(c27415516,0))
	e1:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e1:SetType(EFFECT_TYPE_IGNITION)
	e1:SetRange(LOCATION_HAND)
	e1:SetCountLimit(1,c27415516)
...
c27415516.listed_names={26400609} --"Tc27415516al, Dragon Ruler of Waterfalls"
