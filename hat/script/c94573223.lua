...
function c94573223.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc94573223(c94573223,0))
...
function c94573223.spfilter(c,e,tp)
	return c:IsSetCard(0x56) and c:GetCode()~=c94573223 and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
