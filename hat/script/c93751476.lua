...
function c93751476.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc93751476(c93751476,1))
...
function c93751476.spfilter(c,e,tp)
	return c:IsSetCard(0x79) and c:GetLevel()==4 and c:GetCode()~=c93751476 and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
