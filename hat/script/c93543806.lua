...
function c93543806.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc93543806(c93543806,0))
	...
	c:RegisterEffect(e1)
	Duel.AddCustomActivityCounter(c93543806,ACTIVITY_SPSUMMON,c93543806.counterfilter)
end
c93543806.listed_series={0x70}
function c93543806.counterfilter(c)
	return c:IsSetCard(0x70)
end
function c93543806.lvcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetCustomActivityCount(c93543806,tp,ACTIVITY_SPSUMMON)==0 end
	...
	e2:SetDescription(aux.Stringc93543806(c93543806,1))
