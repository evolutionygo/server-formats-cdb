...
function c69000994.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc69000994(c69000994,0))
	...
	e3:SetDescription(aux.Stringc69000994(c69000994,1))
...
function c69000994.threg(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.GetCurrentPhase()==PHASE_STANDBY then
		...
		c:RegisterFlagEffect(c69000994,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_STANDBY,0,2)
	else
		e:SetLabel(0)
		c:RegisterFlagEffect(c69000994,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_STANDBY,0,1)
	end
end
function c69000994.thcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetLabelObject():GetLabel()~=Duel.GetTurnCount() and e:GetHandler():GetFlagEffect(c69000994)>0
end
function c69000994.thfilter(c)
	return c:IsSetCard(0x81) and c:GetCode()~=c69000994 and c:IsAbleToHand()
end
function c69000994.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
	Duel.SetOperationInfo(0,CATEGORY_TOHAND,nil,1,tp,LOCATION_DECK)
	e:GetHandler():ResetFlagEffect(c69000994)
end
