...
function c59627393.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc59627393(c59627393,0))
...
c59627393.listed_series={0x84}
c59627393.aux.xyz_number=105
...
function c59627393.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetFlagEffect(tp,c59627393)==0 and e:GetHandler():CheckRemoveOverlayCard(tp,1,REASON_COST) end
	e:GetHandler():RemoveOverlayCard(tp,1,1,REASON_COST)
	Duel.RegisterFlagEffect(tp,c59627393,RESET_PHASE+PHASE_DAMAGE,0,1)
end
