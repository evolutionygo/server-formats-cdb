...
function c81994591.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc81994591(c81994591,0))
	...
	e2:SetDescription(aux.Stringc81994591(c81994591,1))
...
c81994591.listed_series={0x1d}
function c81994591.filter(c)
	return c:IsSetCard(0x1d) and c:GetCode()~=c81994591 and c:IsAbleToHand()
end
