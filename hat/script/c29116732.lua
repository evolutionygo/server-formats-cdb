...
function c29116732.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc29116732(c29116732,0))
...
c29116732.listed_names={c29116732}
function c29116732.filter(c,e,tp)
	return c:IsCode(c29116732) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
