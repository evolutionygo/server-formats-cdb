...
function c85138716.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc85138716(c85138716,0))
	e2:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e2:SetType(EFFECT_TYPE_IGNITION)
	e2:SetRange(LOCATION_MZONE)
	e2:SetCountLimit(1,c85138716)
...
function c85138716.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then
		...
		return not Duel.IsPlayerAffectedByEffect(tp,CARD_BLUEEYES_SPIRIT) and ft>1 and g:IsExists(c85138716.filter2,1,nil,g)
	end
...
function c85138716.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if #dg>=1 then
		local fc85138716=e:GetHandler():GetFieldID()
		...
		tc1:RegisterFlagEffect(c85138716,RESET_EVENT+RESETS_STANDARD,0,1,fc85138716)
		tc2:RegisterFlagEffect(c85138716,RESET_EVENT+RESETS_STANDARD,0,1,fc85138716)
...
function c85138716.desfilter(c,fc85138716)
	return c:GetFlagEffectLabel(c85138716)==fc85138716
end
