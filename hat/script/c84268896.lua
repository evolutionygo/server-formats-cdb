...
function c84268896.initial_effect(c)
	c:SetUniqueOnField(1,0,c84268896)
	--set
	...
	e2:SetDescription(aux.Stringc84268896(c84268896,0))
	...
	e3:SetDescription(aux.Stringc84268896(c84268896,1))
