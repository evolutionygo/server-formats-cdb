...
function c28577986.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc28577986(c28577986,0))
	e1:SetType(EFFECT_TYPE_IGNITION)
	e1:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e1:SetRange(LOCATION_MZONE)
	e1:SetCountLimit(1,c28577986)
	e1:SetTarget(c28577986.target)
	e1:SetOperation(c28577986.operation)
	c:RegisterEffect(e1)
end
c28577986.listed_series={0x74}
...
function c28577986.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	local tg=aux.SelectUnselectGroup(sg,e,tp,1,ft,c28577986.rescon(slv),1,tp,HINTMSG_SPSUMMON)
