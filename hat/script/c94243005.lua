...
function c94243005.initial_effect(c)
	...
	e3:SetDescription(aux.Stringc94243005(c94243005,0))
	...
	e4:SetOperation(c94243005.regop)
	c:RegisterEffect(e4)
	--Search
	local e5=Effect.CreateEffect(c)
	e5:SetCategory(CATEGORY_TOHAND+CATEGORY_SEARCH)
	e5:SetDescription(aux.Stringc94243005(c94243005,1))
	e5:SetProperty(EFFECT_FLAG_DAMAGE_STEP)
	e5:SetType(EFFECT_TYPE_TRIGGER_O+EFFECT_TYPE_SINGLE)
	e5:SetCode(EVENT_TO_GRAVE)
	e5:SetCondition(c94243005.thcon)
	e5:SetTarget(c94243005.thtg)
	e5:SetOperation(c94243005.thop)
	e5:SetLabelObject(e4)
	c:RegisterEffect(e5)
end
c94243005.counter_place_list={0x13}
