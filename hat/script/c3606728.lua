...
function c3606728.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc3606728(c3606728,0))
...
function c3606728.efop(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_CARD,0,c3606728)
	local c=e:GetHandler()
	local rc=c:GetReasonCard()
	local e1=Effect.CreateEffect(rc)
	e1:SetDescription(aux.Stringc3606728(c3606728,1))
