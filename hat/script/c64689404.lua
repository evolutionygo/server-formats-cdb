...
function c64689404.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc64689404(c64689404,0))
	...
	e2:SetDescription(aux.Stringc64689404(c64689404,1))
...
function c64689404.ractg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if e:GetHandler():GetFlagEffect(c64689404)==0 then
		e:GetHandler():RegisterFlagEffect(c64689404,RESET_EVENT+RESETS_STANDARD,0,0)
...
function c64689404.descon(e,tp,eg,ep,ev,re,r,rp)
	...
	return c:GetFlagEffect(c64689404)~=0 and bc and bc:IsFaceup() and bc:IsRace(e:GetLabel())
end
