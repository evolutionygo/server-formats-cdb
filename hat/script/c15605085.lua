...
function c15605085.initial_effect(c)
	...
	local e2=aux.AddNormalSummonProcedure(c,true,true,1,1,SUMMON_TYPE_TRIBUTE,aux.Stringc15605085(c15605085,0),c15605085.otfilter)
	--destroy
	local e2=Effect.CreateEffect(c)
	e2:SetDescription(aux.Stringc15605085(c15605085,1))
