...
function c61019812.initial_effect(c)
	c:SetUniqueOnField(1,0,c61019812)
	--cannot release
	...
	e4:SetDescription(aux.Stringc61019812(c61019812,0))
	e4:SetCategory(CATEGORY_DAMAGE)
	e4:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_F)
	e4:SetCode(EVENT_DESTROYED)
	e4:SetCondition(c61019812.dmcon)
	e4:SetTarget(c61019812.dmtg)
	e4:SetOperation(c61019812.dmop)
	c:RegisterEffect(e4)
end
