...
function c79279397.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc79279397(c79279397,0))
...
c79279397.listed_names={c79279397}
...
function c79279397.filter(c,e,tp)
	return c:IsCode(c79279397) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
