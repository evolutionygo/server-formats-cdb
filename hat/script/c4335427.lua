...
function c4335427.initial_effect(c)
	...
	e4:SetDescription(aux.Stringc4335427(c4335427,0))
...
function c4335427.sptg(e,tp,eg,ep,ev,re,r,rp,c)
	...
	local sg=aux.SelectUnselectGroup(g,e,tp,4,4,c4335427.rescon,1,tp,HINTMSG_REMOVE,nil,nil,true)
	if #sg==4 then
		sg:KeepAlive()
		e:SetLabelObject(sg)
		return true
