...
function c66789970.initial_effect(c)
	...
	e1:SetCondition(c66789970.spcon)
	e1:SetTarget(c66789970.sptg)
	e1:SetOperation(c66789970.spop)
	c:RegisterEffect(e1)
	--destroy
	local e2=Effect.CreateEffect(c)
	e2:SetDescription(aux.Stringc66789970(c66789970,0))
...
function c66789970.spop(e,tp,eg,ep,ev,re,r,rp,c)
