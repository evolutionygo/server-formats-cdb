...
function c72167543.initial_effect(c)
	--xyz summon
	aux.AddXyzProcedure(c,aux.FilterBoolFunctionEx(Card.IsRace,RACE_SPELLCASTER),4,2,c72167543.ovfilter,aux.Stringc72167543(c72167543,0))
	c:EnableReviveLimit()
	--pierce
	...
	e3:SetDescription(aux.Stringc72167543(c72167543,1))
