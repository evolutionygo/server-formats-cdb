...
function c99004752.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsFaceup() and tc:IsRelateToEffect(e) and not tc:IsImmuneToEffect(e) then
		...
		e2:SetDescription(aux.Stringc99004752(c99004752,0))
		...
		tc:RegisterFlagEffect(c99004752,RESET_EVENT+RESETS_STANDARD_EXC_GRAVE+RESET_PHASE+PHASE_END,0,1)
	end
end
function c99004752.damcon(e,tp,eg,ep,ev,re,r,rp)
	local tc=e:GetLabelObject()
	return eg:IsContains(tc) and tc:GetFlagEffect(c99004752)~=0 and tc:GetOwner()==1-tp
