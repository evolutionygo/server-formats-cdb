...
function c83725008.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc83725008(c83725008,0))
...
function c83725008.set(e,tp,eg,ep,ev,re,r,rp)
	...
	if (r&REASON_EFFECT)>0 and rc:IsSetCard(0x38) and eg:IsExists(c83725008.cfilter,1,nil) then
		s[rp]=true
	end
end
