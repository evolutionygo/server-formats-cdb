...
function c97452817.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc97452817(c97452817,0))
...
c97452817.listed_names={97452818}
...
function c97452817.coinop(e,tp,eg,ep,ev,re,r,rp)
	...
	c97452817.arcanareg(c,Arcana.TossCoin(c,tp))
end
function c97452817.arcanareg(c,coin)
	--coin effect
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc97452817(c97452817,1))
	...
	e2:SetDescription(aux.Stringc97452817(c97452817,2))
...
function c97452817.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsPlayerCanSpecialSummonMonster(tp,c97452817+1,0,TYPES_TOKEN,0,0,1,RACE_FAIRY,ATTRIBUTE_LIGHT) end
	Duel.SetOperationInfo(0,CATEGORY_TOKEN,nil,1,0,0)
	Duel.SetOperationInfo(0,CATEGORY_SPECIAL_SUMMON,nil,1,tp,0)
end
function c97452817.spop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsPlayerCanSpecialSummonMonster(tp,c97452817+1,0,TYPES_TOKEN,0,0,1,RACE_FAIRY,ATTRIBUTE_LIGHT) then
		local token=Duel.CreateToken(tp,c97452817+1)
