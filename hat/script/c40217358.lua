...
function c40217358.initial_effect(c)
	c:SetUniqueOnField(1,0,c40217358)
	--cannot release
	...
	e4:SetDescription(aux.Stringc40217358(c40217358,0))
	e4:SetCategory(CATEGORY_REMOVE)
	e4:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_F)
	e4:SetCode(EVENT_DESTROYED)
	e4:SetCondition(c40217358.rmcon)
	e4:SetTarget(c40217358.rmtg)
	e4:SetOperation(c40217358.rmop)
	c:RegisterEffect(e4)
end
...
function c40217358.rmop(e,tp,eg,ep,ev,re,r,rp)
	...
	tc:RegisterFlagEffect(c40217358,RESET_EVENT+RESETS_STANDARD,0,0)
...
function c40217358.retop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:GetFlagEffect(c40217358)~=0 then
