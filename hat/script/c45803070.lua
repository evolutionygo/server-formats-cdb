...
function c45803070.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc45803070(c45803070,0))
	...
	e3:SetDescription(aux.Stringc45803070(c45803070,1))
	e3:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e3:SetCode(EVENT_SPSUMMON_SUCCESS)
	e3:SetProperty(EFFECT_FLAG_CARD_TARGET+EFFECT_FLAG_DAMAGE_STEP)
	e3:SetCountLimit(1,c45803070)
	e3:SetTarget(c45803070.settg)
	e3:SetOperation(c45803070.setop)
	c:RegisterEffect(e3)
end
c45803070.listed_series={0x4c,0x89,0x108a}
...
function c45803070.setop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) and Duel.GetLocationCount(tp,LOCATION_SZONE)>0 then
		Duel.SSet(tp,tc)
		local fc45803070=e:GetHandler():GetFieldID()
		...
		e1:SetValue(fc45803070)
		e1:SetCondition(c45803070.rmcon)
		e1:SetOperation(c45803070.rmop)
		Duel.RegisterEffect(e1,tp)
		tc:RegisterFlagEffect(c45803070,RESET_EVENT+RESETS_STANDARD,0,1,fc45803070)
	end
end
...
function c45803070.rmop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:GetFlagEffectLabel(c45803070)==e:GetValue() then
