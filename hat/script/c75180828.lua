...
function c75180828.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc75180828(c75180828,0))
	...
	e2:SetDescription(aux.Stringc75180828(c75180828,1))
	...
	e3:SetDescription(aux.Stringc75180828(c75180828,2))
...
function c75180828.atktg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():GetFlagEffect(c75180828)==0 end
end
function c75180828.atkop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e) and c:IsFaceup() then
		--destroy
		local e1=Effect.CreateEffect(c)
		e1:SetDescription(aux.Stringc75180828(c75180828,3))
		...
		c:RegisterEffect(e1)
		c:RegisterFlagEffect(c75180828,RESET_PHASE+PHASE_END,0,1)
	end
end
