...
function c79080761.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc79080761(c79080761,0))
...
function c79080761.spfilter(c,tp)
...
function c79080761.spcon(e,c)
	...
	local rg=Duel.GetMatchingGroup(c79080761.spfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,nil,tp)
	local ft=Duel.GetLocationCount(tp,LOCATION_MZONE)
	return ft>-1 and #rg>0 and aux.SelectUnselectGroup(rg,e,tp,2,2,nil,0)
end
function c79080761.sptg(e,tp,eg,ep,ev,re,r,rp,c)
