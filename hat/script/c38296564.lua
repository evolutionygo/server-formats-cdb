...
function c38296564.op(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e) and tc and tc:IsFaceup() and tc:IsRelateToEffect(e) then
		c:RegisterFlagEffect(c38296564,RESET_EVENT+RESETS_STANDARD,0,1,tp)
	end
end
function c38296564.acon(e)
	return e:GetHandler():GetFlagEffect(c38296564)>0 and e:GetHandler():GetFlagEffectLabel(c38296564)==e:GetHandler():GetFirstCardTarget():GetControler()
end
