...
function c61466310.initial_effect(c)
	...
	e3:SetDescription(aux.Stringc61466310(c61466310,0))
	e3:SetCategory(CATEGORY_TOHAND+CATEGORY_SEARCH)
	e3:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_O)
	e3:SetRange(LOCATION_SZONE)
	e3:SetCountLimit(1,c61466310)
...
function c61466310.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if t1 and t2 then e:SetLabel(Duel.SelectOption(tp,aux.Stringc61466310(c61466310,1),aux.Stringc61466310(c61466310,2)))
	elseif t1 then e:SetLabel(Duel.SelectOption(tp,aux.Stringc61466310(c61466310,1)))
	else e:SetLabel(Duel.SelectOption(tp,aux.Stringc61466310(c61466310,2))+1) end
