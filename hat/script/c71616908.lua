...
function c71616908.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCode2(c,true,true,aux.FilterBoolFunctionEx(Card.IsSetCard,0x1047),aux.FilterBoolFunctionEx(Card.IsRace,RACE_AQUA))
	--spsummon condition
	...
	e3:SetDescription(aux.Stringc71616908(c71616908,0))
...
c71616908.listed_series={0x1047}
