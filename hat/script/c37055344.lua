...
function c37055344.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc37055344(c37055344,0))
...
function c37055344.target2(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local op=0
	if b1 and b2 then
		op=Duel.SelectOption(tp,aux.Stringc37055344(c37055344,1),aux.Stringc37055344(c37055344,2))
	elseif b1 then
		op=Duel.SelectOption(tp,aux.Stringc37055344(c37055344,1))
	else
		op=Duel.SelectOption(tp,aux.Stringc37055344(c37055344,2))+1
	end
	e:SetLabel(op)
	if op==0 then
