...
function c82386016.initial_effect(c)
	...
	c:RegisterEffect(e1)
	Duel.AddCustomActivityCounter(c82386016,ACTIVITY_CHAIN,c82386016.chainfilter)
end
function c82386016.chainfilter(re,tp,cc82386016)
	return not re:IsActiveType(TYPE_SPELL+TYPE_TRAP)
end
function c82386016.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetCustomActivityCount(c82386016,tp,ACTIVITY_CHAIN)==0 end
	...
	e2:SetDescription(aux.Stringc82386016(c82386016,1))
