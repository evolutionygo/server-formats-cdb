...
function c25341652.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc25341652(c25341652,0))
	...
	e2:SetValue(function(e,c) return c25341652.repfilter(c,e:GetHandlerPlayer()) end)
	c:RegisterEffect(e2)
end
c25341652.listed_series={SET_DJINN}
