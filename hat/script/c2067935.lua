...
function c2067935.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc2067935(c2067935,0))
	...
	e2:SetDescription(aux.Stringc2067935(c2067935,1))
...
c2067935.listed_series={0x19}
c2067935.listed_names={c2067935}
...
function c2067935.filter(c,e,tp)
	return not c:IsCode(c2067935) and c:IsSetCard(0x19) and c:IsCanBeSpecialSummoned(e,112,tp,false,false)
end
