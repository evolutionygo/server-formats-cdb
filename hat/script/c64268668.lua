...
function c64268668.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc64268668(c64268668,0))
...
c64268668.listed_names={c64268668}
function c64268668.atkcon(e,tp,eg,ep,ev,re,r,rp)
	local a=Duel.GetAttacker()
	local d=Duel.GetAttackTarget()
	return (Duel.GetCurrentPhase()>=PHASE_BATTLE_START and Duel.GetCurrentPhase()<=PHASE_BATTLE)
		and ((a and a:IsControler(tp) and a:IsFaceup() and a:IsCode(c64268668))
		or (d and d:IsControler(tp) and d:IsFaceup() and d:IsCode(c64268668)))
end
