...
function c89642993.eftg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local op=Duel.SelectOption(tp,aux.Stringc89642993(c89642993,1),aux.Stringc89642993(c89642993,2))
	e:SetLabel(op)
end
...
function c89642993.drop(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_CARD,0,c89642993)
