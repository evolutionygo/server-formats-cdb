...
function c22993208.initial_effect(c)
	...
	e1:SetCountLimit(1,c22993208,EFFECT_COUNT_CODE_OATH)
...
function c22993208.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc and Duel.SpecialSummonStep(tc,0,tp,tp,false,false,POS_FACEUP) then
		...
		tc:RegisterFlagEffect(c22993208,RESET_EVENT+RESETS_STANDARD,0,1)
...
function c22993208.descon(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:GetFlagEffect(c22993208)~=0 then
		return true
	else
		e:Reset()
		return false
