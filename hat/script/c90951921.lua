...
function c90951921.initial_effect(c)
	...
	e1:SetCountLimit(1,c90951921,EFFECT_COUNT_CODE_OATH)
	e1:SetCost(c90951921.cost)
	e1:SetTarget(c90951921.target)
	e1:SetOperation(c90951921.activate)
	c:RegisterEffect(e1)
	Duel.AddCustomActivityCounter(c90951921,ACTIVITY_SPSUMMON,c90951921.counterfilter)
end
c90951921.listed_series={0x70}
function c90951921.counterfilter(c)
	return c:IsSetCard(0x70)
end
function c90951921.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetCustomActivityCount(c90951921,tp,ACTIVITY_SPSUMMON)==0 end
	--oath effects
	...
	e2:SetDescription(aux.Stringc90951921(c90951921,1))
