...
function c50321796.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc50321796(c50321796,0))
	e1:SetCategory(CATEGORY_TOHAND)
	e1:SetType(EFFECT_TYPE_IGNITION)
	e1:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e1:SetRange(LOCATION_MZONE)
	e1:SetCountLimit(1,c50321796)
...
function c50321796.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return aux.IceBarrierDiscardCost(c50321796.costfilter,true,1,rt)(e,tp,eg,ep,ev,re,r,rp,0) end
	local cg=aux.IceBarrierDiscardCost(c50321796.costfilter,true,1,rt)(e,tp,eg,ep,ev,re,r,rp,1)
	e:SetLabel(cg)
end
