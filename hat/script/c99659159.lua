...
function c99659159.initial_effect(c)
	...
	e3:SetDescription(aux.Stringc99659159(c99659159,0))
...
function c99659159.filter(c)
	return c:IsSetCard(0x29) and c:IsRace(RACE_DRAGON) and not c:IsForbc99659159den()
end
