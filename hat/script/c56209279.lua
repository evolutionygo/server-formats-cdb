...
function c56209279.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc56209279(c56209279,0))
	...
	e2:SetDescription(aux.Stringc56209279(c56209279,1))
...
function c56209279.filter(c,e,tp)
	return c:IsSetCard(0xb) and c:GetCode()~=c56209279 and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
