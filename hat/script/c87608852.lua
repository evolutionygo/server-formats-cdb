...
function c87608852.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc87608852(c87608852,0))
	...
	c:RegisterEffect(e1)
	Duel.AddCustomActivityCounter(c87608852,ACTIVITY_SPSUMMON,c87608852.counterfilter)
	Duel.AddCustomActivityCounter(c87608852,ACTIVITY_CHAIN,c87608852.chainfilter)
end
c87608852.listed_series={0x106e}
function c87608852.counterfilter(c)
	return not c:IsLevelAbove(5)
end
function c87608852.chainfilter(re,tp,cc87608852)
...
function c87608852.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():IsReleasable()
		and Duel.GetCustomActivityCount(c87608852,tp,ACTIVITY_SPSUMMON)==0
		and Duel.GetCustomActivityCount(c87608852,tp,ACTIVITY_CHAIN)>0 end
	...
	e2:SetDescription(aux.Stringc87608852(c87608852,1))
