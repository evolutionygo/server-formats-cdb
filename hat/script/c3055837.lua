...
function c3055837.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	local cc3055837=Duel.GetChainInfo(ev,CHAININFO_CHAIN_ID)
	local e1=Effect.CreateEffect(e:GetHandler())
	e1:SetType(EFFECT_TYPE_FIELD)
	e1:SetCode(EFFECT_CHANGE_DAMAGE)
	e1:SetProperty(EFFECT_FLAG_PLAYER_TARGET)
	e1:SetTargetRange(1,0)
	e1:SetLabel(cc3055837)
...
function c3055837.refcon(e,re,val,r,rp,rc)
	...
	local cc3055837=Duel.GetChainInfo(0,CHAININFO_CHAIN_ID)
	if cc3055837==e:GetLabel() then return 0
	else return val end
end