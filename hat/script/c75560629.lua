...
function c75560629.initial_effect(c)
	...
	e6:SetDescription(aux.Stringc75560629(c75560629,0))
...
function c75560629.eqlimit(e,c)
	return c:GetCode()~=83812099 or c:IsDisabled() or not c:GetEquipGroup():IsExists(Card.IsCode,1,e:GetHandler(),c75560629)
end
function c75560629.filter(c)
	return c:IsFaceup() and (c:GetCode()~=83812099 or c:IsDisabled() or not c:GetEquipGroup():IsExists(Card.IsCode,1,nil,c75560629))
end
