...
function c37781520.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc37781520(c37781520,0))
	...
	e2:SetDescription(aux.Stringc37781520(c37781520,1))
	...
	e3:SetDescription(aux.Stringc37781520(c37781520,2))
	e3:SetCategory(CATEGORY_TOGRAVE)
	e3:SetProperty(EFFECT_FLAG_PLAYER_TARGET)
	e3:SetType(EFFECT_TYPE_IGNITION)
	e3:SetRange(LOCATION_MZONE)
	e3:SetCountLimit(1,c37781520)
	e3:SetCost(c37781520.hdcost)
	e3:SetTarget(c37781520.hdtg)
	e3:SetOperation(c37781520.hdop)
	c:RegisterEffect(e3)
end
c37781520.listed_series={0x75,0x74}
