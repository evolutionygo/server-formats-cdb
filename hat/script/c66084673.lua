...
function c66084673.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc66084673(c66084673,0))
...
c66084673.listed_series={0x79,0x7c}
...
function c66084673.atkcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():GetFlagEffect(c66084673)==0
	...
	e:GetHandler():RegisterFlagEffect(c66084673,RESET_PHASE+PHASE_DAMAGE_CAL,0,1)
end
