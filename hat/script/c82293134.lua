...
function c82293134.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc82293134(c82293134,0))
	...
	e2:SetDescription(aux.Stringc82293134(c82293134,1))
	e2:SetCategory(CATEGORY_TOHAND+CATEGORY_SEARCH)
	e2:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_F)
	e2:SetCode(EVENT_TO_GRAVE)
	e2:SetCountLimit(1,c82293134)
	e2:SetTarget(c82293134.thtg)
	e2:SetOperation(c82293134.thop)
	c:RegisterEffect(e2)
end
c82293134.listed_series={0x76}
...
function c82293134.filter(c)
	return c:IsSetCard(0x76) and c:GetCode()~=c82293134 and c:IsMonster() and c:IsAbleToHand()
end
