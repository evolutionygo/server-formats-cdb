...
function c73428497.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc73428497(c73428497,0))
...
function c73428497.filter(c,e,tp)
	return c:IsSetCard(0x72) and c:GetCode()~=c73428497 and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP_DEFENSE)
end
