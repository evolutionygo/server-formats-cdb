...
function c30604579.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc30604579(c30604579,0))
	...
	e3:SetDescription(aux.Stringc30604579(c30604579,1))
	...
	e4:SetDescription(aux.Stringc30604579(c30604579,2))
...
c30604579.listed_series={0x6042}
function c30604579.tfilter(c,scard,sumtype,tp)
...
function c30604579.regop(e,tp,eg,ep,ev,re,r,rp)
	...
	if rp~=tp and c:IsPreviousControler(tp) and c:IsReason(REASON_DESTROY)
		...
		c:RegisterFlagEffect(c30604579,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
	end
end
function c30604579.spcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c30604579)~=0
end
