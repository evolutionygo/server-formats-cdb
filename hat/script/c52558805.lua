...
function c52558805.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc52558805(c52558805,0))
...
c52558805.listed_series={SET_DJINN}
...
function c52558805.atktg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.IsExistingTarget(c52558805.filter,tp,0,LOCATION_MZONE,1,nil,tp)
		and Duel.IsExistingMatchingCard(c52558805.atkfilter,tp,LOCATION_MZONE,0,1,nil) end
