...
function c46384403.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc46384403(c46384403,0))
...
c46384403.listed_names={c46384403}
...
function c46384403.filter(c,e,tp)
	return c:IsCode(c46384403) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
