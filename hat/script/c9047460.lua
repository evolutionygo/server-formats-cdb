...
function c9047460.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc9047460(c9047460,0))
	...
	e2:SetDescription(aux.Stringc9047460(c9047460,1))
	e2:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e2:SetType(EFFECT_TYPE_IGNITION)
	e2:SetRange(LOCATION_GRAVE)
	e2:SetCountLimit(1,c9047460,EFFECT_COUNT_CODE_DUEL)
...
c9047460.listed_names={9047461}
c9047460.listed_series={0x33}
...
function c9047460.tkop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.GetLocationCount(tp,LOCATION_MZONE)>0 
		and Duel.IsPlayerCanSpecialSummonMonster(tp,c9047460+1,0,TYPES_TOKEN,100,100,3,RACE_AQUA,ATTRIBUTE_WIND) then
		local token=Duel.CreateToken(tp,c9047460+1)
...
function c9047460.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e) and Duel.SpecialSummon(c,0,tp,tp,false,false,POS_FACEUP)~=0 then
		c:RegisterFlagEffect(c9047460,RESET_EVENT+RESETS_STANDARD,0,0)
	end
end
function c9047460.matcon(e)
	return e:GetHandler():GetFlagEffect(c9047460)>0
end