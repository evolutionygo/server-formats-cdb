...
function c12235475.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc12235475(c12235475,0))
...
function c12235475.con(e,tp,eg,ep,ev,re,r,rp)
	...
	return c:GetFlagEffect(c12235475)==0 and (Duel.GetAttacker()==c or Duel.GetAttackTarget()==c)
end
function c12235475.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	e:GetHandler():RegisterFlagEffect(c12235475,RESET_PHASE+PHASE_DAMAGE_CAL,0,1)
end
