...
function c75673220.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc75673220(c75673220,0))
	e1:SetCategory(CATEGORY_REMOVE)
	e1:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_F)
	e1:SetCode(EVENT_TO_GRAVE)
	e1:SetCountLimit(1,c75673220)
...
function c75673220.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	tc:RegisterFlagEffect(c75673220,RESET_EVENT+RESETS_STANDARD,0,1)
...
function c75673220.retcon(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:GetFlagEffect(c75673220)==0 then
		e:Reset()
		return false
	else
		return true
