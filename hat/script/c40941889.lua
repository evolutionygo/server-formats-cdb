...
function c40941889.initial_effect(c)
	c:SetUniqueOnField(1,0,c40941889)
	--equip
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc40941889(c40941889,0))
	...
	c:RegisterEffect(e1)
	aux.AddZWEquipLimit(c,c40941889.eqcon,function(tc,c,tp) return c40941889.filter(tc) and tc:IsControler(tp) end,c40941889.equipop,e1)
	--attack all
...
c40941889.listed_series={0x107f}
function c40941889.eqcon(e)
...
function c40941889.eqop(e,tp,eg,ep,ev,re,r,rp)
	...
	c40941889.equipop(c,e,tp,tc)
end
function c40941889.equipop(c,e,tp,tc)
