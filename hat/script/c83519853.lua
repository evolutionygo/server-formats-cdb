...
function c83519853.initial_effect(c)
	c:SetUniqueOnField(1,0,c83519853)
	--synchro summon
	aux.AddSynchroProcedure(c,nil,1,1,aux.NonTunerEx(Card.IsSetCard,0x107a),1,99)
	c:EnableReviveLimit()
	--equip
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc83519853(c83519853,0))
	...
	e3:SetDescription(aux.Stringc83519853(c83519853,1))
...
c83519853.listed_series={0x207a,0x107a}
...
function c83519853.regop(e,tp,eg,ep,ev,re,r,rp)
	e:GetHandler():RegisterFlagEffect(c83519853,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
end
function c83519853.thcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c83519853)~=0
end
