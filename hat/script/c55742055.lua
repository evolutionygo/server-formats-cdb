...
function c55742055.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc55742055(c55742055,0))
	...
	e3:SetDescription(aux.Stringc55742055(c55742055,1))
	...
	e4:SetDescription(aux.Stringc55742055(c55742055,2))
	...
	e5:SetDescription(aux.Stringc55742055(c55742055,3))
...
c55742055.listed_series={0x107a,0x207a}
...
function c55742055.operation2(e,tp,eg,ep,ev,re,r,rp)
	...
	if #tg>0 and Duel.GetLocationCount(tp,LOCATION_SZONE)>0 and Duel.SelectYesNo(tp,aux.Stringc55742055(c55742055,4)) then
		Duel.BreakEffect()
