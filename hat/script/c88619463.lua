...
function c88619463.initial_effect(c)
	...
	e3:SetDescription(aux.Stringc88619463(c88619463,0))
	...
	c:RegisterEffect(e3)
	aux.DoubleSnareValc88619463ity(c,LOCATION_MZONE)
end
...
function c88619463.spcon(e,c)
	...
	return Duel.CheckReleaseGroup(tp,c88619463.rfilter,2,false,2,true,c,tp,nil,nil,nil,tp)
end
function c88619463.sptg(e,tp,eg,ep,ev,re,r,rp,chk,c)
	local ft=Duel.GetLocationCount(tp,LOCATION_MZONE)
	local g=Duel.SelectReleaseGroup(tp,c88619463.rfilter,2,2,false,true,true,c,nil,nil,false,nil,tp)
	if g then
		g:KeepAlive()
		e:SetLabelObject(g)
	return true
