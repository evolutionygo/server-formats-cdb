...
function c41493640.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc41493640(c41493640,0))
	...
	e2:SetDescription(aux.Stringc41493640(c41493640,1))
	e2:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e2:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e2:SetCode(EVENT_CUSTOM+c41493640)
...
function c41493640.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsTrap() and Duel.Destroy(tc,REASON_EFFECT)~=0 then
		if c:IsFaceup() and c:IsRelateToEffect(e) then
			Duel.RaiseSingleEvent(c,EVENT_CUSTOM+c41493640,e,0,tp,tp,0)
		end
	end
end
