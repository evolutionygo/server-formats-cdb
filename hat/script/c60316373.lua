...
function c60316373.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc60316373(c60316373,0))
	e1:SetCategory(CATEGORY_TOHAND)
	e1:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e1:SetType(EFFECT_TYPE_IGNITION)
	e1:SetRange(LOCATION_GRAVE)
	e1:SetCountLimit(1,c60316373)
	e1:SetCost(c60316373.cost)
	e1:SetTarget(c60316373.target)
	e1:SetOperation(c60316373.operation)
	c:RegisterEffect(e1)
end
c60316373.listed_series={0x76}
c60316373.listed_names={c60316373}
function c60316373.rfilter(c)
	return c:IsCode(c60316373) and c:IsAbleToRemoveAsCost() and aux.SpElimFilter(c,true)
end
