...
function c29357956.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCode2N(c,true,true,aux.FilterBoolFunctionEx(Card.IsSetCard,0x19),3)
	Fusion.AddContactProc(c,c29357956.contactfil,c29357956.contactop,c29357956.splimit)
	...
	e6:SetDescription(aux.Stringc29357956(c29357956,1))
