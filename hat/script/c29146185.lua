...
function c29146185.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc29146185(c29146185,0))
	...
	e2:SetDescription(aux.Stringc29146185(c29146185,1))
	e2:SetCategory(CATEGORY_DESTROY)
	e2:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e2:SetCode(EVENT_CUSTOM+c29146185)
	e2:SetCost(c29146185.descost)
	e2:SetTarget(c29146185.destg)
	e2:SetOperation(c29146185.desop)
	c:RegisterEffect(e2)
end
c29146185.listed_series={0x106e}
...
function c29146185.retcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	e1:SetDescription(aux.Stringc29146185(c29146185,1))
...
function c29146185.retop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.SendtoHand(g,nil,REASON_EFFECT)>0 then
		...
		if c:IsFaceup() and c:IsRelateToEffect(e) then
			Duel.RaiseSingleEvent(c,EVENT_CUSTOM+c29146185,re,r,rp,0,0)
		end
	end
end
