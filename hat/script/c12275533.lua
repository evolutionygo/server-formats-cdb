...
function c12275533.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc12275533(c12275533,0))
...
function c12275533.checkop(e,tp,eg,ep,ev,re,r,rp)
	...
	for tc in aux.Next(eg) do
		Duel.RegisterFlagEffect(tc:GetSummonPlayer(),c12275533,RESET_PHASE+PHASE_END,0,1)
	end
end
function c12275533.condition(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetFlagEffect(1-tp,c12275533)>=3
end
