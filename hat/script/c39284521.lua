...
function c39284521.spfilter(c,tp)
	return c:IsRace(RACE_MACHINE) and c:IsAbleToGraveAsCost()
end
function c39284521.spcon(e,c)
	if c==nil then return true end
	local rg=Duel.GetMatchingGroup(c39284521.spfilter,c:GetControler(),LOCATION_HAND,0,e:GetHandler())
	return aux.SelectUnselectGroup(rg,e,c:GetControler(),1,#rg,aux.ChkfMMZ(1),0)
end
function c39284521.sptg(e,tp,eg,ep,ev,re,r,rp,c)
	local rg=Duel.GetMatchingGroup(c39284521.spfilter,tp,LOCATION_HAND,0,e:GetHandler())
