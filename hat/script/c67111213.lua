...
function c67111213.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc67111213(c67111213,0))
...
c67111213.listed_series={0x3a}
function c67111213.filter(c)
	return c:IsDefenseBelow(1000) and c:IsSetCard(0x3a) and c:IsMonster() and c:GetCode()~=c67111213 and c:IsAbleToHand()
end
