...
function c15893860.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc15893860(c15893860,0))
...
function c15893860.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	for i=1,ct do
		Duel.Hint(HINT_SELECTMSG,tp,aux.Stringc15893860(c15893860,1))
		local tc=g:Select(tp,1,1,nil):GetFirst()
		tc:AddCounter(0x1015,1)
	end
	if ct>=3 and Duel.SelectYesNo(tp,aux.Stringc15893860(c15893860,2)) then
		Duel.BreakEffect()
