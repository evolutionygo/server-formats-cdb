...
function c72709014.initial_effect(c)
	...
	e5:SetDescription(aux.Stringc72709014(c72709014,0))
...
c72709014.listed_names={75917088,2316186,46128076}
...
function c72709014.regop(e,tp,eg,ep,ev,re,r,rp)
	if eg:IsExists(c72709014.regfilter,1,nil,e:GetHandler():GetEquipTarget()) then
		e:GetHandler():RegisterFlagEffect(c72709014,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
	end
end
function c72709014.spcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c72709014)~=0
end
