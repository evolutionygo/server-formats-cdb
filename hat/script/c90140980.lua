...
function c90140980.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCode2(c,true,true,12482652,42941100,79335209)
	--disable field
...
function c90140980.disop(e,tp)
	...
	if c>1 and Duel.SelectYesNo(tp,aux.Stringc90140980(c90140980,0)) then
		local dis2=Duel.SelectDisableField(tp,1,0,LOCATION_MZONE,dis1)
		dis1=(dis1|dis2)
		if c>2 and Duel.SelectYesNo(tp,aux.Stringc90140980(c90140980,0)) then
