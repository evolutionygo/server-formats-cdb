...
function c24101897.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc24101897(c24101897,0))
	...
	e3:SetDescription(aux.Stringc24101897(c24101897,1))
...
function c24101897.postg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return c:IsCanTurnSet() and c:GetFlagEffect(c24101897)==0 end
	c:RegisterFlagEffect(c24101897,RESET_EVENT+RESETS_STANDARD-RESET_TURN_SET+RESET_PHASE+PHASE_END,0,1)
