...
function c99365553.initial_effect(c)
	...
	e3:SetDescription(aux.Stringc99365553(c99365553,0))
...
function c99365553.spcon1(e,c)
	...
	return ft>-2 and #rg1>0 and #rg2>0 and aux.SelectUnselectGroup(rg,e,tp,2,2,c99365553.rescon,0)
end
function c99365553.sptg1(e,tp,eg,ep,ev,re,r,rp,c)
	...
	local g=aux.SelectUnselectGroup(rg,e,tp,2,2,c99365553.rescon,1,tp,HINTMSG_REMOVE,nil,nil,true)
	if #g>0 then
		g:KeepAlive()
		e:SetLabelObject(g)
		return true
...
function c99365553.rescon2(sg,e,tp,mg)
	return sg:IsExists(c99365553.atchk1,1,nil,sg)
end
function c99365553.sptg2(e,tp,eg,ep,ev,re,r,rp,c)
	local c=e:GetHandler()
	local g=nil
	local rg=Duel.GetMatchingGroup(c99365553.spfilter2,tp,LOCATION_HAND,0,nil,ATTRIBUTE_LIGHT+ATTRIBUTE_DARK)
	local g=aux.SelectUnselectGroup(rg,e,tp,2,2,c99365553.rescon2,1,tp,HINTMSG_TOGRAVE,nil,nil,true)
	if #g>0 then
		g:KeepAlive()
		e:SetLabelObject(g)
		return true
