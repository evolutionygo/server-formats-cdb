...
function c56321639.initial_effect(c)
	...
	e4:SetOperation(c56321639.regop)
	c:RegisterEffect(e4)
	--add a Spellcaster to hand
	local e5=Effect.CreateEffect(c)
	e5:SetDescription(aux.Stringc56321639(c56321639,0))
	e5:SetCategory(CATEGORY_TOHAND+CATEGORY_SEARCH)
	e5:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e5:SetProperty(EFFECT_FLAG_DAMAGE_STEP)
	e5:SetCode(EVENT_TO_GRAVE)
	e5:SetLabelObject(e4)
	e5:SetCondition(c56321639.thcon)
	e5:SetTarget(c56321639.thtg)
	e5:SetOperation(c56321639.thop)
	c:RegisterEffect(e5)
end
c56321639.listed_series={0x106e}
c56321639.counter_list={COUNTER_SPELL}
...
function c56321639.filter(c,level)
