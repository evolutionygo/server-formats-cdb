...
function c54578613.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc54578613(c54578613,0))
	...
	c:RegisterEffect(e1)
	aux.AddEREquipLimit(c,nil,c54578613.eqval,Card.EquipByEffectAndLimitRegister,e1)
	--destroy
	local e2=Effect.CreateEffect(c)
	e2:SetDescription(aux.Stringc54578613(c54578613,1))
...
function c54578613.filter(c)
	return c:IsSetCard(0x29) and c:IsLevelBelow(3) and c:IsRace(RACE_DRAGON) and not c:IsForbc54578613den()
end
