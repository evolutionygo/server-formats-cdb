...
function c40390147.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc40390147(c40390147,0))
...
function c40390147.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local opt=0
	if b1 and b2 then
		opt=Duel.SelectOption(tp,aux.Stringc40390147(c40390147,1),aux.Stringc40390147(c40390147,2))
	elseif b1 then
		opt=Duel.SelectOption(tp,aux.Stringc40390147(c40390147,1))
	else
		opt=Duel.SelectOption(tp,aux.Stringc40390147(c40390147,2))+1
	end
	e:SetLabel(opt)
