...
c50705071.listed_names={24311372,68540058}
...
function c50705071.spcon(e,c)
	...
	return Duel.CheckReleaseGroup(c:GetControler(),c50705071.spfilter,1,false,1,true,c,c:GetControler(),nil,false,nil)
end
function c50705071.sptg(e,tp,eg,ep,ev,re,r,rp,c)
	local g=Duel.SelectReleaseGroup(tp,c50705071.spfilter,1,1,false,true,true,c,nil,nil,false,nil)
	if g then
		g:KeepAlive()
		e:SetLabelObject(g)
	return true
