...
function c54059040.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc54059040(c54059040,0))
	e2:SetCategory(CATEGORY_POSITION)
	e2:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_F)
	e2:SetCode(EVENT_SUMMON_SUCCESS)
	e2:SetRange(LOCATION_SZONE)
	e2:SetCondition(c54059040.poscon)
	e2:SetTarget(c54059040.postg)
	e2:SetOperation(c54059040.posop)
	c:RegisterEffect(e2)
	local e3=e2:Clone()
	e3:SetCode(EVENT_SPSUMMON_SUCCESS)
	c:RegisterEffect(e3)
end
function c54059040.poscon(e,tp,eg,ep,ev,re,r,rp)
...
function c54059040.postg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c54059040.posop(e,tp,eg,ep,ev,re,r,rp)
