...
function c90238142.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc90238142(c90238142,0))
	e1:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e1:SetType(EFFECT_TYPE_IGNITION)
	e1:SetCountLimit(1,c90238142)
...
function c90238142.filter(c,e,tp)
	return c:IsSetCard(0x64) and c:GetCode()~=c90238142 and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP_DEFENSE)
end
