...
function c98263709.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc98263709(c98263709,0))
	...
	e3:SetDescription(aux.Stringc98263709(c98263709,1))
...
function c98263709.flipop(e,tp,eg,ep,ev,re,r,rp)
	e:GetHandler():RegisterFlagEffect(c98263709,RESET_EVENT+RESETS_STANDARD+RESET_OVERLAY-RESET_LEAVE-RESET_TOGRAVE,0,0)
end
function c98263709.spcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c98263709)~=0 and e:GetHandler():IsReason(REASON_DESTROY)
end
