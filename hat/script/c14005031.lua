...
function c14005031.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc14005031(c14005031,0))
...
function c14005031.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e) and tc:IsRelateToEffect(e) then
		c:RegisterFlagEffect(c14005031,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,0)
	end
end
...
function c14005031.matcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFirstCardTarget()~=nil and e:GetHandler():GetFlagEffect(c14005031)>0
end
