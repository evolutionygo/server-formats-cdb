...
function c4253484.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc4253484(c4253484,0))
...
c4253484.listed_series={0x19}
c4253484.listed_names={c4253484}
function c4253484.defcon(e)
	return e:GetHandler():GetFlagEffect(c4253484)>0
end
...
function c4253484.filter(c,e,tp)
	return not c:IsCode(c4253484) and c:IsSetCard(0x19) and c:IsCanBeSpecialSummoned(e,101,tp,false,false)
end
