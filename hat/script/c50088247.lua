...
function c50088247.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc50088247(c50088247,0))
	...
	c:RegisterEffect(e2)
	Duel.AddCustomActivityCounter(c50088247,ACTIVITY_SPSUMMON,c50088247.counterfilter)
end
c50088247.listed_series={0x2f}
...
function c50088247.spcon(e,c)
	...
	return Duel.GetCustomActivityCount(c50088247,tp,ACTIVITY_SPSUMMON)==0
...
function c50088247.filter(c,e,tp)
	return c:IsSetCard(0x2f) and c:GetCode()~=c50088247 and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
