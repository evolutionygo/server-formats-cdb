...
function c22900598.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.ActivateFieldSpell(tc,e,tp,eg,ep,ev,re,r,rp) then
		...
		if #sg>0 and Duel.SelectYesNo(tp,aux.Stringc22900598(c22900598,0)) then
			Duel.BreakEffect()
