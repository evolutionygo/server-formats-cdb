...
function c27769400.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc27769400(c27769400,0))
	e1:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e1:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_O)
	e1:SetCode(EVENT_CUSTOM+c27769400)
	...
	e2:SetDescription(aux.Stringc27769400(c27769400,1))
...
function c27769400.checkop2(e,tp,eg,ep,ev,re,r,rp)
	...
	if s[0]:GetCount()==0 then
		Duel.RaiseEvent(e:GetHandler(),EVENT_CUSTOM+c27769400,e,0,0,0,0)
	end
end
