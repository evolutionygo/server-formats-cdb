...
function c41858121.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if b1 and b2 then op=Duel.SelectOption(tp,aux.Stringc41858121(c41858121,0),aux.Stringc41858121(c41858121,1))
	elseif b1 then op=Duel.SelectOption(tp,aux.Stringc41858121(c41858121,0))
	elseif b2 then Duel.SelectOption(tp,aux.Stringc41858121(c41858121,1)) op=1
	else return end
	if op==0 then
