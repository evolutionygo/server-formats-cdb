...
function c36499284.disfilter(c)
...
function c36499284.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if Duel.IsExistingTarget(Card.IsFaceup,tp,0,LOCATION_ONFIELD,1,nil)
		and Duel.IsExistingMatchingCard(c36499284.disfilter,tp,LOCATION_HAND,0,1,nil)
		and Duel.SelectYesNo(tp,aux.Stringc36499284(c36499284,0)) then
		e:SetCategory(CATEGORY_DESTROY)
		e:SetProperty(EFFECT_FLAG_CARD_TARGET)
		e:SetOperation(c36499284.activate)
...
function c36499284.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.DiscardHand(tp,c36499284.disfilter,1,1,REASON_EFFECT+REASON_DISCARD)>0 and tc:IsRelateToEffect(e) and tc:IsFaceup() then
