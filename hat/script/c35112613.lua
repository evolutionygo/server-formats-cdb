...
function c35112613.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc35112613(c35112613,0))
	...
	e2:SetDescription(aux.Stringc35112613(c35112613,1))
	e2:SetType(EFFECT_TYPE_IGNITION)
	e2:SetRange(LOCATION_GRAVE)
	e2:SetCountLimit(1,c35112613)
	e2:SetCost(c35112613.thcost)
	e2:SetTarget(c35112613.thtg)
	e2:SetOperation(c35112613.thop)
	c:RegisterEffect(e2)
end
c35112613.listed_series={0x55}
...
function c35112613.cfilter(c)
	return c:IsSetCard(0x55) and c:IsMonster() and c:GetCode()~=c35112613 and c:IsAbleToGraveAsCost()
end
