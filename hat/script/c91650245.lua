...
function c91650245.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local tc=g:GetFirst()
	if tc then
		local opt=Duel.SelectOption(tp,aux.Stringc91650245(c91650245,0),aux.Stringc91650245(c91650245,1))
...
function c91650245.tdop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsType(TYPE_FUSION+TYPE_SYNCHRO+TYPE_XYZ)
		or Duel.SelectOption(tp,aux.Stringc91650245(c91650245,0),aux.Stringc91650245(c91650245,1))==0 then
