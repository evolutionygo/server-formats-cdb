...
function c23979249.initial_effect(c)
	c:SetUniqueOnField(1,0,c23979249)
	--Special summon itself from hand
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc23979249(c23979249,0))
	...
	e3:SetDescription(aux.Stringc23979249(c23979249,1))
...
function c23979249.regop(e,tp,eg,ep,ev,re,r,rp)
	e:GetHandler():RegisterFlagEffect(c23979249,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
end
function c23979249.drcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c23979249)>0
end
