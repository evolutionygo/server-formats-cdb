...
function c50474354.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc50474354(c50474354,0))
	e1:SetCategory(CATEGORY_TOHAND+CATEGORY_SEARCH)
	e1:SetType(EFFECT_TYPE_IGNITION)
	e1:SetRange(LOCATION_HAND)
	e1:SetCountLimit(1,c50474354)
	...
	c:RegisterEffect(e1)
	Duel.AddCustomActivityCounter(c50474354,ACTIVITY_CHAIN,c50474354.chainfilter)
end
c50474354.listed_series={0x88}
function c50474354.chainfilter(re,tp,cc50474354)
...
function c50474354.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return Duel.GetCustomActivityCount(c50474354,tp,ACTIVITY_CHAIN)==0 and c:IsAbleToGraveAsCost() end
	...
	aux.RegisterClientHint(e:GetHandler(),nil,tp,1,0,aux.Stringc50474354(c50474354,1),nil)
end
