...
function c64631466.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc64631466(c64631466,0))
...
c64631466.listed_names={41426869}
...
function c64631466.eqfilter(c)
	return c:GetFlagEffect(c64631466)~=0
end
...
function c64631466.equipop(c,e,tp,tc)
	if not c:EquipByEffectAndLimitRegister(e,tp,tc,c64631466) then return end
	--substitute
	local e1=Effect.CreateEffect(c)
	...
	e1:SetValue(c64631466.repval)
	tc:RegisterEffect(e1)
end
function c64631466.eqop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	local tc=Duel.GetFirstTarget()
	if tc and tc:IsRelateToEffect(e) and tc:IsMonster() and tc:IsControler(1-tp) and c64631466.eqcon(e,tp,eg,ep,ev,re,r,rp) then
