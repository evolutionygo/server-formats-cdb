...
function c49456901.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc49456901(c49456901,0))
	...
	e2:SetDescription(aux.Stringc49456901(c49456901,1))
	...
	aux.DoubleSnareValc49456901ity(c,LOCATION_MZONE)
end
c49456901.aux.xyz_number=104
...
function c49456901.operation(e,tp,eg,ep,ev,re,r,rp)
	if Duel.NegateActivation(ev) and Duel.GetFieldGroupCount(1-tp,LOCATION_HAND,0)>0
		and Duel.SelectYesNo(tp,aux.Stringc49456901(c49456901,2)) then
