...
function c98555327.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc98555327(c98555327,0))
	...
	e2:SetDescription(aux.Stringc98555327(c98555327,1))
...
function c98555327.filter(c)
	return c:IsSetCard(0x7b) and c:GetCode()~=c98555327 and c:IsAbleToHand()
end
