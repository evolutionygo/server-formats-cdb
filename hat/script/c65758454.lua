...
function c65758454.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc65758454(c65758454,0))
...
c65758454.listed_names={c65758454}
function c65758454.filter(c,e,tp)
	return c:IsCode(c65758454) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP_DEFENSE)
end
