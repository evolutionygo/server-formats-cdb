...
function c40732515.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc40732515(c40732515,0))
	...
	e3:SetDescription(aux.Stringc40732515(c40732515,1))
...
function c40732515.spop(e,tp,eg,ep,ev,re,r,rp,c)
	...
	if #g==1 then
		...
		while ct<6 do
			...
			local tc=Duel.SelectMatchingCard(tp,c40732515.spfilter,tp,LOCATION_ONFIELD,0,1,1,nil,tp):GetFirst()
