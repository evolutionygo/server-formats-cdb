...
function c15335853.initial_effect(c)
	...
	e4:SetDescription(aux.Stringc15335853(c15335853,0))
...
c15335853.listed_series={SET_MECHA_PHANTOM_BEAST}
c15335853.listed_names={TOKEN_MECHA_PHANTOM_BEAST}
...
function c15335853.tknfilter(c)
	return c:IsType(TYPE_TOKEN) or c:IsOriginalType(TYPE_TOKEN)
end
function c15335853.indcon(e)
	return Duel.IsExistingMatchingCard(c15335853.tknfilter,e:GetHandlerPlayer(),LOCATION_ONFIELD,0,1,nil)
end
