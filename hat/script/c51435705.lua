...
function c51435705.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc51435705(c51435705,0))
	e1:SetCategory(CATEGORY_TOHAND+CATEGORY_SEARCH)
	e1:SetType(EFFECT_TYPE_IGNITION)
	e1:SetRange(LOCATION_HAND)
	e1:SetCountLimit(1,c51435705)
...
function c51435705.filter(c)
	return c:IsSetCard(0x70) and c:GetCode()~=c51435705 and c:IsMonster() and c:IsAbleToHand()
end
