...
c76902476.listed_names={TOKEN_MECHA_PHANTOM_BEAST}
...
function c76902476.tknfilter(c)
	return c:IsType(TYPE_TOKEN) or c:IsOriginalType(TYPE_TOKEN)
end
function c76902476.indcon(e)
	return Duel.IsExistingMatchingCard(c76902476.tknfilter,e:GetHandlerPlayer(),LOCATION_ONFIELD,0,1,nil)
end
