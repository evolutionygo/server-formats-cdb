...
function c54702678.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCode2N(c,true,true,c54702678.ffilter,5)
	--extra attack
	...
	e2:SetDescription(aux.Stringc54702678(c54702678,0))
	...
	e3:SetDescription(aux.Stringc54702678(c54702678,1))
