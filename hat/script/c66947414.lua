...
function c66947414.initial_effect(c)
	...
	e5:SetDescription(aux.Stringc66947414(c66947414,0))
...
function c66947414.checkop(e,tp,eg,ep,ev,re,r,rp)
	if eg:IsExists(c66947414.chkfilter,1,nil,tp) then
		e:GetHandler():RegisterFlagEffect(c66947414,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
	end
end
function c66947414.spcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c66947414)~=0
end
