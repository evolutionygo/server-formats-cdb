...
function c97433739.initial_effect(c)
	...
	c:RegisterEffect(e1)
	Duel.AddCustomActivityCounter(c97433739,ACTIVITY_SPSUMMON,c97433739.counterfilter)
end
function c97433739.counterfilter(c)
	return c:IsSummonType(SUMMON_TYPE_XYZ)
end
function c97433739.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetCustomActivityCount(c97433739,tp,ACTIVITY_SPSUMMON)==0 end
	...
	e2:SetDescription(aux.Stringc97433739(c97433739,1))
