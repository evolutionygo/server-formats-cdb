...
function c31801517.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc31801517(c31801517,0))
	...
	e2:SetDescription(aux.Stringc31801517(c31801517,1))
...
function c31801517.atkcost(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	if chk==0 then return c:CheckRemoveOverlayCard(tp,1,REASON_COST) and c:GetFlagEffect(c31801517)==0 end
	c:RemoveOverlayCard(tp,1,1,REASON_COST)
	c:RegisterFlagEffect(c31801517,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_DAMAGE_CAL,0,1)
end
