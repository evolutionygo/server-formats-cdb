...
function c49441499.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc49441499(c49441499,0))
...
c49441499.LVnum=1
c49441499.LVset=0x5d
function c49441499.efilter(e,te)
	return te:IsActiveType(TYPE_SPELL)
end
function c49441499.regop(e,tp,eg,ep,ev,re,r,rp)
	e:GetHandler():RegisterFlagEffect(c49441499,RESET_EVENT|RESETS_STANDARD&~(RESET_TEMP_REMOVE|RESET_TURN_SET)|RESET_PHASE|PHASE_END,0,1)
end
function c49441499.spcon(e,tp,eg,ep,ev,re,r,rp)
	return tp==Duel.GetTurnPlayer() and e:GetHandler():GetFlagEffect(c49441499)==0
end
