...
function c42256406.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc42256406(c42256406,0))
	...
	e4:SetDescription(aux.Stringc42256406(c42256406,1))
	...
	e5:SetDescription(aux.Stringc42256406(c42256406,2))
...
function c42256406.defcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if #ct==1 then 
		...
		Duel.Hint(HINT_SELECTMSG,tp,aux.Stringc42256406(c42256406,3))
