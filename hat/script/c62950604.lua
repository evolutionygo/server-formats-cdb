...
function c62950604.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc62950604(c62950604,0))
	...
	e2:SetDescription(aux.Stringc62950604(c62950604,1))
...
function c62950604.rmop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc and tc:IsRelateToEffect(e) and Duel.Remove(tc,POS_FACEUP,REASON_EFFECT)~=0 and c:IsRelateToEffect(e) then
		c:RegisterFlagEffect(c62950604,RESET_EVENT|RESETS_STANDARD&~(RESET_LEAVE|RESET_TEMP_REMOVE|RESET_TOGRAVE|RESET_TURN_SET),0,0)
		tc:RegisterFlagEffect(c62950604,RESET_EVENT|RESETS_STANDARD,0,0)
...
function c62950604.spcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return tc and act==1 and e:GetHandler():IsPreviousLocation(LOCATION_ONFIELD)
		and c:GetFlagEffect(c62950604)~=0
end
function c62950604.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	local tc=e:GetLabelObject()
	if chk==0 then return tc:GetFlagEffect(c62950604)~=0 end
