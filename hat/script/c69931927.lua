...
function c69931927.initial_effect(c)
	...
	e1:SetCondition(c69931927.sdcon)
	c:RegisterEffect(e1)
	...
	e4:SetDescription(aux.Stringc69931927(c69931927,0))
	e4:SetCategory(CATEGORY_DAMAGE)
	e4:SetType(EFFECT_TYPE_IGNITION)
	e4:SetRange(LOCATION_MZONE)
	e4:SetCountLimit(1)
	e4:SetCost(c69931927.damcost)
	e4:SetTarget(c69931927.damtg)
	e4:SetOperation(c69931927.damop)
	c:RegisterEffect(e4)
	...
	e5:SetCondition(c69931927.bpcon)
	c:RegisterEffect(e5)
end
c69931927.listed_series={SET_EARTHBOUND_IMMORTAL}
