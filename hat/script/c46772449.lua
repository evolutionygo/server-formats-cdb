...
function c46772449.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc46772449(c46772449,0))
	...
	e1:SetCondition(c46772449.descon)
	e1:SetCost(Cost.Detach(1))
	e1:SetTarget(c46772449.destg)
	e1:SetOperation(c46772449.desop)
	c:RegisterEffect(e1,false,REGISTER_FLAG_DETACH_XMAT)
end
function c46772449.descon(e,tp,eg,ep,ev,re,r,rp)
...
function c46772449.destg(e,tp,eg,ep,ev,re,r,rp,chk)
	local g=Duel.GetMatchingGroup(nil,tp,LOCATION_ONFIELD,LOCATION_ONFIELD,e:GetHandler())
	if chk==0 then return #g>0 end
	Duel.SetOperationInfo(0,CATEGORY_DESTROY,g,#g,tp,0)
end
function c46772449.desop(e,tp,eg,ep,ev,re,r,rp)
	...
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc46772449(c46772449,1))
