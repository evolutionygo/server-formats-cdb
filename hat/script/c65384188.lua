...
function c65384188.reg(c,tc1,tc2)
	tc1:RegisterFlagEffect(c65384188,RESET_EVENT+RESETS_STANDARD,0,0)
	local e1=Effect.CreateEffect(c)
...
function c65384188.posop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	if c:GetFlagEffect(c65384188)~=0 and not c:IsPosition(POS_FACEUP_ATTACK) then
		c:ResetFlagEffect(c65384188)
	end
end
function c65384188.effcon(e)
	return e:GetHandler():GetFlagEffect(c65384188)~=0 and e:GetLabelObject():GetFlagEffect(c65384188)~=0
end
