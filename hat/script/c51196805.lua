...
function c51196805.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc51196805(c51196805,0))
	...
	e3:SetDescription(aux.Stringc51196805(c51196805,1))
	e3:SetCategory(CATEGORY_REMOVE)
	e3:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_F)
	e3:SetCountLimit(1,c51196805)
	e3:SetCode(EVENT_FLIP)
	e3:SetTarget(c51196805.rmtg)
	e3:SetOperation(c51196805.rmop)
	c:RegisterEffect(e3)
end
c51196805.listed_series={0x8d}
...
function c51196805.postg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return c:IsCanTurnSet() and c:GetFlagEffect(c51196805)==0 end
	c:RegisterFlagEffect(c51196805,RESET_EVENT+RESETS_STANDARD-RESET_TURN_SET+RESET_PHASE+PHASE_END,0,1)
...
function c51196805.rmop(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.Hint(HINT_SELECTMSG,tp,aux.Stringc51196805(c51196805,2))
