...
function c93379652.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCode2(c,true,true,aux.FilterBoolFunctionEx(Card.IsSetCard,0x1047),aux.FilterBoolFunctionEx(Card.IsRace,RACE_THUNDER))
	--spsummon condition
	...
	e3:SetDescription(aux.Stringc93379652(c93379652,0))
...
c93379652.listed_series={0x1047}
