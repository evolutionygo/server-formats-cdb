...
function c7392745.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc7392745(c7392745,0))
...
function c7392745.operation(e,tp,eg,ep,ev,re,r,rp)
	if Duel.IsPlayerAffectedByEffect(tp,CARD_BLUEEYES_SPIRIT) or Duel.GetLocationCount(1-tp,LOCATION_MZONE)<3 
		or not Duel.IsPlayerCanSpecialSummonMonster(tp,c7392745+1,0,TYPES_TOKEN,100,300,1,RACE_ZOMBIE,ATTRIBUTE_EARTH,POS_FACEUP_DEFENSE,1-tp) then return end
	for i=1,3 do
		local token=Duel.CreateToken(tp,c7392745+1)
