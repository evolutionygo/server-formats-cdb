--ネクロバレーの祭殿
--Hc70000776den Temples of Necrovalley
...
c70000776.listed_series={0x2e}
c70000776.listed_names={CARD_NECROVALLEY}
function c70000776.cfilter1(c)
	return c:IsFaceup() and c:IsSetCard(0x2e)
end
function c70000776.actcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(c70000776.cfilter1,tp,LOCATION_MZONE,LOCATION_MZONE,1,nil) and Duel.IsEnvironment(CARD_NECROVALLEY)
end
