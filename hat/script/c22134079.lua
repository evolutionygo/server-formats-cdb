...
function c22134079.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc22134079(c22134079,0))
	...
	e3:SetDescription(aux.Stringc22134079(c22134079,1))
...
function c22134079.flipop(e,tp,eg,ep,ev,re,r,rp)
	e:GetHandler():RegisterFlagEffect(c22134079,RESET_EVENT|(RESETS_STANDARD|RESET_OVERLAY)&~(RESET_LEAVE|RESET_TOGRAVE),0,0)
end
function c22134079.thcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c22134079)~=0
end
