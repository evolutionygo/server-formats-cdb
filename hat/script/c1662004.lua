...
function c1662004.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc1662004(c1662004,0))
	e1:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e1:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e1:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e1:SetCode(EVENT_SUMMON_SUCCESS)
	e1:SetCountLimit(1,c1662004)
	e1:SetTarget(c1662004.sptg)
	e1:SetOperation(c1662004.spop)
	c:RegisterEffect(e1)
end
...
function c1662004.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) and tc:IsAttribute(ATTRIBUTE_FIRE) and Duel.SpecialSummon(tc,0,tp,tp,false,false,POS_FACEUP_DEFENSE)>0 then
		...
		aux.RegisterClientHint(c,nil,tp,1,0,aux.Stringc1662004(c1662004,1))
	end
end