...
function c40101111.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCode2(c,true,true,c40101111.ffilter,aux.FilterBoolFunctionEx(Card.IsRace,RACE_PSYCHIC))
	--pierce
	...
	e4:SetDescription(aux.Stringc40101111(c40101111,0))
