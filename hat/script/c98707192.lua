...
function c98707192.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc98707192(c98707192,0))
	...
	e3:SetDescription(aux.Stringc98707192(c98707192,1))
	e3:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e3:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_O)
	e3:SetProperty(EFFECT_FLAG_DAMAGE_STEP)
	e3:SetRange(LOCATION_HAND)
	e3:SetCode(EVENT_DAMAGE)
	e3:SetCountLimit(1,c98707192)
...
function c98707192.postg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return c:IsCanTurnSet() and c:GetFlagEffect(c98707192)==0 end
	c:RegisterFlagEffect(c98707192,RESET_EVENT+RESETS_STANDARD-RESET_TURN_SET+RESET_PHASE+PHASE_END,0,1)
