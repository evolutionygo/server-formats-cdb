--ラヴァル炎火山の侍女
--Laval Volcano Handmac2407147en
function c2407147.initial_effect(c)
	--to grave
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc2407147(c2407147,0))
...
c2407147.listed_series={0x39}
function c2407147.cfilter(c)
	return c:IsSetCard(0x39) and c:GetCode()~=c2407147
end
