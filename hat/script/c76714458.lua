...
function c76714458.operation(e,tp,eg,ep,ev,re,r,rp)
	local cc76714458=Duel.GetChainInfo(ev,CHAININFO_CHAIN_ID)
	local e1=Effect.CreateEffect(e:GetHandler())
	e1:SetType(EFFECT_TYPE_FIELD)
	e1:SetCode(EFFECT_REFLECT_DAMAGE)
	e1:SetProperty(EFFECT_FLAG_PLAYER_TARGET)
	e1:SetTargetRange(1,0)
	e1:SetLabel(cc76714458)
...
function c76714458.refcon(e,re,val,r,rp,rc)
	...
	local cc76714458=Duel.GetChainInfo(0,CHAININFO_CHAIN_ID)
	return cc76714458==e:GetLabel()
end