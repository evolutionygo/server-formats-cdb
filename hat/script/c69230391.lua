...
function c69230391.initial_effect(c)
	...
	local e1=aux.AddNormalSummonProcedure(c,true,true,1,1,SUMMON_TYPE_TRIBUTE,aux.Stringc69230391(c69230391,0),c69230391.otfilter)
	local e2=aux.AddNormalSetProcedure(c,true,true,1,1,SUMMON_TYPE_TRIBUTE,aux.Stringc69230391(c69230391,0),c69230391.otfilter)
	--handes
	local e3=Effect.CreateEffect(c)
	e3:SetDescription(aux.Stringc69230391(c69230391,1))
