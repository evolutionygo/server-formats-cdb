...
function c21496848.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc21496848(c21496848,0))
...
function c21496848.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.Hint(HINT_SELECTMSG,tp,aux.Stringc21496848(c21496848,5))
	local ac=Duel.SelectOption(tp,aux.Stringc21496848(c21496848,1),aux.Stringc21496848(c21496848,2),aux.Stringc21496848(c21496848,3))
	e:SetLabel(ac)
...
function c21496848.operation(e,tp,eg,ep,ev,re,r,rp)
	if Duel.GetFieldGroupCount(tp,0,LOCATION_HAND)>0 and Duel.IsChainDisablable(0)
		and Duel.SelectYesNo(1-tp,aux.Stringc21496848(c21496848,4)) then
