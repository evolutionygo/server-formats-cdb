...
function c18865703.initial_effect(c)
	c:SetUniqueOnField(1,0,c18865703)
	--equip
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc18865703(c18865703,0))
	...
	c:RegisterEffect(e1)
	aux.AddZWEquipLimit(c,c18865703.eqcon,function(tc,c,tp) return c18865703.filter(tc) and tc:IsControler(tp) end,c18865703.equipop,e1)
	--spsummon
	local e2=Effect.CreateEffect(c)
	e2:SetDescription(aux.Stringc18865703(c18865703,1))
...
c18865703.listed_series={0x107f}
function c18865703.eqcon(e)
...
function c18865703.eqop(e,tp,eg,ep,ev,re,r,rp)
	...
	c18865703.equipop(c,e,tp,tc)
end
function c18865703.equipop(c,e,tp,tc)
