...
function c65591858.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc65591858(c65591858,0))
	...
	c:RegisterEffect(e1)
	Duel.AddCustomActivityCounter(c65591858,ACTIVITY_SPSUMMON,c65591858.counterfilter)
end
c65591858.listed_series={0x70}
function c65591858.counterfilter(c)
	return c:IsSetCard(0x70)
end
function c65591858.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetCustomActivityCount(c65591858,tp,ACTIVITY_SPSUMMON)==0 end
	...
	aux.RegisterClientHint(e:GetHandler(),nil,tp,1,0,aux.Stringc65591858(c65591858,1),nil)
end
