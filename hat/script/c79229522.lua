...
function c79229522.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCode2Rep(c,true,true,c79229522.fil,1,99,CARD_CYBER_DRAGON)
	Fusion.AddContactProc(c,c79229522.contactfil,c79229522.contactop,c79229522.splimit)
