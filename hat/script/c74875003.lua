...
function c74875003.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc74875003(c74875003,0))
...
c74875003.listed_names={c74875003,CARD_RA,10000020,10000000}
function c74875003.filter(c,e,tp)
	return c:IsCode(c74875003) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function c74875003.splimit(e,c,sump,sumtype,sumpos,targetp,se)
	return not se:GetHandler():IsCode(c74875003)
end