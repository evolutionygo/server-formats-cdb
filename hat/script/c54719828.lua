...
function c54719828.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc54719828(c54719828,0))
...
function c54719828.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.Hint(HINT_SELECTMSG,tp,aux.Stringc54719828(c54719828,1))
...
function c54719828.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if e:GetLabel()==0 then
		e1:SetDescription(aux.Stringc54719828(c54719828,2))
		e1:SetValue(c54719828.aclimit1)
	elseif e:GetLabel()==1 then
		e1:SetDescription(aux.Stringc54719828(c54719828,3))
		e1:SetValue(c54719828.aclimit2)
	else
		e1:SetDescription(aux.Stringc54719828(c54719828,4))
