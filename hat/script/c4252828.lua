--シー・アーチャー
--Mermac4252828 Archer
function c4252828.initial_effect(c)
	--equip
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc4252828(c4252828,0))
...
function c4252828.eqfilter(c)
	return c:GetFlagEffect(c4252828)~=0 
end
...
function c4252828.equipop(c,e,tp,tc)
	if not c:EquipByEffectAndLimitRegister(e,tp,tc,c4252828) then return end
	local e2=Effect.CreateEffect(c)
