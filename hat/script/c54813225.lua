...
function c54813225.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc54813225(c54813225,0))
	e1:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e1:SetType(EFFECT_TYPE_IGNITION)
	e1:SetRange(LOCATION_HAND+LOCATION_GRAVE)
	e1:SetCountLimit(1,c54813225)
...
function c54813225.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckReleaseGroupCost(tp,Card.IsType,1,99,false,c54813225.spcheck,nil,TYPE_TOKEN) end
