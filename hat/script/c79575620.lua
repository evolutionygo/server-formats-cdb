...
function c79575620.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc79575620(c79575620,0))
...
function c79575620.con(e,tp,eg,ep,ev,re,r,rp)
	...
	return c:GetFlagEffect(c79575620)==0 and (Duel.GetAttacker()==c or Duel.GetAttackTarget()==c)
end
function c79575620.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckLPCost(tp,2000) end
	Duel.PayLPCost(tp,2000)
	e:GetHandler():RegisterFlagEffect(c79575620,RESET_PHASE+PHASE_DAMAGE_CAL,0,1)
end
