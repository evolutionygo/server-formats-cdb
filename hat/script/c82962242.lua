...
function c82962242.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc82962242(c82962242,0))
	...
	e2:SetDescription(aux.Stringc82962242(c82962242,1))
	...
	e4:SetDescription(aux.Stringc82962242(c82962242,2))
...
function c82962242.equipop(c,e,tp,tc)
	...
	if not c:EquipByEffectAndLimitRegister(e,tp,tc,c82962242,true) then return end
	local e1=Effect.CreateEffect(c)
...
function c82962242.spfilter(c)
	return c:GetFlagEffect(c82962242)~=0
end
