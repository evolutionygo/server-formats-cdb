...
function c52684508.initial_effect(c)
	...
	c:RegisterEffect(e1)
	Duel.AddCustomActivityCounter(c52684508,ACTIVITY_ATTACK,c52684508.counterfilter)
end
c52684508.listed_names={CARD_REDEYES_B_DRAGON}
...
function c52684508.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetCustomActivityCount(c52684508,tp,ACTIVITY_ATTACK)==0 end
