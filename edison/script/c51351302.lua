...
function c51351302.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc51351302(c51351302,0))
	...
	e2:SetDescription(aux.Stringc51351302(c51351302,0))
...
function c51351302.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	Duel.Hint(HINT_SELECTMSG,tp,aux.Stringc51351302(c51351302,1))
