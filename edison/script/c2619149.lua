...
function c2619149.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc2619149(c2619149,0))
	...
	e2:SetDescription(aux.Stringc2619149(c2619149,1))
...
c2619149.listed_series={SET_GLADIATOR_BEAST}
c2619149.listed_names={c2619149}
function c2619149.scon(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	return c:GetFlagEffect(c2619149)>0 and aux.bdogcon(e,tp,eg,ep,ev,re,r,rp)
end
...
function c2619149.filter(c,e,tp)
	return not c:IsCode(c2619149) and c:IsSetCard(SET_GLADIATOR_BEAST) and c:IsCanBeSpecialSummoned(e,108,tp,false,false)
end
