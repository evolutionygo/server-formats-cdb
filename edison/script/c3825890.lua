...
function c3825890.initial_effect(c)
	...
	local e1=aux.AddNormalSummonProcedure(c,true,true,1,1,SUMMON_TYPE_TRIBUTE,aux.Stringc3825890(c3825890,0),c3825890.otfilter)
	local e2=aux.AddNormalSetProcedure(c,true,true,1,1,SUMMON_TYPE_TRIBUTE,aux.Stringc3825890(c3825890,0),c3825890.otfilter)
	--atk up
	...
	e4:SetTarget(c3825890.desreptg)
	c:RegisterEffect(e4)
end
c3825890.listed_series={0x2e}
