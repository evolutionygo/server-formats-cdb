...
function c88341502.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsFaceup() and tc:IsRelateToEffect(e) then
		...
		e3:SetDescription(aux.Stringc88341502(c88341502,0))
		...
		tc:RegisterFlagEffect(c88341502,RESET_EVENT+0x1020000+RESET_PHASE+PHASE_END,0,1)
	end
end
function c88341502.damcon(e,tp,eg,ep,ev,re,r,rp)
	local tc=e:GetLabelObject()
	local bc=tc:GetBattleTarget()
	return eg:IsContains(tc) and tc:GetFlagEffect(c88341502)~=0
