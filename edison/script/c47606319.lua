...
function c47606319.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc47606319(c47606319,0))
...
function c47606319.spcon(e,c)
	...
	local rg=Duel.GetMatchingGroup(c47606319.spfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,nil,tp)
	local ft=Duel.GetLocationCount(tp,LOCATION_MZONE)
	return ft>-1 and #rg>0 and aux.SelectUnselectGroup(rg,e,tp,1,1,nil,0)
end
function c47606319.sptg(e,tp,eg,ep,ev,re,r,rp,c)
