...
function c18013090.initial_effect(c)
	...
	e3:SetDescription(aux.Stringc18013090(c18013090,0))
...
c18013090.material={96182448}
c18013090.listed_names={96182448}
c18013090.material_setcode=0x1017
function c18013090.tfilter(c,lc,stype,tp)
...
function c18013090.atop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:GetFlagEffect(1)==0 or c:GetFlagEffect(c18013090)~=0 then return end
	local e2=Effect.CreateEffect(c)
	...
	c:RegisterEffect(e2)
	c:RegisterFlagEffect(c18013090,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
end
