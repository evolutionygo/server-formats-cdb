...
function c85087012.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc85087012(c85087012,0))
	...
	e2:SetDescription(aux.Stringc85087012(c85087012,1))
...
function c85087012.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if #ct==1 then 
		...
		Duel.Hint(HINT_SELECTMSG,tp,aux.Stringc85087012(c85087012,2))
