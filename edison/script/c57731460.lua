...
function c57731460.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc57731460(c57731460,0))
	...
	e2:SetDescription(aux.Stringc57731460(c57731460,1))
...
c57731460.listed_series={SET_GLADIATOR_BEAST}
c57731460.listed_names={c57731460}
...
function c57731460.filter(c,e,tp)
	return not c:IsCode(c57731460) and c:IsSetCard(SET_GLADIATOR_BEAST) and c:IsCanBeSpecialSummoned(e,103,tp,false,false)
end
