...
function c36625827.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc36625827(c36625827,0))
	...
	e2:SetDescription(aux.Stringc36625827(c36625827,1))
...
c36625827.counter_place_list={0x1b} --Clock Counter
c36625827.listed_names={75041269} --Clock Tower Prison"
