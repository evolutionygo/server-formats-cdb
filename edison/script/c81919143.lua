...
function c81919143.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc81919143(c81919143,0))
...
function c81919143.regop(e,tp,eg,ep,ev,re,r,rp)
	e:GetHandler():RegisterFlagEffect(c81919143,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
end
function c81919143.spcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c81919143)~=0
end
function c81919143.filter(c,e,tp,rc,tc81919143)
	return c:IsReason(REASON_BATTLE) and c:GetReasonCard()==rc and c:GetTurnID()==tc81919143
