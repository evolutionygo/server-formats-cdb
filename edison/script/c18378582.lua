...
function c18378582.initial_effect(c)
	...
	e2:SetCondition(c18378582.hspcon)
	e2:SetTarget(c18378582.hsptg)
	e2:SetOperation(c18378582.hspop)
	c:RegisterEffect(e2)
	--Destroy all the opponent's monsters
	local e3=Effect.CreateEffect(c)
	e3:SetDescription(aux.Stringc18378582(c18378582,0))
	e3:SetCategory(CATEGORY_DESTROY)
	e3:SetType(EFFECT_TYPE_IGNITION)
	e3:SetRange(LOCATION_MZONE)
	e3:SetCondition(c18378582.descon)
	e3:SetCost(c18378582.descost)
	e3:SetTarget(c18378582.destg)
	e3:SetOperation(c18378582.desop)
	c:RegisterEffect(e3)
end
c18378582.listed_names={66073051,CARD_SANCTUARY_SKY}
function c18378582.hspcon(e,c)
...
function c18378582.hsptg(e,tp,eg,ep,ev,re,r,rp,c)
...
function c18378582.hspop(e,tp,eg,ep,ev,re,r,rp,c)
	local g=e:GetLabelObject()
	if not g then return end
	Duel.Release(g,REASON_COST)
	g:DeleteGroup()
end
function c18378582.descon(e,tp,eg,ep,ev,re,r,rp)
