...
function c75109441.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc75109441(c75109441,0))
	...
	e2:SetDescription(aux.Stringc75109441(c75109441,1))
...
function c75109441.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return c:IsCanTurnSet() and c:GetFlagEffect(c75109441)==0 end
	c:RegisterFlagEffect(c75109441,RESET_EVENT+RESETS_STANDARD-RESET_TURN_SET+RESET_PHASE+PHASE_END,0,1)
