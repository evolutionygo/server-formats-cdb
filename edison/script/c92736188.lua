...
function c92736188.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc92736188(c92736188,0))
	...
	e2:SetDescription(aux.Stringc92736188(c92736188,1))
...
function c92736188.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return c:IsCanTurnSet() and c:GetFlagEffect(c92736188)==0 end
	c:RegisterFlagEffect(c92736188,RESET_EVENT+RESETS_STANDARD-RESET_TURN_SET+RESET_PHASE+PHASE_END,0,1)
