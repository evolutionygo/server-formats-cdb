...
function c28124263.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc28124263(c28124263,0))
...
c28124263.listed_series={0x26}
c28124263.listed_names={c28124263}
...
function c28124263.filter(c,e,tp)
	return c:IsLevelBelow(4) and c:IsSetCard(0x26) and not c:IsCode(c28124263)
