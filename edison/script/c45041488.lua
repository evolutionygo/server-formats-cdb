...
function c45041488.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc45041488(c45041488,3))
...
function c45041488.mtop(e,tp,eg,ep,ev,re,r,rp)
	...
	if #g1>0 and #g2>0 then
		select=Duel.SelectOption(tp,aux.Stringc45041488(c45041488,0),aux.Stringc45041488(c45041488,1),aux.Stringc45041488(c45041488,2))
	elseif #g1>0 then
		select=Duel.SelectOption(tp,aux.Stringc45041488(c45041488,0),aux.Stringc45041488(c45041488,2))
		if select==1 then select=2 end
	elseif #g2>0 then
		select=Duel.SelectOption(tp,aux.Stringc45041488(c45041488,1),aux.Stringc45041488(c45041488,2))+1
	else
		select=Duel.SelectOption(tp,aux.Stringc45041488(c45041488,2))
		select=2
	end
	if select==0 then
