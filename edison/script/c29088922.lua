...
function c29088922.initial_effect(c)
	...
	e3:SetDescription(aux.Stringc29088922(c29088922,0))
	...
	e4:SetDescription(aux.Stringc29088922(c29088922,1))
...
function c29088922.cfilter(c)
	return c:IsFaceup() and c:IsSetCard(0x31) and c:GetCode()~=c29088922
end
