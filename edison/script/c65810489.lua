...
function c65810489.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc65810489(c65810489,0))
...
c65810489.listed_names={65810490}
...
function c65810489.spop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.GetLocationCount(tp,LOCATION_MZONE)>0 
		and Duel.IsPlayerCanSpecialSummonMonster(tp,c65810489+1,0,TYPES_TOKEN,1000,1000,4,RACE_FIEND,ATTRIBUTE_DARK) then
		local token=Duel.CreateToken(tp,c65810489+1)
