...
function c3510565.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc3510565(c3510565,0))
	...
	e2:SetDescription(aux.Stringc3510565(c3510565,1))
...
function c3510565.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return c:IsCanTurnSet() and c:GetFlagEffect(c3510565)==0 end
	c:RegisterFlagEffect(c3510565,RESET_EVENT+RESETS_STANDARD-RESET_TURN_SET+RESET_PHASE+PHASE_END,0,1)
