...
function c60999392.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc60999392(c60999392,0))
...
c60999392.listed_series={0x36}
function c60999392.sumcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetFieldGroupCount(tp,LOCATION_MZONE,0)==1
end
function c60999392.filter(c,e,tp)
	return c:IsSetCard(0x36) and c:GetCode()~=c60999392 and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
