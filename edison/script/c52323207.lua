...
function c52323207.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc52323207(c52323207,0))
	...
	e2:SetDescription(aux.Stringc52323207(c52323207,1))
...
function c52323207.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return c:IsCanTurnSet() and c:GetFlagEffect(c52323207)==0 end
	c:RegisterFlagEffect(c52323207,RESET_EVENT+RESETS_STANDARD-RESET_TURN_SET+RESET_PHASE+PHASE_END,0,1)
