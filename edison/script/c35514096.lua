...
local TOKEN_MULTI=c35514096+1
function c35514096.initial_effect(c)
	--Activate 1 of these effects
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc35514096(c35514096,0))
	e1:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_F)
	e1:SetCode(EVENT_BATTLE_DESTROYING)
	e1:SetCondition(function(e) return e:GetHandler():IsRelateToBattle() end)
	e1:SetTarget(c35514096.efftg)
	e1:SetOperation(c35514096.effop)
	c:RegisterEffect(e1)
end
c35514096.listed_names={TOKEN_MULTI}
function c35514096.efftg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local op=Duel.SelectEffect(tp,
		{b1,aux.Stringc35514096(c35514096,1)},
		{b2,aux.Stringc35514096(c35514096,2)},
		{b3,aux.Stringc35514096(c35514096,3)})
	e:SetLabel(op)
	if op==1 then
		e:SetCategory(0)
		e:SetProperty(0)
...
function c35514096.effop(e,tp,eg,ep,ev,re,r,rp)
	local op=e:GetLabel()
	if op==1 then
