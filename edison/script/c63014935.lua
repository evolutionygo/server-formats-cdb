...
function c63014935.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc63014935(c63014935,0))
	...
	e3:SetDescription(aux.Stringc63014935(c63014935,1))
...
function c63014935.phop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.CheckReleaseGroup(tp,aux.TRUE,1,e:GetHandler()) and Duel.SelectYesNo(tp,aux.Stringc63014935(c63014935,2)) then
