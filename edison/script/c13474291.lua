...
function c13474291.initial_effect(c)
	...
	e4:SetDescription(aux.Stringc13474291(c13474291,0))
...
c13474291.listed_series={0x18}
c13474291.counter_place_list={0x1019}
function c13474291.sdcon(e)
	return e:GetHandler():IsPosition(POS_FACEUP_DEFENSE)
end
function c13474291.spfilter(c)
	return c:IsSetCard(0x18) and c:IsMonster() and c:IsAbleToRemoveAsCost()
end
function c13474291.spcon(e,c)
	if c==nil then return true end
	local tp=c:GetControler()
	local rg=Duel.GetMatchingGroup(c13474291.spfilter,tp,LOCATION_GRAVE,0,nil,ATTRIBUTE_WIND)
	return aux.SelectUnselectGroup(rg,e,tp,1,1,aux.ChkfMMZ(1),0)
end
function c13474291.sptg(e,tp,eg,ep,ev,re,r,rp,c)
	local rg=Duel.GetMatchingGroup(c13474291.spfilter,tp,LOCATION_GRAVE,0,nil,ATTRIBUTE_WIND)
