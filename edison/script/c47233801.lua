...
function c47233801.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc47233801(c47233801,0))
...
function c47233801.damop(e,tp,eg,ep,ev,re,r,rp)
	...
	local dam=c:GetFlagEffectLabel(c47233801)
	if dam==nil then
		c:RegisterFlagEffect(c47233801,RESET_EVENT+RESETS_STANDARD,0,0,200)
		dam=200
	else
		dam=dam*2
		c:SetFlagEffectLabel(c47233801,dam)
	end
