...
function c95519486.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc95519486(c95519486,0))
...
c95519486.listed_series={0x3d}
c95519486.listed_names={c95519486}
function c95519486.cfilter(c)
	return c:IsFaceup() and c:IsSetCard(0x3d) and not c:IsCode(c95519486)
end
