...
function c58132856.initial_effect(c)
	...
	e3:SetDescription(aux.Stringc58132856(c58132856,0))
	...
	e4:SetDescription(aux.Stringc58132856(c58132856,1))
...
c58132856.listed_names={c58132856}
function c58132856.regop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsPreviousLocation(LOCATION_SZONE) and c:IsPreviousPosition(POS_FACEDOWN)
		...
		c:RegisterFlagEffect(c58132856,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,0)
	end
end
function c58132856.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():GetFlagEffect(c58132856)>0 end
...
function c58132856.cfilter(c)
	return c:IsFaceup() and c:IsCode(c58132856)
end
