...
function c48716139.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc48716139(c48716139,0))
	e2:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_F)
	e2:SetCategory(CATEGORY_TOHAND)
	e2:SetCode(EVENT_TO_GRAVE)
	e2:SetCondition(c48716139.retcon)
	e2:SetTarget(c48716139.rettg)
	e2:SetOperation(c48716139.retop)
	c:RegisterEffect(e2)
end
c48716139.listed_card_types={TYPE_SPIRIT}
