...
function c15383415.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc15383415(c15383415,0))
	...
	e2:SetDescription(aux.Stringc15383415(c15383415,1))
...
function c15383415.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return c:IsCanTurnSet() and c:GetFlagEffect(c15383415)==0 end
	c:RegisterFlagEffect(c15383415,RESET_EVENT+RESETS_STANDARD-RESET_TURN_SET+RESET_PHASE+PHASE_END,0,1)
