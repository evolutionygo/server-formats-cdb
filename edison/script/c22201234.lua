...
function c22201234.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc22201234(c22201234,1))
...
function c22201234.qcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsPlayerCanDiscardDeckAsCost(tp,2) and e:GetHandler():GetFlagEffect(c22201234)==0 end
	e:GetHandler():RegisterFlagEffect(c22201234,RESET_CHAIN,0,1)
