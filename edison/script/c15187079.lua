...
function c15187079.initial_effect(c)
	...
	e1:SetCondition(c15187079.sdcon)
	c:RegisterEffect(e1)
	...
	e4:SetDescription(aux.Stringc15187079(c15187079,0))
	e4:SetCategory(CATEGORY_CONTROL)
	e4:SetType(EFFECT_TYPE_IGNITION)
	e4:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e4:SetRange(LOCATION_MZONE)
	e4:SetCountLimit(1)
	e4:SetCost(c15187079.ctcost)
	e4:SetTarget(c15187079.cttg)
	e4:SetOperation(c15187079.ctop)
	c:RegisterEffect(e4)
end
c15187079.listed_series={SET_EARTHBOUND_IMMORTAL}
