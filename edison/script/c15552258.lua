...
function c15552258.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local opt=0
	if #g==0 then
		opt=Duel.SelectOption(1-tp,aux.Stringc15552258(c15552258,1))+1
	else
		opt=Duel.SelectOption(1-tp,aux.Stringc15552258(c15552258,0),aux.Stringc15552258(c15552258,1))
	end
	if opt==1 then
