...
function c55171412.initial_effect(c)
	...
	Fusion.AddContactProc(c,c55171412.contactfil,c55171412.contactop,c55171412.splimit)
	aux.EnableNeosReturn(c)
	--destroy
	local e5=Effect.CreateEffect(c)
	e5:SetDescription(aux.Stringc55171412(c55171412,1))
...
c55171412.listed_names={CARD_NEOS}
