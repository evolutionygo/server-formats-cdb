...
function c10060427.initial_effect(c)
	...
	local e2=aux.AddNormalSummonProcedure(c,true,true,1,1,SUMMON_TYPE_TRIBUTE,aux.Stringc10060427(c10060427,3),c10060427.otfilter)
	local e2a=aux.AddNormalSetProcedure(c,true,true,1,1,SUMMON_TYPE_TRIBUTE,aux.Stringc10060427(c10060427,3),c10060427.otfilter)
	--summon success
	local e3=Effect.CreateEffect(c)
	e3:SetDescription(aux.Stringc10060427(c10060427,4))
...
function c10060427.mtop(e,tp,eg,ep,ev,re,r,rp)
	...
	if #g1>0 and #g2>0 then
		select=Duel.SelectOption(tp,aux.Stringc10060427(c10060427,0),aux.Stringc10060427(c10060427,1),aux.Stringc10060427(c10060427,2))
	elseif #g1>0 then
		select=Duel.SelectOption(tp,aux.Stringc10060427(c10060427,0),aux.Stringc10060427(c10060427,2))
		if select==1 then select=2 end
	elseif #g2>0 then
		select=Duel.SelectOption(tp,aux.Stringc10060427(c10060427,1),aux.Stringc10060427(c10060427,2))+1
	else
		select=Duel.SelectOption(tp,aux.Stringc10060427(c10060427,2))
		select=2
	end
	if select==0 then
