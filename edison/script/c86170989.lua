...
function c86170989.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc86170989(c86170989,0))
...
function c86170989.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local op=0
	Duel.Hint(HINT_SELECTMSG,tp,aux.Stringc86170989(c86170989,0))
	...
	if t1 and t2 then
		op=Duel.SelectOption(tp,aux.Stringc86170989(c86170989,1),aux.Stringc86170989(c86170989,2))+1
	elseif t1 then
		Duel.SelectOption(tp,aux.Stringc86170989(c86170989,1))
		op=1
	elseif t2 then
		Duel.SelectOption(tp,aux.Stringc86170989(c86170989,2))
		op=2
	end
	e:SetLabel(op)
	if op==2 then
