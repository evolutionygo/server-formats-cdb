...
function c44330098.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc44330098(c44330098,0))
	...
	e2:SetDescription(aux.Stringc44330098(c44330098,1))
	...
	e3:SetDescription(aux.Stringc44330098(c44330098,2))
...
function c44330098.sumop2(e,tp,eg,ep,ev,re,r,rp)
	...
	if not Duel.IsPlayerCanSpecialSummonMonster(tp,c44330098+1,0,TYPES_TOKEN,-2,-2,7,RACE_FAIRY,ATTRIBUTE_LIGHT) then return end
	local token=Duel.CreateToken(tp,c44330098+1)
	local e1=Effect.CreateEffect(c)
