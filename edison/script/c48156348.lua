...
function c48156348.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCode2(c,true,true,41470137,aux.FilterBoolFunctionEx(Card.IsSetCard,0x19))
	Fusion.AddContactProc(c,c48156348.contactfil,c48156348.contactop,c48156348.splimit)
	--destroy
	local e3=Effect.CreateEffect(c)
	e3:SetDescription(aux.Stringc48156348(c48156348,0))
	...
	e4:SetDescription(aux.Stringc48156348(c48156348,1))
