...
function c53039326.initial_effect(c)
	...
	e4:SetDescription(aux.Stringc53039326(c53039326,2))
	e4:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_O)
	e4:SetRange(LOCATION_FZONE)
	e4:SetProperty(EFFECT_FLAG_DAMAGE_STEP+EFFECT_FLAG_EVENT_PLAYER)
	e4:SetCode(EVENT_CUSTOM+c53039326)
...
function c53039326.mtop(e,tp,eg,ep,ev,re,r,rp)
	...
	local sel=1
	if #g~=0 then
		sel=Duel.SelectOption(tp,aux.Stringc53039326(c53039326,0),aux.Stringc53039326(c53039326,1))
	else
		sel=Duel.SelectOption(tp,aux.Stringc53039326(c53039326,1))+1
	end
	if sel==0 then
...
function c53039326.check(e,tp,eg,ep,ev,re,r,rp)
	...
	if #g1>0 then Duel.RaiseEvent(g1,EVENT_CUSTOM+c53039326,re,r,rp,turnp,0) end
	if #g2>0 then Duel.RaiseEvent(g2,EVENT_CUSTOM+c53039326,re,r,rp,1-turnp,0) end
end
