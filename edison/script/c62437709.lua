...
function c62437709.initial_effect(c)
	...
	e3:SetDescription(aux.Stringc62437709(c62437709,0))
...
c62437709.listed_series={0xc}
c62437709.counter_place_list={COUNTER_A}
...
function c62437709.flop(e,tp,eg,ep,ev,re,r,rp)
	e:GetHandler():RegisterFlagEffect(c62437709,RESET_EVENT+RESETS_STANDARD_EXC_GRAVE,0,0)
end
function c62437709.drcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsLocation(LOCATION_GRAVE) and e:GetHandler():IsReason(REASON_BATTLE)
		and e:GetHandler():GetFlagEffect(c62437709)~=0
end
