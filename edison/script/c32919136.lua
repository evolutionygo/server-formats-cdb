...
function c32919136.initial_effect(c)
	aux.AddEquipProcedure(c,1,aux.CheckStealEquip,c32919136.eqlimit,nil,c32919136.target)
	--damage
	local e2=Effect.CreateEffect(c)
	e2:SetDescription(aux.Stringc32919136(c32919136,0))
