...
function c75209824.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc75209824(c75209824,0))
	...
	e2:SetDescription(aux.Stringc75209824(c75209824,1))
...
function c75209824.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return c:IsCanTurnSet() and c:GetFlagEffect(c75209824)==0 end
	c:RegisterFlagEffect(c75209824,RESET_EVENT+RESETS_STANDARD-RESET_TURN_SET+RESET_PHASE+PHASE_END,0,1)
