...
function c84926738.initial_effect(c)
	...
	e0:SetOperation(function(e) e:GetHandler():RegisterFlagEffect(c84926738,RESET_EVENT|RESETS_STANDARD,0,1) end)
	c:RegisterEffect(e0)
	--Gain 3000 LP if it is flipped face-up
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc84926738(c84926738,0))
	...
	e2:SetDescription(aux.Stringc84926738(c84926738,1))
	...
	e3:SetOperation(c84926738.regop)
...
function c84926738.regop(e,tp,eg,ep,ev,re,r,rp)
	if e:GetHandler():HasFlagEffect(c84926738) then
