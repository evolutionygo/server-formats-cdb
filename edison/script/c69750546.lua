...
function c69750546.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc69750546(c69750546,0))
	...
	e2:SetDescription(aux.Stringc69750546(c69750546,1))
...
c69750546.listed_series={0xb9}
c69750546.listed_names={c69750546}
...
function c69750546.costfilter(c)
	return c:IsCode(c69750546) and c:IsAbleToGraveAsCost()
end
