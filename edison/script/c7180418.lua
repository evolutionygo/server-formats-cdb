...
c7180418.counter_list={COUNTER_SPELL}
...
function c7180418.ccost(e,tp,eg,ep,ev,re,r,rp)
	if Duel.IsCanRemoveCounter(tp,1,0,COUNTER_SPELL,1,REASON_COST) and Duel.SelectYesNo(tp,aux.Stringc7180418(c7180418,0)) then
