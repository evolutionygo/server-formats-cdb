...
c22628574.listed_names={c22628574}
c22628574.listed_series={SET_BLACKWING}
...
function c22628574.filter(c)
	return c:IsNormalTrap() and not c:IsCode(c22628574) and c:CheckActivateEffect(false,true,false)~=nil
end
function c22628574.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	Duel.Hint(HINT_SELECTMSG,tp,aux.Stringc22628574(c22628574,0))
