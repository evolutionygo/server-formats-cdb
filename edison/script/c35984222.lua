...
function c35984222.initial_effect(c)
	c:SetUniqueOnField(1,0,c35984222)
	--spsummon
	...
	e2:SetDescription(aux.Stringc35984222(c35984222,0))
...
function c35984222.spr(e,tp,eg,ep,ev,re,r,rp)
	...
	c:RegisterFlagEffect(c35984222,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,2)
end
function c35984222.spcon(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	return c:GetTurnID()~=Duel.GetTurnCount() and c:GetFlagEffect(c35984222)>0
end
