...
function c74591968.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc74591968(c74591968,0))
	...
	e3:SetDescription(aux.Stringc74591968(c74591968,1))
...
c74591968.LVnum=4
c74591968.LVset=0x5f
function c74591968.bdop(e,tp,eg,ep,ev,re,r,rp)
	e:GetHandler():RegisterFlagEffect(c74591968,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
end
...
function c74591968.spcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c74591968)>0
end
