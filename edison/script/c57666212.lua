...
function c57666212.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc57666212(c57666212,0))
...
function c57666212.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if d1>0 and Duel.SelectYesNo(0,aux.Stringc57666212(c57666212,1)) then Duel.Draw(0,d1,REASON_EFFECT) end
	if d2>0 and Duel.SelectYesNo(1,aux.Stringc57666212(c57666212,1)) then Duel.Draw(1,d2,REASON_EFFECT) end
end
