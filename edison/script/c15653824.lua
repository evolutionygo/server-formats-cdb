...
function c15653824.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc15653824(c15653824,0))
...
c15653824.listed_names={c15653824}
...
function c15653824.spfilter(c,e,tp)
	return c:IsCode(c15653824) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
