...
function c5861892.initial_effect(c)
	...
	e3:SetDescription(aux.Stringc5861892(c5861892,0))
	...
	c:RegisterEffect(e3)
	aux.DoubleSnareValc5861892ity(c,LOCATION_MZONE)
end
...
function c5861892.sptg(e,tp,eg,ep,ev,re,r,rp,c)
...
function c5861892.coinop(e,tp,eg,ep,ev,re,r,rp)
	...
	c5861892.arcanareg(c,Arcana.TossCoin(c,tp))
end
function c5861892.arcanareg(c,coin)
	--coin effect
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc5861892(c5861892,1))
	...
	--
	local e2=Effect.CreateEffect(c)
	e2:SetDescription(aux.Stringc5861892(c5861892,2))
...
function c5861892.negtg(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	if chk==0 then return c:GetFlagEffect(c5861892)==0 end
	if c:IsHasEffect(EFFECT_REVERSE_UPDATE) then
		c:RegisterFlagEffect(c5861892,RESETS_STANDARD_PHASE_END,0,1)
	end
