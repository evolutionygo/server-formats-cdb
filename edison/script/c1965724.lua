...
c1965724.listed_names={27288416}
...
function c1965724.regcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(c1965724)==0 and eg:IsExists(c1965724.cfilter,1,nil,tp)
...
function c1965724.regop(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():RegisterFlagEffect(c1965724,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
end
function c1965724.atkcon(e)
	return e:GetHandler():GetFlagEffect(c1965724)~=0
end
