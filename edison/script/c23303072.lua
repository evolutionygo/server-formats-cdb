...
function c23303072.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc23303072(c23303072,1))
...
function c23303072.filter(c,tp)
	return c:IsMonster() and c:IsAbleToGraveAsCost()
end
function c23303072.spcon(e,c)
	if c==nil then return true end
	local tp=c:GetControler()
	local rg=Duel.GetMatchingGroup(c23303072.filter,tp,LOCATION_HAND,0,e:GetHandler())
	return aux.SelectUnselectGroup(rg,e,tp,3,3,aux.ChkfMMZ(1),0,c)
end
function c23303072.sptg(e,tp,eg,ep,ev,re,r,rp,c)
