...
function c27174286.op(e,tp,eg,ep,ev,re,r,rp)
	...
	if #g>0 then
		local fc27174286=e:GetHandler():GetFieldID()
		local tc=g:GetFirst()
		for tc in aux.Next(g) do
			Duel.SpecialSummonStep(tc,0,tp,tp,false,false,POS_FACEUP)
			tc:RegisterFlagEffect(c27174286,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1,fc27174286)
		end
...
function c27174286.rmfilter(c,fc27174286)
	return c:GetFlagEffectLabel(c27174286)==fc27174286
end
