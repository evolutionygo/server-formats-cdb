...
function c1764972.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc1764972(c1764972,0))
	...
	e3:SetDescription(aux.Stringc1764972(c1764972,1))
...
c1764972.listed_names={CARD_ASSAULT_MODE,6021033}
...
function c1764972.spop1(e,tp,eg,ep,ev,re,r,rp)
	...
	for tc in aux.Next(g) do
		...
		tc:RegisterFlagEffect(c1764972,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1,fc1764972)
	end
	...
	de:SetLabel(fc1764972)
	de:SetLabelObject(g)
	de:SetCondition(c1764972.descon)
	de:SetOperation(c1764972.desop)
	Duel.RegisterEffect(de,tp)
end
function c1764972.desfilter(c,fc1764972)
	return c:GetFlagEffectLabel(c1764972)==fc1764972
end
