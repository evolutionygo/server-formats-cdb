...
function c21208154.initial_effect(c)
	...
	e7:SetCode(c21208154)
	c:RegisterEffect(e7)
end
function c21208154.filter(c)
	return c:IsFaceup() and not c:IsHasEffect(c21208154)
end
...
function c21208154.regop(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetDescription(aux.Stringc21208154(c21208154,1))
	...
	local e3=Effect.CreateEffect(c)
	e3:SetType(EFFECT_TYPE_SINGLE)
	e3:SetDescription(aux.Stringc21208154(c21208154,descnum))
