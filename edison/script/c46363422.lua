...
function c46363422.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc46363422(c46363422,0))
...
c46363422.counter_place_list={COUNTER_SPELL}
...
function c46363422.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return ft>0 and Duel.IsExistingMatchingCard(c46363422.filter,tp,LOCATION_DECK|LOCATION_HAND|LOCATION_GRAVE,0,1,nil,e,tp) end
...
function c46363422.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,aux.NecroValleyFilter(c46363422.filter),tp,LOCATION_DECK|LOCATION_HAND|LOCATION_GRAVE,0,1,1,nil,e,tp)
	if #g>0 then
