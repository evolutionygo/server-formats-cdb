...
function c96029574.initial_effect(c)
	--synchro summon
	aux.AddSynchroProcedure(c,nil,1,1,aux.NonTunerEx(Card.IsType,TYPE_GEMINI),1,99)
	c:EnableReviveLimit()
	--destroy
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringc96029574(c96029574,0))
	...
	e2:SetDescription(aux.Stringc96029574(c96029574,1))
