...
function c41181774.initial_effect(c)
	...
	e1:SetCondition(c41181774.sdcon)
	c:RegisterEffect(e1)
	...
	e4:SetDescription(aux.Stringc41181774(c41181774,0))
	e4:SetCategory(CATEGORY_TODECK+CATEGORY_HANDES)
	e4:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_F)
	e4:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e4:SetCode(EVENT_SUMMON_SUCCESS)
	e4:SetTarget(c41181774.hdtg)
	e4:SetOperation(c41181774.hdop)
	c:RegisterEffect(e4)
end
c41181774.listed_series={SET_EARTHBOUND_IMMORTAL}
