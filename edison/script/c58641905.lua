...
function c58641905.operation(e,tp,eg,ep,ev,re,r,rp)
	local cc58641905=Duel.GetChainInfo(ev,CHAININFO_CHAIN_ID)
	local e1=Effect.CreateEffect(e:GetHandler())
	e1:SetType(EFFECT_TYPE_FIELD)
	e1:SetCode(EFFECT_CHANGE_DAMAGE)
	e1:SetProperty(EFFECT_FLAG_PLAYER_TARGET)
	e1:SetTargetRange(1,1)
	e1:SetLabel(cc58641905)
...
function c58641905.refcon(e,re,val,r,rp,rc)
	...
	local cc58641905=Duel.GetChainInfo(0,CHAININFO_CHAIN_ID)
	if cc58641905==e:GetLabel() then return 0 end
	return val
end