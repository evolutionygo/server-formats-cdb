...
function c46668237.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc46668237(c46668237,0))
...
function c46668237.condition(e,tp,eg,ep,ev,re,r,rp)
	return not eg:IsContains(e:GetHandler()) and eg:IsExists(c46668237.cfilter,1,nil,tp) and (r&REASON_DESTROY)~=0
end
