...
c6544078.listed_card_types={TYPE_SPIRIT}
...
function c6544078.spcon(e,c)
	...
	local rg=Duel.GetMatchingGroup(c6544078.filter,tp,LOCATION_HAND,0,nil)
	return Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and #rg>0 and aux.SelectUnselectGroup(rg,e,tp,1,1,nil,0)
end
function c6544078.sptg(e,tp,eg,ep,ev,re,r,rp,c)
	local c=e:GetHandler()
	local g=nil
	local rg=Duel.GetMatchingGroup(c6544078.filter,tp,LOCATION_HAND,0,nil,tp)
