...
function c79106360.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc79106360(c79106360,0))
...
function c79106360.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	rg=Duel.GetOperatedGroup():Match(c79106360.filter2,nil)
...
function c79106360.sp(e,tp,ct)
	...
	g:Match(c79106360.spfilter,nil,e,tp)
	if #g>ft then
