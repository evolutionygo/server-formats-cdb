...
function c80887952.initial_effect(c)
	...
	e4:SetDescription(aux.Stringc80887952(c80887952,0))
...
function c80887952.rescon(sg,e,tp,mg)
...
function c80887952.hspcon(e,c)
	...
	return aux.SelectUnselectGroup(rg,e,tp,1,1,c80887952.rescon,0)
end
function c80887952.hsptg(e,tp,eg,ep,ev,re,r,rp,c)
	local rg=Duel.GetReleaseGroup(tp)
	local g=aux.SelectUnselectGroup(rg,e,tp,1,1,c80887952.rescon,1,tp,HINTMSG_RELEASE,c80887952.rescon,nil,true)
	if #g>0 then
		g:KeepAlive()
		e:SetLabelObject(g)
		return true
