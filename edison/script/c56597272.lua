...
function c56597272.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc56597272(c56597272,0))
...
c56597272.listed_names={56597273}
...
function c56597272.operation(e,tp,eg,ep,ev,re,r,rp)
	if Duel.IsPlayerAffectedByEffect(tp,CARD_BLUEEYES_SPIRIT) or Duel.GetLocationCount(tp,LOCATION_MZONE)<2 
		or not Duel.IsPlayerCanSpecialSummonMonster(tp,c56597272+1,0x18,TYPES_TOKEN,0,0,1,RACE_FAIRY,ATTRIBUTE_WATER) then return end
	for i=1,2 do
		local token=Duel.CreateToken(tp,c56597272+1)
