...
function c69890967.initial_effect(c)
	...
	e3:SetDescription(aux.Stringc69890967(c69890967,0))
	...
	e4:SetDescription(aux.Stringc69890967(c69890967,1))
...
c69890967.listed_names={69890968}
...
function c69890967.sptg(e,tp,eg,ep,ev,re,r,rp,c)
	local rg=Duel.GetReleaseGroup(tp):Filter(c69890967.rfilter,nil,tp)
...
function c69890967.tkop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and Duel.IsPlayerCanSpecialSummonMonster(tp,c69890967+1,0,TYPES_TOKEN,1000,1000,1,RACE_FIEND,ATTRIBUTE_DARK) then
		local token=Duel.CreateToken(tp,c69890967+1)
...
function c69890967.atkfilter(c)
	return c:GetTextAttack()>0
end
function c69890967.atcost(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	if chk==0 then return Duel.CheckReleaseGroupCost(tp,c69890967.atkfilter,1,false,nil,c) end
	local g=Duel.SelectReleaseGroupCost(tp,c69890967.atkfilter,1,1,false,nil,c)
