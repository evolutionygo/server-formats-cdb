...
function c79569173.initial_effect(c)
	...
	e2:SetDescription(aux.Stringc79569173(c79569173,0))
	e2:SetCategory(CATEGORY_TOHAND)
	e2:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e2:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e2:SetCode(EVENT_CUSTOM+c79569173)
...
function c79569173.desop(e,tp,eg,ep,ev,re,r,rp)
	...
	if ct==3 and Duel.Destroy(c,REASON_EFFECT)>0 then
		Duel.RaiseSingleEvent(e:GetHandler(),EVENT_CUSTOM+c79569173,e,0,tp,tp,0)
	end
end
