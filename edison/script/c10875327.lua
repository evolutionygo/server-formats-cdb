...
function c10875327.initial_effect(c)
	...
	e1:SetCondition(c10875327.sdcon)
	c:RegisterEffect(e1)
	...
	e4:SetDescription(aux.Stringc10875327(c10875327,0))
	e4:SetCategory(CATEGORY_DESTROY+CATEGORY_DAMAGE)
	e4:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_F)
	e4:SetCode(EVENT_LEAVE_FIELD)
	e4:SetCondition(c10875327.descon)
	e4:SetTarget(c10875327.destg)
	e4:SetOperation(c10875327.desop)
	c:RegisterEffect(e4)
end
c10875327.listed_series={SET_EARTHBOUND_IMMORTAL}
