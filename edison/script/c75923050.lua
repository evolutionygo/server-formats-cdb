...
function c75923050.initial_effect(c)
	...
	e1:SetDescription(aux.Stringc75923050(c75923050,0))
	...
	e2:SetDescription(aux.Stringc75923050(c75923050,1))
...
function c75923050.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return c:GetOwner()==tp and c:IsAbleToExtra()
		and Duel.IsExistingMatchingCard(c75923050.spfilter,tp,LOCATION_EXTRA,0,1,nil,e,tp,c) end
...
function c75923050.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.SendtoDeck(c,nil,2,REASON_EFFECT)>0 then
		...
		local sg=Duel.SelectMatchingCard(tp,c75923050.spfilter,tp,LOCATION_EXTRA,0,1,1,nil,e,tp,c)
